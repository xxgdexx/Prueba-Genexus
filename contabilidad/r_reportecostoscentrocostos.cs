...
namespace GeneXus.Programs.contabilidad {
   public class r_reportecostoscentrocostos : GXDataArea
   {
      public r_reportecostoscentrocostos( )
      {
      ...
      public r_reportecostoscentrocostos( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031998", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_reportecostoscentrocostos.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vCOSCOD_DATA", AV22COScod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vCOSCOD_DATA", AV22COScod_Data);
         }
         GxWebStd.gx_hidden_field( context, "vMONCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18MonCod), 6, 0, ".", "")));
      ...
      {
         return formatLink("contabilidad.r_reportecostoscentrocostos.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_ReporteCostosCentroCostos" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte de Costos por Centro de Costos" ;
      }
      ...
      protected void WB450( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockano_Internalname, "Año", "", "", lblTextblockano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavAno_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Ano), 4, 0, ".", "")), StringUtil.LTrim( ((edtavAno_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5Ano), "ZZZ9") : context.localUtil.Format( (decimal)(AV5Ano), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAno_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavAno_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockmes_Internalname, "Mes", "", "", lblTextblockmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavMes, cmbavMes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17Mes), 2, 0)), 1, cmbavMes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavMes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "", true, 1, "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            cmbavMes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV17Mes), 2, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_coscod_Internalname, "Centro de Costos", "", "", lblTextblockcombo_coscod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_coscod.SetProperty("DropDownOptionsData", AV22COScod_Data);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCoscod_Internalname, StringUtil.RTrim( AV21COScod), StringUtil.RTrim( context.localUtil.Format( AV21COScod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCoscod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCoscod_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_ReporteCostosCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START452( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte de Costos por Centro de Costos", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV17Mes = (short)(NumberUtil.Val( cmbavMes.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV17Mes), 2, 0))), "."));
            AssignAttri("", false, "AV17Mes", StringUtil.LTrimStr( (decimal)(AV17Mes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavMes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV17Mes), 2, 0));
      ...
      protected void STRUP450( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vCOSCOD_DATA"), AV22COScod_Data);
            /* Read saved values. */
            ...
            AV17Mes = (short)(NumberUtil.Val( cgiGet( cmbavMes_Internalname), "."));
            AssignAttri("", false, "AV17Mes", StringUtil.LTrimStr( (decimal)(AV17Mes), 2, 0));
            AV21COScod = cgiGet( edtavCoscod_Internalname);
            AssignAttri("", false, "AV21COScod", AV21COScod);
      ...
      protected void E11452( )
      {
         ...
         AssignAttri("", false, "AV5Ano", StringUtil.LTrimStr( (decimal)(AV5Ano), 4, 0));
         AV17Mes = (short)(DateTimeUtil.Month( DateTimeUtil.Today( context)));
         AssignAttri("", false, "AV17Mes", StringUtil.LTrimStr( (decimal)(AV17Mes), 2, 0));
      }
      ...
      protected void E12452( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "contabilidad.r_reportecostocentrocostospdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV5Ano,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV17Mes,2,0)) + "," + UrlEncode(StringUtil.RTrim(AV21COScod)) + "," + UrlEncode(StringUtil.LTrimStr(AV18MonCod,6,0));
         Innewwindow_Target = formatLink("contabilidad.r_reportecostocentrocostospdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E13452( )
      {
         ...
         new GeneXus.Programs.contabilidad.p_reportecostocentrocostoexcel(context ).execute( ref  AV5Ano, ref  AV17Mes, ref  AV21COScod, ref  AV18MonCod, out  AV16ExcelFilename, out  AV15ErrorMessage) ;
         AssignAttri("", false, "AV5Ano", StringUtil.LTrimStr( (decimal)(AV5Ano), 4, 0));
         AssignAttri("", false, "AV17Mes", StringUtil.LTrimStr( (decimal)(AV17Mes), 2, 0));
         AssignAttri("", false, "AV21COScod", AV21COScod);
         AssignAttri("", false, "AV18MonCod", StringUtil.LTrimStr( (decimal)(AV18MonCod), 6, 0));
      ...
      protected void S112( )
      {
         ...
         {
            A762COSSts = H00452_A762COSSts[0];
            A79COSCod = H00452_A79COSCod[0];
            A761COSDsc = H00452_A761COSDsc[0];
            AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV10Combo_DataItem.gxTpr_Id = A79COSCod;
            AV10Combo_DataItem.gxTpr_Title = A761COSDsc;
            AV22COScod_Data.Add(AV10Combo_DataItem, 0);
            pr_default.readNext(0);
         }
         pr_default.close(0);
         Combo_coscod_Selectedvalue_set = AV21COScod;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810311070", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_reportecostoscentrocostos.js", "?202281810311070", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Costos por Centro de Costos";
         ...
         Form.Caption = "Reporte de Costos por Centro de Costos";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12452',iparms:[{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV17Mes',fld:'vMES',pic:'Z9'},{av:'AV21COScod',fld:'vCOSCOD',pic:''},{av:'AV18MonCod',fld:'vMONCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13452',iparms:[{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV17Mes',fld:'vMES',pic:'Z9'},{av:'AV21COScod',fld:'vCOSCOD',pic:''},{av:'AV18MonCod',fld:'vMONCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV18MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV21COScod',fld:'vCOSCOD',pic:''},{av:'cmbavMes'},{av:'AV17Mes',fld:'vMES',pic:'Z9'},{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E14452',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV22COScod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV15ErrorMessage = "";
         scmdbuf = "";
         H00452_A762COSSts = new short[1] ;
         H00452_A79COSCod = new string[] {""} ;
         H00452_A761COSDsc = new string[] {""} ;
         A79COSCod = "";
         A761COSDsc = "";
         AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_reportecostoscentrocostos__default(),
            new Object[][] {
                new Object[] {
               H00452_A762COSSts, H00452_A79COSCod, H00452_A761COSDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV17Mes ;
      private short nDonePA ;
      private short A762COSSts ;
      private short nGXWrapped ;
      private int AV18MonCod ;
      ...
      private short[] H00452_A762COSSts ;
      private string[] H00452_A79COSCod ;
      private string[] H00452_A761COSDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV22COScod_Data ;
      private GXWebForm Form ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV10Combo_DataItem ;
   }

   public class r_reportecostoscentrocostos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00452", "SELECT [COSSts], [COSCod], [COSDsc] FROM [CBCOSTOS] WHERE [COSSts] = 1 ORDER BY [COSDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00452,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
