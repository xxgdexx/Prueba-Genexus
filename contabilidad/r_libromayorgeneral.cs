...
namespace GeneXus.Programs.contabilidad {
   public class r_libromayorgeneral : GXDataArea
   {
      public r_libromayorgeneral( )
      {
      ...
      public r_libromayorgeneral( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181032265", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_libromayorgeneral.aspx") +"\">") ;
      ...
      {
         return formatLink("contabilidad.r_libromayorgeneral.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_LibroMayorGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Libro Mayor General" ;
      }
      ...
      protected void WB6A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockano_Internalname, "Año", "", "", lblTextblockano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavAno_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Ano), 4, 0, ".", "")), StringUtil.LTrim( ((edtavAno_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5Ano), "ZZZ9") : context.localUtil.Format( (decimal)(AV5Ano), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAno_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavAno_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockmes_Internalname, "Mes", "", "", lblTextblockmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavMes, cmbavMes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV6Mes), 2, 0)), 1, cmbavMes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavMes.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "", true, 1, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccuenta1_Internalname, "Cuenta Desde", "", "", lblTextblockccuenta1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_42_6A2( true) ;
         }
         else
         {
            wb_table1_42_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_42_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccuenta2_Internalname, "Cuenta Hasta", "", "", lblTextblockccuenta2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_59_6A2( true) ;
         }
         else
         {
            wb_table2_59_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_59_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipadcod_Internalname, "Auxiliar", "", "", lblTextblocktipadcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table3_76_6A2( true) ;
         }
         else
         {
            wb_table3_76_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table3_76_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccosto_Internalname, "Cuenta Costo Desde", "", "", lblTextblockccosto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table4_92_6A2( true) ;
         }
         else
         {
            wb_table4_92_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table4_92_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplittedccosto2_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccosto2_Internalname, "Cuenta Costo Hasta", "", "", lblTextblockccosto2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table5_106_6A2( true) ;
         }
         else
         {
            wb_table5_106_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table5_106_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "ButtonColor";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Libro Mayor General", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP6A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13cCosto = cgiGet( edtavCcosto_Internalname);
            AssignAttri("", false, "AV13cCosto", AV13cCosto);
            AV14cCosto2 = cgiGet( edtavCcosto2_Internalname);
            AssignAttri("", false, "AV14cCosto2", AV14cCosto2);
      ...
      protected void E126A2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "contabilidad.r_libromayorgeneralpdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV5Ano,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6Mes,2,0)) + "," + UrlEncode(StringUtil.RTrim(AV7cCuenta1)) + "," + UrlEncode(StringUtil.RTrim(AV9cCuenta2)) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.RTrim(AV11TipADCod)) + "," + UrlEncode(StringUtil.RTrim(AV13cCosto)) + "," + UrlEncode(StringUtil.RTrim(AV14cCosto2));
         Innewwindow_Target = formatLink("contabilidad.r_libromayorgeneralpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E136A2( )
      {
         ...
         returnInSub = false;
         GXt_int1 = 0;
         new GeneXus.Programs.contabilidad.r_libromayorgeneralexcel(context ).execute( ref  AV5Ano, ref  AV6Mes, ref  AV7cCuenta1, ref  AV9cCuenta2, ref  GXt_int1, ref  AV13cCosto, ref  AV14cCosto2, out  AV16ExcelFilename, out  AV17ErrorMessage) ;
         AssignAttri("", false, "AV5Ano", StringUtil.LTrimStr( (decimal)(AV5Ano), 4, 0));
         AssignAttri("", false, "AV6Mes", StringUtil.LTrimStr( (decimal)(AV6Mes), 2, 0));
         AssignAttri("", false, "AV7cCuenta1", AV7cCuenta1);
         AssignAttri("", false, "AV9cCuenta2", AV9cCuenta2);
      ...
      protected void wb_table5_106_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedccosto2_Internalname, tblTablemergedccosto2_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='MergeDataCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCcosto2_Internalname, "c Costo2", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 110,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCcosto2_Internalname, StringUtil.RTrim( AV14cCosto2), StringUtil.RTrim( context.localUtil.Format( AV14cCosto2, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,110);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcosto2_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCcosto2_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtncostoh_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cuenta Costo Hasta", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtncostoh_Jsonclick, "'"+""+"'"+",false,"+"'"+"e166a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_106_6A2e( true) ;
         }
         else
         {
            wb_table5_106_6A2e( false) ;
         }
      }

      protected void wb_table4_92_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedccosto_Internalname, tblTablemergedccosto_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='MergeDataCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCcosto_Internalname, "c Costo", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 96,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCcosto_Internalname, StringUtil.RTrim( AV13cCosto), StringUtil.RTrim( context.localUtil.Format( AV13cCosto, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,96);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcosto_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCcosto_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='CellPaddingLeft10'>") ;
            /* Active images/pictures */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtncostod_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cuenta Costo Desde", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtncostod_Jsonclick, "'"+""+"'"+",false,"+"'"+"e176a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_92_6A2e( true) ;
         }
         else
         {
            wb_table4_92_6A2e( false) ;
         }
      }

      protected void wb_table3_76_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnauxi_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Auxiliar", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnauxi_Jsonclick, "'"+""+"'"+",false,"+"'"+"e186a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavTipadsc_Internalname, StringUtil.RTrim( AV12TipADsc), StringUtil.RTrim( context.localUtil.Format( AV12TipADsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,85);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipadsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavTipadsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_76_6A2e( true) ;
         }
         else
         {
            wb_table3_76_6A2e( false) ;
         }
      }

      protected void wb_table2_59_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCcuenta2_Internalname, "c Cuenta2", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCcuenta2_Internalname, StringUtil.RTrim( AV9cCuenta2), StringUtil.RTrim( context.localUtil.Format( AV9cCuenta2, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcuenta2_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCcuenta2_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='CellPaddingLeft10'>") ;
            /* Active images/pictures */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtncuehast_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cuenta Hasta", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtncuehast_Jsonclick, "'"+""+"'"+",false,"+"'"+"e196a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCcuedsc2_Internalname, "c Cue Dsc2", "gx-form-item ReadonlyAttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 68,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCcuedsc2_Internalname, StringUtil.RTrim( AV10cCueDsc2), StringUtil.RTrim( context.localUtil.Format( AV10cCueDsc2, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,68);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcuedsc2_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavCcuedsc2_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_59_6A2e( true) ;
         }
         else
         {
            wb_table2_59_6A2e( false) ;
         }
      }

      protected void wb_table1_42_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtncuedes_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cuenta Desde", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtncuedes_Jsonclick, "'"+""+"'"+",false,"+"'"+"e206a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCcuedsc1_Internalname, "c Cue Dsc1", "gx-form-item ReadonlyAttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 51,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCcuedsc1_Internalname, StringUtil.RTrim( AV8cCueDsc1), StringUtil.RTrim( context.localUtil.Format( AV8cCueDsc1, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcuedsc1_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavCcuedsc1_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_42_6A2e( true) ;
         }
         else
         {
            wb_table1_42_6A2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181032364", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_libromayorgeneral.js", "?20228181032364", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         imgBtncostod_Internalname = "BTNCOSTOD";
         tblTablemergedccosto_Internalname = "TABLEMERGEDCCOSTO";
         divTablesplittedccosto_Internalname = "TABLESPLITTEDCCOSTO";
         lblTextblockccosto2_Internalname = "TEXTBLOCKCCOSTO2";
         edtavCcosto2_Internalname = "vCCOSTO2";
         imgBtncostoh_Internalname = "BTNCOSTOH";
         tblTablemergedccosto2_Internalname = "TABLEMERGEDCCOSTO2";
         divTablesplittedccosto2_Internalname = "TABLESPLITTEDCCOSTO2";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCcosto_Enabled = 1;
         edtavCcosto2_Jsonclick = "";
         edtavCcosto2_Enabled = 1;
         cmbavMes_Jsonclick = "";
         cmbavMes.Enabled = 1;
         edtavAno_Jsonclick = "";
         edtavAno_Enabled = 1;
         ...
         Dvpanel_panel1_Title = "Libro Mayor General";
         ...
         Form.Caption = "Libro Mayor General";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E126A2',iparms:[{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV6Mes',fld:'vMES',pic:'Z9'},{av:'AV7cCuenta1',fld:'vCCUENTA1',pic:''},{av:'AV9cCuenta2',fld:'vCCUENTA2',pic:''},{av:'AV11TipADCod',fld:'vTIPADCOD',pic:''},{av:'AV13cCosto',fld:'vCCOSTO',pic:''},{av:'AV14cCosto2',fld:'vCCOSTO2',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E136A2',iparms:[{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV6Mes',fld:'vMES',pic:'Z9'},{av:'AV7cCuenta1',fld:'vCCUENTA1',pic:''},{av:'AV9cCuenta2',fld:'vCCUENTA2',pic:''},{av:'AV13cCosto',fld:'vCCOSTO',pic:''},{av:'AV14cCosto2',fld:'vCCOSTO2',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV14cCosto2',fld:'vCCOSTO2',pic:''},{av:'AV13cCosto',fld:'vCCOSTO',pic:''},{av:'AV9cCuenta2',fld:'vCCUENTA2',pic:''},{av:'AV7cCuenta1',fld:'vCCUENTA1',pic:''},{av:'cmbavMes'},{av:'AV6Mes',fld:'vMES',pic:'Z9'},{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E146A2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNCUEDES'","{handler:'E206A1',iparms:[{av:'AV7cCuenta1',fld:'vCCUENTA1',pic:''}]");
         setEventMetadata("'DOBTNCUEDES'",",oparms:[{av:'AV8cCueDsc1',fld:'vCCUEDSC1',pic:''},{av:'AV7cCuenta1',fld:'vCCUENTA1',pic:''}]}");
         setEventMetadata("'DOBTNCUEHAST'","{handler:'E196A1',iparms:[{av:'AV9cCuenta2',fld:'vCCUENTA2',pic:''}]");
         setEventMetadata("'DOBTNCUEHAST'",",oparms:[{av:'AV10cCueDsc2',fld:'vCCUEDSC2',pic:''},{av:'AV9cCuenta2',fld:'vCCUENTA2',pic:''}]}");
         setEventMetadata("'DOBTNAUXI'","{handler:'E186A1',iparms:[{av:'AV11TipADCod',fld:'vTIPADCOD',pic:''},{av:'AV12TipADsc',fld:'vTIPADSC',pic:''}]");
         setEventMetadata("'DOBTNAUXI'",",oparms:[{av:'AV12TipADsc',fld:'vTIPADSC',pic:''},{av:'AV11TipADCod',fld:'vTIPADCOD',pic:''}]}");
         setEventMetadata("'DOBTNCOSTOD'","{handler:'E176A1',iparms:[{av:'AV13cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("'DOBTNCOSTOD'",",oparms:[{av:'AV13cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("'DOBTNCOSTOH'","{handler:'E166A1',iparms:[{av:'AV14cCosto2',fld:'vCCOSTO2',pic:''}]");
         setEventMetadata("'DOBTNCOSTOH'",",oparms:[{av:'AV14cCosto2',fld:'vCCOSTO2',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sStyleString = "";
         sImgUrl = "";
         imgBtncostoh_Jsonclick = "";
         imgBtncostod_Jsonclick = "";
      ...
      private int edtavCcosto2_Enabled ;
      private int edtavCcosto_Enabled ;
      ...
      private string divTablesplittedccosto2_Internalname ;
      private string lblTextblockccosto2_Internalname ;
      private string lblTextblockccosto2_Jsonclick ;
      ...
      private string AV13cCosto ;
      private string edtavCcosto_Internalname ;
      private string AV14cCosto2 ;
      private string edtavCcosto2_Internalname ;
      private string GXEncryptionTmp ;
      private string sStyleString ;
      private string tblTablemergedccosto2_Internalname ;
      private string edtavCcosto2_Jsonclick ;
      private string sImgUrl ;
      private string imgBtncostoh_Internalname ;
      private string imgBtncostoh_Jsonclick ;
      private string tblTablemergedccosto_Internalname ;
      private string edtavCcosto_Jsonclick ;
      private string imgBtncostod_Internalname ;
      private string imgBtncostod_Jsonclick ;
