   ...
   public class r_reporteflujocaja : GXDataArea
   {
      ...
      protected void WB530( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjano_Internalname, "Año", "", "", lblTextblockjano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_ReporteFlujoCaja.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
