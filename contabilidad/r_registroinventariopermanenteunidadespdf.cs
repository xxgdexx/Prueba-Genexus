   ...
   public class r_registroinventariopermanenteunidadespdf : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV21cMes = GXt_char1;
            AV87Tipo = "16";
            AV12Titulo = "FORMATO 12.1: REGISTRO DE INVENTARIO PERMANENTE EN UNIDADES FÍSICAS - DETALLE DE INVENTARIO PERMANENTE EN UNIDADES FÍSICAS";
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               ...
               getPrinter().GxDrawText("Página:", 693, Gx_line+31, 737, Gx_line+45, 0+256, 0, 0, 0) ;
               getPrinter().GxAttris("Tahoma", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               ...
               getPrinter().GxDrawText("Número", 203, Gx_line+155, 245, Gx_line+168, 0+256, 0, 0, 0) ;
               ...
               getPrinter().GxDrawText("Operación", 282, Gx_line+147, 336, Gx_line+160, 0+256, 0, 0, 0) ;
