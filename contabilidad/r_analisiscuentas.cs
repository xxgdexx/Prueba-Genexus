   ...
   public class r_analisiscuentas : GXDataArea
   {
      ...
      protected void WB670( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockano_Internalname, "Año", "", "", lblTextblockano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_AnalisisCuentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavAno_Internalname, "Año", "col-sm-3 AttributeWidthAutoLabel", 0, true, "");
            /* Single line edit */
      ...
      protected void START672( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Análisis de Cuenta", 0) ;
         }
         context.wjLoc = "";
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Análisis de Cuenta";
         ...
         Form.Caption = "Análisis de Cuenta";
