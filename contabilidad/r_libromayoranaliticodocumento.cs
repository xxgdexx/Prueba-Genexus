...
namespace GeneXus.Programs.contabilidad {
   public class r_libromayoranaliticodocumento : GXDataArea
   {
      public r_libromayoranaliticodocumento( )
      {
      ...
      public r_libromayoranaliticodocumento( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810315828", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_libromayoranaliticodocumento.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCCUENTA2", StringUtil.RTrim( AV11cCuenta2));
      ...
      {
         return formatLink("contabilidad.r_libromayoranaliticodocumento.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_LibroMayorAnaliticoDocumento" ;
      }

      public override string GetPgmdesc( )
      {
         return "Libro Mayor Analitico por Documento" ;
      }
      ...
      protected void WB620( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV16FDesde, "99/99/99"), context.localUtil.Format( AV16FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV17FHasta, "99/99/99"), context.localUtil.Format( AV17FHasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccosto_Internalname, "Centro de Costos", "", "", lblTextblockccosto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCcosto, dynavCcosto_Internalname, StringUtil.RTrim( AV6cCosto), 1, dynavCcosto_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, dynavCcosto.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "", true, 1, "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            dynavCcosto.CurrentValue = StringUtil.RTrim( AV6cCosto);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccuenta1_Internalname, "Cuenta Desde", "", "", lblTextblockccuenta1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_50_622( true) ;
         }
         else
         {
            wb_table1_50_622( false) ;
         }
         return  ;
      }

      protected void wb_table1_50_622e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipadcod_Internalname, "Auxiliar", "", "", lblTextblocktipadcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_67_622( true) ;
         }
         else
         {
            wb_table2_67_622( false) ;
         }
         return  ;
      }

      protected void wb_table2_67_622e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START622( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Libro Mayor Analitico por Documento", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvCCOSTO622( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvCCOSTO_html622( )
      {
      ...
      protected void GXDLVvCCOSTO_data622( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.RTrim( H00622_A79COSCod[0]));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H00622_A761COSDsc[0]));
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV6cCosto = dynavCcosto.getValidValue(AV6cCosto);
      ...
      protected void STRUP620( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavFhasta_Internalname), 2) == 0 )
            {
               ...
               AssignAttri("", false, "AV17FHasta", context.localUtil.Format(AV17FHasta, "99/99/99"));
            }
            else
            {
               AV17FHasta = context.localUtil.CToD( cgiGet( edtavFhasta_Internalname), 2);
               AssignAttri("", false, "AV17FHasta", context.localUtil.Format(AV17FHasta, "99/99/99"));
            }
            dynavCcosto.CurrentValue = cgiGet( dynavCcosto_Internalname);
            AV6cCosto = cgiGet( dynavCcosto_Internalname);
            AssignAttri("", false, "AV6cCosto", AV6cCosto);
            ...
            AV22TipADCod = cgiGet( edtavTipadcod_Internalname);
            AssignAttri("", false, "AV22TipADCod", AV22TipADCod);
            AV23TipADsc = cgiGet( edtavTipadsc_Internalname);
            AssignAttri("", false, "AV23TipADsc", AV23TipADsc);
      ...
      protected void E11622( )
      {
         ...
         AV19Mes = (short)(DateTimeUtil.Month( DateTimeUtil.Today( context)));
      }
      ...
      protected void E12622( )
      {
         ...
         {
            GX_msglist.addItem("Falta ingresar el numero de cuenta a analizar");
            AV18Flag = 1;
         }
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "contabilidad.r_mayorgeneralanaliticopdf.aspx"+UrlEncode(DateTimeUtil.FormatDateParm(AV16FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV17FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV6cCosto)) + "," + UrlEncode(StringUtil.RTrim(AV10cCuenta1)) + "," + UrlEncode(StringUtil.RTrim(AV11cCuenta2)) + "," + UrlEncode(StringUtil.RTrim(AV22TipADCod));
            Innewwindow_Target = formatLink("contabilidad.r_mayorgeneralanaliticopdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E13622( )
      {
         ...
         if ( AV18Flag == 0 )
         {
            new GeneXus.Programs.contabilidad.r_libromayorgeneralbimonedaexcel(context ).execute( ref  AV16FDesde, ref  AV17FHasta, ref  AV6cCosto, ref  AV10cCuenta1, ref  AV11cCuenta2, ref  AV22TipADCod, out  AV15ExcelFilename, out  AV14ErrorMessage) ;
            AssignAttri("", false, "AV16FDesde", context.localUtil.Format(AV16FDesde, "99/99/99"));
            AssignAttri("", false, "AV17FHasta", context.localUtil.Format(AV17FHasta, "99/99/99"));
            AssignAttri("", false, "AV6cCosto", AV6cCosto);
            AssignAttri("", false, "AV10cCuenta1", AV10cCuenta1);
      ...
      protected void wb_table2_67_622( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTipadcod_Internalname, StringUtil.RTrim( AV22TipADCod), StringUtil.RTrim( context.localUtil.Format( AV22TipADCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,71);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipadcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTipadcod_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscaraux_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cuenta", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscaraux_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16621_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavTipadsc_Internalname, StringUtil.RTrim( AV23TipADsc), StringUtil.RTrim( context.localUtil.Format( AV23TipADsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipadsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavTipadsc_Enabled, 1, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_67_622e( true) ;
         }
         else
         {
            wb_table2_67_622e( false) ;
         }
      }

      protected void wb_table1_50_622( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnbuscarcue_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cuenta", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscarcue_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17621_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcuedsc1_Internalname, StringUtil.RTrim( AV8cCueDsc1), StringUtil.RTrim( context.localUtil.Format( AV8cCueDsc1, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcuedsc1_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavCcuedsc1_Enabled, 1, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_LibroMayorAnaliticoDocumento.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_50_622e( true) ;
         }
         else
         {
            wb_table1_50_622e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031590", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_libromayoranaliticodocumento.js", "?20228181031590", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Libro Mayor Analitico por Documento";
         ...
         Form.Caption = "Libro Mayor Analitico por Documento";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12622',iparms:[{av:'AV10cCuenta1',fld:'vCCUENTA1',pic:''},{av:'AV16FDesde',fld:'vFDESDE',pic:''},{av:'AV17FHasta',fld:'vFHASTA',pic:''},{av:'AV11cCuenta2',fld:'vCCUENTA2',pic:''},{av:'AV22TipADCod',fld:'vTIPADCOD',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13622',iparms:[{av:'AV10cCuenta1',fld:'vCCUENTA1',pic:''},{av:'AV16FDesde',fld:'vFDESDE',pic:''},{av:'AV17FHasta',fld:'vFHASTA',pic:''},{av:'AV11cCuenta2',fld:'vCCUENTA2',pic:''},{av:'AV22TipADCod',fld:'vTIPADCOD',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV22TipADCod',fld:'vTIPADCOD',pic:''},{av:'AV11cCuenta2',fld:'vCCUENTA2',pic:''},{av:'AV10cCuenta1',fld:'vCCUENTA1',pic:''},{av:'AV17FHasta',fld:'vFHASTA',pic:''},{av:'AV16FDesde',fld:'vFDESDE',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E14622',iparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("'DOBTNBUSCARCUE'","{handler:'E17621',iparms:[{av:'AV10cCuenta1',fld:'vCCUENTA1',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("'DOBTNBUSCARCUE'",",oparms:[{av:'AV8cCueDsc1',fld:'vCCUEDSC1',pic:''},{av:'AV10cCuenta1',fld:'vCCUENTA1',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("'DOBTNBUSCARAUX'","{handler:'E16621',iparms:[{av:'AV22TipADCod',fld:'vTIPADCOD',pic:''},{av:'AV23TipADsc',fld:'vTIPADSC',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("'DOBTNBUSCARAUX'",",oparms:[{av:'AV23TipADsc',fld:'vTIPADSC',pic:''},{av:'AV22TipADCod',fld:'vTIPADCOD',pic:''},{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'dynavCcosto'},{av:'AV6cCosto',fld:'vCCOSTO',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H00622_A79COSCod = new string[] {""} ;
         H00622_A761COSDsc = new string[] {""} ;
         H00622_A762COSSts = new short[1] ;
         AV10cCuenta1 = "";
         AV8cCueDsc1 = "";
         AV22TipADCod = "";
         AV23TipADsc = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_libromayoranaliticodocumento__default(),
            new Object[][] {
                new Object[] {
               H00622_A79COSCod, H00622_A761COSDsc, H00622_A762COSSts
               }
            }
         );
         AV17FHasta = DateTimeUtil.Today( context);
      ...
      private string AV22TipADCod ;
      private string edtavTipadcod_Internalname ;
      private string AV23TipADsc ;
      ...
      private string[] H00622_A79COSCod ;
      private string[] H00622_A761COSDsc ;
      private short[] H00622_A762COSSts ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class r_libromayoranaliticodocumento__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00622", "SELECT [COSCod], [COSDsc], [COSSts] FROM [CBCOSTOS] WHERE [COSSts] = 1 ORDER BY [COSDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00622,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
