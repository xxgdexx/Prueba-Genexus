...
namespace GeneXus.Programs.contabilidad {
   public class r_resultadofuncionpdf : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "contabilidad.r_resultadofuncionpdf.aspx")), "contabilidad.r_resultadofuncionpdf.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "contabilidad.r_resultadofuncionpdf.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public r_resultadofuncionpdf( IGxContext context )
      {
      ...
      public void executeSubmit( ref short aP0_Ano ,
                                 ...
                                 ref string aP4_CosCod )
      {
         r_resultadofuncionpdf objr_resultadofuncionpdf;
         objr_resultadofuncionpdf = new r_resultadofuncionpdf();
         objr_resultadofuncionpdf.AV11Ano = aP0_Ano;
         objr_resultadofuncionpdf.AV12Mes = aP1_Mes;
         objr_resultadofuncionpdf.AV48Tipo = aP2_Tipo;
         objr_resultadofuncionpdf.AV49Moneda = aP3_Moneda;
         objr_resultadofuncionpdf.AV52CosCod = aP4_CosCod;
         objr_resultadofuncionpdf.context.SetSubmitInitialConfig(context);
         objr_resultadofuncionpdf.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_resultadofuncionpdf);
         aP0_Ano=this.AV11Ano;
         aP1_Mes=this.AV12Mes;
         aP2_Tipo=this.AV48Tipo;
         aP3_Moneda=this.AV49Moneda;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_resultadofuncionpdf)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV8TotTipo = "FUN";
            AV13Titulo = "Estado de Ganancias y Pérdidas por Función";
            AV50Titulo2 = "";
            /* Using cursor P00BQ2 */
            pr_default.execute(0, new Object[] {AV49Moneda});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A180MonCod = P00BQ2_A180MonCod[0];
               A1234MonDsc = P00BQ2_A1234MonDsc[0];
            ...
            {
               A126TASICod = P00BQ3_A126TASICod[0];
               A2077VouSts = P00BQ3_A2077VouSts[0];
               A127VouAno = P00BQ3_A127VouAno[0];
               A2074VouFec = P00BQ3_A2074VouFec[0];
               A128VouMes = P00BQ3_A128VouMes[0];
               A129VouNum = P00BQ3_A129VouNum[0];
            ...
            {
               A114TotTipo = P00BQ4_A114TotTipo[0];
               A115TotRub = P00BQ4_A115TotRub[0];
               A1928TotDsc = P00BQ4_A1928TotDsc[0];
               A1929TotDscTot = P00BQ4_A1929TotDscTot[0];
               A120TotOrd = P00BQ4_A120TotOrd[0];
               ...
               {
                  A115TotRub = P00BQ5_A115TotRub[0];
                  A114TotTipo = P00BQ5_A114TotTipo[0];
                  A1829RubSts = P00BQ5_A1829RubSts[0];
                  A116RubCod = P00BQ5_A116RubCod[0];
                  A1822RubDsc = P00BQ5_A1822RubDsc[0];
                  A1823RubDscTot = P00BQ5_A1823RubDscTot[0];
                  A117RubOrd = P00BQ5_A117RubOrd[0];
                  ...
                  {
                     A116RubCod = P00BQ6_A116RubCod[0];
                     A115TotRub = P00BQ6_A115TotRub[0];
                     A114TotTipo = P00BQ6_A114TotTipo[0];
                     A118RubLinCod = P00BQ6_A118RubLinCod[0];
                     A1826RubLinDsc = P00BQ6_A1826RubLinDsc[0];
                     A119RubLinOrd = P00BQ6_A119RubLinOrd[0];
      ...
      protected void S111( )
      {
         ...
         {
            A118RubLinCod = P00BQ7_A118RubLinCod[0];
            A116RubCod = P00BQ7_A116RubCod[0];
            A115TotRub = P00BQ7_A115TotRub[0];
            A114TotTipo = P00BQ7_A114TotTipo[0];
            A860CueDsc = P00BQ7_A860CueDsc[0];
            A91CueCod = P00BQ7_A91CueCod[0];
            A860CueDsc = P00BQ7_A860CueDsc[0];
      ...
      protected void HBQ0( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         AV50Titulo2 = "";
         scmdbuf = "";
         P00BQ2_A180MonCod = new int[1] ;
         P00BQ2_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV36FechaA = "";
         P00BQ3_A126TASICod = new int[1] ;
         P00BQ3_A2077VouSts = new short[1] ;
         P00BQ3_A127VouAno = new short[1] ;
         P00BQ3_A2074VouFec = new DateTime[] {DateTime.MinValue} ;
         P00BQ3_A128VouMes = new short[1] ;
         P00BQ3_A129VouNum = new string[] {""} ;
         ...
         AV14Periodo = "";
         P00BQ4_A114TotTipo = new string[] {""} ;
         P00BQ4_A115TotRub = new int[1] ;
         P00BQ4_A1928TotDsc = new string[] {""} ;
         P00BQ4_A1929TotDscTot = new string[] {""} ;
         P00BQ4_A120TotOrd = new short[1] ;
         A114TotTipo = "";
         A1928TotDsc = "";
         A1929TotDscTot = "";
         P00BQ5_A115TotRub = new int[1] ;
         P00BQ5_A114TotTipo = new string[] {""} ;
         P00BQ5_A1829RubSts = new short[1] ;
         P00BQ5_A116RubCod = new int[1] ;
         P00BQ5_A1822RubDsc = new string[] {""} ;
         P00BQ5_A1823RubDscTot = new string[] {""} ;
         P00BQ5_A117RubOrd = new short[1] ;
         A1822RubDsc = "";
         A1823RubDscTot = "";
         P00BQ6_A116RubCod = new int[1] ;
         P00BQ6_A115TotRub = new int[1] ;
         P00BQ6_A114TotTipo = new string[] {""} ;
         P00BQ6_A118RubLinCod = new int[1] ;
         P00BQ6_A1826RubLinDsc = new string[] {""} ;
         P00BQ6_A119RubLinOrd = new short[1] ;
         A1826RubLinDsc = "";
         P00BQ7_A118RubLinCod = new int[1] ;
         P00BQ7_A116RubCod = new int[1] ;
         P00BQ7_A115TotRub = new int[1] ;
         P00BQ7_A114TotTipo = new string[] {""} ;
         P00BQ7_A860CueDsc = new string[] {""} ;
         P00BQ7_A91CueCod = new string[] {""} ;
         A860CueDsc = "";
         A91CueCod = "";
         AV40Cuenta = "";
         AV41CueDsc = "";
         P00BQ8_A91CueCod = new string[] {""} ;
         AV43CueCod = "";
         GXt_char1 = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_resultadofuncionpdf__default(),
            new Object[][] {
                new Object[] {
               P00BQ2_A180MonCod, P00BQ2_A1234MonDsc
               }
               , new Object[] {
               P00BQ3_A126TASICod, P00BQ3_A2077VouSts, P00BQ3_A127VouAno, P00BQ3_A2074VouFec, P00BQ3_A128VouMes, P00BQ3_A129VouNum
               }
               , new Object[] {
               P00BQ4_A114TotTipo, P00BQ4_A115TotRub, P00BQ4_A1928TotDsc, P00BQ4_A1929TotDscTot, P00BQ4_A120TotOrd
               }
               , new Object[] {
               P00BQ5_A115TotRub, P00BQ5_A114TotTipo, P00BQ5_A1829RubSts, P00BQ5_A116RubCod, P00BQ5_A1822RubDsc, P00BQ5_A1823RubDscTot, P00BQ5_A117RubOrd
               }
               , new Object[] {
               P00BQ6_A116RubCod, P00BQ6_A115TotRub, P00BQ6_A114TotTipo, P00BQ6_A118RubLinCod, P00BQ6_A1826RubLinDsc, P00BQ6_A119RubLinOrd
               }
               , new Object[] {
               P00BQ7_A118RubLinCod, P00BQ7_A116RubCod, P00BQ7_A115TotRub, P00BQ7_A114TotTipo, P00BQ7_A860CueDsc, P00BQ7_A91CueCod
               }
               , new Object[] {
               P00BQ8_A91CueCod
               }
      ...
      private int[] P00BQ2_A180MonCod ;
      private string[] P00BQ2_A1234MonDsc ;
      private int[] P00BQ3_A126TASICod ;
      private short[] P00BQ3_A2077VouSts ;
      private short[] P00BQ3_A127VouAno ;
      private DateTime[] P00BQ3_A2074VouFec ;
      private short[] P00BQ3_A128VouMes ;
      private string[] P00BQ3_A129VouNum ;
      private string[] P00BQ4_A114TotTipo ;
      private int[] P00BQ4_A115TotRub ;
      private string[] P00BQ4_A1928TotDsc ;
      private string[] P00BQ4_A1929TotDscTot ;
      private short[] P00BQ4_A120TotOrd ;
      private int[] P00BQ5_A115TotRub ;
      private string[] P00BQ5_A114TotTipo ;
      private short[] P00BQ5_A1829RubSts ;
      private int[] P00BQ5_A116RubCod ;
      private string[] P00BQ5_A1822RubDsc ;
      private string[] P00BQ5_A1823RubDscTot ;
      private short[] P00BQ5_A117RubOrd ;
      private int[] P00BQ6_A116RubCod ;
      private int[] P00BQ6_A115TotRub ;
      private string[] P00BQ6_A114TotTipo ;
      private int[] P00BQ6_A118RubLinCod ;
      private string[] P00BQ6_A1826RubLinDsc ;
      private short[] P00BQ6_A119RubLinOrd ;
      private int[] P00BQ7_A118RubLinCod ;
      private int[] P00BQ7_A116RubCod ;
      private int[] P00BQ7_A115TotRub ;
      private string[] P00BQ7_A114TotTipo ;
      private string[] P00BQ7_A860CueDsc ;
      private string[] P00BQ7_A91CueCod ;
      private string[] P00BQ8_A91CueCod ;
   }

   public class r_resultadofuncionpdf__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmP00BQ8;
          prmP00BQ8 = new Object[] {
          new ParDef("@AV47Len",GXType.Int32,5,0) ,
          new ParDef("@AV40Cuenta",GXType.Char,15,0)
          };
          def= new CursorDef[] {
              new CursorDef("P00BQ2", "SELECT [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonCod] = @AV49Moneda ORDER BY [MonCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00BQ3", "SELECT [TASICod], [VouSts], [VouAno], [VouFec], [VouMes], [VouNum] FROM [CBVOUCHER] WHERE ([VouAno] = @AV11Ano) AND ([VouSts] = 1) AND ([TASICod] = 1) ORDER BY [VouAno] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00BQ4", "SELECT [TotTipo], [TotRub], [TotDsc], [TotDscTot], [TotOrd] FROM [CBRUBROST] WHERE [TotTipo] = @AV8TotTipo ORDER BY [TotOrd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BQ5", "SELECT [TotRub], [TotTipo], [RubSts], [RubCod], [RubDsc], [RubDscTot], [RubOrd] FROM [CBRUBROS] WHERE ([TotTipo] = @AV8TotTipo) AND ([TotRub] = @AV9TotRub) ORDER BY [RubOrd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ5,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BQ6", "SELECT [RubCod], [TotRub], [TotTipo], [RubLinCod], [RubLinDsc], [RubLinOrd] FROM [CBRUBROSL] WHERE ([TotTipo] = @AV8TotTipo) AND ([TotRub] = @AV9TotRub) AND ([RubCod] = @AV10RubCod) ORDER BY [RubLinOrd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ6,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BQ7", "SELECT T1.[RubLinCod], T1.[RubCod], T1.[TotRub], T1.[TotTipo], T2.[CueDsc], T1.[CueCod] FROM ([CBRUBROSLD] T1 INNER JOIN [CBPLANCUENTA] T2 ON T2.[CueCod] = T1.[CueCod]) WHERE T1.[TotTipo] = @AV8TotTipo and T1.[TotRub] = @AV9TotRub and T1.[RubCod] = @AV10RubCod and T1.[RubLinCod] = @AV39RubLinCod ORDER BY T1.[TotTipo], T1.[TotRub], T1.[RubCod], T1.[RubLinCod], T1.[CueCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ7,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BQ8", "SELECT [CueCod] FROM [CBPLANCUENTA] WHERE SUBSTRING([CueCod], 1, @AV47Len) = @AV40Cuenta ORDER BY [CueCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BQ8,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
