...
namespace GeneXus.Programs.contabilidad {
   public class r_registroretenciones : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810312198", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_registroretenciones.aspx") +"\">") ;
      ...
      {
         return formatLink("contabilidad.r_registroretenciones.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_RegistroRetenciones" ;
      }

      public override string GetPgmdesc( )
      {
         return "Registro de Retenciones" ;
      }
      ...
      protected void WB4X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjano_Internalname, "Año", "", "", lblTextblockjano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavJano_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10jAno), 4, 0, ".", "")), StringUtil.LTrim( ((edtavJano_Enabled!=0) ? context.localUtil.Format( (decimal)(AV10jAno), "ZZZ9") : context.localUtil.Format( (decimal)(AV10jAno), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavJano_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavJano_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjmes_Internalname, "Mes", "", "", lblTextblockjmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavJmes, cmbavJmes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV11jMes), 2, 0)), 1, cmbavJmes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavJmes.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "", true, 1, "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV11jMes), 2, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_RegistroRetenciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Registro de Retenciones", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV11jMes = (short)(NumberUtil.Val( cmbavJmes.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV11jMes), 2, 0))), "."));
            AssignAttri("", false, "AV11jMes", StringUtil.LTrimStr( (decimal)(AV11jMes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV11jMes), 2, 0));
      ...
      protected void STRUP4X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV10jAno = 0;
               AssignAttri("", false, "AV10jAno", StringUtil.LTrimStr( (decimal)(AV10jAno), 4, 0));
            }
            else
            {
               AV10jAno = (short)(context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ","));
               AssignAttri("", false, "AV10jAno", StringUtil.LTrimStr( (decimal)(AV10jAno), 4, 0));
            }
            cmbavJmes.CurrentValue = cgiGet( cmbavJmes_Internalname);
            AV11jMes = (short)(NumberUtil.Val( cgiGet( cmbavJmes_Internalname), "."));
            AssignAttri("", false, "AV11jMes", StringUtil.LTrimStr( (decimal)(AV11jMes), 2, 0));
      ...
      protected void E114X2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV11jMes = (short)(DateTimeUtil.Month( DateTimeUtil.Now( context)));
         AssignAttri("", false, "AV11jMes", StringUtil.LTrimStr( (decimal)(AV11jMes), 2, 0));
         AV10jAno = (short)(DateTimeUtil.Year( DateTimeUtil.Now( context)));
         AssignAttri("", false, "AV10jAno", StringUtil.LTrimStr( (decimal)(AV10jAno), 4, 0));
      }
      ...
      protected void E124X2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "contabilidad.rrlibro4_1.aspx"+UrlEncode(StringUtil.LTrimStr(AV10jAno,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11jMes,2,0));
      ...
      protected void E134X2( )
      {
         /* 'DoBtnExcel' Routine */
         returnInSub = false;
         new GeneXus.Programs.compras.r_registroretencionesexcel(context ).execute( ref  AV10jAno, ref  AV11jMes, out  AV7ExcelFilename, out  AV6ErrorMessage) ;
         AssignAttri("", false, "AV10jAno", StringUtil.LTrimStr( (decimal)(AV10jAno), 4, 0));
         AssignAttri("", false, "AV11jMes", StringUtil.LTrimStr( (decimal)(AV11jMes), 2, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810312235", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_registroretenciones.js", "?202281810312236", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Registro de Retenciones";
         ...
         Form.Caption = "Registro de Retenciones";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E124X2',iparms:[{av:'AV10jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV11jMes',fld:'vJMES',pic:'Z9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E134X2',iparms:[{av:'AV10jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV11jMes',fld:'vJMES',pic:'Z9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'cmbavJmes'},{av:'AV11jMes',fld:'vJMES',pic:'Z9'},{av:'AV10jAno',fld:'vJANO',pic:'ZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E144X2',iparms:[]");
      ...
      private short AV10jAno ;
      private short AV11jMes ;
