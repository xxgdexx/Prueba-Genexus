...
namespace GeneXus.Programs.contabilidad {
   public class r_plibromayorsimplificadoexcel : GXProcedure
   {
      public r_plibromayorsimplificadoexcel( )
      {
      ...
      public r_plibromayorsimplificadoexcel( IGxContext context )
      {
      ...
      public void executeSubmit( ref short aP0_Ano ,
                                 ...
                                 out string aP3_ErrorMessage )
      {
         r_plibromayorsimplificadoexcel objr_plibromayorsimplificadoexcel;
         objr_plibromayorsimplificadoexcel = new r_plibromayorsimplificadoexcel();
         objr_plibromayorsimplificadoexcel.AV8Ano = aP0_Ano;
         objr_plibromayorsimplificadoexcel.AV9Mes = aP1_Mes;
         objr_plibromayorsimplificadoexcel.AV10Filename = "" ;
         objr_plibromayorsimplificadoexcel.AV11ErrorMessage = "" ;
         objr_plibromayorsimplificadoexcel.context.SetSubmitInitialConfig(context);
         objr_plibromayorsimplificadoexcel.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_plibromayorsimplificadoexcel);
         aP0_Ano=this.AV8Ano;
         aP1_Mes=this.AV9Mes;
         aP2_Filename=this.AV10Filename;
         aP3_ErrorMessage=this.AV11ErrorMessage;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_plibromayorsimplificadoexcel)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV37Archivo.Source = "Excel/PlantillasLibroDiarioSimplificado.xlsx";
         AV38Path = AV37Archivo.GetPath();
         AV41FilenameOrigen = StringUtil.Trim( AV38Path) + "\\PlantillasLibroDiarioSimplificado.xlsx";
         ...
         {
            BRKC92 = false;
            A133CueCodAux = P00C92_A133CueCodAux[0];
            A91CueCod = P00C92_A91CueCod[0];
            A79COSCod = P00C92_A79COSCod[0];
            n79COSCod = P00C92_n79COSCod[0];
            A127VouAno = P00C92_A127VouAno[0];
            A860CueDsc = P00C92_A860CueDsc[0];
            A70TipACod = P00C92_A70TipACod[0];
            n70TipACod = P00C92_n70TipACod[0];
            A128VouMes = P00C92_A128VouMes[0];
            A126TASICod = P00C92_A126TASICod[0];
            A129VouNum = P00C92_A129VouNum[0];
            A130VouDSec = P00C92_A130VouDSec[0];
            A860CueDsc = P00C92_A860CueDsc[0];
            A70TipACod = P00C92_A70TipACod[0];
            n70TipACod = P00C92_n70TipACod[0];
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00C92_A91CueCod[0], A91CueCod) == 0 ) )
            {
               BRKC92 = false;
               A133CueCodAux = P00C92_A133CueCodAux[0];
               A127VouAno = P00C92_A127VouAno[0];
      ...
      protected void S111( )
      {
         ...
         if ( AV87TipACod > 0 )
         {
            ...
            {
               BRKC94 = false;
               A134CueAuxCod = P00C93_A134CueAuxCod[0];
               A133CueCodAux = P00C93_A133CueCodAux[0];
               A91CueCod = P00C93_A91CueCod[0];
               A127VouAno = P00C93_A127VouAno[0];
               A128VouMes = P00C93_A128VouMes[0];
               A126TASICod = P00C93_A126TASICod[0];
               A129VouNum = P00C93_A129VouNum[0];
               A130VouDSec = P00C93_A130VouDSec[0];
               while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00C93_A133CueCodAux[0], A133CueCodAux) == 0 ) )
               {
                  BRKC94 = false;
                  A134CueAuxCod = P00C93_A134CueAuxCod[0];
                  A127VouAno = P00C93_A127VouAno[0];
      ...
      protected void S124( )
      {
         ...
         {
            A71TipADCod = P00C94_A71TipADCod[0];
            A70TipACod = P00C94_A70TipACod[0];
            n70TipACod = P00C94_n70TipACod[0];
            A72TipADDsc = P00C94_A72TipADDsc[0];
            AV96GXLvl197 = 1;
      ...
      protected void S171( )
      {
         ...
         {
            A126TASICod = P00C95_A126TASICod[0];
            A2077VouSts = P00C95_A2077VouSts[0];
            A79COSCod = P00C95_A79COSCod[0];
            n79COSCod = P00C95_n79COSCod[0];
            A91CueCod = P00C95_A91CueCod[0];
            A128VouMes = P00C95_A128VouMes[0];
            A127VouAno = P00C95_A127VouAno[0];
            A2069VouDTcmb = P00C95_A2069VouDTcmb[0];
            A1894TASIAbr = P00C95_A1894TASIAbr[0];
            A129VouNum = P00C95_A129VouNum[0];
            A2053VouDDoc = P00C95_A2053VouDDoc[0];
            A136VouReg = P00C95_A136VouReg[0];
            A2051VouDDeb = P00C95_A2051VouDDeb[0];
            A2055VouDHab = P00C95_A2055VouDHab[0];
            A2075VouGls = P00C95_A2075VouGls[0];
            A2054VouDGls = P00C95_A2054VouDGls[0];
            A131VouDMon = P00C95_A131VouDMon[0];
            A2052VouDDebO = P00C95_A2052VouDDebO[0];
            A2056VouDHabO = P00C95_A2056VouDHabO[0];
            A135VouDFec = P00C95_A135VouDFec[0];
            A130VouDSec = P00C95_A130VouDSec[0];
            A1894TASIAbr = P00C95_A1894TASIAbr[0];
            A2077VouSts = P00C95_A2077VouSts[0];
            A2075VouGls = P00C95_A2075VouGls[0];
      ...
      protected void S154( )
      {
         ...
         {
            A126TASICod = P00C96_A126TASICod[0];
            A2077VouSts = P00C96_A2077VouSts[0];
            A79COSCod = P00C96_A79COSCod[0];
            n79COSCod = P00C96_n79COSCod[0];
            A133CueCodAux = P00C96_A133CueCodAux[0];
            A91CueCod = P00C96_A91CueCod[0];
            A128VouMes = P00C96_A128VouMes[0];
            A127VouAno = P00C96_A127VouAno[0];
            A2069VouDTcmb = P00C96_A2069VouDTcmb[0];
            A1894TASIAbr = P00C96_A1894TASIAbr[0];
            A129VouNum = P00C96_A129VouNum[0];
            A2053VouDDoc = P00C96_A2053VouDDoc[0];
            A136VouReg = P00C96_A136VouReg[0];
            A2051VouDDeb = P00C96_A2051VouDDeb[0];
            A2055VouDHab = P00C96_A2055VouDHab[0];
            A2075VouGls = P00C96_A2075VouGls[0];
            A2054VouDGls = P00C96_A2054VouDGls[0];
            A131VouDMon = P00C96_A131VouDMon[0];
            A2052VouDDebO = P00C96_A2052VouDDebO[0];
            A2056VouDHabO = P00C96_A2056VouDHabO[0];
            A135VouDFec = P00C96_A135VouDFec[0];
            A130VouDSec = P00C96_A130VouDSec[0];
            A1894TASIAbr = P00C96_A1894TASIAbr[0];
            A2077VouSts = P00C96_A2077VouSts[0];
            A2075VouGls = P00C96_A2075VouGls[0];
            AV66TasiAbr = A1894TASIAbr;
      ...
      protected void S201( )
      {
         ...
         {
            A126TASICod = P00C97_A126TASICod[0];
            A129VouNum = P00C97_A129VouNum[0];
            A79COSCod = P00C97_A79COSCod[0];
            n79COSCod = P00C97_n79COSCod[0];
            A2077VouSts = P00C97_A2077VouSts[0];
            A91CueCod = P00C97_A91CueCod[0];
            A128VouMes = P00C97_A128VouMes[0];
            A127VouAno = P00C97_A127VouAno[0];
            A2069VouDTcmb = P00C97_A2069VouDTcmb[0];
            A130VouDSec = P00C97_A130VouDSec[0];
            A2077VouSts = P00C97_A2077VouSts[0];
            AV62Flag = 1;
      ...
      protected void S134( )
      {
         ...
         {
            A126TASICod = P00C98_A126TASICod[0];
            A129VouNum = P00C98_A129VouNum[0];
            A2077VouSts = P00C98_A2077VouSts[0];
            A79COSCod = P00C98_A79COSCod[0];
            n79COSCod = P00C98_n79COSCod[0];
            A133CueCodAux = P00C98_A133CueCodAux[0];
            A91CueCod = P00C98_A91CueCod[0];
            A128VouMes = P00C98_A128VouMes[0];
            A127VouAno = P00C98_A127VouAno[0];
            A2069VouDTcmb = P00C98_A2069VouDTcmb[0];
            A130VouDSec = P00C98_A130VouDSec[0];
            A2077VouSts = P00C98_A2077VouSts[0];
            AV63Flag1 = 1;
            /* Exit For each command. Update data (if necessary), close cursors & exit. */
            if (true) break;
      ...
      public override void initialize( )
      {
         ...
         A91CueCod = "";
         A79COSCod = "";
         P00C92_A133CueCodAux = new string[] {""} ;
         P00C92_A91CueCod = new string[] {""} ;
         P00C92_A79COSCod = new string[] {""} ;
         P00C92_n79COSCod = new bool[] {false} ;
         P00C92_A127VouAno = new short[1] ;
         P00C92_A860CueDsc = new string[] {""} ;
         P00C92_A70TipACod = new int[1] ;
         P00C92_n70TipACod = new bool[] {false} ;
         P00C92_A128VouMes = new short[1] ;
         P00C92_A126TASICod = new int[1] ;
         P00C92_A129VouNum = new string[] {""} ;
         P00C92_A130VouDSec = new int[1] ;
         A133CueCodAux = "";
         A860CueDsc = "";
         A129VouNum = "";
         AV46CueCod = "";
         AV47CueDsc = "";
         P00C93_A134CueAuxCod = new string[] {""} ;
         P00C93_A133CueCodAux = new string[] {""} ;
         P00C93_A91CueCod = new string[] {""} ;
         P00C93_A127VouAno = new short[1] ;
         P00C93_A128VouMes = new short[1] ;
         P00C93_A126TASICod = new int[1] ;
         P00C93_A129VouNum = new string[] {""} ;
         P00C93_A130VouDSec = new int[1] ;
         A134CueAuxCod = "";
         AV64CueDAxu = "";
         P00C94_A71TipADCod = new string[] {""} ;
         P00C94_A70TipACod = new int[1] ;
         P00C94_n70TipACod = new bool[] {false} ;
         P00C94_A72TipADDsc = new string[] {""} ;
         A71TipADCod = "";
         A72TipADDsc = "";
         AV65CueDAxuDsc = "";
         P00C95_A126TASICod = new int[1] ;
         P00C95_A2077VouSts = new short[1] ;
         P00C95_A79COSCod = new string[] {""} ;
         P00C95_n79COSCod = new bool[] {false} ;
         P00C95_A91CueCod = new string[] {""} ;
         P00C95_A128VouMes = new short[1] ;
         P00C95_A127VouAno = new short[1] ;
         P00C95_A2069VouDTcmb = new decimal[1] ;
         P00C95_A1894TASIAbr = new string[] {""} ;
         P00C95_A129VouNum = new string[] {""} ;
         P00C95_A2053VouDDoc = new string[] {""} ;
         P00C95_A136VouReg = new string[] {""} ;
         P00C95_A2051VouDDeb = new decimal[1] ;
         P00C95_A2055VouDHab = new decimal[1] ;
         P00C95_A2075VouGls = new string[] {""} ;
         P00C95_A2054VouDGls = new string[] {""} ;
         P00C95_A131VouDMon = new int[1] ;
         P00C95_A2052VouDDebO = new decimal[1] ;
         P00C95_A2056VouDHabO = new decimal[1] ;
         P00C95_A135VouDFec = new DateTime[] {DateTime.MinValue} ;
         P00C95_A130VouDSec = new int[1] ;
         A1894TASIAbr = "";
         A2053VouDDoc = "";
         A136VouReg = "";
         A2075VouGls = "";
         ...
         AV89COSCod = "";
         AV73Glosa = "";
         P00C96_A126TASICod = new int[1] ;
         P00C96_A2077VouSts = new short[1] ;
         P00C96_A79COSCod = new string[] {""} ;
         P00C96_n79COSCod = new bool[] {false} ;
         P00C96_A133CueCodAux = new string[] {""} ;
         P00C96_A91CueCod = new string[] {""} ;
         P00C96_A128VouMes = new short[1] ;
         P00C96_A127VouAno = new short[1] ;
         P00C96_A2069VouDTcmb = new decimal[1] ;
         P00C96_A1894TASIAbr = new string[] {""} ;
         P00C96_A129VouNum = new string[] {""} ;
         P00C96_A2053VouDDoc = new string[] {""} ;
         P00C96_A136VouReg = new string[] {""} ;
         P00C96_A2051VouDDeb = new decimal[1] ;
         P00C96_A2055VouDHab = new decimal[1] ;
         P00C96_A2075VouGls = new string[] {""} ;
         P00C96_A2054VouDGls = new string[] {""} ;
         P00C96_A131VouDMon = new int[1] ;
         P00C96_A2052VouDDebO = new decimal[1] ;
         P00C96_A2056VouDHabO = new decimal[1] ;
         P00C96_A135VouDFec = new DateTime[] {DateTime.MinValue} ;
         P00C96_A130VouDSec = new int[1] ;
         P00C97_A126TASICod = new int[1] ;
         P00C97_A129VouNum = new string[] {""} ;
         P00C97_A79COSCod = new string[] {""} ;
         P00C97_n79COSCod = new bool[] {false} ;
         P00C97_A2077VouSts = new short[1] ;
         P00C97_A91CueCod = new string[] {""} ;
         P00C97_A128VouMes = new short[1] ;
         P00C97_A127VouAno = new short[1] ;
         P00C97_A2069VouDTcmb = new decimal[1] ;
         P00C97_A130VouDSec = new int[1] ;
         P00C98_A126TASICod = new int[1] ;
         P00C98_A129VouNum = new string[] {""} ;
         P00C98_A2077VouSts = new short[1] ;
         P00C98_A79COSCod = new string[] {""} ;
         P00C98_n79COSCod = new bool[] {false} ;
         P00C98_A133CueCodAux = new string[] {""} ;
         P00C98_A91CueCod = new string[] {""} ;
         P00C98_A128VouMes = new short[1] ;
         P00C98_A127VouAno = new short[1] ;
         P00C98_A2069VouDTcmb = new decimal[1] ;
         P00C98_A130VouDSec = new int[1] ;
         GXt_dtime2 = (DateTime)(DateTime.MinValue);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_plibromayorsimplificadoexcel__default(),
            new Object[][] {
                new Object[] {
               P00C92_A133CueCodAux, P00C92_A91CueCod, P00C92_A79COSCod, P00C92_n79COSCod, P00C92_A127VouAno, P00C92_A860CueDsc, P00C92_A70TipACod, P00C92_n70TipACod, P00C92_A128VouMes, P00C92_A126TASICod,
               P00C92_A129VouNum, P00C92_A130VouDSec
               }
               , new Object[] {
               P00C93_A134CueAuxCod, P00C93_A133CueCodAux, P00C93_A91CueCod, P00C93_A127VouAno, P00C93_A128VouMes, P00C93_A126TASICod, P00C93_A129VouNum, P00C93_A130VouDSec
               }
               , new Object[] {
               P00C94_A71TipADCod, P00C94_A70TipACod, P00C94_A72TipADDsc
               }
               , new Object[] {
               P00C95_A126TASICod, P00C95_A2077VouSts, P00C95_A79COSCod, P00C95_n79COSCod, P00C95_A91CueCod, P00C95_A128VouMes, P00C95_A127VouAno, P00C95_A2069VouDTcmb, P00C95_A1894TASIAbr, P00C95_A129VouNum,
               P00C95_A2053VouDDoc, P00C95_A136VouReg, P00C95_A2051VouDDeb, P00C95_A2055VouDHab, P00C95_A2075VouGls, P00C95_A2054VouDGls, P00C95_A131VouDMon, P00C95_A2052VouDDebO, P00C95_A2056VouDHabO, P00C95_A135VouDFec,
               P00C95_A130VouDSec
               }
               , new Object[] {
               P00C96_A126TASICod, P00C96_A2077VouSts, P00C96_A79COSCod, P00C96_n79COSCod, P00C96_A133CueCodAux, P00C96_A91CueCod, P00C96_A128VouMes, P00C96_A127VouAno, P00C96_A2069VouDTcmb, P00C96_A1894TASIAbr,
               P00C96_A129VouNum, P00C96_A2053VouDDoc, P00C96_A136VouReg, P00C96_A2051VouDDeb, P00C96_A2055VouDHab, P00C96_A2075VouGls, P00C96_A2054VouDGls, P00C96_A131VouDMon, P00C96_A2052VouDDebO, P00C96_A2056VouDHabO,
               P00C96_A135VouDFec, P00C96_A130VouDSec
               }
               , new Object[] {
               P00C97_A126TASICod, P00C97_A129VouNum, P00C97_A79COSCod, P00C97_n79COSCod, P00C97_A2077VouSts, P00C97_A91CueCod, P00C97_A128VouMes, P00C97_A127VouAno, P00C97_A2069VouDTcmb, P00C97_A130VouDSec
               }
               , new Object[] {
               P00C98_A126TASICod, P00C98_A129VouNum, P00C98_A2077VouSts, P00C98_A79COSCod, P00C98_n79COSCod, P00C98_A133CueCodAux, P00C98_A91CueCod, P00C98_A128VouMes, P00C98_A127VouAno, P00C98_A2069VouDTcmb,
               P00C98_A130VouDSec
               }
            }
         );
      ...
      private string[] P00C92_A133CueCodAux ;
      private string[] P00C92_A91CueCod ;
      private string[] P00C92_A79COSCod ;
      private bool[] P00C92_n79COSCod ;
      private short[] P00C92_A127VouAno ;
      private string[] P00C92_A860CueDsc ;
      private int[] P00C92_A70TipACod ;
      private bool[] P00C92_n70TipACod ;
      private short[] P00C92_A128VouMes ;
      private int[] P00C92_A126TASICod ;
      private string[] P00C92_A129VouNum ;
      private int[] P00C92_A130VouDSec ;
      private string[] P00C93_A134CueAuxCod ;
      private string[] P00C93_A133CueCodAux ;
      private string[] P00C93_A91CueCod ;
      private short[] P00C93_A127VouAno ;
      private short[] P00C93_A128VouMes ;
      private int[] P00C93_A126TASICod ;
      private string[] P00C93_A129VouNum ;
      private int[] P00C93_A130VouDSec ;
      private string[] P00C94_A71TipADCod ;
      private int[] P00C94_A70TipACod ;
      private bool[] P00C94_n70TipACod ;
      private string[] P00C94_A72TipADDsc ;
      private int[] P00C95_A126TASICod ;
      private short[] P00C95_A2077VouSts ;
      private string[] P00C95_A79COSCod ;
      private bool[] P00C95_n79COSCod ;
      private string[] P00C95_A91CueCod ;
      private short[] P00C95_A128VouMes ;
      private short[] P00C95_A127VouAno ;
      private decimal[] P00C95_A2069VouDTcmb ;
      private string[] P00C95_A1894TASIAbr ;
      private string[] P00C95_A129VouNum ;
      private string[] P00C95_A2053VouDDoc ;
      private string[] P00C95_A136VouReg ;
      private decimal[] P00C95_A2051VouDDeb ;
      private decimal[] P00C95_A2055VouDHab ;
      private string[] P00C95_A2075VouGls ;
      private string[] P00C95_A2054VouDGls ;
      private int[] P00C95_A131VouDMon ;
      private decimal[] P00C95_A2052VouDDebO ;
      private decimal[] P00C95_A2056VouDHabO ;
      private DateTime[] P00C95_A135VouDFec ;
      private int[] P00C95_A130VouDSec ;
      private int[] P00C96_A126TASICod ;
      private short[] P00C96_A2077VouSts ;
      private string[] P00C96_A79COSCod ;
      private bool[] P00C96_n79COSCod ;
      private string[] P00C96_A133CueCodAux ;
      private string[] P00C96_A91CueCod ;
      private short[] P00C96_A128VouMes ;
      private short[] P00C96_A127VouAno ;
      private decimal[] P00C96_A2069VouDTcmb ;
      private string[] P00C96_A1894TASIAbr ;
      private string[] P00C96_A129VouNum ;
      private string[] P00C96_A2053VouDDoc ;
      private string[] P00C96_A136VouReg ;
      private decimal[] P00C96_A2051VouDDeb ;
      private decimal[] P00C96_A2055VouDHab ;
      private string[] P00C96_A2075VouGls ;
      private string[] P00C96_A2054VouDGls ;
      private int[] P00C96_A131VouDMon ;
      private decimal[] P00C96_A2052VouDDebO ;
      private decimal[] P00C96_A2056VouDHabO ;
      private DateTime[] P00C96_A135VouDFec ;
      private int[] P00C96_A130VouDSec ;
      private int[] P00C97_A126TASICod ;
      private string[] P00C97_A129VouNum ;
      private string[] P00C97_A79COSCod ;
      private bool[] P00C97_n79COSCod ;
      private short[] P00C97_A2077VouSts ;
      private string[] P00C97_A91CueCod ;
      private short[] P00C97_A128VouMes ;
      private short[] P00C97_A127VouAno ;
      private decimal[] P00C97_A2069VouDTcmb ;
      private int[] P00C97_A130VouDSec ;
      private int[] P00C98_A126TASICod ;
      private string[] P00C98_A129VouNum ;
      private short[] P00C98_A2077VouSts ;
      private string[] P00C98_A79COSCod ;
      private bool[] P00C98_n79COSCod ;
      private string[] P00C98_A133CueCodAux ;
      private string[] P00C98_A91CueCod ;
      private short[] P00C98_A128VouMes ;
      private short[] P00C98_A127VouAno ;
      private decimal[] P00C98_A2069VouDTcmb ;
      private int[] P00C98_A130VouDSec ;
   ...
   public class r_plibromayorsimplificadoexcel__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00C92( IGxContext context ,
                                             string AV44cCuenta1 ,
                                             string AV45cCuenta2 ,
                                             string AV43cCosto ,
                                             string AV88cCosto2 ,
      ...
      protected Object[] conditional_P00C95( IGxContext context ,
                                             string AV43cCosto ,
                                             string AV88cCosto2 ,
                                             string A79COSCod ,
                                             short A127VouAno ,
      ...
      protected Object[] conditional_P00C96( IGxContext context ,
                                             string AV43cCosto ,
                                             string AV88cCosto2 ,
                                             string A79COSCod ,
                                             short A127VouAno ,
      ...
      protected Object[] conditional_P00C97( IGxContext context ,
                                             string AV43cCosto ,
                                             string AV88cCosto2 ,
                                             string A79COSCod ,
                                             short A2077VouSts ,
      ...
      protected Object[] conditional_P00C98( IGxContext context ,
                                             string AV43cCosto ,
                                             string AV88cCosto2 ,
                                             string A79COSCod ,
                                             short A2077VouSts ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C92(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] );
               case 3 :
                     return conditional_P00C95(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] );
               case 4 :
                     return conditional_P00C96(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (short)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] );
               case 5 :
                     return conditional_P00C97(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] );
               case 6 :
                     return conditional_P00C98(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00C92", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C92,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C93", "SELECT [CueAuxCod], [CueCodAux], [CueCod], [VouAno], [VouMes], [TASICod], [VouNum], [VouDSec] FROM [CBVOUCHERDET] WHERE ([VouAno] = @AV8Ano) AND ([CueCod] = @AV46CueCod) ORDER BY [CueCodAux], [CueAuxCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C93,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C94", "SELECT [TipADCod], [TipACod], [TipADDsc] FROM [CBAUXILIARES] WHERE [TipACod] = @AV87TipACod and [TipADCod] = @AV64CueDAxu ORDER BY [TipACod], [TipADCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C94,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00C95", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C95,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C96", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C96,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00C97", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C97,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00C98", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C98,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
