...
namespace GeneXus.Programs.contabilidad {
   public class r_resultadofuncionanualpdf : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "contabilidad.r_resultadofuncionanualpdf.aspx")), "contabilidad.r_resultadofuncionanualpdf.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "contabilidad.r_resultadofuncionanualpdf.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public r_resultadofuncionanualpdf( )
      {
      ...
      public r_resultadofuncionanualpdf( IGxContext context )
      {
      ...
      public void executeSubmit( ref short aP0_Ano ,
                                 ...
                                 ref int aP2_Moneda )
      {
         r_resultadofuncionanualpdf objr_resultadofuncionanualpdf;
         objr_resultadofuncionanualpdf = new r_resultadofuncionanualpdf();
         objr_resultadofuncionanualpdf.AV8Ano = aP0_Ano;
         objr_resultadofuncionanualpdf.AV72Tipo = aP1_Tipo;
         objr_resultadofuncionanualpdf.AV39Moneda = aP2_Moneda;
         objr_resultadofuncionanualpdf.context.SetSubmitInitialConfig(context);
         objr_resultadofuncionanualpdf.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_resultadofuncionanualpdf);
         aP0_Ano=this.AV8Ano;
         aP1_Tipo=this.AV72Tipo;
         aP2_Moneda=this.AV39Moneda;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_resultadofuncionanualpdf)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV76TotTipo = "FUN";
            AV73Titulo = "Estado de Ganancias y Pérdidas por Función - Anual";
            AV74Titulo2 = "";
            ...
            {
               A180MonCod = P00D92_A180MonCod[0];
               A1234MonDsc = P00D92_A1234MonDsc[0];
            ...
            {
               A114TotTipo = P00D93_A114TotTipo[0];
               A115TotRub = P00D93_A115TotRub[0];
               A1928TotDsc = P00D93_A1928TotDsc[0];
               A1929TotDscTot = P00D93_A1929TotDscTot[0];
               A120TotOrd = P00D93_A120TotOrd[0];
               ...
               {
                  A115TotRub = P00D94_A115TotRub[0];
                  A114TotTipo = P00D94_A114TotTipo[0];
                  A1829RubSts = P00D94_A1829RubSts[0];
                  A116RubCod = P00D94_A116RubCod[0];
                  A1822RubDsc = P00D94_A1822RubDsc[0];
                  A1823RubDscTot = P00D94_A1823RubDscTot[0];
                  A117RubOrd = P00D94_A117RubOrd[0];
                  ...
                  {
                     A116RubCod = P00D95_A116RubCod[0];
                     A115TotRub = P00D95_A115TotRub[0];
                     A114TotTipo = P00D95_A114TotTipo[0];
                     A118RubLinCod = P00D95_A118RubLinCod[0];
                     A1826RubLinDsc = P00D95_A1826RubLinDsc[0];
                     A119RubLinOrd = P00D95_A119RubLinOrd[0];
      ...
      protected void S111( )
      {
         ...
         {
            A118RubLinCod = P00D96_A118RubLinCod[0];
            A116RubCod = P00D96_A116RubCod[0];
            A115TotRub = P00D96_A115TotRub[0];
            A114TotTipo = P00D96_A114TotTipo[0];
            A860CueDsc = P00D96_A860CueDsc[0];
            A91CueCod = P00D96_A91CueCod[0];
            A860CueDsc = P00D96_A860CueDsc[0];
      ...
      protected void HD90( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         AV66Periodo = "";
         scmdbuf = "";
         P00D92_A180MonCod = new int[1] ;
         P00D92_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV21Fecha = DateTime.MinValue;
         P00D93_A114TotTipo = new string[] {""} ;
         P00D93_A115TotRub = new int[1] ;
         P00D93_A1928TotDsc = new string[] {""} ;
         P00D93_A1929TotDscTot = new string[] {""} ;
         P00D93_A120TotOrd = new short[1] ;
         A114TotTipo = "";
         A1928TotDsc = "";
         A1929TotDscTot = "";
         P00D94_A115TotRub = new int[1] ;
         P00D94_A114TotTipo = new string[] {""} ;
         P00D94_A1829RubSts = new short[1] ;
         P00D94_A116RubCod = new int[1] ;
         P00D94_A1822RubDsc = new string[] {""} ;
         P00D94_A1823RubDscTot = new string[] {""} ;
         P00D94_A117RubOrd = new short[1] ;
         A1822RubDsc = "";
         A1823RubDscTot = "";
         P00D95_A116RubCod = new int[1] ;
         P00D95_A115TotRub = new int[1] ;
         P00D95_A114TotTipo = new string[] {""} ;
         P00D95_A118RubLinCod = new int[1] ;
         P00D95_A1826RubLinDsc = new string[] {""} ;
         P00D95_A119RubLinOrd = new short[1] ;
         A1826RubLinDsc = "";
         P00D96_A118RubLinCod = new int[1] ;
         P00D96_A116RubCod = new int[1] ;
         P00D96_A115TotRub = new int[1] ;
         P00D96_A114TotTipo = new string[] {""} ;
         P00D96_A860CueDsc = new string[] {""} ;
         P00D96_A91CueCod = new string[] {""} ;
         A860CueDsc = "";
         A91CueCod = "";
         AV14Cuenta = "";
         AV13CueDsc = "";
         P00D97_A91CueCod = new string[] {""} ;
         AV12CueCod = "";
         GXt_char2 = "";
         GXt_char3 = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_resultadofuncionanualpdf__default(),
            new Object[][] {
                new Object[] {
               P00D92_A180MonCod, P00D92_A1234MonDsc
               }
               , new Object[] {
               P00D93_A114TotTipo, P00D93_A115TotRub, P00D93_A1928TotDsc, P00D93_A1929TotDscTot, P00D93_A120TotOrd
               }
               , new Object[] {
               P00D94_A115TotRub, P00D94_A114TotTipo, P00D94_A1829RubSts, P00D94_A116RubCod, P00D94_A1822RubDsc, P00D94_A1823RubDscTot, P00D94_A117RubOrd
               }
               , new Object[] {
               P00D95_A116RubCod, P00D95_A115TotRub, P00D95_A114TotTipo, P00D95_A118RubLinCod, P00D95_A1826RubLinDsc, P00D95_A119RubLinOrd
               }
               , new Object[] {
               P00D96_A118RubLinCod, P00D96_A116RubCod, P00D96_A115TotRub, P00D96_A114TotTipo, P00D96_A860CueDsc, P00D96_A91CueCod
               }
               , new Object[] {
               P00D97_A91CueCod
               }
      ...
      private int[] P00D92_A180MonCod ;
      private string[] P00D92_A1234MonDsc ;
      private string[] P00D93_A114TotTipo ;
      private int[] P00D93_A115TotRub ;
      private string[] P00D93_A1928TotDsc ;
      private string[] P00D93_A1929TotDscTot ;
      private short[] P00D93_A120TotOrd ;
      private int[] P00D94_A115TotRub ;
      private string[] P00D94_A114TotTipo ;
      private short[] P00D94_A1829RubSts ;
      private int[] P00D94_A116RubCod ;
      private string[] P00D94_A1822RubDsc ;
      private string[] P00D94_A1823RubDscTot ;
      private short[] P00D94_A117RubOrd ;
      private int[] P00D95_A116RubCod ;
      private int[] P00D95_A115TotRub ;
      private string[] P00D95_A114TotTipo ;
      private int[] P00D95_A118RubLinCod ;
      private string[] P00D95_A1826RubLinDsc ;
      private short[] P00D95_A119RubLinOrd ;
      private int[] P00D96_A118RubLinCod ;
      private int[] P00D96_A116RubCod ;
      private int[] P00D96_A115TotRub ;
      private string[] P00D96_A114TotTipo ;
      private string[] P00D96_A860CueDsc ;
      private string[] P00D96_A91CueCod ;
      private string[] P00D97_A91CueCod ;
   }

   public class r_resultadofuncionanualpdf__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00D92", "SELECT [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonCod] = @AV39Moneda ORDER BY [MonCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D92,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00D93", "SELECT [TotTipo], [TotRub], [TotDsc], [TotDscTot], [TotOrd] FROM [CBRUBROST] WHERE [TotTipo] = @AV76TotTipo ORDER BY [TotOrd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D93,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00D94", "SELECT [TotRub], [TotTipo], [RubSts], [RubCod], [RubDsc], [RubDscTot], [RubOrd] FROM [CBRUBROS] WHERE ([TotTipo] = @AV76TotTipo) AND ([TotRub] = @AV75TotRub) ORDER BY [RubOrd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D94,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00D95", "SELECT [RubCod], [TotRub], [TotTipo], [RubLinCod], [RubLinDsc], [RubLinOrd] FROM [CBRUBROSL] WHERE ([TotTipo] = @AV76TotTipo) AND ([TotRub] = @AV75TotRub) AND ([RubCod] = @AV67RubCod) ORDER BY [RubLinOrd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D95,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00D96", "SELECT T1.[RubLinCod], T1.[RubCod], T1.[TotRub], T1.[TotTipo], T2.[CueDsc], T1.[CueCod] FROM ([CBRUBROSLD] T1 INNER JOIN [CBPLANCUENTA] T2 ON T2.[CueCod] = T1.[CueCod]) WHERE T1.[TotTipo] = @AV76TotTipo and T1.[TotRub] = @AV75TotRub and T1.[RubCod] = @AV67RubCod and T1.[RubLinCod] = @AV68RubLinCod ORDER BY T1.[TotTipo], T1.[TotRub], T1.[RubCod], T1.[RubLinCod], T1.[CueCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D96,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00D97", "SELECT [CueCod] FROM [CBPLANCUENTA] WHERE SUBSTRING([CueCod], 1, @AV35Len) = @AV14Cuenta ORDER BY [CueCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D97,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
