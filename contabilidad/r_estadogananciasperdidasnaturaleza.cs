...
namespace GeneXus.Programs.contabilidad {
   public class r_estadogananciasperdidasnaturaleza : GXDataArea
   {
      public r_estadogananciasperdidasnaturaleza( )
      {
      ...
      public r_estadogananciasperdidasnaturaleza( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810311058", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_estadogananciasperdidasnaturaleza.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vCOSCOD_DATA", AV23COSCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vCOSCOD_DATA", AV23COSCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      {
         return formatLink("contabilidad.r_estadogananciasperdidasnaturaleza.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_EstadoGananciasPerdidasNaturaleza" ;
      }

      public override string GetPgmdesc( )
      {
         return "Estado de Ganancias y Perdidas por Naturaleza" ;
      }
      ...
      protected void WB460( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipbalance_Internalname, "Tipo de Reporte", "", "", lblTextblocktipbalance_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavTipbalance, cmbavTipbalance_Internalname, StringUtil.RTrim( AV20TipBalance), 1, cmbavTipbalance_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavTipbalance.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, 1, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            cmbavTipbalance.CurrentValue = StringUtil.RTrim( AV20TipBalance);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockano_Internalname, "Año", "", "", lblTextblockano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavAno_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6Ano), 4, 0, ".", "")), StringUtil.LTrim( ((edtavAno_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6Ano), "ZZZ9") : context.localUtil.Format( (decimal)(AV6Ano), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAno_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavAno_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockmes_Internalname, "Mes", "", "", lblTextblockmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavMes, cmbavMes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV16Mes), 2, 0)), 1, cmbavMes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavMes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "", true, 1, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            cmbavMes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV16Mes), 2, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_coscod_Internalname, "Centro de Costos", "", "", lblTextblockcombo_coscod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_coscod.SetProperty("DropDownOptionsData", AV23COSCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Tipo", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV21Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCoscod_Internalname, StringUtil.RTrim( AV22COSCod), StringUtil.RTrim( context.localUtil.Format( AV22COSCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,80);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCoscod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCoscod_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 81,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV17MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,81);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_EstadoGananciasPerdidasNaturaleza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START462( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Estado de Ganancias y Perdidas por Naturaleza", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV20TipBalance = cmbavTipbalance.getValidValue(AV20TipBalance);
            AssignAttri("", false, "AV20TipBalance", AV20TipBalance);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavTipbalance.CurrentValue = StringUtil.RTrim( AV20TipBalance);
         ...
         {
            AV16Mes = (short)(NumberUtil.Val( cmbavMes.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV16Mes), 2, 0))), "."));
            AssignAttri("", false, "AV16Mes", StringUtil.LTrimStr( (decimal)(AV16Mes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavMes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV16Mes), 2, 0));
         ...
         AV21Tipo = StringUtil.RTrim( AV21Tipo);
         AssignAttri("", false, "AV21Tipo", AV21Tipo);
      }
      ...
      protected void STRUP460( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vCOSCOD_DATA"), AV23COSCod_Data);
            ...
            AV20TipBalance = cgiGet( cmbavTipbalance_Internalname);
            AssignAttri("", false, "AV20TipBalance", AV20TipBalance);
            ...
            AV16Mes = (short)(NumberUtil.Val( cgiGet( cmbavMes_Internalname), "."));
            AssignAttri("", false, "AV16Mes", StringUtil.LTrimStr( (decimal)(AV16Mes), 2, 0));
            AV21Tipo = cgiGet( radavTipo_Internalname);
            AssignAttri("", false, "AV21Tipo", AV21Tipo);
            AV22COSCod = cgiGet( edtavCoscod_Internalname);
            AssignAttri("", false, "AV22COSCod", AV22COSCod);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavMoncod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavMoncod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV17MonCod = 0;
               AssignAttri("", false, "AV17MonCod", StringUtil.LTrimStr( (decimal)(AV17MonCod), 6, 0));
            }
            else
            {
               AV17MonCod = (int)(context.localUtil.CToN( cgiGet( edtavMoncod_Internalname), ".", ","));
               AssignAttri("", false, "AV17MonCod", StringUtil.LTrimStr( (decimal)(AV17MonCod), 6, 0));
            }
      ...
      protected void E11462( )
      {
         ...
         AssignAttri("", false, "AV6Ano", StringUtil.LTrimStr( (decimal)(AV6Ano), 4, 0));
         AV16Mes = (short)(DateTimeUtil.Month( DateTimeUtil.Today( context)));
         AssignAttri("", false, "AV16Mes", StringUtil.LTrimStr( (decimal)(AV16Mes), 2, 0));
         AV21Tipo = "L";
         AssignAttri("", false, "AV21Tipo", AV21Tipo);
         AV17MonCod = 1;
      ...
      protected void E12462( )
      {
         ...
         if ( StringUtil.StrCmp(AV20TipBalance, "M") == 0 )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "contabilidad.r_resultadonaturalezapdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV6Ano,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV16Mes,2,0)) + "," + UrlEncode(StringUtil.RTrim(AV21Tipo)) + "," + UrlEncode(StringUtil.LTrimStr(AV17MonCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV22COSCod));
            AV5URL = formatLink("contabilidad.r_resultadonaturalezapdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            Innewwindow1_Target = AV5URL;
            ucInnewwindow1.SendProperty(context, "", false, Innewwindow1_Internalname, "Target", Innewwindow1_Target);
            this.executeUsercontrolMethod("", false, "INNEWWINDOW1Container", "OpenWindow", "", new Object[] {});
         }
         if ( StringUtil.StrCmp(AV20TipBalance, "A") == 0 )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "contabilidad.r_resultadonaturalezaanualpdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV6Ano,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV21Tipo)) + "," + UrlEncode(StringUtil.LTrimStr(AV17MonCod,6,0));
            AV5URL = formatLink("contabilidad.r_resultadonaturalezaanualpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            Innewwindow1_Target = AV5URL;
            ucInnewwindow1.SendProperty(context, "", false, Innewwindow1_Internalname, "Target", Innewwindow1_Target);
            this.executeUsercontrolMethod("", false, "INNEWWINDOW1Container", "OpenWindow", "", new Object[] {});
         }
      ...
      protected void S122( )
      {
         ...
         {
            A1235MonSts = H00462_A1235MonSts[0];
            A180MonCod = H00462_A180MonCod[0];
            A1234MonDsc = H00462_A1234MonDsc[0];
            AV11Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV11Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A180MonCod), 6, 0));
            AV11Combo_DataItem.gxTpr_Title = A1234MonDsc;
            AV18MonCod_Data.Add(AV11Combo_DataItem, 0);
            pr_default.readNext(0);
         }
         pr_default.close(0);
         Combo_moncod_Selectedvalue_set = ((0==AV17MonCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV17MonCod), 6, 0)));
      ...
      protected void S112( )
      {
         ...
         {
            A762COSSts = H00463_A762COSSts[0];
            A79COSCod = H00463_A79COSCod[0];
            A761COSDsc = H00463_A761COSDsc[0];
            AV11Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV11Combo_DataItem.gxTpr_Id = A79COSCod;
            AV11Combo_DataItem.gxTpr_Title = A761COSDsc;
            AV23COSCod_Data.Add(AV11Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_coscod_Selectedvalue_set = AV22COSCod;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810311185", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_estadogananciasperdidasnaturaleza.js", "?202281810311185", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavTipbalance.addItem("M", "Estado de Ganancias y Perdidas Mensual", 0);
         cmbavTipbalance.addItem("A", "Estado de Ganancias y Perdidas Anual", 0);
         if ( cmbavTipbalance.ItemCount > 0 )
         {
            AV20TipBalance = cmbavTipbalance.getValidValue(AV20TipBalance);
            AssignAttri("", false, "AV20TipBalance", AV20TipBalance);
         ...
         radavTipo.WebTags = "";
         radavTipo.addItem("L", "Por Líneas", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Estado de Ganancias y Perdidas por Naturaleza";
         ...
         Form.Caption = "Estado de Ganancias y Perdidas por Naturaleza";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavTipo'},{av:'AV21Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipo'},{av:'AV21Tipo',fld:'vTIPO',pic:''}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12462',iparms:[{av:'cmbavTipbalance'},{av:'AV20TipBalance',fld:'vTIPBALANCE',pic:''},{av:'AV6Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV16Mes',fld:'vMES',pic:'Z9'},{av:'AV17MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV22COSCod',fld:'vCOSCOD',pic:''},{av:'radavTipo'},{av:'AV21Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow1_Target',ctrl:'INNEWWINDOW1',prop:'Target'},{av:'radavTipo'},{av:'AV21Tipo',fld:'vTIPO',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E13462',iparms:[{av:'radavTipo'},{av:'AV21Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV21Tipo',fld:'vTIPO',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV23COSCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H00462_A1235MonSts = new short[1] ;
         H00462_A180MonCod = new int[1] ;
         H00462_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV11Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00463_A762COSSts = new short[1] ;
         H00463_A79COSCod = new string[] {""} ;
         H00463_A761COSDsc = new string[] {""} ;
         A79COSCod = "";
         A761COSDsc = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_estadogananciasperdidasnaturaleza__default(),
            new Object[][] {
                new Object[] {
               H00462_A1235MonSts, H00462_A180MonCod, H00462_A1234MonDsc
               }
               , new Object[] {
               H00463_A762COSSts, H00463_A79COSCod, H00463_A761COSDsc
               }
            }
         );
         AV17MonCod = 1;
      ...
      private short[] H00462_A1235MonSts ;
      private int[] H00462_A180MonCod ;
      private string[] H00462_A1234MonDsc ;
      private short[] H00463_A762COSSts ;
      private string[] H00463_A79COSCod ;
      private string[] H00463_A761COSDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV23COSCod_Data ;
   ...
   public class r_estadogananciasperdidasnaturaleza__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00462", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00462,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00463", "SELECT [COSSts], [COSCod], [COSDsc] FROM [CBCOSTOS] WHERE [COSSts] = 1 ORDER BY [COSDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00463,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
