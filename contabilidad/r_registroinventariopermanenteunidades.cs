...
namespace GeneXus.Programs.contabilidad {
   public class r_registroinventariopermanenteunidades : GXDataArea
   {
      public r_registroinventariopermanenteunidades( )
      {
      ...
      public r_registroinventariopermanenteunidades( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810315863", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_registroinventariopermanenteunidades.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFAMCOD_DATA", AV14FamCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFAMCOD_DATA", AV14FamCod_Data);
         }
      ...
      {
         return formatLink("contabilidad.r_registroinventariopermanenteunidades.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_RegistroInventarioPermanenteUnidades" ;
      }

      public override string GetPgmdesc( )
      {
         return "Registro de Inventario Permanente Unidades" ;
      }
      ...
      protected void WB5Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_almcod_Internalname, "Almacen", "", "", lblTextblockcombo_almcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Línea Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub LÍnea", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_famcod.SetProperty("DropDownOptionsData", AV14FamCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_55_5Y2( true) ;
         }
         else
         {
            wb_table1_55_5Y2( false) ;
         }
         return  ;
      }

      protected void wb_table1_55_5Y2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcano_Internalname, "Año", "", "", lblTextblockcano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCano_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cAno), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCano_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8cAno), "ZZZ9") : context.localUtil.Format( (decimal)(AV8cAno), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,72);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCano_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavCano_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcmes_Internalname, "Mes", "", "", lblTextblockcmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCmes, cmbavCmes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV9cMes), 2, 0)), 1, cmbavCmes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavCmes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,81);\"", "", true, 1, "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            cmbavCmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV9cMes), 2, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAlmcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5AlmCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5AlmCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAlmcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavAlmcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 96,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV19LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,96);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 97,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV26SublCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV26SublCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,97);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            /* Single line edit */
      ...
      protected void START5Y2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Registro de Inventario Permanente Unidades", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV9cMes = (short)(NumberUtil.Val( cmbavCmes.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV9cMes), 2, 0))), "."));
            AssignAttri("", false, "AV9cMes", StringUtil.LTrimStr( (decimal)(AV9cMes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavCmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV9cMes), 2, 0));
      ...
      protected void STRUP5Y0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vFAMCOD_DATA"), AV14FamCod_Data);
            /* Read saved values. */
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCano_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCano_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV8cAno = 0;
               AssignAttri("", false, "AV8cAno", StringUtil.LTrimStr( (decimal)(AV8cAno), 4, 0));
            }
            else
            {
               AV8cAno = (short)(context.localUtil.CToN( cgiGet( edtavCano_Internalname), ".", ","));
               AssignAttri("", false, "AV8cAno", StringUtil.LTrimStr( (decimal)(AV8cAno), 4, 0));
            }
            cmbavCmes.CurrentValue = cgiGet( cmbavCmes_Internalname);
            AV9cMes = (short)(NumberUtil.Val( cgiGet( cmbavCmes_Internalname), "."));
            AssignAttri("", false, "AV9cMes", StringUtil.LTrimStr( (decimal)(AV9cMes), 2, 0));
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV19LinCod = 0;
               AssignAttri("", false, "AV19LinCod", StringUtil.LTrimStr( (decimal)(AV19LinCod), 6, 0));
            }
            else
            {
               AV19LinCod = (int)(context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ","));
               AssignAttri("", false, "AV19LinCod", StringUtil.LTrimStr( (decimal)(AV19LinCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV26SublCod = 0;
               AssignAttri("", false, "AV26SublCod", StringUtil.LTrimStr( (decimal)(AV26SublCod), 6, 0));
            }
            else
            {
               AV26SublCod = (int)(context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ","));
               AssignAttri("", false, "AV26SublCod", StringUtil.LTrimStr( (decimal)(AV26SublCod), 6, 0));
            }
      ...
      protected void E115Y2( )
      {
         ...
         S142 ();
         if (returnInSub) return;
         AV8cAno = (short)(DateTimeUtil.Year( DateTimeUtil.Today( context)));
         AssignAttri("", false, "AV8cAno", StringUtil.LTrimStr( (decimal)(AV8cAno), 4, 0));
         AV9cMes = (short)(DateTimeUtil.Month( DateTimeUtil.Today( context)));
         AssignAttri("", false, "AV9cMes", StringUtil.LTrimStr( (decimal)(AV9cMes), 2, 0));
      }
      ...
      protected void E125Y2( )
      {
         ...
         AV16FechaC = "01/" + StringUtil.PadL( StringUtil.Trim( StringUtil.Str( (decimal)(AV9cMes), 10, 0)), 2, "0") + "/" + StringUtil.Trim( StringUtil.Str( (decimal)(AV8cAno), 10, 0));
         AV15FDesde = context.localUtil.CToD( AV16FechaC, 2);
         AV21Mes2 = (short)(((AV9cMes==12) ? 1 : AV9cMes+1));
         AV7Ano2 = (short)(((AV9cMes==12) ? AV8cAno+1 : AV8cAno));
         AV16FechaC = "01/" + StringUtil.PadL( StringUtil.Trim( StringUtil.Str( (decimal)(AV21Mes2), 10, 0)), 2, "0") + "/" + StringUtil.Trim( StringUtil.Str( (decimal)(AV7Ano2), 10, 0));
         AV17FHasta = DateTimeUtil.DAdd(context.localUtil.CToD( AV16FechaC, 2),-((int)(1)));
         if ( AV18Flag == 0 )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "contabilidad.r_registroinventariopermanenteunidadespdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV19LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV26SublCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV13FamCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV23ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV17FHasta));
            Innewwindow_Target = formatLink("contabilidad.r_registroinventariopermanenteunidadespdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S142( )
      {
         ...
         {
            A979FamSts = H005Y2_A979FamSts[0];
            A50FamCod = H005Y2_A50FamCod[0];
            A977FamDsc = H005Y2_A977FamDsc[0];
            AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV10Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A50FamCod), 6, 0));
            AV10Combo_DataItem.gxTpr_Title = A977FamDsc;
            AV14FamCod_Data.Add(AV10Combo_DataItem, 0);
      ...
      protected void S132( )
      {
         ...
         {
            A1893SublSts = H005Y3_A1893SublSts[0];
            A51SublCod = H005Y3_A51SublCod[0];
            A1892SublDsc = H005Y3_A1892SublDsc[0];
            AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV10Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A51SublCod), 6, 0));
            AV10Combo_DataItem.gxTpr_Title = A1892SublDsc;
            AV27SublCod_Data.Add(AV10Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_sublcod_Selectedvalue_set = ((0==AV26SublCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV26SublCod), 6, 0)));
      ...
      protected void S122( )
      {
         ...
         {
            A1159LinSts = H005Y4_A1159LinSts[0];
            A52LinCod = H005Y4_A52LinCod[0];
            A1153LinDsc = H005Y4_A1153LinDsc[0];
            AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV10Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A52LinCod), 6, 0));
            AV10Combo_DataItem.gxTpr_Title = A1153LinDsc;
            AV20LinCod_Data.Add(AV10Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_lincod_Selectedvalue_set = ((0==AV19LinCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV19LinCod), 6, 0)));
      ...
      protected void S112( )
      {
         ...
         {
            A438AlmSts = H005Y5_A438AlmSts[0];
            A63AlmCod = H005Y5_A63AlmCod[0];
            A436AlmDsc = H005Y5_A436AlmDsc[0];
            AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV10Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A63AlmCod), 6, 0));
            AV10Combo_DataItem.gxTpr_Title = A436AlmDsc;
            AV6AlmCod_Data.Add(AV10Combo_DataItem, 0);
      ...
      protected void wb_table1_55_5Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavProdcod_Internalname, StringUtil.RTrim( AV23ProdCod), StringUtil.RTrim( context.localUtil.Format( AV23ProdCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProdcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavProdcod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavProddsc_Internalname, StringUtil.RTrim( AV24ProdDsc), StringUtil.RTrim( context.localUtil.Format( AV24ProdDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProddsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavProddsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Contabilidad\\R_RegistroInventarioPermanenteUnidades.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_55_5Y2e( true) ;
         }
         else
         {
            wb_table1_55_5Y2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181032065", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_registroinventariopermanenteunidades.js", "?20228181032065", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Registro de Inventario Permanente Unidades";
         ...
         Form.Caption = "Registro de Inventario Permanente Unidades";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E125Y2',iparms:[{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'cmbavCmes'},{av:'AV9cMes',fld:'vCMES',pic:'Z9'},{av:'AV8cAno',fld:'vCANO',pic:'ZZZ9'},{av:'AV19LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV26SublCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV13FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV23ProdCod',fld:'vPRODCOD',pic:'@!'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E135Y2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNBUSCARPRO'","{handler:'E155Y1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         AV14FamCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV24ProdDsc = "";
         AV16FechaC = "";
         AV15FDesde = DateTime.MinValue;
         AV17FHasta = DateTime.MinValue;
         GXEncryptionTmp = "";
         scmdbuf = "";
         H005Y2_A979FamSts = new short[1] ;
         H005Y2_A50FamCod = new int[1] ;
         H005Y2_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV10Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H005Y3_A1893SublSts = new short[1] ;
         H005Y3_A51SublCod = new int[1] ;
         H005Y3_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H005Y4_A1159LinSts = new short[1] ;
         H005Y4_A52LinCod = new int[1] ;
         H005Y4_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H005Y5_A438AlmSts = new short[1] ;
         H005Y5_A63AlmCod = new int[1] ;
         H005Y5_A436AlmDsc = new string[] {""} ;
         A436AlmDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contabilidad.r_registroinventariopermanenteunidades__default(),
            new Object[][] {
                new Object[] {
               H005Y2_A979FamSts, H005Y2_A50FamCod, H005Y2_A977FamDsc
               }
               , new Object[] {
               H005Y3_A1893SublSts, H005Y3_A51SublCod, H005Y3_A1892SublDsc
               }
               , new Object[] {
               H005Y4_A1159LinSts, H005Y4_A52LinCod, H005Y4_A1153LinDsc
               }
               , new Object[] {
               H005Y5_A438AlmSts, H005Y5_A63AlmCod, H005Y5_A436AlmDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV8cAno ;
      private short AV9cMes ;
      private short nDonePA ;
      private short AV18Flag ;
      private short AV21Mes2 ;
      private short AV7Ano2 ;
      ...
      private short[] H005Y2_A979FamSts ;
      private int[] H005Y2_A50FamCod ;
      private string[] H005Y2_A977FamDsc ;
      private short[] H005Y3_A1893SublSts ;
      private int[] H005Y3_A51SublCod ;
      private string[] H005Y3_A1892SublDsc ;
      private short[] H005Y4_A1159LinSts ;
      private int[] H005Y4_A52LinCod ;
      private string[] H005Y4_A1153LinDsc ;
      private short[] H005Y5_A438AlmSts ;
      private int[] H005Y5_A63AlmCod ;
      private string[] H005Y5_A436AlmDsc ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV14FamCod_Data ;
      private GXWebForm Form ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV10Combo_DataItem ;
   }

   public class r_registroinventariopermanenteunidades__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH005Y4;
          prmH005Y4 = new Object[] {
          };
          Object[] prmH005Y5;
          prmH005Y5 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H005Y2", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Y2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005Y3", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Y3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005Y4", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Y4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005Y5", "SELECT [AlmSts], [AlmCod], [AlmDsc] FROM [CALMACEN] WHERE [AlmSts] = 1 ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Y5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
