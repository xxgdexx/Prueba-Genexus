   ...
   public class r_libromayoranalitico : GXDataArea
   {
      ...
      protected void WB610( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockano_Internalname, "Año", "", "", lblTextblockano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_LibroMayorAnalitico.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
