...
namespace GeneXus.Programs.contabilidad {
   public class r_balancecomprobacionhojatrabajo : GXDataArea
   {
      public r_balancecomprobacionhojatrabajo( )
      {
      ...
      public r_balancecomprobacionhojatrabajo( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031777", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contabilidad.r_balancecomprobacionhojatrabajo.aspx") +"\">") ;
      ...
      {
         return formatLink("contabilidad.r_balancecomprobacionhojatrabajo.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Contabilidad.R_BalanceComprobacionHojaTrabajo" ;
      }

      public override string GetPgmdesc( )
      {
         return "Balance de Comprobacion Hoja de Trabajo" ;
      }
      ...
      protected void WB430( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockano_Internalname, "Año", "", "", lblTextblockano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavAno_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5Ano), 4, 0, ".", "")), StringUtil.LTrim( ((edtavAno_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5Ano), "ZZZ9") : context.localUtil.Format( (decimal)(AV5Ano), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAno_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavAno_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockmes_Internalname, "Mes", "", "", lblTextblockmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavMes, cmbavMes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17Mes), 2, 0)), 1, cmbavMes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavMes.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "", true, 1, "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockndig_Internalname, "N° Dígitos", "", "", lblTextblockndig_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavNdig, cmbavNdig_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV20nDig), 2, 0)), 1, cmbavNdig_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavNdig.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "", true, 1, "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            cmbavNdig.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV20nDig), 2, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Contabilidad\\R_BalanceComprobacionHojaTrabajo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START432( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Balance de Comprobacion Hoja de Trabajo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV20nDig = (short)(NumberUtil.Val( cmbavNdig.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV20nDig), 2, 0))), "."));
            AssignAttri("", false, "AV20nDig", StringUtil.LTrimStr( (decimal)(AV20nDig), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavNdig.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV20nDig), 2, 0));
      ...
      protected void STRUP430( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV20nDig = (short)(NumberUtil.Val( cgiGet( cmbavNdig_Internalname), "."));
            AssignAttri("", false, "AV20nDig", StringUtil.LTrimStr( (decimal)(AV20nDig), 2, 0));
      ...
      protected void E12432( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "contabilidad.r_balancecomprobacionhojatrabajopdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV5Ano,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV17Mes,2,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20nDig,2,0));
         Innewwindow_Target = formatLink("contabilidad.r_balancecomprobacionhojatrabajopdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E13432( )
      {
         ...
         new GeneXus.Programs.contabilidad.r_balancecomprobacionhojatrabajoexcel(context ).execute( ref  AV5Ano, ref  AV17Mes, ref  AV20nDig, ref  AV18MonCod, out  AV16ExcelFilename, out  AV15ErrorMessage) ;
         AssignAttri("", false, "AV5Ano", StringUtil.LTrimStr( (decimal)(AV5Ano), 4, 0));
         AssignAttri("", false, "AV17Mes", StringUtil.LTrimStr( (decimal)(AV17Mes), 2, 0));
         AssignAttri("", false, "AV20nDig", StringUtil.LTrimStr( (decimal)(AV20nDig), 2, 0));
         AssignAttri("", false, "AV18MonCod", StringUtil.LTrimStr( (decimal)(AV18MonCod), 6, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031821", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contabilidad/r_balancecomprobacionhojatrabajo.js", "?20228181031821", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavNdig.WebTags = "";
         cmbavNdig.addItem("1", "1", 0);
         cmbavNdig.addItem("2", "2", 0);
         cmbavNdig.addItem("3", "3", 0);
         cmbavNdig.addItem("4", "4", 0);
         cmbavNdig.addItem("5", "5", 0);
         cmbavNdig.addItem("6", "6", 0);
         cmbavNdig.addItem("7", "7", 0);
         cmbavNdig.addItem("8", "8", 0);
         cmbavNdig.addItem("9", "9", 0);
         cmbavNdig.addItem("10", "10", 0);
         cmbavNdig.addItem("0", "Todos", 0);
         if ( cmbavNdig.ItemCount > 0 )
         {
            AV20nDig = (short)(NumberUtil.Val( cmbavNdig.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV20nDig), 2, 0))), "."));
            AssignAttri("", false, "AV20nDig", StringUtil.LTrimStr( (decimal)(AV20nDig), 2, 0));
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Balance Comprobación - Hoja de Trabajo";
         ...
         Form.Caption = "Balance de Comprobacion Hoja de Trabajo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12432',iparms:[{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV17Mes',fld:'vMES',pic:'Z9'},{av:'cmbavNdig'},{av:'AV20nDig',fld:'vNDIG',pic:'Z9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13432',iparms:[{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'},{av:'cmbavMes'},{av:'AV17Mes',fld:'vMES',pic:'Z9'},{av:'cmbavNdig'},{av:'AV20nDig',fld:'vNDIG',pic:'Z9'},{av:'AV18MonCod',fld:'vMONCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV18MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'cmbavNdig'},{av:'AV20nDig',fld:'vNDIG',pic:'Z9'},{av:'cmbavMes'},{av:'AV17Mes',fld:'vMES',pic:'Z9'},{av:'AV5Ano',fld:'vANO',pic:'ZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E14432',iparms:[]");
