...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemClickData" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	public class SdtQueryViewerItemClickData : GxUserType
	{
		...
		public GXBaseCollection<SdtQueryViewerItemClickData_Element> gxTpr_Context
		{
			...
			set {
				gxTv_SdtQueryViewerItemClickData_Context_N = false;
		...
		public GXBaseCollection<SdtQueryViewerItemClickData_Filter> gxTpr_Filters
		{
			...
			set {
				gxTv_SdtQueryViewerItemClickData_Filters_N = false;
		...
		protected bool gxTv_SdtQueryViewerItemClickData_Context_N;
		protected GXBaseCollection<SdtQueryViewerItemClickData_Element> gxTv_SdtQueryViewerItemClickData_Context = null; 

		protected bool gxTv_SdtQueryViewerItemClickData_Filters_N;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerItemClickData", Namespace="SIGERP_ADVANCED")]
