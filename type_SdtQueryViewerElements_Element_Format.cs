...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Format" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerElements.Element.Format", Namespace="SIGERP_ADVANCED")]
