...
namespace GeneXus.Programs.bancos {
   public class r_reportemovimientobancossinidentificar : GXDataArea
   {
      public r_reportemovimientobancossinidentificar( )
      {
      ...
      public r_reportemovimientobancossinidentificar( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031149", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("bancos.r_reportemovimientobancossinidentificar.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12Tipo, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTIPO", StringUtil.RTrim( AV12Tipo));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12Tipo, "")), context));
      ...
      {
         return formatLink("bancos.r_reportemovimientobancossinidentificar.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Bancos.R_ReporteMovimientoBancosSinIdentificar" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte Movimientos Bancos Sin Identificar" ;
      }
      ...
      protected void WB3M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_pagbancod_Internalname, "Banco", "", "", lblTextblockcombo_pagbancod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_pagcbcod_Internalname, "N° Cuenta ", "", "", lblTextblockcombo_pagcbcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV8FDesde, "99/99/99"), context.localUtil.Format( AV8FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,41);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavPagbancod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10PagBanCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10PagBanCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPagbancod_Jsonclick, 0, "Attribute", "", "", "", "", edtavPagbancod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPagcbcod_Internalname, StringUtil.RTrim( AV13PagCBCod), StringUtil.RTrim( context.localUtil.Format( AV13PagCBCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPagcbcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavPagcbcod_Visible, 1, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Bancos\\R_ReporteMovimientoBancosSinIdentificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte Movimientos Bancos Sin Identificar", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E143M2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "bancos.r_reportemovimientossinidentificarpdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PagBanCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV13PagCBCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV8FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV9FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV12Tipo));
         Innewwindow_Target = formatLink("bancos.r_reportemovimientossinidentificarpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E153M2( )
      {
         ...
         new GeneXus.Programs.bancos.r_reportemovimientossinidentificarexcel(context ).execute( ref  AV10PagBanCod, ref  AV13PagCBCod, ref  AV8FDesde, ref  AV9FHasta, out  AV7ExcelFilename, out  AV6ErrorMessage) ;
         AssignAttri("", false, "AV10PagBanCod", StringUtil.LTrimStr( (decimal)(AV10PagBanCod), 6, 0));
         AssignAttri("", false, "AV13PagCBCod", AV13PagCBCod);
         AssignAttri("", false, "AV8FDesde", context.localUtil.Format(AV8FDesde, "99/99/99"));
         AssignAttri("", false, "AV9FHasta", context.localUtil.Format(AV9FHasta, "99/99/99"));
      ...
      protected void S122( )
      {
         ...
         {
            A504CBSts = H003M2_A504CBSts[0];
            A377CBCod = H003M2_A377CBCod[0];
            AV19GXLvl92 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            A483BanSts = H003M3_A483BanSts[0];
            A372BanCod = H003M3_A372BanCod[0];
            A482BanDsc = H003M3_A482BanDsc[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031268", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("bancos/r_reportemovimientobancossinidentificar.js", "?20228181031269", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Movimiento de Bancos Sin Identificar";
         ...
         Combo_pagcbcod_Datalistproc = "Bancos.R_ReporteMovimientoBancosSinIdentificarLoadDVCombo";
         ...
         Form.Caption = "Reporte Movimientos Bancos Sin Identificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12Tipo',fld:'vTIPO',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E143M2',iparms:[{av:'AV10PagBanCod',fld:'vPAGBANCOD',pic:'ZZZZZ9'},{av:'AV13PagCBCod',fld:'vPAGCBCOD',pic:''},{av:'AV8FDesde',fld:'vFDESDE',pic:''},{av:'AV9FHasta',fld:'vFHASTA',pic:''},{av:'AV12Tipo',fld:'vTIPO',pic:'',hsh:true}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E153M2',iparms:[{av:'AV10PagBanCod',fld:'vPAGBANCOD',pic:'ZZZZZ9'},{av:'AV13PagCBCod',fld:'vPAGCBCOD',pic:''},{av:'AV8FDesde',fld:'vFDESDE',pic:''},{av:'AV9FHasta',fld:'vFHASTA',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV9FHasta',fld:'vFHASTA',pic:''},{av:'AV8FDesde',fld:'vFDESDE',pic:''},{av:'AV13PagCBCod',fld:'vPAGCBCOD',pic:''},{av:'AV10PagBanCod',fld:'vPAGBANCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E163M2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("COMBO_PAGCBCOD.ONOPTIONCLICKED","{handler:'E123M2',iparms:[{av:'Combo_pagcbcod_Selectedvalue_get',ctrl:'COMBO_PAGCBCOD',prop:'SelectedValue_get'}]");
         setEventMetadata("COMBO_PAGCBCOD.ONOPTIONCLICKED",",oparms:[{av:'AV13PagCBCod',fld:'vPAGCBCOD',pic:''}]}");
         setEventMetadata("COMBO_PAGBANCOD.ONOPTIONCLICKED","{handler:'E113M2',iparms:[{av:'AV10PagBanCod',fld:'vPAGBANCOD',pic:'ZZZZZ9'},{av:'Combo_pagbancod_Selectedvalue_get',ctrl:'COMBO_PAGBANCOD',prop:'SelectedValue_get'}]");
         setEventMetadata("COMBO_PAGBANCOD.ONOPTIONCLICKED",",oparms:[{av:'AV10PagBanCod',fld:'vPAGBANCOD',pic:'ZZZZZ9'},{av:'AV13PagCBCod',fld:'vPAGCBCOD',pic:''},{av:'Combo_pagcbcod_Selectedvalue_set',ctrl:'COMBO_PAGCBCOD',prop:'SelectedValue_set'},{av:'Combo_pagcbcod_Selectedtext_set',ctrl:'COMBO_PAGCBCOD',prop:'SelectedText_set'}]}");
      ...
      public override void initialize( )
      {
         ...
         AV6ErrorMessage = "";
         scmdbuf = "";
         H003M2_A372BanCod = new int[1] ;
         H003M2_A504CBSts = new short[1] ;
         H003M2_A377CBCod = new string[] {""} ;
         A377CBCod = "";
         H003M3_A483BanSts = new short[1] ;
         H003M3_A372BanCod = new int[1] ;
         H003M3_A482BanDsc = new string[] {""} ;
         A482BanDsc = "";
         AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.bancos.r_reportemovimientobancossinidentificar__default(),
            new Object[][] {
                new Object[] {
               H003M2_A372BanCod, H003M2_A504CBSts, H003M2_A377CBCod
               }
               , new Object[] {
               H003M3_A483BanSts, H003M3_A372BanCod, H003M3_A482BanDsc
               }
            }
         );
      ...
      private int[] H003M2_A372BanCod ;
      private short[] H003M2_A504CBSts ;
      private string[] H003M2_A377CBCod ;
      private short[] H003M3_A483BanSts ;
      private int[] H003M3_A372BanCod ;
      private string[] H003M3_A482BanDsc ;
   ...
   public class r_reportemovimientobancossinidentificar__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003M2", "SELECT TOP 1 [BanCod], [CBSts], [CBCod] FROM [TSCUENTABANCO] WHERE ([CBCod] = @AV13PagCBCod) AND ([CBSts] = 1) ORDER BY [BanCod], [CBCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003M2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H003M3", "SELECT [BanSts], [BanCod], [BanDsc] FROM [TSBANCOS] WHERE [BanSts] = 1 ORDER BY [BanDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003M3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
