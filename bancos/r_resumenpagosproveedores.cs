...
namespace GeneXus.Programs.bancos {
   public class r_resumenpagosproveedores : GXDataArea
   {
      public r_resumenpagosproveedores( )
      {
      ...
      public r_resumenpagosproveedores( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810304525", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("bancos.r_resumenpagosproveedores.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFORCOD_DATA", AV9ForCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFORCOD_DATA", AV9ForCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTIPCOD_DATA", AV15TipCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTIPCOD_DATA", AV15TipCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      {
         return formatLink("bancos.r_resumenpagosproveedores.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Bancos.R_ResumenPagosProveedores" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte Resumen Pagos Proveedores" ;
      }
      ...
      protected void WB2T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprvcod_Internalname, "Proveedores", "", "", lblTextblockprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_25_2T2( true) ;
         }
         else
         {
            wb_table1_25_2T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_2T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_forcod_Internalname, "Forma de Pago", "", "", lblTextblockcombo_forcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_forcod.SetProperty("DropDownOptionsData", AV9ForCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipcod_Internalname, "Tipo de Documento", "", "", lblTextblockcombo_tipcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_tipcod.SetProperty("DropDownOptionsData", AV15TipCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV6FDesde, "99/99/99"), context.localUtil.Format( AV6FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV7FHasta, "99/99/99"), context.localUtil.Format( AV7FHasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavForcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ForCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8ForCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,88);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavForcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavForcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 89,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipcod_Internalname, StringUtil.RTrim( AV14TipCod), StringUtil.RTrim( context.localUtil.Format( AV14TipCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipcod_Visible, 1, 0, "text", "", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 90,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START2T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte Resumen Pagos Proveedores", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP2T0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vFORCOD_DATA"), AV9ForCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vTIPCOD_DATA"), AV15TipCod_Data);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavForcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavForcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV8ForCod = 0;
               AssignAttri("", false, "AV8ForCod", StringUtil.LTrimStr( (decimal)(AV8ForCod), 6, 0));
            }
            else
            {
               AV8ForCod = (int)(context.localUtil.CToN( cgiGet( edtavForcod_Internalname), ".", ","));
               AssignAttri("", false, "AV8ForCod", StringUtil.LTrimStr( (decimal)(AV8ForCod), 6, 0));
            }
            AV14TipCod = cgiGet( edtavTipcod_Internalname);
            AssignAttri("", false, "AV14TipCod", AV14TipCod);
      ...
      protected void E122T2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "bancos.r_resumenpagosproveedorespdf.aspx"+UrlEncode(DateTimeUtil.FormatDateParm(AV6FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV7FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV12PrvCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV8ForCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10MonCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV14TipCod));
         Innewwindow_Target = formatLink("bancos.r_resumenpagosproveedorespdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S132( )
      {
         ...
         {
            A1235MonSts = H002T2_A1235MonSts[0];
            A180MonCod = H002T2_A180MonCod[0];
            A1234MonDsc = H002T2_A1234MonDsc[0];
      ...
      protected void S122( )
      {
         ...
         {
            A1919TipSts = H002T3_A1919TipSts[0];
            A149TipCod = H002T3_A149TipCod[0];
            A1910TipDsc = H002T3_A1910TipDsc[0];
            AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV5Combo_DataItem.gxTpr_Id = A149TipCod;
            AV5Combo_DataItem.gxTpr_Title = A1910TipDsc;
            AV15TipCod_Data.Add(AV5Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_tipcod_Selectedvalue_set = AV14TipCod;
      ...
      protected void S112( )
      {
         ...
         {
            A989ForSts = H002T4_A989ForSts[0];
            A143ForCod = H002T4_A143ForCod[0];
            A988ForDsc = H002T4_A988ForDsc[0];
            AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV5Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A143ForCod), 6, 0));
            AV5Combo_DataItem.gxTpr_Title = A988ForDsc;
            AV9ForCod_Data.Add(AV5Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_forcod_Selectedvalue_set = ((0==AV8ForCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV8ForCod), 6, 0)));
      ...
      protected void wb_table1_25_2T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvcod_Internalname, StringUtil.RTrim( AV12PrvCod), StringUtil.RTrim( context.localUtil.Format( AV12PrvCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavPrvcod_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e152t1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvdsc_Internalname, StringUtil.RTrim( AV13PrvDsc), StringUtil.RTrim( context.localUtil.Format( AV13PrvDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvdsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavPrvdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Bancos\\R_ResumenPagosProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_25_2T2e( true) ;
         }
         else
         {
            wb_table1_25_2T2e( false) ;
         }
      }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("bancos/r_resumenpagosproveedores.js", "?202281810304680", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Resumen de Pagos a Proveedores";
         ...
         Form.Caption = "Reporte Resumen Pagos Proveedores";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E122T2',iparms:[{av:'AV6FDesde',fld:'vFDESDE',pic:''},{av:'AV7FHasta',fld:'vFHASTA',pic:''},{av:'AV12PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV8ForCod',fld:'vFORCOD',pic:'ZZZZZ9'},{av:'AV10MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV14TipCod',fld:'vTIPCOD',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E132T2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E152T1',iparms:[]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV13PrvDsc',fld:'vPRVDSC',pic:''},{av:'AV12PrvCod',fld:'vPRVCOD',pic:'@!'}]}");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV9ForCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV15TipCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H002T2_A1235MonSts = new short[1] ;
         H002T2_A180MonCod = new int[1] ;
         H002T2_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H002T3_A1919TipSts = new short[1] ;
         H002T3_A149TipCod = new string[] {""} ;
         H002T3_A1910TipDsc = new string[] {""} ;
         A149TipCod = "";
         A1910TipDsc = "";
         H002T4_A989ForSts = new short[1] ;
         H002T4_A143ForCod = new int[1] ;
         H002T4_A988ForDsc = new string[] {""} ;
         A988ForDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.bancos.r_resumenpagosproveedores__default(),
            new Object[][] {
                new Object[] {
               H002T2_A1235MonSts, H002T2_A180MonCod, H002T2_A1234MonDsc
               }
               , new Object[] {
               H002T3_A1919TipSts, H002T3_A149TipCod, H002T3_A1910TipDsc
               }
               , new Object[] {
               H002T4_A989ForSts, H002T4_A143ForCod, H002T4_A988ForDsc
               }
            }
         );
      ...
      private short[] H002T2_A1235MonSts ;
      private int[] H002T2_A180MonCod ;
      private string[] H002T2_A1234MonDsc ;
      private short[] H002T3_A1919TipSts ;
      private string[] H002T3_A149TipCod ;
      private string[] H002T3_A1910TipDsc ;
      private short[] H002T4_A989ForSts ;
      private int[] H002T4_A143ForCod ;
      private string[] H002T4_A988ForDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV9ForCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV15TipCod_Data ;
   ...
   public class r_resumenpagosproveedores__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002T2", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002T2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H002T3", "SELECT [TipSts], [TipCod], [TipDsc] FROM [CTIPDOC] WHERE [TipSts] = 1 ORDER BY [TipDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002T3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H002T4", "SELECT [ForSts], [ForCod], [ForDsc] FROM [CFORMAPAGO] WHERE [ForSts] = 1 ORDER BY [ForDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002T4,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
