...
namespace GeneXus.Programs.bancos {
   public class r_reporteconciliacionbancarialoaddvcombo : GXProcedure
   {
      public r_reporteconciliacionbancarialoaddvcombo( )
      {
      ...
      public r_reporteconciliacionbancarialoaddvcombo( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP3_Combo_DataJson )
      {
         r_reporteconciliacionbancarialoaddvcombo objr_reporteconciliacionbancarialoaddvcombo;
         objr_reporteconciliacionbancarialoaddvcombo = new r_reporteconciliacionbancarialoaddvcombo();
         objr_reporteconciliacionbancarialoaddvcombo.AV16ComboName = aP0_ComboName;
         objr_reporteconciliacionbancarialoaddvcombo.AV17Cond_BanCod = aP1_Cond_BanCod;
         objr_reporteconciliacionbancarialoaddvcombo.AV11SearchTxt = aP2_SearchTxt;
         objr_reporteconciliacionbancarialoaddvcombo.AV12Combo_DataJson = "" ;
         objr_reporteconciliacionbancarialoaddvcombo.context.SetSubmitInitialConfig(context);
         objr_reporteconciliacionbancarialoaddvcombo.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_reporteconciliacionbancarialoaddvcombo);
         aP3_Combo_DataJson=this.AV12Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_reporteconciliacionbancarialoaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S111( )
      {
         ...
         {
            A504CBSts = P00AL2_A504CBSts[0];
            A377CBCod = P00AL2_A377CBCod[0];
            A372BanCod = P00AL2_A372BanCod[0];
      ...
      public override void initialize( )
      {
         ...
         lV11SearchTxt = "";
         A377CBCod = "";
         P00AL2_A504CBSts = new short[1] ;
         P00AL2_A377CBCod = new string[] {""} ;
         P00AL2_A372BanCod = new int[1] ;
         AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV13Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.bancos.r_reporteconciliacionbancarialoaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00AL2_A504CBSts, P00AL2_A377CBCod, P00AL2_A372BanCod
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P00AL2_A504CBSts ;
      private string[] P00AL2_A377CBCod ;
      private int[] P00AL2_A372BanCod ;
   ...
   public class r_reporteconciliacionbancarialoaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00AL2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] );
         }
