...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemCollapseData" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	public class SdtQueryViewerItemCollapseData : GxUserType
	{
		...
		public GxSimpleCollection<string> gxTpr_Expandedvalues_GxSimpleCollection
		{
			...
			set {
				gxTv_SdtQueryViewerItemCollapseData_Expandedvalues_N = false;
		...
		{
			gxTv_SdtQueryViewerItemCollapseData_Expandedvalues_N = true;
		...
		{
			return gxTv_SdtQueryViewerItemCollapseData_Expandedvalues == null;
		}
		...
		protected bool gxTv_SdtQueryViewerItemCollapseData_Expandedvalues_N;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerItemCollapseData", Namespace="SIGERP_ADVANCED")]
