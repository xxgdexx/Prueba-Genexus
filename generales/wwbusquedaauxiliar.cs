...
namespace GeneXus.Programs.generales {
   public class wwbusquedaauxiliar : GXDataArea
   {
      public wwbusquedaauxiliar( )
      {
      ...
      public wwbusquedaauxiliar( IGxContext context )
      {
      ...
      public void execute( ref string aP0_InOutTipADCod ,
                           ref string aP1_InOutTipADDsc )
      {
         this.AV8InOutTipADCod = aP0_InOutTipADCod;
         this.AV9InOutTipADDsc = aP1_InOutTipADDsc;
         executePrivate();
         aP0_InOutTipADCod=this.AV8InOutTipADCod;
         aP1_InOutTipADDsc=this.AV9InOutTipADDsc;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutTipADCod");
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV37FilterFullText = GetPar( "FilterFullText");
               ...
               gxgrGrid_refresh( subGrid_Rows, AV37FilterFullText, AV40Pgmname) ;
            ...
            {
               AV8InOutTipADCod = gxfirstwebparm;
               AssignAttri("", false, "AV8InOutTipADCod", AV8InOutTipADCod);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutTipADDsc = GetPar( "InOutTipADDsc");
                  AssignAttri("", false, "AV9InOutTipADDsc", AV9InOutTipADDsc);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810321222", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("generales.wwbusquedaauxiliar.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV8InOutTipADCod)),UrlEncode(StringUtil.RTrim(AV9InOutTipADDsc))}, new string[] {"InOutTipADCod","InOutTipADDsc"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFILTERFULLTEXT", AV37FilterFullText);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTTIPADCOD", StringUtil.RTrim( AV8InOutTipADCod));
         GxWebStd.gx_hidden_field( context, "vINOUTTIPADDSC", StringUtil.RTrim( AV9InOutTipADDsc));
      ...
      {
         return formatLink("generales.wwbusquedaauxiliar.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV8InOutTipADCod)),UrlEncode(StringUtil.RTrim(AV9InOutTipADDsc))}, new string[] {"InOutTipADCod","InOutTipADDsc"})  ;
      }

      public override string GetPgmname( )
      {
         return "Generales.WWBusquedaAuxiliar" ;
      }

      public override string GetPgmdesc( )
      {
         return "Selecciona Auxiliares" ;
      }
      ...
      protected void WB6Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_13_6Q2( true) ;
         }
         else
         {
            wb_table1_13_6Q2( false) ;
         }
         return  ;
      }

      protected void wb_table1_13_6Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Codigo T. Auxiliar") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( AV35Select));
      ...
      protected void START6Q2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selecciona Auxiliares", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignAttri("", false, edtavSelect_Internalname, AV35Select);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFILTERFULLTEXT"), AV37FilterFullText) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TIPADDSC", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A72TipADDsc, "")), context));
         GxWebStd.gx_hidden_field( context, "TIPADDSC", StringUtil.RTrim( A72TipADDsc));
      }
      ...
      {
         /* GeneXus formulas. */
         AV40Pgmname = "Generales.WWBusquedaAuxiliar";
         context.Gx_err = 0;
      ...
      protected void RF6Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV37FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV37FilterFullText), "%", "");
            /* Using cursor H006Q2 */
            pr_default.execute(0, new Object[] {lV37FilterFullText, lV37FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1901TipADSts = H006Q2_A1901TipADSts[0];
               A72TipADDsc = H006Q2_A72TipADDsc[0];
               A71TipADCod = H006Q2_A71TipADCod[0];
               A70TipACod = H006Q2_A70TipACod[0];
               E166Q2 ();
      ...
      protected void send_integrity_lvl_hashes6Q2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV40Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV40Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TIPADCOD"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A71TipADCod, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TIPADDSC"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A72TipADDsc, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV37FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV37FilterFullText), "%", "");
         /* Using cursor H006Q3 */
         pr_default.execute(1, new Object[] {lV37FilterFullText, lV37FilterFullText});
      ...
      protected void STRUP6Q0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV32GridCurrentPage = (long)(context.localUtil.CToN( cgiGet( "vGRIDCURRENTPAGE"), ".", ","));
            AV33GridPageCount = (long)(context.localUtil.CToN( cgiGet( "vGRIDPAGECOUNT"), ".", ","));
            ...
            AV37FilterFullText = cgiGet( edtavFilterfulltext_Internalname);
            AssignAttri("", false, "AV37FilterFullText", AV37FilterFullText);
      ...
      protected void E146Q2( )
      {
         ...
         Form.Caption = "Selecciona Auxiliares";
      ...
      private void E166Q2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         AV35Select = "<i class=\"fas fa-check\"></i>";
         AssignAttri("", false, edtavSelect_Internalname, AV35Select);
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E176Q2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutTipADCod = A71TipADCod;
         AssignAttri("", false, "AV8InOutTipADCod", AV8InOutTipADCod);
         AV9InOutTipADDsc = A72TipADDsc;
         AssignAttri("", false, "AV9InOutTipADDsc", AV9InOutTipADDsc);
         context.setWebReturnParms(new Object[] {(string)AV8InOutTipADCod,(string)AV9InOutTipADDsc});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutTipADCod","AV9InOutTipADDsc"});
      ...
      protected void wb_table1_13_6Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV37FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV37FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar", edtavFilterfulltext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "WWPFullTextFilter", "left", true, "", "HLP_Generales\\WWBusquedaAuxiliar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_13_6Q2e( true) ;
         }
         else
         {
            wb_table1_13_6Q2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutTipADCod = (string)getParm(obj,0);
         AssignAttri("", false, "AV8InOutTipADCod", AV8InOutTipADCod);
         AV9InOutTipADDsc = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutTipADDsc", AV9InOutTipADDsc);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810321345", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("generales/wwbusquedaauxiliar.js", "?202281810321346", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtTipACod_Internalname = "TIPACOD_"+sGXsfl_24_idx;
         edtTipADCod_Internalname = "TIPADCOD_"+sGXsfl_24_idx;
         edtTipADDsc_Internalname = "TIPADDSC_"+sGXsfl_24_idx;
         edtTipADSts_Internalname = "TIPADSTS_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx;
         edtTipACod_Internalname = "TIPACOD_"+sGXsfl_24_fel_idx;
         edtTipADCod_Internalname = "TIPADCOD_"+sGXsfl_24_fel_idx;
         edtTipADDsc_Internalname = "TIPADDSC_"+sGXsfl_24_fel_idx;
         edtTipADSts_Internalname = "TIPADSTS_"+sGXsfl_24_fel_idx;
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:TipADCod|3:TipADDsc";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV37FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV32GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV33GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV34GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E116Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV37FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E126Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV37FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E136Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV37FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E166Q2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV35Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E176Q2',iparms:[{av:'A71TipADCod',fld:'TIPADCOD',pic:'',hsh:true},{av:'A72TipADDsc',fld:'TIPADDSC',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTipADCod',fld:'vINOUTTIPADCOD',pic:''},{av:'AV9InOutTipADDsc',fld:'vINOUTTIPADDSC',pic:''}]}");
      ...
      {
         wcpOAV8InOutTipADCod = "";
         wcpOAV9InOutTipADDsc = "";
         ...
         scmdbuf = "";
         lV37FilterFullText = "";
         H006Q2_A1901TipADSts = new short[1] ;
         H006Q2_A72TipADDsc = new string[] {""} ;
         H006Q2_A71TipADCod = new string[] {""} ;
         H006Q2_A70TipACod = new int[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.generales.wwbusquedaauxiliar__default(),
            new Object[][] {
                new Object[] {
               H006Q2_A1901TipADSts, H006Q2_A72TipADDsc, H006Q2_A71TipADCod, H006Q2_A70TipACod
               }
               , new Object[] {
      ...
      private string AV8InOutTipADCod ;
      private string AV9InOutTipADDsc ;
      private string wcpOAV8InOutTipADCod ;
      private string wcpOAV9InOutTipADDsc ;
      ...
      private string aP0_InOutTipADCod ;
      private string aP1_InOutTipADDsc ;
      private IDataStoreProvider pr_default ;
      private short[] H006Q2_A1901TipADSts ;
      private string[] H006Q2_A72TipADDsc ;
      private string[] H006Q2_A71TipADCod ;
      private int[] H006Q2_A70TipACod ;
   ...
   public class wwbusquedaauxiliar__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV15OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [TipADSts], [TipADDsc], [TipADCod], [TipACod]";
         sFromString = " FROM [CBAUXILIARES]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV37FilterFullText)) )
         {
            AddWhere(sWhereString, "(( [TipADCod] like '%' + @lV37FilterFullText) or ( [TipADDsc] like '%' + @lV37FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [TipADCod]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TipADCod] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TipADDsc]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TipADDsc] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [TipACod], [TipADCod]";
         }
                                             ...
                                             bool AV15OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [CBAUXILIARES]";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV37FilterFullText)) )
         {
            AddWhere(sWhereString, "(( [TipADCod] like '%' + @lV37FilterFullText) or ( [TipADDsc] like '%' + @lV37FilterFullText))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006Q2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H006Q3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV37FilterFullText",GXType.NVarChar,100,0) ,
          new ParDef("@lV37FilterFullText",GXType.NVarChar,100,0) ,
