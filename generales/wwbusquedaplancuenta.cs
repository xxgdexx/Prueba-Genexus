...
namespace GeneXus.Programs.generales {
   public class wwbusquedaplancuenta : GXDataArea
   {
      public wwbusquedaplancuenta( )
      {
      ...
      public wwbusquedaplancuenta( IGxContext context )
      {
      ...
      public void execute( ref string aP0_InOutCueCod ,
                           out string aP1_OutCueDsc )
      {
         this.AV7InOutCueCod = aP0_InOutCueCod;
         this.AV9OutCueDsc = "" ;
         executePrivate();
         aP0_InOutCueCod=this.AV7InOutCueCod;
         aP1_OutCueDsc=this.AV9OutCueDsc;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutCueCod");
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV36FilterFullText = GetPar( "FilterFullText");
               ...
               gxgrGrid_refresh( subGrid_Rows, AV36FilterFullText, AV39Pgmname) ;
            ...
            {
               AV7InOutCueCod = gxfirstwebparm;
               AssignAttri("", false, "AV7InOutCueCod", AV7InOutCueCod);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9OutCueDsc = GetPar( "OutCueDsc");
                  AssignAttri("", false, "AV9OutCueDsc", AV9OutCueDsc);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810303934", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("generales.wwbusquedaplancuenta.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7InOutCueCod)),UrlEncode(StringUtil.RTrim(AV9OutCueDsc))}, new string[] {"InOutCueCod","OutCueDsc"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFILTERFULLTEXT", AV36FilterFullText);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCUECOD", StringUtil.RTrim( AV7InOutCueCod));
         GxWebStd.gx_hidden_field( context, "vOUTCUEDSC", StringUtil.RTrim( AV9OutCueDsc));
      ...
      {
         return formatLink("generales.wwbusquedaplancuenta.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7InOutCueCod)),UrlEncode(StringUtil.RTrim(AV9OutCueDsc))}, new string[] {"InOutCueCod","OutCueDsc"})  ;
      }

      public override string GetPgmname( )
      {
         return "Generales.WWBusquedaPlanCuenta" ;
      }

      public override string GetPgmdesc( )
      {
         return "Selecciona Plan de Cuentas" ;
      }
      ...
      protected void WB2I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_13_2I2( true) ;
         }
         else
         {
            wb_table1_13_2I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_13_2I2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Movimiento Cuenta") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
      ...
      protected void START2I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selecciona Plan de Cuentas", 0) ;
         }
         context.wjLoc = "";
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFILTERFULLTEXT"), AV36FilterFullText) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_CUEDSC", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A860CueDsc, "")), context));
      ...
      {
         /* GeneXus formulas. */
         AV39Pgmname = "Generales.WWBusquedaPlanCuenta";
         context.Gx_err = 0;
      ...
      protected void RF2I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV36FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV36FilterFullText), "%", "");
            /* Using cursor H002I2 */
            pr_default.execute(0, new Object[] {lV36FilterFullText, lV36FilterFullText, lV36FilterFullText, lV36FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A859CueCos = H002I2_A859CueCos[0];
               A867CueMov = H002I2_A867CueMov[0];
               A873CueSts = H002I2_A873CueSts[0];
               A860CueDsc = H002I2_A860CueDsc[0];
               A91CueCod = H002I2_A91CueCod[0];
               E162I2 ();
      ...
      protected void send_integrity_lvl_hashes2I2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV39Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CUECOD"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A91CueCod, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CUEDSC"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A860CueDsc, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV36FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV36FilterFullText), "%", "");
         /* Using cursor H002I3 */
         pr_default.execute(1, new Object[] {lV36FilterFullText, lV36FilterFullText, lV36FilterFullText, lV36FilterFullText});
      ...
      protected void STRUP2I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV36FilterFullText = cgiGet( edtavFilterfulltext_Internalname);
            AssignAttri("", false, "AV36FilterFullText", AV36FilterFullText);
      ...
      protected void E142I2( )
      {
         ...
         Form.Caption = "Selecciona Plan de Cuentas";
      ...
      protected void E152I2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV39Pgmname, out  GXt_char2) ;
      ...
      protected void E172I2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV7InOutCueCod = A91CueCod;
         AssignAttri("", false, "AV7InOutCueCod", AV7InOutCueCod);
         AV9OutCueDsc = A860CueDsc;
         AssignAttri("", false, "AV9OutCueDsc", AV9OutCueDsc);
         context.setWebReturnParms(new Object[] {(string)AV7InOutCueCod,(string)AV9OutCueDsc});
         context.setWebReturnParmsMetadata(new Object[] {"AV7InOutCueCod","AV9OutCueDsc"});
      ...
      protected void wb_table1_13_2I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV36FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV36FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar", edtavFilterfulltext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "WWPFullTextFilter", "left", true, "", "HLP_Generales\\WWBusquedaPlanCuenta.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_13_2I2e( true) ;
         }
         else
         {
            wb_table1_13_2I2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7InOutCueCod = (string)getParm(obj,0);
         AssignAttri("", false, "AV7InOutCueCod", AV7InOutCueCod);
         AV9OutCueDsc = (string)getParm(obj,1);
         AssignAttri("", false, "AV9OutCueDsc", AV9OutCueDsc);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810304071", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("generales/wwbusquedaplancuenta.js", "?202281810304071", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtCueCod_Internalname = "CUECOD_"+sGXsfl_24_idx;
         edtCueDsc_Internalname = "CUEDSC_"+sGXsfl_24_idx;
         cmbCueSts_Internalname = "CUESTS_"+sGXsfl_24_idx;
         edtCueMov_Internalname = "CUEMOV_"+sGXsfl_24_idx;
         edtCueCos_Internalname = "CUECOS_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx;
         edtCueCod_Internalname = "CUECOD_"+sGXsfl_24_fel_idx;
         edtCueDsc_Internalname = "CUEDSC_"+sGXsfl_24_fel_idx;
         cmbCueSts_Internalname = "CUESTS_"+sGXsfl_24_fel_idx;
         edtCueMov_Internalname = "CUEMOV_"+sGXsfl_24_fel_idx;
         edtCueCos_Internalname = "CUECOS_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, cmbCueSts_Internalname, "Values", (string)(cmbCueSts.ToJavascriptSource()), !bGXsfl_24_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CueCod|2:CueDsc|3:CueSts";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV36FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E112I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV36FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E122I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV36FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E132I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV36FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E162I2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV35Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E172I2',iparms:[{av:'A91CueCod',fld:'CUECOD',pic:'',hsh:true},{av:'A860CueDsc',fld:'CUEDSC',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV7InOutCueCod',fld:'vINOUTCUECOD',pic:''},{av:'AV9OutCueDsc',fld:'vOUTCUEDSC',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Cuecos',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV36FilterFullText = "";
         H002I2_A859CueCos = new short[1] ;
         H002I2_A867CueMov = new short[1] ;
         H002I2_A873CueSts = new short[1] ;
         H002I2_A860CueDsc = new string[] {""} ;
         H002I2_A91CueCod = new string[] {""} ;
         H002I3_AGRID_nRecordCount = new long[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.generales.wwbusquedaplancuenta__default(),
            new Object[][] {
                new Object[] {
               H002I2_A859CueCos, H002I2_A867CueMov, H002I2_A873CueSts, H002I2_A860CueDsc, H002I2_A91CueCod
               }
               , new Object[] {
      ...
      private string AV7InOutCueCod ;
      private string AV9OutCueDsc ;
      private string wcpOAV7InOutCueCod ;
      ...
      private string aP0_InOutCueCod ;
      private GXCombobox cmbCueSts ;
      private IDataStoreProvider pr_default ;
      private short[] H002I2_A859CueCos ;
      private short[] H002I2_A867CueMov ;
      private short[] H002I2_A873CueSts ;
      private string[] H002I2_A860CueDsc ;
      private string[] H002I2_A91CueCod ;
      private long[] H002I3_AGRID_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private string aP1_OutCueDsc ;
   ...
   public class wwbusquedaplancuenta__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A867CueMov )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [CueCos], [CueMov], [CueSts], [CueDsc], [CueCod]";
         sFromString = " FROM [CBPLANCUENTA]";
         sOrderString = "";
         AddWhere(sWhereString, "([CueSts] = 1)");
         AddWhere(sWhereString, "([CueMov] = 1)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV36FilterFullText)) )
         {
            AddWhere(sWhereString, "(( [CueCod] like '%' + @lV36FilterFullText) or ( [CueDsc] like '%' + @lV36FilterFullText) or ( 'activo' like '%' + LOWER(@lV36FilterFullText) and [CueSts] = 1) or ( 'inactivo' like '%' + LOWER(@lV36FilterFullText) and [CueSts] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002I2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H002I3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV36FilterFullText",GXType.NVarChar,100,0) ,
          new ParDef("@lV36FilterFullText",GXType.NVarChar,100,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H002I2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002I2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002I3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002I3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
