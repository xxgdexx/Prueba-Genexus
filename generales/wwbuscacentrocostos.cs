...
namespace GeneXus.Programs.generales {
   public class wwbuscacentrocostos : GXDataArea
   {
      public wwbuscacentrocostos( )
      {
      ...
      public wwbuscacentrocostos( IGxContext context )
      {
      ...
      public void execute( ref string aP0_InOutCOSCod )
      {
         this.AV7InOutCOSCod = aP0_InOutCOSCod;
         executePrivate();
         aP0_InOutCOSCod=this.AV7InOutCOSCod;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutCOSCod");
            ...
            {
               AV7InOutCOSCod = gxfirstwebparm;
               AssignAttri("", false, "AV7InOutCOSCod", AV7InOutCOSCod);
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181032149", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("generales.wwbuscacentrocostos.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7InOutCOSCod))}, new string[] {"InOutCOSCod"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCOSCOD", StringUtil.RTrim( AV7InOutCOSCod));
      ...
      {
         return formatLink("generales.wwbuscacentrocostos.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7InOutCOSCod))}, new string[] {"InOutCOSCod"})  ;
      }

      public override string GetPgmname( )
      {
         return "Generales.WWBuscaCentroCostos" ;
      }

      public override string GetPgmdesc( )
      {
         return "Selecciona Centro de Costos" ;
      }
      ...
      protected void WB6R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_13_6R2( true) ;
         }
         else
         {
            wb_table1_13_6R2( false) ;
         }
         return  ;
      }

      protected void wb_table1_13_6R2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A760CosCueDestinoDsc));
               GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void START6R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selecciona Centro de Costos", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A760CosCueDestinoDsc = cgiGet( edtCosCueDestinoDsc_Internalname);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      {
         /* GeneXus formulas. */
         AV21Pgmname = "Generales.WWBuscaCentroCostos";
         context.Gx_err = 0;
      ...
      protected void RF6R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV12FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV12FilterFullText), "%", "");
            /* Using cursor H006R2 */
            pr_default.execute(0, new Object[] {lV12FilterFullText, lV12FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A760CosCueDestinoDsc = H006R2_A760CosCueDestinoDsc[0];
               A80COSCueDestino = H006R2_A80COSCueDestino[0];
               n80COSCueDestino = H006R2_n80COSCueDestino[0];
               A762COSSts = H006R2_A762COSSts[0];
               A759COSAbr = H006R2_A759COSAbr[0];
               A761COSDsc = H006R2_A761COSDsc[0];
               A79COSCod = H006R2_A79COSCod[0];
               A760CosCueDestinoDsc = H006R2_A760CosCueDestinoDsc[0];
               E166R2 ();
      ...
      protected void send_integrity_lvl_hashes6R2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV21Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV21Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_COSCOD"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A79COSCod, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H006R3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E146R2( )
      {
         ...
         Form.Caption = "Selecciona Centro de Costos";
      ...
      protected void E176R2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV7InOutCOSCod = A79COSCod;
         AssignAttri("", false, "AV7InOutCOSCod", AV7InOutCOSCod);
         context.setWebReturnParms(new Object[] {(string)AV7InOutCOSCod});
         context.setWebReturnParmsMetadata(new Object[] {"AV7InOutCOSCod"});
      ...
      protected void wb_table1_13_6R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV12FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV12FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar", edtavFilterfulltext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "WWPFullTextFilter", "left", true, "", "HLP_Generales\\WWBuscaCentroCostos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_13_6R2e( true) ;
         }
         else
         {
            wb_table1_13_6R2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7InOutCOSCod = (string)getParm(obj,0);
         AssignAttri("", false, "AV7InOutCOSCod", AV7InOutCOSCod);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810321535", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("generales/wwbuscacentrocostos.js", "?202281810321535", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtCOSCod_Internalname = "COSCOD_"+sGXsfl_24_idx;
         edtCOSDsc_Internalname = "COSDSC_"+sGXsfl_24_idx;
         edtCOSAbr_Internalname = "COSABR_"+sGXsfl_24_idx;
         cmbCOSSts_Internalname = "COSSTS_"+sGXsfl_24_idx;
         edtCOSCueDestino_Internalname = "COSCUEDESTINO_"+sGXsfl_24_idx;
         edtCosCueDestinoDsc_Internalname = "COSCUEDESTINODSC_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx;
         edtCOSCod_Internalname = "COSCOD_"+sGXsfl_24_fel_idx;
         edtCOSDsc_Internalname = "COSDSC_"+sGXsfl_24_fel_idx;
         edtCOSAbr_Internalname = "COSABR_"+sGXsfl_24_fel_idx;
         cmbCOSSts_Internalname = "COSSTS_"+sGXsfl_24_fel_idx;
         edtCOSCueDestino_Internalname = "COSCUEDESTINO_"+sGXsfl_24_fel_idx;
         edtCosCueDestinoDsc_Internalname = "COSCUEDESTINODSC_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, cmbCOSSts_Internalname, "Values", (string)(cmbCOSSts.ToJavascriptSource()), !bGXsfl_24_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCosCueDestinoDsc_Internalname,StringUtil.RTrim( A760CosCueDestinoDsc),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCosCueDestinoDsc_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
      ...
      protected void init_default_properties( )
      {
         ...
         edtCosCueDestinoDsc_Internalname = "COSCUEDESTINODSC";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:COSCod|2:COSDsc";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E166R2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV18Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E176R2',iparms:[{av:'A79COSCod',fld:'COSCOD',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV7InOutCOSCod',fld:'vINOUTCOSCOD',pic:''}]}");
         setEventMetadata("VALID_COSCUEDESTINO","{handler:'Valid_Coscuedestino',iparms:[]");
         setEventMetadata("VALID_COSCUEDESTINO",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Coscuedestinodsc',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV12FilterFullText = "";
         H006R2_A760CosCueDestinoDsc = new string[] {""} ;
         H006R2_A80COSCueDestino = new string[] {""} ;
         H006R2_n80COSCueDestino = new bool[] {false} ;
         H006R2_A762COSSts = new short[1] ;
         H006R2_A759COSAbr = new string[] {""} ;
         H006R2_A761COSDsc = new string[] {""} ;
         H006R2_A79COSCod = new string[] {""} ;
         H006R3_AGRID_nRecordCount = new long[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.generales.wwbuscacentrocostos__default(),
            new Object[][] {
                new Object[] {
               H006R2_A760CosCueDestinoDsc, H006R2_A80COSCueDestino, H006R2_n80COSCueDestino, H006R2_A762COSSts, H006R2_A759COSAbr, H006R2_A761COSDsc, H006R2_A79COSCod
               }
               , new Object[] {
               H006R3_AGRID_nRecordCount
               }
            }
         );
         AV21Pgmname = "Generales.WWBuscaCentroCostos";
      ...
      private string AV7InOutCOSCod ;
      private string wcpOAV7InOutCOSCod ;
      ...
      private string edtCosCueDestinoDsc_Internalname ;
      ...
      private string edtCosCueDestinoDsc_Jsonclick ;
      ...
      private string aP0_InOutCOSCod ;
      private GXCombobox cmbCOSSts ;
      private IDataStoreProvider pr_default ;
      private string[] H006R2_A760CosCueDestinoDsc ;
      private string[] H006R2_A80COSCueDestino ;
      private bool[] H006R2_n80COSCueDestino ;
      private short[] H006R2_A762COSSts ;
      private string[] H006R2_A759COSAbr ;
      private string[] H006R2_A761COSDsc ;
      private string[] H006R2_A79COSCod ;
      private long[] H006R3_AGRID_nRecordCount ;
   ...
   public class wwbuscacentrocostos__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H006R2( IGxContext context ,
                                             string AV12FilterFullText ,
                                             string A79COSCod ,
                                             string A761COSDsc ,
                                             short AV10OrderedBy ,
                                             bool AV11OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[CueDsc] AS CosCueDestinoDsc, T1.[COSCueDestino] AS COSCueDestino, T1.[COSSts], T1.[COSAbr], T1.[COSDsc], T1.[COSCod]";
         sFromString = " FROM ([CBCOSTOS] T1 LEFT JOIN [CBPLANCUENTA] T2 ON T2.[CueCod] = T1.[COSCueDestino])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T1.[COSCod] like '%' + @lV12FilterFullText) or ( T1.[COSDsc] like '%' + @lV12FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.[COSCod]";
         }
         else if ( ( AV10OrderedBy == 1 ) && ( AV11OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[COSCod] DESC";
         }
         else if ( ( AV10OrderedBy == 2 ) && ! AV11OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[COSDsc]";
         }
         else if ( ( AV10OrderedBy == 2 ) && ( AV11OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[COSDsc] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.[COSCod]";
      ...
      protected Object[] conditional_H006R3( IGxContext context ,
                                             string AV12FilterFullText ,
                                             string A79COSCod ,
                                             string A761COSDsc ,
                                             short AV10OrderedBy ,
                                             bool AV11OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([CBCOSTOS] T1 LEFT JOIN [CBPLANCUENTA] T2 ON T2.[CueCod] = T1.[COSCueDestino])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T1.[COSCod] like '%' + @lV12FilterFullText) or ( T1.[COSDsc] like '%' + @lV12FilterFullText))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006R2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H006R3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH006R2;
          prmH006R2 = new Object[] {
          new ParDef("@lV12FilterFullText",GXType.NVarChar,100,0) ,
          new ParDef("@lV12FilterFullText",GXType.NVarChar,100,0) ,
          ...
          Object[] prmH006R3;
          prmH006R3 = new Object[] {
          new ParDef("@lV12FilterFullText",GXType.NVarChar,100,0) ,
          new ParDef("@lV12FilterFullText",GXType.NVarChar,100,0)
          };
          def= new CursorDef[] {
              new CursorDef("H006R2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006R2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006R3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006R3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
