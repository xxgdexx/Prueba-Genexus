...
namespace GeneXus.Programs.generales {
   public class wwbusquedaconceptosbancos : GXDataArea
   {
      public wwbusquedaconceptosbancos( )
      {
      ...
      public wwbusquedaconceptosbancos( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutConBCod ,
                           ref string aP1_InOutConBDsc )
      {
         this.AV7InOutConBCod = aP0_InOutConBCod;
         this.AV8InOutConBDsc = aP1_InOutConBDsc;
         executePrivate();
         aP0_InOutConBCod=this.AV7InOutConBCod;
         aP1_InOutConBDsc=this.AV8InOutConBDsc;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutConBCod");
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV38FilterFullText = GetPar( "FilterFullText");
               ...
               gxgrGrid_refresh( subGrid_Rows, AV38FilterFullText, AV41Pgmname) ;
            ...
            {
               AV7InOutConBCod = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV7InOutConBCod", StringUtil.LTrimStr( (decimal)(AV7InOutConBCod), 6, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8InOutConBDsc = GetPar( "InOutConBDsc");
                  AssignAttri("", false, "AV8InOutConBDsc", AV8InOutConBDsc);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810321180", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("generales.wwbusquedaconceptosbancos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7InOutConBCod,6,0)),UrlEncode(StringUtil.RTrim(AV8InOutConBDsc))}, new string[] {"InOutConBCod","InOutConBDsc"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFILTERFULLTEXT", AV38FilterFullText);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCONBCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7InOutConBCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCONBDSC", StringUtil.RTrim( AV8InOutConBDsc));
      ...
      {
         return formatLink("generales.wwbusquedaconceptosbancos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7InOutConBCod,6,0)),UrlEncode(StringUtil.RTrim(AV8InOutConBDsc))}, new string[] {"InOutConBCod","InOutConBDsc"})  ;
      }

      public override string GetPgmname( )
      {
         return "Generales.WWBusquedaConceptosBancos" ;
      }

      public override string GetPgmdesc( )
      {
         return "Selecciona Conceptos de Bancos" ;
      }
      ...
      protected void WB6O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_13_6O2( true) ;
         }
         else
         {
            wb_table1_13_6O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_13_6O2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( AV37Select));
      ...
      protected void START6O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selecciona Conceptos de Bancos", 0) ;
         }
         context.wjLoc = "";
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFILTERFULLTEXT"), AV38FilterFullText) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_CONBDSC", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A745ConBDsc, "")), context));
         GxWebStd.gx_hidden_field( context, "CONBDSC", StringUtil.RTrim( A745ConBDsc));
      }
      ...
      {
         /* GeneXus formulas. */
         AV41Pgmname = "Generales.WWBusquedaConceptosBancos";
         context.Gx_err = 0;
      ...
      protected void RF6O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 A746ConBSts } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                 }
            });
            ...
            lV38FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV38FilterFullText), "%", "");
            /* Using cursor H006O2 */
            pr_default.execute(0, new Object[] {lV38FilterFullText, lV38FilterFullText, lV38FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A746ConBSts = H006O2_A746ConBSts[0];
               A745ConBDsc = H006O2_A745ConBDsc[0];
               A374ConBCueCod = H006O2_A374ConBCueCod[0];
               A355ConBCod = H006O2_A355ConBCod[0];
               E166O2 ();
      ...
      protected void send_integrity_lvl_hashes6O2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV41Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV41Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CONBCOD"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A355ConBCod), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CONBDSC"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A745ConBDsc, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV38FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV38FilterFullText), "%", "");
         /* Using cursor H006O3 */
         pr_default.execute(1, new Object[] {lV38FilterFullText, lV38FilterFullText, lV38FilterFullText});
      ...
      protected void STRUP6O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV38FilterFullText = cgiGet( edtavFilterfulltext_Internalname);
            AssignAttri("", false, "AV38FilterFullText", AV38FilterFullText);
      ...
      protected void E146O2( )
      {
         ...
         Form.Caption = "Selecciona Conceptos de Bancos";
      ...
      protected void E156O2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV41Pgmname, out  GXt_char2) ;
      ...
      private void E166O2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         AV37Select = "<i class=\"fas fa-check\"></i>";
         AssignAttri("", false, edtavSelect_Internalname, AV37Select);
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E176O2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV7InOutConBCod = A355ConBCod;
         AssignAttri("", false, "AV7InOutConBCod", StringUtil.LTrimStr( (decimal)(AV7InOutConBCod), 6, 0));
         AV8InOutConBDsc = A745ConBDsc;
         AssignAttri("", false, "AV8InOutConBDsc", AV8InOutConBDsc);
         context.setWebReturnParms(new Object[] {(int)AV7InOutConBCod,(string)AV8InOutConBDsc});
         context.setWebReturnParmsMetadata(new Object[] {"AV7InOutConBCod","AV8InOutConBDsc"});
      ...
      protected void wb_table1_13_6O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV38FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV38FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar", edtavFilterfulltext_Jsonclick, 0, "AttributeRealWidth", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "WWPFullTextFilter", "left", true, "", "HLP_Generales\\WWBusquedaConceptosBancos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_13_6O2e( true) ;
         }
         else
         {
            wb_table1_13_6O2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7InOutConBCod = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV7InOutConBCod", StringUtil.LTrimStr( (decimal)(AV7InOutConBCod), 6, 0));
         AV8InOutConBDsc = (string)getParm(obj,1);
         AssignAttri("", false, "AV8InOutConBDsc", AV8InOutConBDsc);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181032136", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("generales/wwbusquedaconceptosbancos.js", "?20228181032136", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtConBCod_Internalname = "CONBCOD_"+sGXsfl_24_idx;
         edtConBCueCod_Internalname = "CONBCUECOD_"+sGXsfl_24_idx;
         edtConBDsc_Internalname = "CONBDSC_"+sGXsfl_24_idx;
         cmbConBSts_Internalname = "CONBSTS_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_24_fel_idx;
         edtConBCod_Internalname = "CONBCOD_"+sGXsfl_24_fel_idx;
         edtConBCueCod_Internalname = "CONBCUECOD_"+sGXsfl_24_fel_idx;
         edtConBDsc_Internalname = "CONBDSC_"+sGXsfl_24_fel_idx;
         cmbConBSts_Internalname = "CONBSTS_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, cmbConBSts_Internalname, "Values", (string)(cmbConBSts.ToJavascriptSource()), !bGXsfl_24_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:ConBCod|2:ConBCueCod|3:ConBDsc";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV34GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV35GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV36GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E116O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E126O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E136O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E166O2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV37Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E176O2',iparms:[{av:'A355ConBCod',fld:'CONBCOD',pic:'ZZZZZ9',hsh:true},{av:'A745ConBDsc',fld:'CONBDSC',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV7InOutConBCod',fld:'vINOUTCONBCOD',pic:'ZZZZZ9'},{av:'AV8InOutConBDsc',fld:'vINOUTCONBDSC',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV38FilterFullText = "";
         H006O2_A746ConBSts = new short[1] ;
         H006O2_A745ConBDsc = new string[] {""} ;
         H006O2_A374ConBCueCod = new string[] {""} ;
         H006O2_A355ConBCod = new int[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.generales.wwbusquedaconceptosbancos__default(),
            new Object[][] {
                new Object[] {
               H006O2_A746ConBSts, H006O2_A745ConBDsc, H006O2_A374ConBCueCod, H006O2_A355ConBCod
               }
               , new Object[] {
      ...
      private int AV7InOutConBCod ;
      private int wcpOAV7InOutConBCod ;
      ...
      private string AV8InOutConBDsc ;
      private string wcpOAV8InOutConBDsc ;
      ...
      private int aP0_InOutConBCod ;
      private string aP1_InOutConBDsc ;
      private GXCombobox cmbConBSts ;
      private IDataStoreProvider pr_default ;
      private short[] H006O2_A746ConBSts ;
      private string[] H006O2_A745ConBDsc ;
      private string[] H006O2_A374ConBCueCod ;
      private int[] H006O2_A355ConBCod ;
   ...
   public class wwbusquedaconceptosbancos__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A746ConBSts )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [ConBSts], [ConBDsc], [ConBCueCod], [ConBCod]";
         sFromString = " FROM [TSCONCEPTOBANCOS]";
         sOrderString = "";
         AddWhere(sWhereString, "([ConBSts] = 1)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(6), CAST([ConBCod] AS decimal(6,0))) like '%' + @lV38FilterFullText) or ( [ConBCueCod] like '%' + @lV38FilterFullText) or ( [ConBDsc] like '%' + @lV38FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [ConBCod]";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ConBCod] DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [ConBCueCod]";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ConBCueCod] DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [ConBDsc]";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ConBDsc] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [ConBCod]";
                                             ...
                                             short A746ConBSts )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [TSCONCEPTOBANCOS]";
         AddWhere(sWhereString, "([ConBSts] = 1)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(6), CAST([ConBCod] AS decimal(6,0))) like '%' + @lV38FilterFullText) or ( [ConBCueCod] like '%' + @lV38FilterFullText) or ( [ConBDsc] like '%' + @lV38FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006O2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H006O3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV38FilterFullText",GXType.NVarChar,100,0) ,
          new ParDef("@lV38FilterFullText",GXType.NVarChar,100,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H006O2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006O2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006O3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006O3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
