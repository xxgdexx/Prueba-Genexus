...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Grouping" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerElements.Element.Grouping", Namespace="SIGERP_ADVANCED")]
