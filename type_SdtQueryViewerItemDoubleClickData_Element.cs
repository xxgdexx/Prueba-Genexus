...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Element" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	public class SdtQueryViewerItemDoubleClickData_Element : GxUserType
	{
		...
		public GxSimpleCollection<string> gxTpr_Values_GxSimpleCollection
		{
			...
			set {
				gxTv_SdtQueryViewerItemDoubleClickData_Element_Values_N = false;
		...
		{
			gxTv_SdtQueryViewerItemDoubleClickData_Element_Values_N = true;
		...
		{
			return gxTv_SdtQueryViewerItemDoubleClickData_Element_Values == null;
		}
		...
		protected bool gxTv_SdtQueryViewerItemDoubleClickData_Element_Values_N;
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Element", Namespace="SIGERP_ADVANCED")]
