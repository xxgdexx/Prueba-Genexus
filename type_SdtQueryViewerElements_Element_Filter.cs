...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Filter" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerElements.Element.Filter", Namespace="SIGERP_ADVANCED")]
