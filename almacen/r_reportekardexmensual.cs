...
namespace GeneXus.Programs.almacen {
   public class r_reportekardexmensual : GXDataArea
   {
      public r_reportekardexmensual( )
      {
      ...
      public r_reportekardexmensual( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810322111", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("almacen.r_reportekardexmensual.aspx") +"\">") ;
      ...
      {
         return formatLink("almacen.r_reportekardexmensual.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Almacen.R_ReporteKardexMensual" ;
      }

      public override string GetPgmdesc( )
      {
         return "Kardex Mensual" ;
      }
      ...
      protected void WB770( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_almcod_Internalname, "Almacen", "", "", lblTextblockcombo_almcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_57_772( true) ;
         }
         else
         {
            wb_table1_57_772( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_772e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Año", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavFdesde_Internalname, "FDesde", "col-sm-3 AttributeWidthAutoLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 75,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22FDesde), 4, 0, ".", "")), StringUtil.LTrim( ((edtavFdesde_Enabled!=0) ? context.localUtil.Format( (decimal)(AV22FDesde), "ZZZ9") : context.localUtil.Format( (decimal)(AV22FDesde), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,75);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfechames_Internalname, "Mes", "", "", lblTextblockfechames_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavFechames, cmbavFechames_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV23FechaMes), 2, 0)), 1, cmbavFechames_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavFechames.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,84);\"", "", true, 1, "HLP_Almacen\\R_ReporteKardexMensual.htm");
            cmbavFechames.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV23FechaMes), 2, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_ReporteKardexMensual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START772( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Kardex Mensual", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV23FechaMes = (short)(NumberUtil.Val( cmbavFechames.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV23FechaMes), 2, 0))), "."));
            AssignAttri("", false, "AV23FechaMes", StringUtil.LTrimStr( (decimal)(AV23FechaMes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavFechames.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV23FechaMes), 2, 0));
      ...
      protected void STRUP770( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavFdesde_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavFdesde_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vFDESDE");
               GX_FocusControl = edtavFdesde_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV22FDesde = 0;
               AssignAttri("", false, "AV22FDesde", StringUtil.LTrimStr( (decimal)(AV22FDesde), 4, 0));
            }
            else
            {
               AV22FDesde = (short)(context.localUtil.CToN( cgiGet( edtavFdesde_Internalname), ".", ","));
               AssignAttri("", false, "AV22FDesde", StringUtil.LTrimStr( (decimal)(AV22FDesde), 4, 0));
            }
            cmbavFechames.CurrentValue = cgiGet( cmbavFechames_Internalname);
            AV23FechaMes = (short)(NumberUtil.Val( cgiGet( cmbavFechames_Internalname), "."));
            AssignAttri("", false, "AV23FechaMes", StringUtil.LTrimStr( (decimal)(AV23FechaMes), 2, 0));
      ...
      protected void E12772( )
      {
         ...
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "almacen.rrmovalmacenes.aspx"+UrlEncode(StringUtil.LTrimStr(AV13LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV18SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10FamCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV15ProdCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV22FDesde,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV23FechaMes,2,0));
         AV21URL = formatLink("almacen.rrmovalmacenes.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S142( )
      {
         ...
         {
            A979FamSts = H00772_A979FamSts[0];
            A50FamCod = H00772_A50FamCod[0];
            A977FamDsc = H00772_A977FamDsc[0];
      ...
      protected void S132( )
      {
         ...
         {
            A1893SublSts = H00773_A1893SublSts[0];
            A51SublCod = H00773_A51SublCod[0];
            A1892SublDsc = H00773_A1892SublDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A1159LinSts = H00774_A1159LinSts[0];
            A52LinCod = H00774_A52LinCod[0];
            A1153LinDsc = H00774_A1153LinDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A438AlmSts = H00775_A438AlmSts[0];
            A63AlmCod = H00775_A63AlmCod[0];
            A436AlmDsc = H00775_A436AlmDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table1_57_772( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscarpro_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgBtnbuscarpro_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOBTNBUSCARPRO\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Almacen\\R_ReporteKardexMensual.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810322310", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("almacen/r_reportekardexmensual.js", "?202281810322310", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Kardex Mensual";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12772',iparms:[{av:'AV13LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV18SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV15ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV22FDesde',fld:'vFDESDE',pic:'ZZZ9'},{av:'cmbavFechames'},{av:'AV23FechaMes',fld:'vFECHAMES',pic:'Z9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E13772',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNBUSCARPRO'","{handler:'E14772',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H00772_A979FamSts = new short[1] ;
         H00772_A50FamCod = new int[1] ;
         H00772_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00773_A1893SublSts = new short[1] ;
         H00773_A51SublCod = new int[1] ;
         H00773_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H00774_A1159LinSts = new short[1] ;
         H00774_A52LinCod = new int[1] ;
         H00774_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H00775_A438AlmSts = new short[1] ;
         H00775_A63AlmCod = new int[1] ;
         H00775_A436AlmDsc = new string[] {""} ;
         A436AlmDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.almacen.r_reportekardexmensual__default(),
            new Object[][] {
                new Object[] {
               H00772_A979FamSts, H00772_A50FamCod, H00772_A977FamDsc
               }
               , new Object[] {
               H00773_A1893SublSts, H00773_A51SublCod, H00773_A1892SublDsc
               }
               , new Object[] {
               H00774_A1159LinSts, H00774_A52LinCod, H00774_A1153LinDsc
               }
               , new Object[] {
               H00775_A438AlmSts, H00775_A63AlmCod, H00775_A436AlmDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV22FDesde ;
      private short AV23FechaMes ;
      ...
      private short[] H00772_A979FamSts ;
      private int[] H00772_A50FamCod ;
      private string[] H00772_A977FamDsc ;
      private short[] H00773_A1893SublSts ;
      private int[] H00773_A51SublCod ;
      private string[] H00773_A1892SublDsc ;
      private short[] H00774_A1159LinSts ;
      private int[] H00774_A52LinCod ;
      private string[] H00774_A1153LinDsc ;
      private short[] H00775_A438AlmSts ;
      private int[] H00775_A63AlmCod ;
      private string[] H00775_A436AlmDsc ;
   ...
   public class r_reportekardexmensual__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00772", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00772,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00773", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00773,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00774", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00774,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00775", "SELECT [AlmSts], [AlmCod], [AlmDsc] FROM [CALMACEN] WHERE [AlmSts] = 1 ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00775,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
