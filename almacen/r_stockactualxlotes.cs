...
namespace GeneXus.Programs.almacen {
   public class r_stockactualxlotes : GXDataArea
   {
      public r_stockactualxlotes( )
      {
      ...
      public r_stockactualxlotes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810311567", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("almacen.r_stockactualxlotes.aspx") +"\">") ;
      ...
      {
         return formatLink("almacen.r_stockactualxlotes.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Almacen.R_StockActualxLotes" ;
      }

      public override string GetPgmdesc( )
      {
         return "Stock Actual Por Lotes" ;
      }
      ...
      protected void WB4G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_almcod_Internalname, "Almacen", "", "", lblTextblockcombo_almcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_57_4G2( true) ;
         }
         else
         {
            wb_table1_57_4G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_4G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipoorden_Internalname, "Ordenado por", "", "", lblTextblocktipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipoorden, radavTipoorden_Internalname, StringUtil.Str( (decimal)(AV20TipoOrden), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,75);\"", "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAlmcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5AlmCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5AlmCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,91);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAlmcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavAlmcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActualxLotes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 92,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,92);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActualxLotes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 93,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18SubLCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV18SubLCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,93);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActualxLotes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 94,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFamcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10FamCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10FamCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,94);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFamcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavFamcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActualxLotes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Stock Actual Por Lotes", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E124G2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "almacen.r_stockactuallotespdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV13LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV18SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10FamCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV15ProdCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV20TipoOrden,1,0));
         Innewwindow_Target = formatLink("almacen.r_stockactuallotespdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E134G2( )
      {
         ...
         new GeneXus.Programs.almacen.r_stockactualxlotesexcel(context ).execute( ref  AV13LinCod, ref  AV18SubLCod, ref  AV10FamCod, ref  AV5AlmCod, ref  AV15ProdCod, ref  AV20TipoOrden, out  AV9ExcelFilename, out  AV8ErrorMessage) ;
         AssignAttri("", false, "AV13LinCod", StringUtil.LTrimStr( (decimal)(AV13LinCod), 6, 0));
         AssignAttri("", false, "AV18SubLCod", StringUtil.LTrimStr( (decimal)(AV18SubLCod), 6, 0));
         AssignAttri("", false, "AV10FamCod", StringUtil.LTrimStr( (decimal)(AV10FamCod), 6, 0));
         AssignAttri("", false, "AV5AlmCod", StringUtil.LTrimStr( (decimal)(AV5AlmCod), 6, 0));
      ...
      protected void S142( )
      {
         ...
         {
            A979FamSts = H004G2_A979FamSts[0];
            A50FamCod = H004G2_A50FamCod[0];
            A977FamDsc = H004G2_A977FamDsc[0];
      ...
      protected void S132( )
      {
         ...
         {
            A1893SublSts = H004G3_A1893SublSts[0];
            A51SublCod = H004G3_A51SublCod[0];
            A1892SublDsc = H004G3_A1892SublDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A1159LinSts = H004G4_A1159LinSts[0];
            A52LinCod = H004G4_A52LinCod[0];
            A1153LinDsc = H004G4_A1153LinDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A438AlmSts = H004G5_A438AlmSts[0];
            A63AlmCod = H004G5_A63AlmCod[0];
            A436AlmDsc = H004G5_A436AlmDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table1_57_4G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOBTNBUSCAR\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Almacen\\R_StockActualxLotes.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810311767", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("almacen/r_stockactualxlotes.js", "?202281810311768", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Stock Actual Por Lotes";
         ...
         Form.Caption = "Stock Actual Por Lotes";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E124G2',iparms:[{av:'AV13LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV18SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV15ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E134G2',iparms:[{av:'AV13LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV18SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV15ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV15ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV18SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV13LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E144G2',iparms:[{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E154G2',iparms:[{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV16ProdDsc',fld:'vPRODDSC',pic:''},{av:'AV15ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavTipoorden'},{av:'AV20TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV8ErrorMessage = "";
         scmdbuf = "";
         H004G2_A979FamSts = new short[1] ;
         H004G2_A50FamCod = new int[1] ;
         H004G2_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H004G3_A1893SublSts = new short[1] ;
         H004G3_A51SublCod = new int[1] ;
         H004G3_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H004G4_A1159LinSts = new short[1] ;
         H004G4_A52LinCod = new int[1] ;
         H004G4_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H004G5_A438AlmSts = new short[1] ;
         H004G5_A63AlmCod = new int[1] ;
         H004G5_A436AlmDsc = new string[] {""} ;
         A436AlmDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.almacen.r_stockactualxlotes__default(),
            new Object[][] {
                new Object[] {
               H004G2_A979FamSts, H004G2_A50FamCod, H004G2_A977FamDsc
               }
               , new Object[] {
               H004G3_A1893SublSts, H004G3_A51SublCod, H004G3_A1892SublDsc
               }
               , new Object[] {
               H004G4_A1159LinSts, H004G4_A52LinCod, H004G4_A1153LinDsc
               }
               , new Object[] {
               H004G5_A438AlmSts, H004G5_A63AlmCod, H004G5_A436AlmDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H004G2_A979FamSts ;
      private int[] H004G2_A50FamCod ;
      private string[] H004G2_A977FamDsc ;
      private short[] H004G3_A1893SublSts ;
      private int[] H004G3_A51SublCod ;
      private string[] H004G3_A1892SublDsc ;
      private short[] H004G4_A1159LinSts ;
      private int[] H004G4_A52LinCod ;
      private string[] H004G4_A1153LinDsc ;
      private short[] H004G5_A438AlmSts ;
      private int[] H004G5_A63AlmCod ;
      private string[] H004G5_A436AlmDsc ;
   ...
   public class r_stockactualxlotes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004G2", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004G2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H004G3", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004G3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H004G4", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004G4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H004G5", "SELECT [AlmSts], [AlmCod], [AlmDsc] FROM [CALMACEN] WHERE [AlmSts] = 1 ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004G5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
