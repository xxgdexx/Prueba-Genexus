...
namespace GeneXus.Programs.almacen {
   public class r_stockactual : GXDataArea
   {
      public r_stockactual( )
      {
      ...
      public r_stockactual( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810304481", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("almacen.r_stockactual.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vALMCOD_DATA", AV14AlmCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vALMCOD_DATA", AV14AlmCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFAMCOD_DATA", AV18FamCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFAMCOD_DATA", AV18FamCod_Data);
         }
      ...
      {
         return formatLink("almacen.r_stockactual.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Almacen.R_StockActual" ;
      }
      ...
      protected void WB2R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_almcod_Internalname, "Almacen", "", "", lblTextblockcombo_almcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            ucCombo_almcod.SetProperty("DropDownOptionsData", AV14AlmCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_famcod.SetProperty("DropDownOptionsData", AV18FamCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_57_2R2( true) ;
         }
         else
         {
            wb_table1_57_2R2( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_2R2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV23FDesde, "99/99/99"), context.localUtil.Format( AV23FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,75);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Almacen\\R_StockActual.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipoorden_Internalname, "Ordenado por", "", "", lblTextblocktipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipoorden, radavTipoorden_Internalname, StringUtil.Str( (decimal)(AV12TipoOrden), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,84);\"", "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAlmcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5AlmCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5AlmCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAlmcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavAlmcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActual.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 101,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,101);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActual.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7SubLCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV7SubLCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActual.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 103,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFamcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8FamCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8FamCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,103);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFamcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavFamcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         AV12TipoOrden = (short)(context.localUtil.CToN( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12TipoOrden), 1, 0, ".", "")), ".", ","));
         AssignAttri("", false, "AV12TipoOrden", StringUtil.Str( (decimal)(AV12TipoOrden), 1, 0));
      }
      ...
      protected void STRUP2R0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vALMCOD_DATA"), AV14AlmCod_Data);
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vFAMCOD_DATA"), AV18FamCod_Data);
            /* Read saved values. */
            ...
            AV13ProdDsc = cgiGet( edtavProddsc_Internalname);
            AssignAttri("", false, "AV13ProdDsc", AV13ProdDsc);
            if ( context.localUtil.VCDate( cgiGet( edtavFdesde_Internalname), 2) == 0 )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV23FDesde = DateTime.MinValue;
               AssignAttri("", false, "AV23FDesde", context.localUtil.Format(AV23FDesde, "99/99/99"));
            }
            else
            {
               AV23FDesde = context.localUtil.CToD( cgiGet( edtavFdesde_Internalname), 2);
               AssignAttri("", false, "AV23FDesde", context.localUtil.Format(AV23FDesde, "99/99/99"));
            }
            ...
            {
               AV12TipoOrden = (short)(context.localUtil.CToN( cgiGet( radavTipoorden_Internalname), ".", ","));
               AssignAttri("", false, "AV12TipoOrden", StringUtil.Str( (decimal)(AV12TipoOrden), 1, 0));
            }
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV6LinCod = 0;
               AssignAttri("", false, "AV6LinCod", StringUtil.LTrimStr( (decimal)(AV6LinCod), 6, 0));
            }
            else
            {
               AV6LinCod = (int)(context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ","));
               AssignAttri("", false, "AV6LinCod", StringUtil.LTrimStr( (decimal)(AV6LinCod), 6, 0));
            }
            ...
            {
               AV7SubLCod = (int)(context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ","));
               AssignAttri("", false, "AV7SubLCod", StringUtil.LTrimStr( (decimal)(AV7SubLCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavFamcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavFamcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV8FamCod = 0;
               AssignAttri("", false, "AV8FamCod", StringUtil.LTrimStr( (decimal)(AV8FamCod), 6, 0));
            }
            else
            {
               AV8FamCod = (int)(context.localUtil.CToN( cgiGet( edtavFamcod_Internalname), ".", ","));
               AssignAttri("", false, "AV8FamCod", StringUtil.LTrimStr( (decimal)(AV8FamCod), 6, 0));
            }
      ...
      protected void E112R2( )
      {
         ...
         AV12TipoOrden = 2;
         AssignAttri("", false, "AV12TipoOrden", StringUtil.Str( (decimal)(AV12TipoOrden), 1, 0));
         AV23FDesde = DateTimeUtil.Today( context);
         AssignAttri("", false, "AV23FDesde", context.localUtil.Format(AV23FDesde, "99/99/99"));
      }
      ...
      protected void E122R2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "almacen.r_stockactualpdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV6LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8FamCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV9ProdCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV12TipoOrden,1,0)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV23FDesde));
         Innewwindow_Target = formatLink("almacen.r_stockactualpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E132R2( )
      {
         ...
         new GeneXus.Programs.almacen.r_stockactualexcel(context ).execute( ref  AV6LinCod, ref  AV7SubLCod, ref  AV8FamCod, ref  AV5AlmCod, ref  AV9ProdCod, ref  AV12TipoOrden, ref  AV23FDesde, out  AV21ExcelFilename, out  AV22ErrorMessage) ;
         AssignAttri("", false, "AV6LinCod", StringUtil.LTrimStr( (decimal)(AV6LinCod), 6, 0));
         AssignAttri("", false, "AV7SubLCod", StringUtil.LTrimStr( (decimal)(AV7SubLCod), 6, 0));
         AssignAttri("", false, "AV8FamCod", StringUtil.LTrimStr( (decimal)(AV8FamCod), 6, 0));
         AssignAttri("", false, "AV5AlmCod", StringUtil.LTrimStr( (decimal)(AV5AlmCod), 6, 0));
         ...
         /*  Sending Event outputs  */
         radavTipoorden.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV12TipoOrden), 1, 0));
      ...
      protected void E152R2( )
      {
         ...
         returnInSub = false;
         context.DoAjaxRefresh();
         context.PopUp(formatLink("generales.wwbusquedaproducto.aspx", new object[] {UrlEncode(StringUtil.RTrim("")),UrlEncode(StringUtil.RTrim("")),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OutProdCod","OutProdDsc","InTipo"}) , new Object[] {"AV9ProdCod","AV13ProdDsc",});
         /*  Sending Event outputs  */
      }
      ...
      protected void S142( )
      {
         ...
         {
            A979FamSts = H002R2_A979FamSts[0];
            A50FamCod = H002R2_A50FamCod[0];
            A977FamDsc = H002R2_A977FamDsc[0];
            AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV15Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A50FamCod), 6, 0));
            AV15Combo_DataItem.gxTpr_Title = A977FamDsc;
            AV18FamCod_Data.Add(AV15Combo_DataItem, 0);
            pr_default.readNext(0);
         }
         pr_default.close(0);
         Combo_famcod_Selectedvalue_set = ((0==AV8FamCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV8FamCod), 6, 0)));
      ...
      protected void S132( )
      {
         ...
         {
            A1893SublSts = H002R3_A1893SublSts[0];
            A51SublCod = H002R3_A51SublCod[0];
            A1892SublDsc = H002R3_A1892SublDsc[0];
            AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV15Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A51SublCod), 6, 0));
            AV15Combo_DataItem.gxTpr_Title = A1892SublDsc;
            AV17SubLCod_Data.Add(AV15Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_sublcod_Selectedvalue_set = ((0==AV7SubLCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV7SubLCod), 6, 0)));
      ...
      protected void S122( )
      {
         ...
         {
            A1159LinSts = H002R4_A1159LinSts[0];
            A52LinCod = H002R4_A52LinCod[0];
            A1153LinDsc = H002R4_A1153LinDsc[0];
            AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV15Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A52LinCod), 6, 0));
            AV15Combo_DataItem.gxTpr_Title = A1153LinDsc;
            AV16LinCod_Data.Add(AV15Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_lincod_Selectedvalue_set = ((0==AV6LinCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV6LinCod), 6, 0)));
      ...
      protected void S112( )
      {
         ...
         {
            A438AlmSts = H002R5_A438AlmSts[0];
            A63AlmCod = H002R5_A63AlmCod[0];
            A436AlmDsc = H002R5_A436AlmDsc[0];
            AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV15Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A63AlmCod), 6, 0));
            AV15Combo_DataItem.gxTpr_Title = A436AlmDsc;
            AV14AlmCod_Data.Add(AV15Combo_DataItem, 0);
      ...
      protected void wb_table1_57_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOBTNBUSCAR\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Almacen\\R_StockActual.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavProddsc_Internalname, StringUtil.RTrim( AV13ProdDsc), StringUtil.RTrim( context.localUtil.Format( AV13ProdDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProddsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavProddsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Almacen\\R_StockActual.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_57_2R2e( true) ;
         }
         else
         {
            wb_table1_57_2R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810304678", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("almacen/r_stockactual.js", "?202281810304679", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Stock Actual";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E122R2',iparms:[{av:'AV6LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV7SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV8FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV23FDesde',fld:'vFDESDE',pic:''},{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E132R2',iparms:[{av:'AV6LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV7SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV8FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV23FDesde',fld:'vFDESDE',pic:''},{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV23FDesde',fld:'vFDESDE',pic:''},{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV8FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV7SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV6LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E142R2',iparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E152R2',iparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV13ProdDsc',fld:'vPRODDSC',pic:''},{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavTipoorden'},{av:'AV12TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV14AlmCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV18FamCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV22ErrorMessage = "";
         scmdbuf = "";
         H002R2_A979FamSts = new short[1] ;
         H002R2_A50FamCod = new int[1] ;
         H002R2_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H002R3_A1893SublSts = new short[1] ;
         H002R3_A51SublCod = new int[1] ;
         H002R3_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H002R4_A1159LinSts = new short[1] ;
         H002R4_A52LinCod = new int[1] ;
         H002R4_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H002R5_A438AlmSts = new short[1] ;
         H002R5_A63AlmCod = new int[1] ;
         H002R5_A436AlmDsc = new string[] {""} ;
         A436AlmDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.almacen.r_stockactual__default(),
            new Object[][] {
                new Object[] {
               H002R2_A979FamSts, H002R2_A50FamCod, H002R2_A977FamDsc
               }
               , new Object[] {
               H002R3_A1893SublSts, H002R3_A51SublCod, H002R3_A1892SublDsc
               }
               , new Object[] {
               H002R4_A1159LinSts, H002R4_A52LinCod, H002R4_A1153LinDsc
               }
               , new Object[] {
               H002R5_A438AlmSts, H002R5_A63AlmCod, H002R5_A436AlmDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H002R2_A979FamSts ;
      private int[] H002R2_A50FamCod ;
      private string[] H002R2_A977FamDsc ;
      private short[] H002R3_A1893SublSts ;
      private int[] H002R3_A51SublCod ;
      private string[] H002R3_A1892SublDsc ;
      private short[] H002R4_A1159LinSts ;
      private int[] H002R4_A52LinCod ;
      private string[] H002R4_A1153LinDsc ;
      private short[] H002R5_A438AlmSts ;
      private int[] H002R5_A63AlmCod ;
      private string[] H002R5_A436AlmDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV14AlmCod_Data ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV18FamCod_Data ;
      private GXWebForm Form ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV15Combo_DataItem ;
   }

   public class r_stockactual__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002R2", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002R2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H002R3", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002R3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H002R4", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002R4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H002R5", "SELECT [AlmSts], [AlmCod], [AlmDsc] FROM [CALMACEN] WHERE [AlmSts] = 1 ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002R5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
