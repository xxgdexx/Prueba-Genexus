   ...
   public class r_guiasconsignacion : GXDataArea
   {
      ...
      protected void WB6C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_almcod_Internalname, "Almacén", "", "", lblTextblockcombo_almcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_GuiasConsignacion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
