...
namespace GeneXus.Programs.almacen {
   public class r_kardexporproductoloaddvcombo : GXProcedure
   {
      public r_kardexporproductoloaddvcombo( )
      {
      ...
      public r_kardexporproductoloaddvcombo( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP3_Combo_DataJson )
      {
         r_kardexporproductoloaddvcombo objr_kardexporproductoloaddvcombo;
         objr_kardexporproductoloaddvcombo = new r_kardexporproductoloaddvcombo();
         objr_kardexporproductoloaddvcombo.AV16ComboName = aP0_ComboName;
         objr_kardexporproductoloaddvcombo.AV17Cond_CliCod = aP1_Cond_CliCod;
         objr_kardexporproductoloaddvcombo.AV11SearchTxt = aP2_SearchTxt;
         objr_kardexporproductoloaddvcombo.AV12Combo_DataJson = "" ;
         objr_kardexporproductoloaddvcombo.context.SetSubmitInitialConfig(context);
         objr_kardexporproductoloaddvcombo.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_kardexporproductoloaddvcombo);
         aP3_Combo_DataJson=this.AV12Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_kardexporproductoloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S111( )
      {
         ...
         {
            A600CliDirDsc = P00F32_A600CliDirDsc[0];
            A164CliDirItem = P00F32_A164CliDirItem[0];
            A45CliCod = P00F32_A45CliCod[0];
      ...
      public override void initialize( )
      {
         ...
         lV11SearchTxt = "";
         A600CliDirDsc = "";
         P00F32_A600CliDirDsc = new string[] {""} ;
         P00F32_A164CliDirItem = new int[1] ;
         P00F32_A45CliCod = new string[] {""} ;
         A45CliCod = "";
         AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV13Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.almacen.r_kardexporproductoloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00F32_A600CliDirDsc, P00F32_A164CliDirItem, P00F32_A45CliCod
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00F32_A600CliDirDsc ;
      private int[] P00F32_A164CliDirItem ;
      private string[] P00F32_A45CliCod ;
   ...
   public class r_kardexporproductoloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00F32( IGxContext context ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00F32(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmP00F32;
          prmP00F32 = new Object[] {
          new ParDef("@lV11SearchTxt",GXType.NVarChar,40,0)
          };
          def= new CursorDef[] {
              new CursorDef("P00F32", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00F32,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
