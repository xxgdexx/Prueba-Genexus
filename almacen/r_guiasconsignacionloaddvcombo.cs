...
namespace GeneXus.Programs.almacen {
   public class r_guiasconsignacionloaddvcombo : GXProcedure
   {
      public r_guiasconsignacionloaddvcombo( )
      {
      ...
      public r_guiasconsignacionloaddvcombo( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP3_Combo_DataJson )
      {
         r_guiasconsignacionloaddvcombo objr_guiasconsignacionloaddvcombo;
         objr_guiasconsignacionloaddvcombo = new r_guiasconsignacionloaddvcombo();
         objr_guiasconsignacionloaddvcombo.AV16ComboName = aP0_ComboName;
         objr_guiasconsignacionloaddvcombo.AV17Cond_CliCod = aP1_Cond_CliCod;
         objr_guiasconsignacionloaddvcombo.AV11SearchTxt = aP2_SearchTxt;
         objr_guiasconsignacionloaddvcombo.AV12Combo_DataJson = "" ;
         objr_guiasconsignacionloaddvcombo.context.SetSubmitInitialConfig(context);
         objr_guiasconsignacionloaddvcombo.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_guiasconsignacionloaddvcombo);
         aP3_Combo_DataJson=this.AV12Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_guiasconsignacionloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S111( )
      {
         ...
         {
            A600CliDirDsc = P00F22_A600CliDirDsc[0];
            A164CliDirItem = P00F22_A164CliDirItem[0];
            A45CliCod = P00F22_A45CliCod[0];
      ...
      public override void initialize( )
      {
         ...
         lV11SearchTxt = "";
         A600CliDirDsc = "";
         P00F22_A600CliDirDsc = new string[] {""} ;
         P00F22_A164CliDirItem = new int[1] ;
         P00F22_A45CliCod = new string[] {""} ;
         A45CliCod = "";
         AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV13Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.almacen.r_guiasconsignacionloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00F22_A600CliDirDsc, P00F22_A164CliDirItem, P00F22_A45CliCod
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00F22_A600CliDirDsc ;
      private int[] P00F22_A164CliDirItem ;
      private string[] P00F22_A45CliCod ;
   ...
   public class r_guiasconsignacionloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00F22(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00F22", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00F22,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
