...
namespace GeneXus.Programs.almacen {
   public class r_resumennotasentrada : GXDataArea
   {
      public r_resumennotasentrada( )
      {
      ...
      public r_resumennotasentrada( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181032480", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("almacen.r_resumennotasentrada.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vMOVCOD_DATA", AV24MovCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vMOVCOD_DATA", AV24MovCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vLINCOD_DATA", AV22LinCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vLINCOD_DATA", AV22LinCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSUBLCOD_DATA", AV32SubLCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSUBLCOD_DATA", AV32SubLCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFAMCOD_DATA", AV15FamCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFAMCOD_DATA", AV15FamCod_Data);
         }
      ...
      {
         return formatLink("almacen.r_resumennotasentrada.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Almacen.R_ResumenNotasEntrada" ;
      }
      ...
      protected void WB6E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_almcod_Internalname, "Almacen", "", "", lblTextblockcombo_almcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_movcod_Internalname, "Tipo de Movimiento", "", "", lblTextblockcombo_movcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_movcod.SetProperty("DropDownOptionsData", AV24MovCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_lincod.SetProperty("DropDownOptionsData", AV22LinCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_sublcod.SetProperty("DropDownOptionsData", AV32SubLCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_famcod.SetProperty("DropDownOptionsData", AV15FamCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_65_6E2( true) ;
         }
         else
         {
            wb_table1_65_6E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_65_6E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Validar", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV38Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,83);\"", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV16FDesde, "99/99/99"), context.localUtil.Format( AV16FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,91);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV20FHasta, "99/99/99"), context.localUtil.Format( AV20FHasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAlmcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5AlmCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5AlmCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,116);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAlmcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavAlmcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 117,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMovcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23MovCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV23MovCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,117);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMovcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMovcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 118,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV21LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV21LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,118);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 119,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31SubLCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV31SubLCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 120,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFamcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14FamCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14FamCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,120);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFamcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavFamcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6E2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Notas de Entrada", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         AV38Tipo = StringUtil.RTrim( AV38Tipo);
      ...
      protected void STRUP6E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vMOVCOD_DATA"), AV24MovCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vLINCOD_DATA"), AV22LinCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vSUBLCOD_DATA"), AV32SubLCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vFAMCOD_DATA"), AV15FamCod_Data);
            /* Read saved values. */
            ...
            AV28ProdCod = StringUtil.Upper( cgiGet( edtavProdcod_Internalname));
            AssignAttri("", false, "AV28ProdCod", AV28ProdCod);
            AV29ProdDsc = cgiGet( edtavProddsc_Internalname);
            AssignAttri("", false, "AV29ProdDsc", AV29ProdDsc);
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavFdesde_Internalname), 2) == 0 )
            {
               ...
               AssignAttri("", false, "AV16FDesde", context.localUtil.Format(AV16FDesde, "99/99/99"));
            }
            else
            {
               AV16FDesde = context.localUtil.CToD( cgiGet( edtavFdesde_Internalname), 2);
               AssignAttri("", false, "AV16FDesde", context.localUtil.Format(AV16FDesde, "99/99/99"));
            }
            if ( context.localUtil.VCDate( cgiGet( edtavFhasta_Internalname), 2) == 0 )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV20FHasta = DateTime.MinValue;
               AssignAttri("", false, "AV20FHasta", context.localUtil.Format(AV20FHasta, "99/99/99"));
            }
            else
            {
               AV20FHasta = context.localUtil.CToD( cgiGet( edtavFhasta_Internalname), 2);
               AssignAttri("", false, "AV20FHasta", context.localUtil.Format(AV20FHasta, "99/99/99"));
            }
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavMovcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavMovcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV23MovCod = 0;
               AssignAttri("", false, "AV23MovCod", StringUtil.LTrimStr( (decimal)(AV23MovCod), 6, 0));
            }
            else
            {
               AV23MovCod = (int)(context.localUtil.CToN( cgiGet( edtavMovcod_Internalname), ".", ","));
               AssignAttri("", false, "AV23MovCod", StringUtil.LTrimStr( (decimal)(AV23MovCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV21LinCod = 0;
               AssignAttri("", false, "AV21LinCod", StringUtil.LTrimStr( (decimal)(AV21LinCod), 6, 0));
            }
            else
            {
               AV21LinCod = (int)(context.localUtil.CToN( cgiGet( edtavLincod_Internalname), ".", ","));
               AssignAttri("", false, "AV21LinCod", StringUtil.LTrimStr( (decimal)(AV21LinCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV31SubLCod = 0;
               AssignAttri("", false, "AV31SubLCod", StringUtil.LTrimStr( (decimal)(AV31SubLCod), 6, 0));
            }
            else
            {
               AV31SubLCod = (int)(context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ","));
               AssignAttri("", false, "AV31SubLCod", StringUtil.LTrimStr( (decimal)(AV31SubLCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavFamcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavFamcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV14FamCod = 0;
               AssignAttri("", false, "AV14FamCod", StringUtil.LTrimStr( (decimal)(AV14FamCod), 6, 0));
            }
            else
            {
               AV14FamCod = (int)(context.localUtil.CToN( cgiGet( edtavFamcod_Internalname), ".", ","));
               AssignAttri("", false, "AV14FamCod", StringUtil.LTrimStr( (decimal)(AV14FamCod), 6, 0));
            }
      ...
      protected void E116E2( )
      {
         ...
         AV35TipoOrden = 2;
         AV34SubTotal = "N";
         AV16FDesde = DateTimeUtil.Today( context);
         AssignAttri("", false, "AV16FDesde", context.localUtil.Format(AV16FDesde, "99/99/99"));
      }
      ...
      protected void E126E2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "almacen.r_resumenentradas.aspx"+UrlEncode(StringUtil.LTrimStr(AV23MovCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21LinCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV28ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV16FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV20FHasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV31SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV14FamCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV38Tipo));
         AV36URL = formatLink("almacen.r_resumenentradas.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         Innewwindow_Target = AV36URL;
      ...
      protected void E136E2( )
      {
         /* 'DoBtnExcel' Routine */
         returnInSub = false;
         new GeneXus.Programs.almacen.r_resumenentradasexcel(context ).execute( ref  AV23MovCod, ref  AV21LinCod, ref  AV28ProdCod, ref  AV16FDesde, ref  AV20FHasta, ref  AV5AlmCod, ref  AV31SubLCod, ref  AV14FamCod, ref  AV38Tipo, out  AV13ExcelFilename, out  AV12ErrorMessage) ;
         AssignAttri("", false, "AV23MovCod", StringUtil.LTrimStr( (decimal)(AV23MovCod), 6, 0));
         AssignAttri("", false, "AV21LinCod", StringUtil.LTrimStr( (decimal)(AV21LinCod), 6, 0));
         AssignAttri("", false, "AV28ProdCod", AV28ProdCod);
         AssignAttri("", false, "AV16FDesde", context.localUtil.Format(AV16FDesde, "99/99/99"));
         ...
         /*  Sending Event outputs  */
         radavTipo.CurrentValue = StringUtil.RTrim( AV38Tipo);
      ...
      protected void E156E2( )
      {
         ...
         context.PopUp(formatLink("generales.wwbusquedaproducto.aspx", new object[] {UrlEncode(StringUtil.RTrim("")),UrlEncode(StringUtil.RTrim("")),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OutProdCod","OutProdDsc","InTipo"}) , new Object[] {"AV28ProdCod","AV29ProdDsc",});
         /*  Sending Event outputs  */
      }
      ...
      protected void S152( )
      {
         ...
         {
            A979FamSts = H006E2_A979FamSts[0];
            A50FamCod = H006E2_A50FamCod[0];
            A977FamDsc = H006E2_A977FamDsc[0];
            AV9Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV9Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A50FamCod), 6, 0));
            AV9Combo_DataItem.gxTpr_Title = A977FamDsc;
            AV15FamCod_Data.Add(AV9Combo_DataItem, 0);
            pr_default.readNext(0);
         }
         pr_default.close(0);
         Combo_famcod_Selectedvalue_set = ((0==AV14FamCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV14FamCod), 6, 0)));
      ...
      protected void S142( )
      {
         ...
         {
            A1893SublSts = H006E3_A1893SublSts[0];
            A51SublCod = H006E3_A51SublCod[0];
            A1892SublDsc = H006E3_A1892SublDsc[0];
            AV9Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV9Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A51SublCod), 6, 0));
            AV9Combo_DataItem.gxTpr_Title = A1892SublDsc;
            AV32SubLCod_Data.Add(AV9Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_sublcod_Selectedvalue_set = ((0==AV31SubLCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV31SubLCod), 6, 0)));
      ...
      protected void S132( )
      {
         ...
         {
            A1159LinSts = H006E4_A1159LinSts[0];
            A52LinCod = H006E4_A52LinCod[0];
            A1153LinDsc = H006E4_A1153LinDsc[0];
            AV9Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV9Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A52LinCod), 6, 0));
            AV9Combo_DataItem.gxTpr_Title = A1153LinDsc;
            AV22LinCod_Data.Add(AV9Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_lincod_Selectedvalue_set = ((0==AV21LinCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV21LinCod), 6, 0)));
      ...
      protected void S122( )
      {
         ...
         {
            A1240MovSts = H006E5_A1240MovSts[0];
            A234MovCod = H006E5_A234MovCod[0];
            A1239MovDsc = H006E5_A1239MovDsc[0];
            AV9Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV9Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A234MovCod), 6, 0));
            AV9Combo_DataItem.gxTpr_Title = A1239MovDsc;
            AV24MovCod_Data.Add(AV9Combo_DataItem, 0);
            pr_default.readNext(3);
         }
         pr_default.close(3);
         Combo_movcod_Selectedvalue_set = ((0==AV23MovCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV23MovCod), 6, 0)));
      ...
      protected void S112( )
      {
         ...
         {
            A438AlmSts = H006E6_A438AlmSts[0];
            A63AlmCod = H006E6_A63AlmCod[0];
            A436AlmDsc = H006E6_A436AlmDsc[0];
            AV9Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV9Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A63AlmCod), 6, 0));
            AV9Combo_DataItem.gxTpr_Title = A436AlmDsc;
            AV6AlmCod_Data.Add(AV9Combo_DataItem, 0);
      ...
      protected void wb_table1_65_6E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavProdcod_Internalname, StringUtil.RTrim( AV28ProdCod), StringUtil.RTrim( context.localUtil.Format( AV28ProdCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProdcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavProdcod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscarpro_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgBtnbuscarpro_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOBTNBUSCARPRO\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavProddsc_Internalname, StringUtil.RTrim( AV29ProdDsc), StringUtil.RTrim( context.localUtil.Format( AV29ProdDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProddsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavProddsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Almacen\\R_ResumenNotasEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_65_6E2e( true) ;
         }
         else
         {
            wb_table1_65_6E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181032749", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("almacen/r_resumennotasentrada.js", "?20228181032749", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         radavTipo.addItem("C", "Costo Cero", 0);
         radavTipo.addItem("S", "Solo con Costo", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Resumen de Notas de Entrada";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E126E2',iparms:[{av:'AV23MovCod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'AV21LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV28ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV16FDesde',fld:'vFDESDE',pic:''},{av:'AV20FHasta',fld:'vFHASTA',pic:''},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV31SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV14FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]");
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E136E2',iparms:[{av:'AV23MovCod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'AV21LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV28ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV16FDesde',fld:'vFDESDE',pic:''},{av:'AV20FHasta',fld:'vFHASTA',pic:''},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV31SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV14FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV14FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV31SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'},{av:'AV20FHasta',fld:'vFHASTA',pic:''},{av:'AV16FDesde',fld:'vFDESDE',pic:''},{av:'AV28ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV21LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV23MovCod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E146E2',iparms:[{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]}");
         setEventMetadata("'DOBTNBUSCARPRO'","{handler:'E156E2',iparms:[{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("'DOBTNBUSCARPRO'",",oparms:[{av:'AV29ProdDsc',fld:'vPRODDSC',pic:''},{av:'AV28ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavTipo'},{av:'AV38Tipo',fld:'vTIPO',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         AV24MovCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV22LinCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV32SubLCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV15FamCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV12ErrorMessage = "";
         scmdbuf = "";
         H006E2_A979FamSts = new short[1] ;
         H006E2_A50FamCod = new int[1] ;
         H006E2_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV9Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H006E3_A1893SublSts = new short[1] ;
         H006E3_A51SublCod = new int[1] ;
         H006E3_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H006E4_A1159LinSts = new short[1] ;
         H006E4_A52LinCod = new int[1] ;
         H006E4_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H006E5_A1240MovSts = new short[1] ;
         H006E5_A234MovCod = new int[1] ;
         H006E5_A1239MovDsc = new string[] {""} ;
         A1239MovDsc = "";
         H006E6_A438AlmSts = new short[1] ;
         H006E6_A63AlmCod = new int[1] ;
         H006E6_A436AlmDsc = new string[] {""} ;
         A436AlmDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.almacen.r_resumennotasentrada__default(),
            new Object[][] {
                new Object[] {
               H006E2_A979FamSts, H006E2_A50FamCod, H006E2_A977FamDsc
               }
               , new Object[] {
               H006E3_A1893SublSts, H006E3_A51SublCod, H006E3_A1892SublDsc
               }
               , new Object[] {
               H006E4_A1159LinSts, H006E4_A52LinCod, H006E4_A1153LinDsc
               }
               , new Object[] {
               H006E5_A1240MovSts, H006E5_A234MovCod, H006E5_A1239MovDsc
               }
               , new Object[] {
               H006E6_A438AlmSts, H006E6_A63AlmCod, H006E6_A436AlmDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string AV34SubTotal ;
      private string AV36URL ;
      ...
      private short[] H006E2_A979FamSts ;
      private int[] H006E2_A50FamCod ;
      private string[] H006E2_A977FamDsc ;
      private short[] H006E3_A1893SublSts ;
      private int[] H006E3_A51SublCod ;
      private string[] H006E3_A1892SublDsc ;
      private short[] H006E4_A1159LinSts ;
      private int[] H006E4_A52LinCod ;
      private string[] H006E4_A1153LinDsc ;
      private short[] H006E5_A1240MovSts ;
      private int[] H006E5_A234MovCod ;
      private string[] H006E5_A1239MovDsc ;
      private short[] H006E6_A438AlmSts ;
      private int[] H006E6_A63AlmCod ;
      private string[] H006E6_A436AlmDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV6AlmCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV24MovCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV22LinCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV32SubLCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV15FamCod_Data ;
      private GXWebForm Form ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV9Combo_DataItem ;
   }

   public class r_resumennotasentrada__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH006E5;
          prmH006E5 = new Object[] {
          };
          Object[] prmH006E6;
          prmH006E6 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H006E2", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006E2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006E3", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006E3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006E4", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006E4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006E5", "SELECT [MovSts], [MovCod], [MovDsc] FROM [CMOVALMACEN] WHERE [MovSts] = 1 ORDER BY [MovDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006E5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006E6", "SELECT [AlmSts], [AlmCod], [AlmDsc] FROM [CALMACEN] WHERE [AlmSts] = 1 ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006E6,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
