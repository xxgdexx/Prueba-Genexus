...
namespace GeneXus.Programs.produccion {
   public class r_resumencostostiposmovimientos : GXDataArea
   {
      public r_resumencostostiposmovimientos( )
      {
      ...
      public r_resumencostostiposmovimientos( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810321883", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("produccion.r_resumencostostiposmovimientos.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vOPCENTRADA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV30OpcEntrada), "9"), context));
         GxWebStd.gx_hidden_field( context, "vMOVCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31movcod), 6, 0, ".", "")));
      ...
      {
         return formatLink("produccion.r_resumencostostiposmovimientos.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Produccion.R_ResumenCostosTiposMovimientos" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Costos por Tipos de Movimientos" ;
      }
      ...
      protected void WB710( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockalmcod_Internalname, "Almacén", "", "", lblTextblockalmcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavAlmcod, dynavAlmcod_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5AlmCod), 6, 0)), 1, dynavAlmcod_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", dynavAlmcod.Visible, dynavAlmcod.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, 1, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea de Productos", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea de Productos", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia de Productos", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_56_712( true) ;
         }
         else
         {
            wb_table1_56_712( false) ;
         }
         return  ;
      }

      protected void wb_table1_56_712e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START712( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Costos por Tipos de Movimientos", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvALMCOD712( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvALMCOD_html712( )
      {
         int gxdynajaxvalue;
         GXDLVvALMCOD_data712( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvALMCOD_data712( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00712_A63AlmCod[0]), 6, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H00712_A436AlmDsc[0]));
      ...
      protected void S132( )
      {
         ...
         {
            A979FamSts = H00713_A979FamSts[0];
            A50FamCod = H00713_A50FamCod[0];
            A977FamDsc = H00713_A977FamDsc[0];
      ...
      protected void S122( )
      {
         ...
         {
            A1893SublSts = H00714_A1893SublSts[0];
            A51SublCod = H00714_A51SublCod[0];
            A1892SublDsc = H00714_A1892SublDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A1159LinSts = H00715_A1159LinSts[0];
            A52LinCod = H00715_A52LinCod[0];
            A1153LinDsc = H00715_A1153LinDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table1_56_712( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16711_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Produccion\\R_ResumenCostosTiposMovimientos.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810322064", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("produccion/r_resumencostostiposmovimientos.js", "?202281810322064", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Resumen de Costos por Tipos de Movimientos";
         ...
         Form.Caption = "Resumen de Costos por Tipos de Movimientos";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13712',iparms:[{av:'AV30OpcEntrada',fld:'vOPCENTRADA',pic:'9',hsh:true},{av:'AV31movcod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         ...
         setEventMetadata("'DOBTNSALIR'","{handler:'E14712',iparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E16711',iparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H00712_A63AlmCod = new int[1] ;
         H00712_A436AlmDsc = new string[] {""} ;
         H00712_A438AlmSts = new short[1] ;
         H00712_A434AlmCos = new short[1] ;
         AV21ProdCod = "";
         AV22ProdDsc = "";
         AV29URL = "";
         GXEncryptionTmp = "";
         AV9ExcelFilename = "";
         AV8ErrorMessage = "";
         H00713_A979FamSts = new short[1] ;
         H00713_A50FamCod = new int[1] ;
         H00713_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00714_A1893SublSts = new short[1] ;
         H00714_A51SublCod = new int[1] ;
         H00714_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H00715_A1159LinSts = new short[1] ;
         H00715_A52LinCod = new int[1] ;
         H00715_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.produccion.r_resumencostostiposmovimientos__default(),
            new Object[][] {
                new Object[] {
               H00712_A63AlmCod, H00712_A436AlmDsc, H00712_A438AlmSts, H00712_A434AlmCos
               }
               , new Object[] {
               H00713_A979FamSts, H00713_A50FamCod, H00713_A977FamDsc
               }
               , new Object[] {
               H00714_A1893SublSts, H00714_A51SublCod, H00714_A1892SublDsc
               }
               , new Object[] {
               H00715_A1159LinSts, H00715_A52LinCod, H00715_A1153LinDsc
               }
            }
         );
      ...
      private int[] H00712_A63AlmCod ;
      private string[] H00712_A436AlmDsc ;
      private short[] H00712_A438AlmSts ;
      private short[] H00712_A434AlmCos ;
      private short[] H00713_A979FamSts ;
      private int[] H00713_A50FamCod ;
      private string[] H00713_A977FamDsc ;
      private short[] H00714_A1893SublSts ;
      private int[] H00714_A51SublCod ;
      private string[] H00714_A1892SublDsc ;
      private short[] H00715_A1159LinSts ;
      private int[] H00715_A52LinCod ;
      private string[] H00715_A1153LinDsc ;
   ...
   public class r_resumencostostiposmovimientos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00714;
          prmH00714 = new Object[] {
          };
          Object[] prmH00715;
          prmH00715 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H00712", "SELECT [AlmCod], [AlmDsc], [AlmSts], [AlmCos] FROM [CALMACEN] WHERE ([AlmSts] = 1) AND ([AlmCos] = 1) ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00712,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00713", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00713,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00714", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00714,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00715", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00715,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
