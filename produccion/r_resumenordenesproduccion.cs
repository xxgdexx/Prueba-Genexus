...
namespace GeneXus.Programs.produccion {
   public class r_resumenordenesproduccion : GXDataArea
   {
      public r_resumenordenesproduccion( )
      {
      ...
      public r_resumenordenesproduccion( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810321269", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("produccion.r_resumenordenesproduccion.aspx") +"\">") ;
      ...
      {
         return formatLink("produccion.r_resumenordenesproduccion.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Produccion.R_ResumenOrdenesProduccion" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Ordenes de Producción" ;
      }
      ...
      protected void WB6T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_25_6T2( true) ;
         }
         else
         {
            wb_table1_25_6T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_6T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableprosts_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprosts_Internalname, "Estado", "", "", lblTextblockprosts_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavProsts_Internalname, "Estado", "col-sm-3 AttributeLabel", 0, true, "");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 59,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavProsts, cmbavProsts_Internalname, StringUtil.RTrim( AV11ProSts), 1, cmbavProsts_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavProsts.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "", true, 1, "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            cmbavProsts.CurrentValue = StringUtil.RTrim( AV11ProSts);
            AssignProp("", false, cmbavProsts_Internalname, "Values", (string)(cmbavProsts.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Ordenes de Producción", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         if ( cmbavProsts.ItemCount > 0 )
         {
            AV11ProSts = cmbavProsts.getValidValue(AV11ProSts);
            AssignAttri("", false, "AV11ProSts", AV11ProSts);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavProsts.CurrentValue = StringUtil.RTrim( AV11ProSts);
            AssignProp("", false, cmbavProsts_Internalname, "Values", cmbavProsts.ToJavascriptSource(), true);
         }
      }
      ...
      protected void STRUP6T0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            cmbavProsts.CurrentValue = cgiGet( cmbavProsts_Internalname);
            AV11ProSts = cgiGet( cmbavProsts_Internalname);
            AssignAttri("", false, "AV11ProSts", AV11ProSts);
      ...
      protected void E126T2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "produccion.r_resumenordenesproduccionpdf.aspx"+UrlEncode(StringUtil.RTrim(AV9ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV7FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV8FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV11ProSts));
         Innewwindow_Target = formatLink("produccion.r_resumenordenesproduccionpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E136T2( )
      {
         ...
         new GeneXus.Programs.produccion.p_resumenproduccionexcel(context ).execute( ref  AV9ProdCod, ref  AV7FDesde, ref  AV8FHasta, ref  AV11ProSts, out  AV6ExcelFilename, out  AV5ErrorMessage) ;
         AssignAttri("", false, "AV9ProdCod", AV9ProdCod);
         AssignAttri("", false, "AV7FDesde", context.localUtil.Format(AV7FDesde, "99/99/99"));
         AssignAttri("", false, "AV8FHasta", context.localUtil.Format(AV8FHasta, "99/99/99"));
         AssignAttri("", false, "AV11ProSts", AV11ProSts);
      ...
      protected void wb_table1_25_6T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscarser_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Servicio", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscarser_Jsonclick, "'"+""+"'"+",false,"+"'"+"e166t1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Produccion\\R_ResumenOrdenesProduccion.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810321321", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("produccion/r_resumenordenesproduccion.js", "?202281810321321", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      {
         cmbavProsts.Name = "vPROSTS";
         cmbavProsts.WebTags = "";
         cmbavProsts.addItem("", "(Todos)", 0);
         cmbavProsts.addItem("", "Pendientes", 0);
         cmbavProsts.addItem("T", "Terminados", 0);
         if ( cmbavProsts.ItemCount > 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV11ProSts)) )
            {
               AV11ProSts = "";
               AssignAttri("", false, "AV11ProSts", AV11ProSts);
            }
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockprosts_Internalname = "TEXTBLOCKPROSTS";
         cmbavProsts_Internalname = "vPROSTS";
         divUnnamedtableprosts_Internalname = "UNNAMEDTABLEPROSTS";
      ...
      public override void initialize_properties( )
      {
         ...
         cmbavProsts_Jsonclick = "";
         cmbavProsts.Enabled = 1;
         ...
         Dvpanel_panel1_Title = "Resumen de Ordenes de Producción";
         ...
         Form.Caption = "Resumen de Ordenes de Producción";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E126T2',iparms:[{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV7FDesde',fld:'vFDESDE',pic:''},{av:'AV8FHasta',fld:'vFHASTA',pic:''},{av:'cmbavProsts'},{av:'AV11ProSts',fld:'vPROSTS',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E136T2',iparms:[{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV7FDesde',fld:'vFDESDE',pic:''},{av:'AV8FHasta',fld:'vFHASTA',pic:''},{av:'cmbavProsts'},{av:'AV11ProSts',fld:'vPROSTS',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'cmbavProsts'},{av:'AV11ProSts',fld:'vPROSTS',pic:''},{av:'AV8FHasta',fld:'vFHASTA',pic:''},{av:'AV7FDesde',fld:'vFDESDE',pic:''},{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E146T2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNBUSCARSER'","{handler:'E166T1',iparms:[]");
      ...
      private string divUnnamedtableprosts_Internalname ;
      private string lblTextblockprosts_Internalname ;
      private string lblTextblockprosts_Jsonclick ;
      private string cmbavProsts_Internalname ;
      private string AV11ProSts ;
      private string cmbavProsts_Jsonclick ;
      ...
      private GXCombobox cmbavProsts ;
