...
namespace GeneXus.Programs.produccion {
   public class conceptosordenesserviciowwexport : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         {
            GXt_int2 = (short)(AV13CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV10ExcelDocument,  true, ref  GXt_int2,  (short)(AV14FirstColumn),  "Tipo Distribución") ;
            AV13CellRow = GXt_int2;
            AV44i = 1;
            AV47GXV1 = 1;
      ...
      protected void S141( )
      {
         ...
         AV10ExcelDocument.get_Cells(AV13CellRow, AV14FirstColumn+2, 1, 1).Text = "Tipo Distribución";
