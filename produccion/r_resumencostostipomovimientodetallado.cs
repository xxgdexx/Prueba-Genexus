...
namespace GeneXus.Programs.produccion {
   public class r_resumencostostipomovimientodetallado : GXDataArea
   {
      public r_resumencostostipomovimientodetallado( )
      {
      ...
      public r_resumencostostipomovimientodetallado( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810321965", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("produccion.r_resumencostostipomovimientodetallado.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vOPCENTRADA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV30OpcEntrada), "9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vMOVCOD_DATA", AV32movcod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vMOVCOD_DATA", AV32movcod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vOPCENTRADA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV30OpcEntrada), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vOPCENTRADA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV30OpcEntrada), "9"), context));
      ...
      {
         return formatLink("produccion.r_resumencostostipomovimientodetallado.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Produccion.R_ResumenCostosTipoMovimientoDetallado" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Costos por Tipo de Movimiento - Detallado" ;
      }
      ...
      protected void WB720( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockalmcod_Internalname, "Almacén", "", "", lblTextblockalmcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavAlmcod, dynavAlmcod_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5AlmCod), 6, 0)), 1, dynavAlmcod_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", dynavAlmcod.Visible, dynavAlmcod.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, 1, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_movcod_Internalname, "Tipo de Movimiento", "", "", lblTextblockcombo_movcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_movcod.SetProperty("DropDownOptionsData", AV32movcod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea de Productos", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea de Productos", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia de Productos", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_63_722( true) ;
         }
         else
         {
            wb_table1_63_722( false) ;
         }
         return  ;
      }

      protected void wb_table1_63_722e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV12FDesde, "99/99/99"), context.localUtil.Format( AV12FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,81);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV16FHasta, "99/99/99"), context.localUtil.Format( AV16FHasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavMovcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31movcod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV31movcod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,105);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMovcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMovcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 106,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV18LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,106);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 107,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24SubLCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV24SubLCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,107);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 108,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavFamcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10FamCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10FamCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,108);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFamcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavFamcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START722( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Costos por Tipo de Movimiento - Detallado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvALMCOD722( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvALMCOD_html722( )
      {
         int gxdynajaxvalue;
         GXDLVvALMCOD_data722( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvALMCOD_data722( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00722_A63AlmCod[0]), 6, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H00722_A436AlmDsc[0]));
      ...
      protected void STRUP720( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vMOVCOD_DATA"), AV32movcod_Data);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavMovcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavMovcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV31movcod = 0;
               AssignAttri("", false, "AV31movcod", StringUtil.LTrimStr( (decimal)(AV31movcod), 6, 0));
            }
            else
            {
               AV31movcod = (int)(context.localUtil.CToN( cgiGet( edtavMovcod_Internalname), ".", ","));
               AssignAttri("", false, "AV31movcod", StringUtil.LTrimStr( (decimal)(AV31movcod), 6, 0));
            }
      ...
      protected void E11722( )
      {
         ...
         AV30OpcEntrada = 0;
         AssignAttri("", false, "AV30OpcEntrada", StringUtil.Str( (decimal)(AV30OpcEntrada), 1, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vOPCENTRADA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV30OpcEntrada), "9"), context));
         if ( AV30OpcEntrada == 0 )
         {
      ...
      protected void E12722( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "produccion.r_arresumencostotipomovimientopdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV31movcod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV18LinCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV21ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV16FHasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV24SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10FamCod,6,0));
            AV29URL = formatLink("produccion.r_arresumencostotipomovimientopdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "produccion.r_rresumencostotipomovimientopdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV31movcod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV18LinCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV21ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV16FHasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV24SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10FamCod,6,0));
            AV29URL = formatLink("produccion.r_rresumencostotipomovimientopdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            Innewwindow_Target = AV29URL;
            ucInnewwindow.SendProperty(context, "", false, Innewwindow_Internalname, "Target", Innewwindow_Target);
            this.executeUsercontrolMethod("", false, "INNEWWINDOWContainer", "OpenWindow", "", new Object[] {});
         }
      ...
      protected void E13722( )
      {
         ...
         if ( AV30OpcEntrada == 0 )
         {
            new GeneXus.Programs.produccion.r_paresumencostotipomovimientoexcel(context ).execute( ref  AV31movcod, ref  AV18LinCod, ref  AV21ProdCod, ref  AV12FDesde, ref  AV16FHasta, ref  AV5AlmCod, ref  AV24SubLCod, ref  AV10FamCod, out  AV9ExcelFilename, out  AV8ErrorMessage) ;
            AssignAttri("", false, "AV31movcod", StringUtil.LTrimStr( (decimal)(AV31movcod), 6, 0));
            AssignAttri("", false, "AV18LinCod", StringUtil.LTrimStr( (decimal)(AV18LinCod), 6, 0));
            AssignAttri("", false, "AV21ProdCod", AV21ProdCod);
            AssignAttri("", false, "AV12FDesde", context.localUtil.Format(AV12FDesde, "99/99/99"));
         ...
         {
            new GeneXus.Programs.produccion.r_presumencostotipomovimientoexcel(context ).execute( ref  AV31movcod, ref  AV18LinCod, ref  AV21ProdCod, ref  AV12FDesde, ref  AV16FHasta, ref  AV24SubLCod, ref  AV10FamCod, out  AV9ExcelFilename, out  AV8ErrorMessage) ;
            AssignAttri("", false, "AV31movcod", StringUtil.LTrimStr( (decimal)(AV31movcod), 6, 0));
            AssignAttri("", false, "AV18LinCod", StringUtil.LTrimStr( (decimal)(AV18LinCod), 6, 0));
            AssignAttri("", false, "AV21ProdCod", AV21ProdCod);
            AssignAttri("", false, "AV12FDesde", context.localUtil.Format(AV12FDesde, "99/99/99"));
      ...
      protected void S142( )
      {
         ...
         {
            A979FamSts = H00723_A979FamSts[0];
            A50FamCod = H00723_A50FamCod[0];
            A977FamDsc = H00723_A977FamDsc[0];
      ...
      protected void S132( )
      {
         ...
         {
            A1893SublSts = H00724_A1893SublSts[0];
            A51SublCod = H00724_A51SublCod[0];
            A1892SublDsc = H00724_A1892SublDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A1159LinSts = H00725_A1159LinSts[0];
            A52LinCod = H00725_A52LinCod[0];
            A1153LinDsc = H00725_A1153LinDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A1240MovSts = H00726_A1240MovSts[0];
            A234MovCod = H00726_A234MovCod[0];
            A1239MovDsc = H00726_A1239MovDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            AV32movcod_Data.Add(AV7Combo_DataItem, 0);
            pr_default.readNext(4);
         }
         pr_default.close(4);
         Combo_movcod_Selectedvalue_set = ((0==AV31movcod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV31movcod), 6, 0)));
      ...
      protected void wb_table1_63_722( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavProdcod_Internalname, StringUtil.RTrim( AV21ProdCod), StringUtil.RTrim( context.localUtil.Format( AV21ProdCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,67);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProdcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavProdcod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16721_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavProddsc_Internalname, StringUtil.RTrim( AV22ProdDsc), StringUtil.RTrim( context.localUtil.Format( AV22ProdDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,72);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProddsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavProddsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Produccion\\R_ResumenCostosTipoMovimientoDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_63_722e( true) ;
         }
         else
         {
            wb_table1_63_722e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810322187", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("produccion/r_resumencostostipomovimientodetallado.js", "?202281810322188", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Resumen de Costos por Tipo de Movimiento - Detallado";
         ...
         Form.Caption = "Resumen de Costos por Tipo de Movimiento - Detallado";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV30OpcEntrada',fld:'vOPCENTRADA',pic:'9',hsh:true},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12722',iparms:[{av:'AV30OpcEntrada',fld:'vOPCENTRADA',pic:'9',hsh:true},{av:'AV31movcod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13722',iparms:[{av:'AV30OpcEntrada',fld:'vOPCENTRADA',pic:'9',hsh:true},{av:'AV31movcod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV31movcod',fld:'vMOVCOD',pic:'ZZZZZ9'},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E14722',iparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E16721',iparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV32movcod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H00722_A63AlmCod = new int[1] ;
         H00722_A436AlmDsc = new string[] {""} ;
         H00722_A438AlmSts = new short[1] ;
         H00722_A434AlmCos = new short[1] ;
         AV21ProdCod = "";
         AV22ProdDsc = "";
         AV29URL = "";
         GXEncryptionTmp = "";
         AV9ExcelFilename = "";
         AV8ErrorMessage = "";
         H00723_A979FamSts = new short[1] ;
         H00723_A50FamCod = new int[1] ;
         H00723_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00724_A1893SublSts = new short[1] ;
         H00724_A51SublCod = new int[1] ;
         H00724_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H00725_A1159LinSts = new short[1] ;
         H00725_A52LinCod = new int[1] ;
         H00725_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H00726_A1240MovSts = new short[1] ;
         H00726_A234MovCod = new int[1] ;
         H00726_A1239MovDsc = new string[] {""} ;
         A1239MovDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.produccion.r_resumencostostipomovimientodetallado__default(),
            new Object[][] {
                new Object[] {
               H00722_A63AlmCod, H00722_A436AlmDsc, H00722_A438AlmSts, H00722_A434AlmCos
               }
               , new Object[] {
               H00723_A979FamSts, H00723_A50FamCod, H00723_A977FamDsc
               }
               , new Object[] {
               H00724_A1893SublSts, H00724_A51SublCod, H00724_A1892SublDsc
               }
               , new Object[] {
               H00725_A1159LinSts, H00725_A52LinCod, H00725_A1153LinDsc
               }
               , new Object[] {
               H00726_A1240MovSts, H00726_A234MovCod, H00726_A1239MovDsc
               }
            }
         );
      ...
      private int[] H00722_A63AlmCod ;
      private string[] H00722_A436AlmDsc ;
      private short[] H00722_A438AlmSts ;
      private short[] H00722_A434AlmCos ;
      private short[] H00723_A979FamSts ;
      private int[] H00723_A50FamCod ;
      private string[] H00723_A977FamDsc ;
      private short[] H00724_A1893SublSts ;
      private int[] H00724_A51SublCod ;
      private string[] H00724_A1892SublDsc ;
      private short[] H00725_A1159LinSts ;
      private int[] H00725_A52LinCod ;
      private string[] H00725_A1153LinDsc ;
      private short[] H00726_A1240MovSts ;
      private int[] H00726_A234MovCod ;
      private string[] H00726_A1239MovDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV32movcod_Data ;
   ...
   public class r_resumencostostipomovimientodetallado__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00722", "SELECT [AlmCod], [AlmDsc], [AlmSts], [AlmCos] FROM [CALMACEN] WHERE ([AlmSts] = 1) AND ([AlmCos] = 1) ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00722,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00723", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00723,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00724", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00724,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00725", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00725,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00726", "SELECT [MovSts], [MovCod], [MovDsc] FROM [CMOVALMACEN] WHERE [MovSts] = 1 ORDER BY [MovDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00726,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
