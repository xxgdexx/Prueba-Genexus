...
namespace GeneXus.Programs.produccion {
   public class r_presumencostotipomovimientoexcel : GXProcedure
   {
      public r_presumencostotipomovimientoexcel( )
      {
      ...
      public r_presumencostotipomovimientoexcel( IGxContext context )
      {
                           ...
                           out string aP8_ErrorMessage )
      {
         ...
         this.AV81SublCod = aP5_SublCod;
         this.AV80FamCod = aP6_FamCod;
         this.AV10Filename = "" ;
         ...
         aP5_SublCod=this.AV81SublCod;
         aP6_FamCod=this.AV80FamCod;
      ...
      public string executeUdp( ref int aP0_MovCod ,
                                ...
                                out string aP7_Filename )
      {
         execute(ref aP0_MovCod, ref aP1_LinCod, ref aP2_Prodcod, ref aP3_FDesde, ref aP4_FHasta, ref aP5_SublCod, ref aP6_FamCod, out aP7_Filename, out aP8_ErrorMessage);
      ...
      public void executeSubmit( ref int aP0_MovCod ,
                                 ...
                                 out string aP8_ErrorMessage )
      {
         r_presumencostotipomovimientoexcel objr_presumencostotipomovimientoexcel;
         objr_presumencostotipomovimientoexcel = new r_presumencostotipomovimientoexcel();
         objr_presumencostotipomovimientoexcel.AV128MovCod = aP0_MovCod;
         objr_presumencostotipomovimientoexcel.AV82LinCod = aP1_LinCod;
         objr_presumencostotipomovimientoexcel.AV78Prodcod = aP2_Prodcod;
         objr_presumencostotipomovimientoexcel.AV77FDesde = aP3_FDesde;
         objr_presumencostotipomovimientoexcel.AV76FHasta = aP4_FHasta;
         objr_presumencostotipomovimientoexcel.AV81SublCod = aP5_SublCod;
         objr_presumencostotipomovimientoexcel.AV80FamCod = aP6_FamCod;
         objr_presumencostotipomovimientoexcel.AV10Filename = "" ;
         objr_presumencostotipomovimientoexcel.AV11ErrorMessage = "" ;
         objr_presumencostotipomovimientoexcel.context.SetSubmitInitialConfig(context);
         objr_presumencostotipomovimientoexcel.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_presumencostotipomovimientoexcel);
         aP0_MovCod=this.AV128MovCod;
         aP1_LinCod=this.AV82LinCod;
         aP2_Prodcod=this.AV78Prodcod;
         aP3_FDesde=this.AV77FDesde;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_presumencostotipomovimientoexcel)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         /* Using cursor P00G62 */
         pr_default.execute(0, new Object[] {AV77FDesde, AV76FHasta, AV128MovCod, AV82LinCod, AV78Prodcod, AV81SublCod, AV80FamCod});
         while ( (pr_default.getStatus(0) != 101) )
         {
            BRKG62 = false;
            A21MvAlm = P00G62_A21MvAlm[0];
            A28ProdCod = P00G62_A28ProdCod[0];
            A1269MvAlmCos = P00G62_A1269MvAlmCos[0];
            A1278MvARef = P00G62_A1278MvARef[0];
            A24DocNum = P00G62_A24DocNum[0];
            n24DocNum = P00G62_n24DocNum[0];
            A1274MvAMovDsc = P00G62_A1274MvAMovDsc[0];
            A1248MvADCant = P00G62_A1248MvADCant[0];
            A1250MVADPrecio = P00G62_A1250MVADPrecio[0];
            A1249MVADCosto = P00G62_A1249MVADCosto[0];
            A14MvACod = P00G62_A14MvACod[0];
            A13MvATip = P00G62_A13MvATip[0];
            A25MvAFec = P00G62_A25MvAFec[0];
            A1158LinStk = P00G62_A1158LinStk[0];
            A1370MVSts = P00G62_A1370MVSts[0];
            A50FamCod = P00G62_A50FamCod[0];
            n50FamCod = P00G62_n50FamCod[0];
            A51SublCod = P00G62_A51SublCod[0];
            n51SublCod = P00G62_n51SublCod[0];
            A52LinCod = P00G62_A52LinCod[0];
            A22MvAMov = P00G62_A22MvAMov[0];
            A55ProdDsc = P00G62_A55ProdDsc[0];
            A1153LinDsc = P00G62_A1153LinDsc[0];
            A30MvADItem = P00G62_A30MvADItem[0];
            A50FamCod = P00G62_A50FamCod[0];
            n50FamCod = P00G62_n50FamCod[0];
            A51SublCod = P00G62_A51SublCod[0];
            n51SublCod = P00G62_n51SublCod[0];
            ...
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00G62_A28ProdCod[0], A28ProdCod) == 0 ) )
            {
               BRKG62 = false;
               A21MvAlm = P00G62_A21MvAlm[0];
               A1269MvAlmCos = P00G62_A1269MvAlmCos[0];
      ...
      public override void initialize( )
      {
         ...
         A1370MVSts = "";
         P00G62_A21MvAlm = new int[1] ;
         P00G62_A28ProdCod = new string[] {""} ;
         P00G62_A1269MvAlmCos = new short[1] ;
         P00G62_A1278MvARef = new string[] {""} ;
         P00G62_A24DocNum = new string[] {""} ;
         P00G62_n24DocNum = new bool[] {false} ;
         P00G62_A1274MvAMovDsc = new string[] {""} ;
         P00G62_A1248MvADCant = new decimal[1] ;
         P00G62_A1250MVADPrecio = new decimal[1] ;
         P00G62_A1249MVADCosto = new decimal[1] ;
         P00G62_A14MvACod = new string[] {""} ;
         P00G62_A13MvATip = new string[] {""} ;
         P00G62_A25MvAFec = new DateTime[] {DateTime.MinValue} ;
         P00G62_A1158LinStk = new short[1] ;
         P00G62_A1370MVSts = new string[] {""} ;
         P00G62_A50FamCod = new int[1] ;
         P00G62_n50FamCod = new bool[] {false} ;
         P00G62_A51SublCod = new int[1] ;
         P00G62_n51SublCod = new bool[] {false} ;
         P00G62_A52LinCod = new int[1] ;
         P00G62_A22MvAMov = new int[1] ;
         P00G62_A55ProdDsc = new string[] {""} ;
         P00G62_A1153LinDsc = new string[] {""} ;
         P00G62_A30MvADItem = new int[1] ;
         A1278MvARef = "";
         A24DocNum = "";
         A1274MvAMovDsc = "";
         A14MvACod = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.produccion.r_presumencostotipomovimientoexcel__default(),
            new Object[][] {
                new Object[] {
               P00G62_A21MvAlm, P00G62_A28ProdCod, P00G62_A1269MvAlmCos, P00G62_A1278MvARef, P00G62_A24DocNum, P00G62_n24DocNum, P00G62_A1274MvAMovDsc, P00G62_A1248MvADCant, P00G62_A1250MVADPrecio, P00G62_A1249MVADCosto,
               P00G62_A14MvACod, P00G62_A13MvATip, P00G62_A25MvAFec, P00G62_A1158LinStk, P00G62_A1370MVSts, P00G62_A50FamCod, P00G62_n50FamCod, P00G62_A51SublCod, P00G62_n51SublCod, P00G62_A52LinCod,
               P00G62_A22MvAMov, P00G62_A55ProdDsc, P00G62_A1153LinDsc, P00G62_A30MvADItem
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] P00G62_A21MvAlm ;
      private string[] P00G62_A28ProdCod ;
      private short[] P00G62_A1269MvAlmCos ;
      private string[] P00G62_A1278MvARef ;
      private string[] P00G62_A24DocNum ;
      private bool[] P00G62_n24DocNum ;
      private string[] P00G62_A1274MvAMovDsc ;
      private decimal[] P00G62_A1248MvADCant ;
      private decimal[] P00G62_A1250MVADPrecio ;
      private decimal[] P00G62_A1249MVADCosto ;
      private string[] P00G62_A14MvACod ;
      private string[] P00G62_A13MvATip ;
      private DateTime[] P00G62_A25MvAFec ;
      private short[] P00G62_A1158LinStk ;
      private string[] P00G62_A1370MVSts ;
      private int[] P00G62_A50FamCod ;
      private bool[] P00G62_n50FamCod ;
      private int[] P00G62_A51SublCod ;
      private bool[] P00G62_n51SublCod ;
      private int[] P00G62_A52LinCod ;
      private int[] P00G62_A22MvAMov ;
      private string[] P00G62_A55ProdDsc ;
      private string[] P00G62_A1153LinDsc ;
      private int[] P00G62_A30MvADItem ;
   ...
   public class r_presumencostotipomovimientoexcel__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00G62( IGxContext context ,
                                             int AV128MovCod ,
                                             int AV82LinCod ,
                                             string AV78Prodcod ,
                                             int AV81SublCod ,
                                             ...
                                             short A1269MvAlmCos )
      {
         ...
         scmdbuf = "SELECT T4.[MvAlm] AS MvAlm, T1.[ProdCod], T5.[AlmCos] AS MvAlmCos, T4.[MvARef], T4.[DocNum], T6.[MovDsc] AS MvAMovDsc, T1.[MvADCant], T1.[MVADPrecio], T1.[MVADCosto], T1.[MvACod], T1.[MvATip], T4.[MvAFec], T3.[LinStk], T4.[MVSts], T2.[FamCod], T2.[SublCod], T2.[LinCod], T4.[MvAMov] AS MvAMov, T2.[ProdDsc], T3.[LinDsc], T1.[MvADItem] FROM ((((([AGUIASDET] T1 INNER JOIN [APRODUCTOS] T2 ON T2.[ProdCod] = T1.[ProdCod]) INNER JOIN [CLINEAPROD] T3 ON T3.[LinCod] = T2.[LinCod]) INNER JOIN [AGUIAS] T4 ON T4.[MvATip] = T1.[MvATip] AND T4.[MvACod] = T1.[MvACod]) INNER JOIN [CALMACEN] T5 ON T5.[AlmCod] = T4.[MvAlm]) INNER JOIN [CMOVALMACEN] T6 ON T6.[MovCod] = T4.[MvAMov])";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00G62(context, (int)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] , (string)dynConstraints[7] , (int)dynConstraints[8] , (int)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (DateTime)dynConstraints[12] , (string)dynConstraints[13] , (short)dynConstraints[14] , (short)dynConstraints[15] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00G62", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00G62,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
