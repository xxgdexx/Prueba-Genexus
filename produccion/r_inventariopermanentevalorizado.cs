...
namespace GeneXus.Programs.produccion {
   public class r_inventariopermanentevalorizado : GXDataArea
   {
      public r_inventariopermanentevalorizado( )
      {
      ...
      public r_inventariopermanentevalorizado( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810321577", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("produccion.r_inventariopermanentevalorizado.aspx") +"\">") ;
      ...
      {
         return formatLink("produccion.r_inventariopermanentevalorizado.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Produccion.R_InventarioPermanenteValorizado" ;
      }

      public override string GetPgmdesc( )
      {
         return "Inventario Permanente Valorizado" ;
      }
      ...
      protected void WB6Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockalmcod_Internalname, "Almacén", "", "", lblTextblockalmcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavAlmcod, dynavAlmcod_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5AlmCod), 6, 0)), 1, dynavAlmcod_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", dynavAlmcod.Visible, dynavAlmcod.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "", true, 1, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_famcod_Internalname, "Familia", "", "", lblTextblockcombo_famcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_56_6Y2( true) ;
         }
         else
         {
            wb_table1_56_6Y2( false) ;
         }
         return  ;
      }

      protected void wb_table1_56_6Y2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6Y2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Inventario Permanente Valorizado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvALMCOD6Y2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvALMCOD_html6Y2( )
      {
         int gxdynajaxvalue;
         GXDLVvALMCOD_data6Y2( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvALMCOD_data6Y2( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006Y2_A63AlmCod[0]), 6, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H006Y2_A436AlmDsc[0]));
      ...
      protected void E126Y2( )
      {
         ...
         if ( AV20OpcEntrada == 0 )
         {
            ...
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "produccion.r_arkardexpermanentepdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV18LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV24SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10FamCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV5AlmCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV21ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV16FHasta));
               AV29URL = formatLink("produccion.r_arkardexpermanentepdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "produccion.r_kardexpermanentepdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV18LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV24SubLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10FamCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV21ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV16FHasta));
            AV29URL = formatLink("produccion.r_kardexpermanentepdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            Innewwindow_Target = AV29URL;
            ucInnewwindow.SendProperty(context, "", false, Innewwindow_Internalname, "Target", Innewwindow_Target);
            this.executeUsercontrolMethod("", false, "INNEWWINDOWContainer", "OpenWindow", "", new Object[] {});
         }
      ...
      protected void E136Y2( )
      {
         ...
         if ( AV20OpcEntrada == 0 )
         {
            new GeneXus.Programs.produccion.r_inventariopermanenteexcel(context ).execute( ref  AV18LinCod, ref  AV24SubLCod, ref  AV10FamCod, ref  AV5AlmCod, ref  AV21ProdCod, ref  AV12FDesde, ref  AV16FHasta, out  AV9ExcelFilename, out  AV8ErrorMessage) ;
            AssignAttri("", false, "AV18LinCod", StringUtil.LTrimStr( (decimal)(AV18LinCod), 6, 0));
            AssignAttri("", false, "AV24SubLCod", StringUtil.LTrimStr( (decimal)(AV24SubLCod), 6, 0));
            AssignAttri("", false, "AV10FamCod", StringUtil.LTrimStr( (decimal)(AV10FamCod), 6, 0));
            AssignAttri("", false, "AV5AlmCod", StringUtil.LTrimStr( (decimal)(AV5AlmCod), 6, 0));
         ...
         {
            new GeneXus.Programs.produccion.r_pinventariopermanenteexcel(context ).execute( ref  AV18LinCod, ref  AV24SubLCod, ref  AV10FamCod, ref  AV21ProdCod, ref  AV12FDesde, ref  AV16FHasta, out  AV9ExcelFilename, out  AV8ErrorMessage) ;
            AssignAttri("", false, "AV18LinCod", StringUtil.LTrimStr( (decimal)(AV18LinCod), 6, 0));
            AssignAttri("", false, "AV24SubLCod", StringUtil.LTrimStr( (decimal)(AV24SubLCod), 6, 0));
            AssignAttri("", false, "AV10FamCod", StringUtil.LTrimStr( (decimal)(AV10FamCod), 6, 0));
            AssignAttri("", false, "AV21ProdCod", AV21ProdCod);
      ...
      protected void S132( )
      {
         ...
         {
            A979FamSts = H006Y3_A979FamSts[0];
            A50FamCod = H006Y3_A50FamCod[0];
            A977FamDsc = H006Y3_A977FamDsc[0];
      ...
      protected void S122( )
      {
         ...
         {
            A1893SublSts = H006Y4_A1893SublSts[0];
            A51SublCod = H006Y4_A51SublCod[0];
            A1892SublDsc = H006Y4_A1892SublDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A1159LinSts = H006Y5_A1159LinSts[0];
            A52LinCod = H006Y5_A52LinCod[0];
            A1153LinDsc = H006Y5_A1153LinDsc[0];
            AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table1_56_6Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e166y1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Produccion\\R_InventarioPermanenteValorizado.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810321760", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("produccion/r_inventariopermanentevalorizado.js", "?202281810321761", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Inventario Permanente Valorizado";
         ...
         Form.Caption = "Inventario Permanente Valorizado";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E126Y2',iparms:[{av:'AV20OpcEntrada',fld:'vOPCENTRADA',pic:'9',hsh:true},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E136Y2',iparms:[{av:'AV20OpcEntrada',fld:'vOPCENTRADA',pic:'9',hsh:true},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV16FHasta',fld:'vFHASTA',pic:''},{av:'AV12FDesde',fld:'vFDESDE',pic:''},{av:'AV21ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV10FamCod',fld:'vFAMCOD',pic:'ZZZZZ9'},{av:'AV24SubLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E146Y2',iparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E166Y1',iparms:[{av:'dynavAlmcod'},{av:'AV5AlmCod',fld:'vALMCOD',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H006Y2_A63AlmCod = new int[1] ;
         H006Y2_A436AlmDsc = new string[] {""} ;
         H006Y2_A438AlmSts = new short[1] ;
         H006Y2_A434AlmCos = new short[1] ;
         AV21ProdCod = "";
         AV22ProdDsc = "";
         AV29URL = "";
         GXEncryptionTmp = "";
         AV9ExcelFilename = "";
         AV8ErrorMessage = "";
         H006Y3_A979FamSts = new short[1] ;
         H006Y3_A50FamCod = new int[1] ;
         H006Y3_A977FamDsc = new string[] {""} ;
         A977FamDsc = "";
         AV7Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H006Y4_A1893SublSts = new short[1] ;
         H006Y4_A51SublCod = new int[1] ;
         H006Y4_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H006Y5_A1159LinSts = new short[1] ;
         H006Y5_A52LinCod = new int[1] ;
         H006Y5_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.produccion.r_inventariopermanentevalorizado__default(),
            new Object[][] {
                new Object[] {
               H006Y2_A63AlmCod, H006Y2_A436AlmDsc, H006Y2_A438AlmSts, H006Y2_A434AlmCos
               }
               , new Object[] {
               H006Y3_A979FamSts, H006Y3_A50FamCod, H006Y3_A977FamDsc
               }
               , new Object[] {
               H006Y4_A1893SublSts, H006Y4_A51SublCod, H006Y4_A1892SublDsc
               }
               , new Object[] {
               H006Y5_A1159LinSts, H006Y5_A52LinCod, H006Y5_A1153LinDsc
               }
            }
         );
      ...
      private int[] H006Y2_A63AlmCod ;
      private string[] H006Y2_A436AlmDsc ;
      private short[] H006Y2_A438AlmSts ;
      private short[] H006Y2_A434AlmCos ;
      private short[] H006Y3_A979FamSts ;
      private int[] H006Y3_A50FamCod ;
      private string[] H006Y3_A977FamDsc ;
      private short[] H006Y4_A1893SublSts ;
      private int[] H006Y4_A51SublCod ;
      private string[] H006Y4_A1892SublDsc ;
      private short[] H006Y5_A1159LinSts ;
      private int[] H006Y5_A52LinCod ;
      private string[] H006Y5_A1153LinDsc ;
   ...
   public class r_inventariopermanentevalorizado__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006Y2", "SELECT [AlmCod], [AlmDsc], [AlmSts], [AlmCos] FROM [CALMACEN] WHERE ([AlmSts] = 1) AND ([AlmCos] = 1) ORDER BY [AlmDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Y2,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006Y3", "SELECT [FamSts], [FamCod], [FamDsc] FROM [CFAMILIA] WHERE [FamSts] = 1 ORDER BY [FamDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Y3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006Y4", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Y4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006Y5", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Y5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
