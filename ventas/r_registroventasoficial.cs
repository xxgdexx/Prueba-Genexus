...
namespace GeneXus.Programs.ventas {
   public class r_registroventasoficial : GXDataArea
   {
      public r_registroventasoficial( )
      {
      ...
      public r_registroventasoficial( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031377", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_registroventasoficial.aspx") +"\">") ;
      ...
      {
         return formatLink("ventas.r_registroventasoficial.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_RegistroVentasOficial" ;
      }
      ...
      protected void WB5H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjano_Internalname, "Año", "", "", lblTextblockjano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_RegistroVentasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavJano_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV27jAno), 4, 0, ".", "")), StringUtil.LTrim( ((edtavJano_Enabled!=0) ? context.localUtil.Format( (decimal)(AV27jAno), "ZZZ9") : context.localUtil.Format( (decimal)(AV27jAno), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavJano_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavJano_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_RegistroVentasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjmes_Internalname, "Mes", "", "", lblTextblockjmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_RegistroVentasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavJmes, cmbavJmes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV28jMes), 2, 0)), 1, cmbavJmes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavJmes.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "", true, 1, "HLP_Ventas\\R_RegistroVentasOficial.htm");
            cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV28jMes), 2, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_RegistroVentasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_RegistroVentasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_RegistroVentasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV28jMes = (short)(NumberUtil.Val( cmbavJmes.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV28jMes), 2, 0))), "."));
            AssignAttri("", false, "AV28jMes", StringUtil.LTrimStr( (decimal)(AV28jMes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV28jMes), 2, 0));
      ...
      protected void STRUP5H0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV27jAno = 0;
               AssignAttri("", false, "AV27jAno", StringUtil.LTrimStr( (decimal)(AV27jAno), 4, 0));
            }
            else
            {
               AV27jAno = (short)(context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ","));
               AssignAttri("", false, "AV27jAno", StringUtil.LTrimStr( (decimal)(AV27jAno), 4, 0));
            }
            cmbavJmes.CurrentValue = cgiGet( cmbavJmes_Internalname);
            AV28jMes = (short)(NumberUtil.Val( cgiGet( cmbavJmes_Internalname), "."));
            AssignAttri("", false, "AV28jMes", StringUtil.LTrimStr( (decimal)(AV28jMes), 2, 0));
      ...
      protected void E115H2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV28jMes = (short)(DateTimeUtil.Month( DateTimeUtil.Now( context)));
         AssignAttri("", false, "AV28jMes", StringUtil.LTrimStr( (decimal)(AV28jMes), 2, 0));
         AV27jAno = (short)(DateTimeUtil.Year( DateTimeUtil.Now( context)));
         AssignAttri("", false, "AV27jAno", StringUtil.LTrimStr( (decimal)(AV27jAno), 4, 0));
      }
      ...
      protected void E125H2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "contabilidad.r_registroventasoficialpdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV27jAno,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV28jMes,2,0));
         Innewwindow_Target = formatLink("contabilidad.r_registroventasoficialpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E135H2( )
      {
         ...
         new GeneXus.Programs.contabilidad.r_registroventasexcel(context ).execute( ref  AV27jAno, ref  AV28jMes, out  AV16ExcelFilename, out  AV13ErrorMessage) ;
         AssignAttri("", false, "AV27jAno", StringUtil.LTrimStr( (decimal)(AV27jAno), 4, 0));
         AssignAttri("", false, "AV28jMes", StringUtil.LTrimStr( (decimal)(AV28jMes), 2, 0));
         ...
         {
            GX_msglist.addItem(AV13ErrorMessage);
         }
         /*  Sending Event outputs  */
         cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV28jMes), 2, 0));
         AssignProp("", false, cmbavJmes_Internalname, "Values", cmbavJmes.ToJavascriptSource(), true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810313746", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_registroventasoficial.js", "?202281810313747", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavJmes.WebTags = "";
         cmbavJmes.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(0), 2, 0)), "(Ninguno)", 0);
         ...
         cmbavJmes.addItem("9", "Setiembre", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte Registro de Ventas Oficial";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E125H2',iparms:[{av:'AV27jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV28jMes',fld:'vJMES',pic:'Z9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E135H2',iparms:[{av:'AV27jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV28jMes',fld:'vJMES',pic:'Z9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'cmbavJmes'},{av:'AV28jMes',fld:'vJMES',pic:'Z9'},{av:'AV27jAno',fld:'vJANO',pic:'ZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E145H2',iparms:[]");
      ...
      private short AV27jAno ;
      private short AV28jMes ;
