...
namespace GeneXus.Programs.ventas {
   public class r_resumenventasxcliente : GXDataArea
   {
      public r_resumenventasxcliente( )
      {
      ...
      public r_resumenventasxcliente( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810315159", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_resumenventasxcliente.aspx") +"\">") ;
      ...
      {
         return formatLink("ventas.r_resumenventasxcliente.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_ResumenVentasxCliente" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Ventas por Clientes - Detallado" ;
      }
      ...
      protected void WB5T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tiecod_Internalname, "Local", "", "", lblTextblockcombo_tiecod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Vendedor", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Productos", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea de Productos ", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, " Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_57_5T2( true) ;
         }
         else
         {
            wb_table1_57_5T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_5T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_74_5T2( true) ;
         }
         else
         {
            wb_table2_74_5T2( false) ;
         }
         return  ;
      }

      protected void wb_table2_74_5T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "F.Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table3_91_5T2( true) ;
         }
         else
         {
            wb_table3_91_5T2( false) ;
         }
         return  ;
      }

      protected void wb_table3_91_5T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Tipo", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV37Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,108);\"", "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Ventas por Clientes - Detallado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E125T2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "rrresumenventasxcliente.aspx"+UrlEncode(StringUtil.LTrimStr(AV41VenCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV25ProdCod)) + "," + UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV13FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FHasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV18LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV29SublCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV37Tipo)) + "," + UrlEncode(StringUtil.LTrimStr(AV31TieCod,6,0));
         Innewwindow_Target = formatLink("rrresumenventasxcliente.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E135T2( )
      {
         ...
         new rrresumenventasxclienteexcel(context ).execute( ref  AV41VenCod, ref  AV25ProdCod, ref  AV5CliCod, ref  AV13FDesde, ref  AV15FHasta, ref  AV18LinCod, ref  AV29SublCod, ref  AV37Tipo, ref  AV31TieCod, out  AV10ExcelFilename, out  AV9ErrorMessage) ;
         AssignAttri("", false, "AV41VenCod", StringUtil.LTrimStr( (decimal)(AV41VenCod), 6, 0));
         AssignAttri("", false, "AV25ProdCod", AV25ProdCod);
         AssignAttri("", false, "AV5CliCod", AV5CliCod);
         AssignAttri("", false, "AV13FDesde", context.localUtil.Format(AV13FDesde, "99/99/99"));
      ...
      protected void S142( )
      {
         ...
         {
            A1893SublSts = H005T2_A1893SublSts[0];
            A51SublCod = H005T2_A51SublCod[0];
            A1892SublDsc = H005T2_A1892SublDsc[0];
      ...
      protected void S132( )
      {
         ...
         {
            A1159LinSts = H005T3_A1159LinSts[0];
            A52LinCod = H005T3_A52LinCod[0];
            A1153LinDsc = H005T3_A1153LinDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A2047VenSts = H005T4_A2047VenSts[0];
            A309VenCod = H005T4_A309VenCod[0];
            A2045VenDsc = H005T4_A2045VenDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A1899TieSts = H005T5_A1899TieSts[0];
            A178TieCod = H005T5_A178TieCod[0];
            A1898TieDsc = H005T5_A1898TieDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table3_91_5T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_91_5T2e( true) ;
         }
         else
         {
            wb_table3_91_5T2e( false) ;
         }
      }

      protected void wb_table2_74_5T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165t1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table1_57_5T2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnbuscarpro_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscarpro_Jsonclick, "'"+""+"'"+",false,"+"'"+"e175t1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_ResumenVentasxCliente.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_resumenventasxcliente.js", "?202281810315391", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel_Title = "Reporte de Ventas por Clientes - Detallado";
         ...
         Form.Caption = "Resumen de Ventas por Clientes - Detallado";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E125T2',iparms:[{av:'AV41VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV25ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV29SublCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV31TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV37Tipo',fld:'vTIPO',pic:''}]");
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E135T2',iparms:[{av:'AV41VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV25ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV29SublCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV31TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV37Tipo',fld:'vTIPO',pic:''}]");
         ...
         setEventMetadata("'DOBTNSALIR'","{handler:'E145T2',iparms:[{av:'radavTipo'},{av:'AV37Tipo',fld:'vTIPO',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV37Tipo',fld:'vTIPO',pic:''}]}");
         setEventMetadata("'DOBTNBUSCARPRO'","{handler:'E175T1',iparms:[{av:'radavTipo'},{av:'AV37Tipo',fld:'vTIPO',pic:''}]");
         ...
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E165T1',iparms:[{av:'radavTipo'},{av:'AV37Tipo',fld:'vTIPO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV9ErrorMessage = "";
         scmdbuf = "";
         H005T2_A1893SublSts = new short[1] ;
         H005T2_A51SublCod = new int[1] ;
         H005T2_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H005T3_A1159LinSts = new short[1] ;
         H005T3_A52LinCod = new int[1] ;
         H005T3_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H005T4_A2047VenSts = new short[1] ;
         H005T4_A309VenCod = new int[1] ;
         H005T4_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         H005T5_A1899TieSts = new short[1] ;
         H005T5_A178TieCod = new int[1] ;
         H005T5_A1898TieDsc = new string[] {""} ;
         A1898TieDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_resumenventasxcliente__default(),
            new Object[][] {
                new Object[] {
               H005T2_A1893SublSts, H005T2_A51SublCod, H005T2_A1892SublDsc
               }
               , new Object[] {
               H005T3_A1159LinSts, H005T3_A52LinCod, H005T3_A1153LinDsc
               }
               , new Object[] {
               H005T4_A2047VenSts, H005T4_A309VenCod, H005T4_A2045VenDsc
               }
               , new Object[] {
               H005T5_A1899TieSts, H005T5_A178TieCod, H005T5_A1898TieDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H005T2_A1893SublSts ;
      private int[] H005T2_A51SublCod ;
      private string[] H005T2_A1892SublDsc ;
      private short[] H005T3_A1159LinSts ;
      private int[] H005T3_A52LinCod ;
      private string[] H005T3_A1153LinDsc ;
      private short[] H005T4_A2047VenSts ;
      private int[] H005T4_A309VenCod ;
      private string[] H005T4_A2045VenDsc ;
      private short[] H005T5_A1899TieSts ;
      private int[] H005T5_A178TieCod ;
      private string[] H005T5_A1898TieDsc ;
   ...
   public class r_resumenventasxcliente__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005T2", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005T2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005T3", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005T3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005T4", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005T4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005T5", "SELECT [TieSts], [TieCod], [TieDsc] FROM [SGTIENDAS] WHERE [TieSts] = 1 ORDER BY [TieDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005T5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
