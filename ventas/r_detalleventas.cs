...
namespace GeneXus.Programs.ventas {
   public class r_detalleventas : GXDataArea
   {
      public r_detalleventas( )
      {
      ...
      public r_detalleventas( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810314085", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_detalleventas.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSUBLCOD_DATA", AV31subLCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSUBLCOD_DATA", AV31subLCod_Data);
         }
         GxWebStd.gx_hidden_field( context, "vESTCOD", StringUtil.RTrim( AV45EstCod));
         GxWebStd.gx_hidden_field( context, "vTIPCOD", StringUtil.RTrim( AV34TipCod));
         GxWebStd.gx_hidden_field( context, "vPAICOD", StringUtil.RTrim( AV46PaiCod));
         GxWebStd.gx_hidden_field( context, "vMONCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23MonCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vDOCCONPCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV47DocConPCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vSERIE", StringUtil.RTrim( AV28Serie));
         GxWebStd.gx_hidden_field( context, "vTIPO", AV38Tipo);
      ...
      {
         return formatLink("ventas.r_detalleventas.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_DetalleVentas" ;
      }

      public override string GetPgmdesc( )
      {
         return "Detalle de Documentos de Cliente" ;
      }
      ...
      protected void WB5M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tiecod_Internalname, "Local", "", "", lblTextblockcombo_tiecod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Vendedor", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipccod_Internalname, "Tipo Cliente", "", "", lblTextblockcombo_tipccod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Line Producto", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea Código", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_sublcod.SetProperty("DropDownOptionsData", AV31subLCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, " Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_65_5M2( true) ;
         }
         else
         {
            wb_table1_65_5M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_65_5M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_79_5M2( true) ;
         }
         else
         {
            wb_table2_79_5M2( false) ;
         }
         return  ;
      }

      protected void wb_table2_79_5M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "F.Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table3_99_5M2( true) ;
         }
         else
         {
            wb_table3_99_5M2( false) ;
         }
         return  ;
      }

      protected void wb_table3_99_5M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTiecod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV44TieCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV44TieCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTiecod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTiecod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 120,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVencod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV40VenCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV40VenCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,120);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVencod_Jsonclick, 0, "Attribute", "", "", "", "", edtavVencod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 121,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipccod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32TipCcod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV32TipCcod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,121);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipccod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipccod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 122,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV21LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV21LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,122);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 123,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV30subLCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV30subLCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,123);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Detalle de Documentos de Cliente", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP5M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vSUBLCOD_DATA"), AV31subLCod_Data);
            /* Read saved values. */
            ...
            AV26ProdCod = StringUtil.Upper( cgiGet( edtavProdcod_Internalname));
            AssignAttri("", false, "AV26ProdCod", AV26ProdCod);
            AV5CliCod = cgiGet( edtavClicod_Internalname);
            AssignAttri("", false, "AV5CliCod", AV5CliCod);
            AV27ProdDsc = cgiGet( edtavProddsc_Internalname);
            AssignAttri("", false, "AV27ProdDsc", AV27ProdDsc);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV30subLCod = 0;
               AssignAttri("", false, "AV30subLCod", StringUtil.LTrimStr( (decimal)(AV30subLCod), 6, 0));
            }
            else
            {
               AV30subLCod = (int)(context.localUtil.CToN( cgiGet( edtavSublcod_Internalname), ".", ","));
               AssignAttri("", false, "AV30subLCod", StringUtil.LTrimStr( (decimal)(AV30subLCod), 6, 0));
            }
      ...
      protected void E125M2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "rrdetalleventas.aspx"+UrlEncode(StringUtil.LTrimStr(AV40VenCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV26ProdCod)) + "," + UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV13FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FHasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV21LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV30subLCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV44TieCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV32TipCcod,6,0));
         Innewwindow_Target = formatLink("rrdetalleventas.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S152( )
      {
         ...
         {
            A1893SublSts = H005M2_A1893SublSts[0];
            A51SublCod = H005M2_A51SublCod[0];
            A1892SublDsc = H005M2_A1892SublDsc[0];
            ...
            AV31subLCod_Data.Add(AV8Combo_DataItem, 0);
            pr_default.readNext(0);
         }
         pr_default.close(0);
         Combo_sublcod_Selectedvalue_set = ((0==AV30subLCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV30subLCod), 6, 0)));
      ...
      protected void S142( )
      {
         ...
         {
            A1159LinSts = H005M3_A1159LinSts[0];
            A52LinCod = H005M3_A52LinCod[0];
            A1153LinDsc = H005M3_A1153LinDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV8Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A52LinCod), 6, 0));
            AV8Combo_DataItem.gxTpr_Title = A1153LinDsc;
            AV22LinCod_Data.Add(AV8Combo_DataItem, 0);
      ...
      protected void S132( )
      {
         ...
         {
            A1908TipCSts = H005M4_A1908TipCSts[0];
            A159TipCCod = H005M4_A159TipCCod[0];
            A1905TipCDsc = H005M4_A1905TipCDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A2047VenSts = H005M5_A2047VenSts[0];
            A309VenCod = H005M5_A309VenCod[0];
            A2045VenDsc = H005M5_A2045VenDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A1899TieSts = H005M6_A1899TieSts[0];
            A178TieCod = H005M6_A178TieCod[0];
            A1898TieDsc = H005M6_A1898TieDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table3_99_5M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV13FDesde, "99/99/99"), context.localUtil.Format( AV13FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,103);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_DetalleVentas.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_99_5M2e( true) ;
         }
         else
         {
            wb_table3_99_5M2e( false) ;
         }
      }

      protected void wb_table2_79_5M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavClicod_Internalname, StringUtil.RTrim( AV5CliCod), StringUtil.RTrim( context.localUtil.Format( AV5CliCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,83);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClicod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavClicod_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavProddsc_Internalname, StringUtil.RTrim( AV27ProdDsc), StringUtil.RTrim( context.localUtil.Format( AV27ProdDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,86);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProddsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavProddsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='CellPaddingLeft10'>") ;
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165m1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_DetalleVentas.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClidsc_Internalname, StringUtil.RTrim( AV7CliDsc), StringUtil.RTrim( context.localUtil.Format( AV7CliDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,91);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClidsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavClidsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_79_5M2e( true) ;
         }
         else
         {
            wb_table2_79_5M2e( false) ;
         }
      }

      protected void wb_table1_65_5M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavProdcod_Internalname, StringUtil.RTrim( AV26ProdCod), StringUtil.RTrim( context.localUtil.Format( AV26ProdCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProdcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavProdcod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_DetalleVentas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='CellPaddingLeft10'>") ;
            /* Active images/pictures */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnbuscarpro_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscarpro_Jsonclick, "'"+""+"'"+",false,"+"'"+"e175m1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_DetalleVentas.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_65_5M2e( true) ;
         }
         else
         {
            wb_table1_65_5M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810314348", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_detalleventas.js", "?202281810314348", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Detalle de Documentos de Cliente";
         ...
         Form.Caption = "Detalle de Documentos de Cliente";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E125M2',iparms:[{av:'AV40VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV26ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV21LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV30subLCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV44TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'AV32TipCcod',fld:'vTIPCCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNBUSCARPRO'","{handler:'E175M1',iparms:[]");
         setEventMetadata("'DOBTNBUSCARPRO'",",oparms:[]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E135M2',iparms:[{av:'AV32TipCcod',fld:'vTIPCCOD',pic:'ZZZZZ9'},{av:'AV45EstCod',fld:'vESTCOD',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV34TipCod',fld:'vTIPCOD',pic:''},{av:'AV46PaiCod',fld:'vPAICOD',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV23MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV47DocConPCod',fld:'vDOCCONPCOD',pic:'ZZZZZ9'},{av:'AV28Serie',fld:'vSERIE',pic:''},{av:'AV38Tipo',fld:'vTIPO',pic:''},{av:'AV44TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'AV40VenCod',fld:'vVENCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV40VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV44TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'AV38Tipo',fld:'vTIPO',pic:''},{av:'AV28Serie',fld:'vSERIE',pic:''},{av:'AV47DocConPCod',fld:'vDOCCONPCOD',pic:'ZZZZZ9'},{av:'AV23MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV46PaiCod',fld:'vPAICOD',pic:''},{av:'AV34TipCod',fld:'vTIPCOD',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV45EstCod',fld:'vESTCOD',pic:''},{av:'AV32TipCcod',fld:'vTIPCCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E145M2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("BTNBUSCAR.CLICK","{handler:'E165M1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         AV31subLCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV45EstCod = "";
         AV34TipCod = "";
         AV46PaiCod = "";
         AV28Serie = "";
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H005M2_A1893SublSts = new short[1] ;
         H005M2_A51SublCod = new int[1] ;
         H005M2_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H005M3_A1159LinSts = new short[1] ;
         H005M3_A52LinCod = new int[1] ;
         H005M3_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H005M4_A1908TipCSts = new short[1] ;
         H005M4_A159TipCCod = new int[1] ;
         H005M4_A1905TipCDsc = new string[] {""} ;
         A1905TipCDsc = "";
         H005M5_A2047VenSts = new short[1] ;
         H005M5_A309VenCod = new int[1] ;
         H005M5_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         H005M6_A1899TieSts = new short[1] ;
         H005M6_A178TieCod = new int[1] ;
         H005M6_A1898TieDsc = new string[] {""} ;
         A1898TieDsc = "";
         AV10ExcelFilename = "";
         AV9ErrorMessage = "";
         sStyleString = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_detalleventas__default(),
            new Object[][] {
                new Object[] {
               H005M2_A1893SublSts, H005M2_A51SublCod, H005M2_A1892SublDsc
               }
               , new Object[] {
               H005M3_A1159LinSts, H005M3_A52LinCod, H005M3_A1153LinDsc
               }
               , new Object[] {
               H005M4_A1908TipCSts, H005M4_A159TipCCod, H005M4_A1905TipCDsc
               }
               , new Object[] {
               H005M5_A2047VenSts, H005M5_A309VenCod, H005M5_A2045VenDsc
               }
               , new Object[] {
               H005M6_A1899TieSts, H005M6_A178TieCod, H005M6_A1898TieDsc
               }
            }
         );
      ...
      private string AV26ProdCod ;
      private string AV5CliCod ;
      private string edtavClicod_Internalname ;
      private string AV27ProdDsc ;
      ...
      private short[] H005M2_A1893SublSts ;
      private int[] H005M2_A51SublCod ;
      private string[] H005M2_A1892SublDsc ;
      private short[] H005M3_A1159LinSts ;
      private int[] H005M3_A52LinCod ;
      private string[] H005M3_A1153LinDsc ;
      private short[] H005M4_A1908TipCSts ;
      private int[] H005M4_A159TipCCod ;
      private string[] H005M4_A1905TipCDsc ;
      private short[] H005M5_A2047VenSts ;
      private int[] H005M5_A309VenCod ;
      private string[] H005M5_A2045VenDsc ;
      private short[] H005M6_A1899TieSts ;
      private int[] H005M6_A178TieCod ;
      private string[] H005M6_A1898TieDsc ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV31subLCod_Data ;
      private GXWebForm Form ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV8Combo_DataItem ;
   }

   public class r_detalleventas__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005M2", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005M2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005M3", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005M3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005M4", "SELECT [TipCSts], [TipCCod], [TipCDsc] FROM [CTIPOCLIENTE] WHERE [TipCSts] = 1 ORDER BY [TipCDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005M4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005M5", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005M5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005M6", "SELECT [TieSts], [TieCod], [TieDsc] FROM [SGTIENDAS] WHERE [TieSts] = 1 ORDER BY [TieDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005M6,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
