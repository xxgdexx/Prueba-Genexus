...
namespace GeneXus.Programs.ventas {
   public class r_resumenpedidosproductos : GXDataArea
   {
      public r_resumenpedidosproductos( )
      {
      ...
      public r_resumenpedidosproductos( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022818103122", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_resumenpedidosproductos.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTIECOD_DATA", AV42TieCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTIECOD_DATA", AV42TieCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTPEDCOD_DATA", AV35TPedCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTPEDCOD_DATA", AV35TPedCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "COMBO_TPEDCOD_Cls", StringUtil.RTrim( Combo_tpedcod_Cls));
         GxWebStd.gx_hidden_field( context, "COMBO_TPEDCOD_Selectedvalue_set", StringUtil.RTrim( Combo_tpedcod_Selectedvalue_set));
         ...
         GxWebStd.gx_hidden_field( context, "COMBO_TPEDCOD_Selectedvalue_get", StringUtil.RTrim( Combo_tpedcod_Selectedvalue_get));
      ...
      {
         return formatLink("ventas.r_resumenpedidosproductos.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_ResumenPedidosProductos" ;
      }
      ...
      protected void WB3L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tiecod_Internalname, "Local", "", "", lblTextblockcombo_tiecod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            ucCombo_tiecod.SetProperty("DropDownOptionsData", AV42TieCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell ExtendedComboCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplittedtpedcod_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tpedcod_Internalname, "Tipo Pedido", "", "", lblTextblockcombo_tpedcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ucCombo_tpedcod.SetProperty("Caption", Combo_tpedcod_Caption);
            ucCombo_tpedcod.SetProperty("Cls", Combo_tpedcod_Cls);
            ucCombo_tpedcod.SetProperty("DropDownOptionsData", AV35TPedCod_Data);
            ucCombo_tpedcod.Render(context, "dvelop.gxbootstrap.ddoextendedcombo", Combo_tpedcod_Internalname, "COMBO_TPEDCODContainer");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipccod_Internalname, "Tipo Cliente", "", "", lblTextblockcombo_tipccod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea Productos", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea de Productos ", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Vendedor", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_73_3L2( true) ;
         }
         else
         {
            wb_table1_73_3L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_73_3L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, " Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_90_3L2( true) ;
         }
         else
         {
            wb_table2_90_3L2( false) ;
         }
         return  ;
      }

      protected void wb_table2_90_3L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "F.Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table3_107_3L2( true) ;
         }
         else
         {
            wb_table3_107_3L2( false) ;
         }
         return  ;
      }

      protected void wb_table3_107_3L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Tipo Reporte", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV41Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,124);\"", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipoorden_Internalname, "Ordenado por", "", "", lblTextblocktipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipoorden, radavTipoorden_Internalname, StringUtil.Str( (decimal)(AV31TipoOrden), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,133);\"", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTiecod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV40TieCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV40TieCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,147);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTiecod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTiecod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 148,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTpedcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV34TPedCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV34TPedCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,148);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTpedcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTpedcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 149,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipccod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV37TipCCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV37TipCCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,149);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipccod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipccod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 150,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV18LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,150);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 151,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV27SublCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV27SublCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,151);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 152,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVencod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32VenCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV32VenCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,152);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVencod_Jsonclick, 0, "Attribute", "", "", "", "", edtavVencod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         AssignAttri("", false, "AV41Tipo", AV41Tipo);
      ...
      protected void STRUP3L0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vTIECOD_DATA"), AV42TieCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vTPEDCOD_DATA"), AV35TPedCod_Data);
            ...
            Combo_tpedcod_Cls = cgiGet( "COMBO_TPEDCOD_Cls");
            Combo_tpedcod_Selectedvalue_set = cgiGet( "COMBO_TPEDCOD_Selectedvalue_set");
            ...
            AV41Tipo = cgiGet( radavTipo_Internalname);
            AssignAttri("", false, "AV41Tipo", AV41Tipo);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavTiecod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavTiecod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV40TieCod = 0;
               AssignAttri("", false, "AV40TieCod", StringUtil.LTrimStr( (decimal)(AV40TieCod), 6, 0));
            }
            else
            {
               AV40TieCod = (int)(context.localUtil.CToN( cgiGet( edtavTiecod_Internalname), ".", ","));
               AssignAttri("", false, "AV40TieCod", StringUtil.LTrimStr( (decimal)(AV40TieCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavTpedcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavTpedcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vTPEDCOD");
               GX_FocusControl = edtavTpedcod_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV34TPedCod = 0;
               AssignAttri("", false, "AV34TPedCod", StringUtil.LTrimStr( (decimal)(AV34TPedCod), 6, 0));
            }
            else
            {
               AV34TPedCod = (int)(context.localUtil.CToN( cgiGet( edtavTpedcod_Internalname), ".", ","));
               AssignAttri("", false, "AV34TPedCod", StringUtil.LTrimStr( (decimal)(AV34TPedCod), 6, 0));
            }
      ...
      protected void E113L2( )
      {
         ...
         edtavTpedcod_Visible = 0;
         AssignProp("", false, edtavTpedcod_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavTpedcod_Visible), 5, 0), true);
         ...
         S112 ();
         if (returnInSub) return;
         /* Execute user subroutine: 'LOADCOMBOTPEDCOD' */
         S122 ();
         if (returnInSub) return;
      ...
      protected void E123L2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "rrresumenpedidosproductos.aspx"+UrlEncode(StringUtil.LTrimStr(AV40TieCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV34TPedCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV37TipCCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV18LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV27SublCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV32VenCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(StringUtil.RTrim(AV23ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV13FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV41Tipo));
         Innewwindow_Target = formatLink("rrresumenpedidosproductos.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S162( )
      {
         ...
         {
            A2047VenSts = H003L2_A2047VenSts[0];
            A309VenCod = H003L2_A309VenCod[0];
            A2045VenDsc = H003L2_A2045VenDsc[0];
      ...
      protected void S152( )
      {
         ...
         {
            A1893SublSts = H003L3_A1893SublSts[0];
            A51SublCod = H003L3_A51SublCod[0];
            A1892SublDsc = H003L3_A1892SublDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S142( )
      {
         ...
         {
            A1159LinSts = H003L4_A1159LinSts[0];
            A52LinCod = H003L4_A52LinCod[0];
            A1153LinDsc = H003L4_A1153LinDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S132( )
      {
         ...
         {
            A1908TipCSts = H003L5_A1908TipCSts[0];
            A159TipCCod = H003L5_A159TipCCod[0];
            A1905TipCDsc = H003L5_A1905TipCDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         /* 'LOADCOMBOTPEDCOD' Routine */
         returnInSub = false;
         /* Using cursor H003L6 */
         pr_default.execute(4);
         while ( (pr_default.getStatus(4) != 101) )
         {
            A1936TPedSts = H003L6_A1936TPedSts[0];
            A212TPedCod = H003L6_A212TPedCod[0];
            A1931TPedDsc = H003L6_A1931TPedDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV8Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A212TPedCod), 6, 0));
            AV8Combo_DataItem.gxTpr_Title = A1931TPedDsc;
            AV35TPedCod_Data.Add(AV8Combo_DataItem, 0);
            pr_default.readNext(4);
         }
         pr_default.close(4);
         Combo_tpedcod_Selectedvalue_set = ((0==AV34TPedCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV34TPedCod), 6, 0)));
         ucCombo_tpedcod.SendProperty(context, "", false, Combo_tpedcod_Internalname, "SelectedValue_set", Combo_tpedcod_Selectedvalue_set);
      }
      ...
      protected void S112( )
      {
         ...
         {
            A1899TieSts = H003L7_A1899TieSts[0];
            A178TieCod = H003L7_A178TieCod[0];
            A1898TieDsc = H003L7_A1898TieDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            AV42TieCod_Data.Add(AV8Combo_DataItem, 0);
            pr_default.readNext(5);
         }
         pr_default.close(5);
         Combo_tiecod_Selectedvalue_set = ((0==AV40TieCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV40TieCod), 6, 0)));
      ...
      protected void wb_table3_107_3L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_107_3L2e( true) ;
         }
         else
         {
            wb_table3_107_3L2e( false) ;
         }
      }

      protected void wb_table2_90_3L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavProdcod_Internalname, StringUtil.RTrim( AV23ProdCod), StringUtil.RTrim( context.localUtil.Format( AV23ProdCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,94);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProdcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavProdcod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='CellPaddingLeft10'>") ;
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscarpro_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscarpro_Jsonclick, "'"+""+"'"+",false,"+"'"+"e163l1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavProddsc_Internalname, StringUtil.RTrim( AV24ProdDsc), StringUtil.RTrim( context.localUtil.Format( AV24ProdDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProddsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavProddsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_90_3L2e( true) ;
         }
         else
         {
            wb_table2_90_3L2e( false) ;
         }
      }

      protected void wb_table1_73_3L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e173l1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_ResumenPedidosProductos.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031546", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_resumenpedidosproductos.js", "?20228181031546", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         radavTipo.WebTags = "";
         radavTipo.addItem("P", "Fecha Pedido", 0);
         radavTipo.addItem("A", "Fecha Atención", 0);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockcombo_tpedcod_Internalname = "TEXTBLOCKCOMBO_TPEDCOD";
         Combo_tpedcod_Internalname = "COMBO_TPEDCOD";
         divTablesplittedtpedcod_Internalname = "TABLESPLITTEDTPEDCOD";
         ...
         edtavTpedcod_Internalname = "vTPEDCOD";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavTpedcod_Jsonclick = "";
         edtavTpedcod_Visible = 1;
         ...
         Combo_tpedcod_Cls = "ExtendedCombo AttributeRealWidth50With";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E123L2',iparms:[{av:'AV40TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'AV34TPedCod',fld:'vTPEDCOD',pic:'ZZZZZ9'},{av:'AV37TipCCod',fld:'vTIPCCOD',pic:'ZZZZZ9'},{av:'AV18LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV27SublCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV32VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV23ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E133L2',iparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E173L1',iparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV7CliDsc',fld:'vCLIDSC',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNBUSCARPRO'","{handler:'E163L1',iparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNBUSCARPRO'",",oparms:[{av:'AV24ProdDsc',fld:'vPRODDSC',pic:''},{av:'AV23ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E143L2',iparms:[{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV16ForCod',fld:'vFORCOD',pic:'ZZZZZ9'},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV29TipCod',fld:'vTIPCOD',pic:''},{av:'AV25Serie',fld:'vSERIE',pic:''},{av:'AV32VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV32VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV25Serie',fld:'vSERIE',pic:''},{av:'AV29TipCod',fld:'vTIPCOD',pic:''},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV16ForCod',fld:'vFORCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'radavTipo'},{av:'AV41Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV31TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         Combo_tpedcod_Selectedvalue_get = "";
         ...
         bodyStyle = "";
         GXKey = "";
         AV42TieCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV35TPedCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         Combo_tpedcod_Selectedvalue_set = "";
         ...
         lblTextblockcombo_tpedcod_Jsonclick = "";
         ucCombo_tpedcod = new GXUserControl();
         Combo_tpedcod_Caption = "";
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H003L2_A2047VenSts = new short[1] ;
         H003L2_A309VenCod = new int[1] ;
         H003L2_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H003L3_A1893SublSts = new short[1] ;
         H003L3_A51SublCod = new int[1] ;
         H003L3_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         H003L4_A1159LinSts = new short[1] ;
         H003L4_A52LinCod = new int[1] ;
         H003L4_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         H003L5_A1908TipCSts = new short[1] ;
         H003L5_A159TipCCod = new int[1] ;
         H003L5_A1905TipCDsc = new string[] {""} ;
         A1905TipCDsc = "";
         H003L6_A1936TPedSts = new short[1] ;
         H003L6_A212TPedCod = new int[1] ;
         H003L6_A1931TPedDsc = new string[] {""} ;
         A1931TPedDsc = "";
         H003L7_A1899TieSts = new short[1] ;
         H003L7_A178TieCod = new int[1] ;
         H003L7_A1898TieDsc = new string[] {""} ;
         A1898TieDsc = "";
         AV10ExcelFilename = "";
         AV9ErrorMessage = "";
         sStyleString = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_resumenpedidosproductos__default(),
            new Object[][] {
                new Object[] {
               H003L2_A2047VenSts, H003L2_A309VenCod, H003L2_A2045VenDsc
               }
               , new Object[] {
               H003L3_A1893SublSts, H003L3_A51SublCod, H003L3_A1892SublDsc
               }
               , new Object[] {
               H003L4_A1159LinSts, H003L4_A52LinCod, H003L4_A1153LinDsc
               }
               , new Object[] {
               H003L5_A1908TipCSts, H003L5_A159TipCCod, H003L5_A1905TipCDsc
               }
               , new Object[] {
               H003L6_A1936TPedSts, H003L6_A212TPedCod, H003L6_A1931TPedDsc
               }
               , new Object[] {
               H003L7_A1899TieSts, H003L7_A178TieCod, H003L7_A1898TieDsc
               }
            }
         );
         AV41Tipo = "P";
      ...
      private int AV40TieCod ;
      private int edtavTiecod_Visible ;
      private int AV34TPedCod ;
      private int edtavTpedcod_Visible ;
      ...
      private string Combo_tpedcod_Selectedvalue_get ;
      ...
      private string Combo_tpedcod_Cls ;
      private string Combo_tpedcod_Selectedvalue_set ;
      ...
      private string divTablesplittedtpedcod_Internalname ;
      private string lblTextblockcombo_tpedcod_Internalname ;
      private string lblTextblockcombo_tpedcod_Jsonclick ;
      private string Combo_tpedcod_Caption ;
      private string Combo_tpedcod_Internalname ;
      ...
      private string edtavTpedcod_Internalname ;
      private string edtavTpedcod_Jsonclick ;
      ...
      private GXUserControl ucCombo_tpedcod ;
      ...
      private short[] H003L2_A2047VenSts ;
      private int[] H003L2_A309VenCod ;
      private string[] H003L2_A2045VenDsc ;
      private short[] H003L3_A1893SublSts ;
      private int[] H003L3_A51SublCod ;
      private string[] H003L3_A1892SublDsc ;
      private short[] H003L4_A1159LinSts ;
      private int[] H003L4_A52LinCod ;
      private string[] H003L4_A1153LinDsc ;
      private short[] H003L5_A1908TipCSts ;
      private int[] H003L5_A159TipCCod ;
      private string[] H003L5_A1905TipCDsc ;
      private short[] H003L6_A1936TPedSts ;
      private int[] H003L6_A212TPedCod ;
      private string[] H003L6_A1931TPedDsc ;
      private short[] H003L7_A1899TieSts ;
      private int[] H003L7_A178TieCod ;
      private string[] H003L7_A1898TieDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV42TieCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV35TPedCod_Data ;
   ...
   public class r_resumenpedidosproductos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH003L5;
          prmH003L5 = new Object[] {
          };
          Object[] prmH003L6;
          prmH003L6 = new Object[] {
          };
          Object[] prmH003L7;
          prmH003L7 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H003L2", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003L3", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003L4", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003L5", "SELECT [TipCSts], [TipCCod], [TipCDsc] FROM [CTIPOCLIENTE] WHERE [TipCSts] = 1 ORDER BY [TipCDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003L6", "SELECT [TPedSts], [TPedCod], [TPedDsc] FROM [CTIPPEDIDO] WHERE [TPedSts] = 1 ORDER BY [TPedDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003L7", "SELECT [TieSts], [TieCod], [TieDsc] FROM [SGTIENDAS] WHERE [TieSts] = 1 ORDER BY [TieDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L7,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
