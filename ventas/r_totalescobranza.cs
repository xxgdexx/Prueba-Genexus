...
namespace GeneXus.Programs.ventas {
   public class r_totalescobranza : GXDataArea
   {
      public r_totalescobranza( )
      {
      ...
      public r_totalescobranza( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810312956", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_totalescobranza.aspx") +"\">") ;
      ...
      {
         return formatLink("ventas.r_totalescobranza.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_TotalesCobranza" ;
      }

      public override string GetPgmdesc( )
      {
         return "Total de Cobranza" ;
      }
      ...
      protected void WB570( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_25_572( true) ;
         }
         else
         {
            wb_table1_25_572( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_572e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Cobrador", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_forcod_Internalname, "Forma Pago", "", "", lblTextblockcombo_forcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipcod_Internalname, "Tipo Documento", "", "", lblTextblockcombo_tipcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_serie_Internalname, "Serie", "", "", lblTextblockcombo_serie_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "F.Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_82_572( true) ;
         }
         else
         {
            wb_table2_82_572( false) ;
         }
         return  ;
      }

      protected void wb_table2_82_572e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Tipo Reporte", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV31Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,99);\"", "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipoorden_Internalname, "Ordenado por", "", "", lblTextblocktipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipoorden, radavTipoorden_Internalname, StringUtil.Str( (decimal)(AV32TipoOrden), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipoorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,108);\"", "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVencod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33VenCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV33VenCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,122);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVencod_Jsonclick, 0, "Attribute", "", "", "", "", edtavVencod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_TotalesCobranza.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 123,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavForcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16ForCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV16ForCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,123);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavForcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavForcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_TotalesCobranza.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 124,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipcod_Internalname, StringUtil.RTrim( AV29TipCod), StringUtil.RTrim( context.localUtil.Format( AV29TipCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,124);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipcod_Visible, 1, 0, "text", "", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_TotalesCobranza.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 125,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV20MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,125);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_TotalesCobranza.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 126,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSerie_Internalname, StringUtil.RTrim( AV25Serie), StringUtil.RTrim( context.localUtil.Format( AV25Serie, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,126);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSerie_Jsonclick, 0, "Attribute", "", "", "", "", edtavSerie_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_TotalesCobranza.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START572( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Total de Cobranza", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         AV31Tipo = StringUtil.RTrim( AV31Tipo);
         AssignAttri("", false, "AV31Tipo", AV31Tipo);
         AV32TipoOrden = (short)(context.localUtil.CToN( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32TipoOrden), 1, 0, ".", "")), ".", ","));
         AssignAttri("", false, "AV32TipoOrden", StringUtil.Str( (decimal)(AV32TipoOrden), 1, 0));
      }
      ...
      protected void STRUP570( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV31Tipo = cgiGet( radavTipo_Internalname);
            AssignAttri("", false, "AV31Tipo", AV31Tipo);
            ...
            {
               AV32TipoOrden = (short)(context.localUtil.CToN( cgiGet( radavTipoorden_Internalname), ".", ","));
               AssignAttri("", false, "AV32TipoOrden", StringUtil.Str( (decimal)(AV32TipoOrden), 1, 0));
            }
      ...
      protected void E12572( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV31Tipo, "M") == 0 )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "rrreportetotalescobranzaorigen.aspx"+UrlEncode(DateTimeUtil.FormatDateParm(AV13FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV16ForCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20MonCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV29TipCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV33VenCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV25Serie));
            Innewwindow_Target = formatLink("rrreportetotalescobranzaorigen.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "rrreportetotalescobranza.aspx"+UrlEncode(DateTimeUtil.FormatDateParm(AV13FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV16ForCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20MonCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV29TipCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV33VenCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV25Serie)) + "," + UrlEncode(StringUtil.RTrim(AV31Tipo));
            Innewwindow_Target = formatLink("rrreportetotalescobranza.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            ucInnewwindow.SendProperty(context, "", false, Innewwindow_Internalname, "Target", Innewwindow_Target);
            this.executeUsercontrolMethod("", false, "INNEWWINDOWContainer", "OpenWindow", "", new Object[] {});
         }
      ...
      protected void S152( )
      {
         ...
         {
            A340CorSerie = H00572_A340CorSerie[0];
            A339CorDoc = H00572_A339CorDoc[0];
      ...
      protected void S142( )
      {
         ...
         {
            A1235MonSts = H00573_A1235MonSts[0];
            A180MonCod = H00573_A180MonCod[0];
            A1234MonDsc = H00573_A1234MonDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S132( )
      {
         ...
         {
            A1919TipSts = H00574_A1919TipSts[0];
            A149TipCod = H00574_A149TipCod[0];
            A1910TipDsc = H00574_A1910TipDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A989ForSts = H00575_A989ForSts[0];
            A143ForCod = H00575_A143ForCod[0];
            A988ForDsc = H00575_A988ForDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A2047VenSts = H00576_A2047VenSts[0];
            A309VenCod = H00576_A309VenCod[0];
            A2045VenDsc = H00576_A2045VenDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void E14572( )
      {
         ...
         new GeneXus.Programs.ventas.r_resumencobranzaexcel(context ).execute( ref  AV13FDesde, ref  AV15FHasta, ref  AV5CliCod, ref  AV16ForCod, ref  AV20MonCod, ref  AV29TipCod, ref  AV25Serie, ref  AV33VenCod, out  AV10ExcelFilename, out  AV9ErrorMessage) ;
         AssignAttri("", false, "AV13FDesde", context.localUtil.Format(AV13FDesde, "99/99/99"));
         AssignAttri("", false, "AV15FHasta", context.localUtil.Format(AV15FHasta, "99/99/99"));
         AssignAttri("", false, "AV5CliCod", AV5CliCod);
         AssignAttri("", false, "AV16ForCod", StringUtil.LTrimStr( (decimal)(AV16ForCod), 6, 0));
      ...
      protected void wb_table2_82_572( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_TotalesCobranza.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table2_82_572e( true) ;
         }
         else
         {
            wb_table2_82_572e( false) ;
         }
      }

      protected void wb_table1_25_572( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16571_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_TotalesCobranza.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810313217", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_totalescobranza.js", "?202281810313217", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         radavTipo.addItem("M", "Por Moneda", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Total de Cobranza";
         ...
         Form.Caption = "Total de Cobranza";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12572',iparms:[{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV16ForCod',fld:'vFORCOD',pic:'ZZZZZ9'},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV29TipCod',fld:'vTIPCOD',pic:''},{av:'AV33VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV25Serie',fld:'vSERIE',pic:''},{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E13572',iparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E14572',iparms:[{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV16ForCod',fld:'vFORCOD',pic:'ZZZZZ9'},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV29TipCod',fld:'vTIPCOD',pic:''},{av:'AV25Serie',fld:'vSERIE',pic:''},{av:'AV33VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV33VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV25Serie',fld:'vSERIE',pic:''},{av:'AV29TipCod',fld:'vTIPCOD',pic:''},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV16ForCod',fld:'vFORCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("BTNBUSCAR.CLICK","{handler:'E16571',iparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("BTNBUSCAR.CLICK",",oparms:[{av:'AV7CliDsc',fld:'vCLIDSC',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'radavTipo'},{av:'AV31Tipo',fld:'vTIPO',pic:''},{av:'radavTipoorden'},{av:'AV32TipoOrden',fld:'vTIPOORDEN',pic:'9'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H00572_A340CorSerie = new string[] {""} ;
         H00572_A339CorDoc = new string[] {""} ;
         A340CorSerie = "";
         A339CorDoc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00573_A1235MonSts = new short[1] ;
         H00573_A180MonCod = new int[1] ;
         H00573_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         H00574_A1919TipSts = new short[1] ;
         H00574_A149TipCod = new string[] {""} ;
         H00574_A1910TipDsc = new string[] {""} ;
         A149TipCod = "";
         A1910TipDsc = "";
         H00575_A989ForSts = new short[1] ;
         H00575_A143ForCod = new int[1] ;
         H00575_A988ForDsc = new string[] {""} ;
         A988ForDsc = "";
         H00576_A2047VenSts = new short[1] ;
         H00576_A309VenCod = new int[1] ;
         H00576_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         AV10ExcelFilename = "";
         AV9ErrorMessage = "";
         sStyleString = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_totalescobranza__default(),
            new Object[][] {
                new Object[] {
               H00572_A340CorSerie, H00572_A339CorDoc
               }
               , new Object[] {
               H00573_A1235MonSts, H00573_A180MonCod, H00573_A1234MonDsc
               }
               , new Object[] {
               H00574_A1919TipSts, H00574_A149TipCod, H00574_A1910TipDsc
               }
               , new Object[] {
               H00575_A989ForSts, H00575_A143ForCod, H00575_A988ForDsc
               }
               , new Object[] {
               H00576_A2047VenSts, H00576_A309VenCod, H00576_A2045VenDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] H00572_A340CorSerie ;
      private string[] H00572_A339CorDoc ;
      private short[] H00573_A1235MonSts ;
      private int[] H00573_A180MonCod ;
      private string[] H00573_A1234MonDsc ;
      private short[] H00574_A1919TipSts ;
      private string[] H00574_A149TipCod ;
      private string[] H00574_A1910TipDsc ;
      private short[] H00575_A989ForSts ;
      private int[] H00575_A143ForCod ;
      private string[] H00575_A988ForDsc ;
      private short[] H00576_A2047VenSts ;
      private int[] H00576_A309VenCod ;
      private string[] H00576_A2045VenDsc ;
   ...
   public class r_totalescobranza__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00574;
          prmH00574 = new Object[] {
          };
          Object[] prmH00575;
          prmH00575 = new Object[] {
          };
          Object[] prmH00576;
          prmH00576 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H00572", "SELECT [CorSerie], [CorDoc] FROM [SGCDOCUMENTOS] ORDER BY [CorDoc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00572,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00573", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00573,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00574", "SELECT [TipSts], [TipCod], [TipDsc] FROM [CTIPDOC] WHERE [TipSts] = 1 ORDER BY [TipDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00574,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00575", "SELECT [ForSts], [ForCod], [ForDsc] FROM [CFORMAPAGO] WHERE [ForSts] = 1 ORDER BY [ForDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00575,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00576", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00576,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
