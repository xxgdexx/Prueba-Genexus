...
namespace GeneXus.Programs.ventas {
   public class r_anticiposclientes : GXDataArea
   {
      public r_anticiposclientes( )
      {
      ...
      public r_anticiposclientes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810313627", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_anticiposclientes.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTIPCCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV40TipCCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vMONCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV29MonCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vFHASTA", context.localUtil.DToC( AV21FHasta, 0, "/"));
         GxWebStd.gx_hidden_field( context, "vZONCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV50ZonCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vSERIE", StringUtil.RTrim( AV36Serie));
         GxWebStd.gx_hidden_field( context, "vTIPLETRAS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV45TipLetras), 1, 0, ".", "")));
      ...
      {
         return formatLink("ventas.r_anticiposclientes.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_AnticiposClientes" ;
      }
      ...
      protected void WB5F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Vendedor", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_AnticiposClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_AnticiposClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_33_5F2( true) ;
         }
         else
         {
            wb_table1_33_5F2( false) ;
         }
         return  ;
      }

      protected void wb_table1_33_5F2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipcod_Internalname, "Tipo Documento", "", "", lblTextblockcombo_tipcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_AnticiposClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_AnticiposClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_AnticiposClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVencod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV48VenCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV48VenCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVencod_Jsonclick, 0, "Attribute", "", "", "", "", edtavVencod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_AnticiposClientes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 65,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipcod_Internalname, StringUtil.RTrim( AV42TipCod), StringUtil.RTrim( context.localUtil.Format( AV42TipCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipcod_Visible, 1, 0, "text", "", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_AnticiposClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Anticipos de Clientes", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E125F2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "rranticipoclientes.aspx"+UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(StringUtil.RTrim(AV42TipCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV48VenCod,6,0));
         Innewwindow_Target = formatLink("rranticipoclientes.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S122( )
      {
         ...
         {
            A1919TipSts = H005F2_A1919TipSts[0];
            A149TipCod = H005F2_A149TipCod[0];
            A1910TipDsc = H005F2_A1910TipDsc[0];
      ...
      protected void S112( )
      {
         ...
         {
            A2047VenSts = H005F3_A2047VenSts[0];
            A309VenCod = H005F3_A309VenCod[0];
            A2045VenDsc = H005F3_A2045VenDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void E145F2( )
      {
         ...
         new pcuentacorrienteexcel(context ).execute( ref  AV40TipCCod, ref  AV5CliCod, ref  AV42TipCod, ref  AV29MonCod, ref  AV21FHasta, ref  AV50ZonCod, ref  AV36Serie, ref  AV45TipLetras, ref  AV48VenCod, out  AV16ExcelFilename, out  AV13ErrorMessage) ;
         AssignAttri("", false, "AV40TipCCod", StringUtil.LTrimStr( (decimal)(AV40TipCCod), 6, 0));
         AssignAttri("", false, "AV5CliCod", AV5CliCod);
         AssignAttri("", false, "AV42TipCod", AV42TipCod);
         AssignAttri("", false, "AV29MonCod", StringUtil.LTrimStr( (decimal)(AV29MonCod), 6, 0));
         AssignAttri("", false, "AV21FHasta", context.localUtil.Format(AV21FHasta, "99/99/99"));
         AssignAttri("", false, "AV50ZonCod", StringUtil.LTrimStr( (decimal)(AV50ZonCod), 6, 0));
         AssignAttri("", false, "AV36Serie", AV36Serie);
         AssignAttri("", false, "AV45TipLetras", StringUtil.Str( (decimal)(AV45TipLetras), 1, 0));
         AssignAttri("", false, "AV48VenCod", StringUtil.LTrimStr( (decimal)(AV48VenCod), 6, 0));
      ...
      protected void wb_table1_33_5F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165f1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_AnticiposClientes.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810313734", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_anticiposclientes.js", "?202281810313734", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte Anticipos de Clientes";
         ...
         Form.Caption = "Anticipos de Clientes";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E125F2',iparms:[{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV42TipCod',fld:'vTIPCOD',pic:''},{av:'AV48VenCod',fld:'vVENCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E135F2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E145F2',iparms:[{av:'AV40TipCCod',fld:'vTIPCCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV42TipCod',fld:'vTIPCOD',pic:''},{av:'AV29MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV21FHasta',fld:'vFHASTA',pic:''},{av:'AV50ZonCod',fld:'vZONCOD',pic:'ZZZZZ9'},{av:'AV36Serie',fld:'vSERIE',pic:''},{av:'AV45TipLetras',fld:'vTIPLETRAS',pic:'9'},{av:'AV48VenCod',fld:'vVENCOD',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV48VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV45TipLetras',fld:'vTIPLETRAS',pic:'9'},{av:'AV36Serie',fld:'vSERIE',pic:''},{av:'AV50ZonCod',fld:'vZONCOD',pic:'ZZZZZ9'},{av:'AV21FHasta',fld:'vFHASTA',pic:''},{av:'AV29MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV42TipCod',fld:'vTIPCOD',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV40TipCCod',fld:'vTIPCCOD',pic:'ZZZZZ9'}]}");
         setEventMetadata("BTNBUSCAR.CLICK","{handler:'E165F1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H005F2_A1919TipSts = new short[1] ;
         H005F2_A149TipCod = new string[] {""} ;
         H005F2_A1910TipDsc = new string[] {""} ;
         A149TipCod = "";
         A1910TipDsc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H005F3_A2047VenSts = new short[1] ;
         H005F3_A309VenCod = new int[1] ;
         H005F3_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         AV16ExcelFilename = "";
         AV13ErrorMessage = "";
         sStyleString = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_anticiposclientes__default(),
            new Object[][] {
                new Object[] {
               H005F2_A1919TipSts, H005F2_A149TipCod, H005F2_A1910TipDsc
               }
               , new Object[] {
               H005F3_A2047VenSts, H005F3_A309VenCod, H005F3_A2045VenDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H005F2_A1919TipSts ;
      private string[] H005F2_A149TipCod ;
      private string[] H005F2_A1910TipDsc ;
      private short[] H005F3_A2047VenSts ;
      private int[] H005F3_A309VenCod ;
      private string[] H005F3_A2045VenDsc ;
   ...
   public class r_anticiposclientes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005F2", "SELECT [TipSts], [TipCod], [TipDsc] FROM [CTIPDOC] WHERE [TipSts] = 1 ORDER BY [TipDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005F2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005F3", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005F3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
