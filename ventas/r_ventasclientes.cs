...
namespace GeneXus.Programs.ventas {
   public class r_ventasclientes : GXDataArea
   {
      public r_ventasclientes( )
      {
      ...
      public r_ventasclientes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810314643", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_ventasclientes.aspx") +"\">") ;
      ...
      {
         return formatLink("ventas.r_ventasclientes.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_VentasClientes" ;
      }
      ...
      protected void WB5O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tiecod_Internalname, "Local", "", "", lblTextblockcombo_tiecod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipcod_Internalname, "Tipo Documento", "", "", lblTextblockcombo_tipcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tipccod_Internalname, "Tipo Cliente", "", "", lblTextblockcombo_tipccod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_paicod_Internalname, "Pais", "", "", lblTextblockcombo_paicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_zoncod_Internalname, "Zona", "", "", lblTextblockcombo_zoncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Local", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_73_5O2( true) ;
         }
         else
         {
            wb_table1_73_5O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_73_5O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "F.Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_90_5O2( true) ;
         }
         else
         {
            wb_table2_90_5O2( false) ;
         }
         return  ;
      }

      protected void wb_table2_90_5O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Tipo", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV46Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,107);\"", "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcheckrec_Internalname, "Incluye Recibos", "", "", lblTextblockcheckrec_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTiecod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV38TieCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV38TieCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,132);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTiecod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTiecod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_VentasClientes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 133,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipcod_Internalname, StringUtil.RTrim( AV42TipCod), StringUtil.RTrim( context.localUtil.Format( AV42TipCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,133);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipcod_Visible, 1, 0, "text", "", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_VentasClientes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 134,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipccod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV40TipCcod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV40TipCcod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,134);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipccod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTipccod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_VentasClientes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 135,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPaicod_Internalname, StringUtil.RTrim( AV30PaiCod), StringUtil.RTrim( context.localUtil.Format( AV30PaiCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,135);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPaicod_Jsonclick, 0, "Attribute", "", "", "", "", edtavPaicod_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Ventas\\R_VentasClientes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 136,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavZoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV50ZonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV50ZonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,136);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavZoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavZoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_VentasClientes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 137,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVencod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV48VenCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV48VenCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,137);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVencod_Jsonclick, 0, "Attribute", "", "", "", "", edtavVencod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_VentasClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Ventas por Clientes", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E125O2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "rrventasclientes.aspx"+UrlEncode(StringUtil.LTrimStr(AV40TipCcod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(StringUtil.RTrim(AV42TipCod)) + "," + UrlEncode(StringUtil.RTrim(AV30PaiCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV17FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV19FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV46Tipo)) + "," + UrlEncode(StringUtil.LTrimStr(AV48VenCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV50ZonCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV38TieCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV52CheckRec,1,0));
         Innewwindow_Target = formatLink("rrventasclientes.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E135O2( )
      {
         ...
         new rventasclientesexcel(context ).execute( ref  AV40TipCcod, ref  AV5CliCod, ref  AV42TipCod, ref  AV30PaiCod, ref  AV17FDesde, ref  AV19FHasta, ref  AV46Tipo, ref  AV48VenCod, ref  AV50ZonCod, ref  AV38TieCod, ref  AV52CheckRec, out  AV14ExcelFilename, out  AV11ErrorMessage) ;
         AssignAttri("", false, "AV40TipCcod", StringUtil.LTrimStr( (decimal)(AV40TipCcod), 6, 0));
         AssignAttri("", false, "AV5CliCod", AV5CliCod);
         AssignAttri("", false, "AV42TipCod", AV42TipCod);
         AssignAttri("", false, "AV30PaiCod", AV30PaiCod);
      ...
      protected void S162( )
      {
         ...
         {
            A2047VenSts = H005O2_A2047VenSts[0];
            A309VenCod = H005O2_A309VenCod[0];
            A2045VenDsc = H005O2_A2045VenDsc[0];
      ...
      protected void S152( )
      {
         ...
         {
            A2095ZonSts = H005O3_A2095ZonSts[0];
            A158ZonCod = H005O3_A158ZonCod[0];
            A2094ZonDsc = H005O3_A2094ZonDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S142( )
      {
         ...
         {
            A1501PaiSts = H005O4_A1501PaiSts[0];
            A139PaiCod = H005O4_A139PaiCod[0];
            A1500PaiDsc = H005O4_A1500PaiDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S132( )
      {
         ...
         {
            A1908TipCSts = H005O5_A1908TipCSts[0];
            A159TipCCod = H005O5_A159TipCCod[0];
            A1905TipCDsc = H005O5_A1905TipCDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A1919TipSts = H005O6_A1919TipSts[0];
            A149TipCod = H005O6_A149TipCod[0];
            A1910TipDsc = H005O6_A1910TipDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         {
            A1899TieSts = H005O7_A1899TieSts[0];
            A178TieCod = H005O7_A178TieCod[0];
            A1898TieDsc = H005O7_A1898TieDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table2_90_5O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_VentasClientes.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table2_90_5O2e( true) ;
         }
         else
         {
            wb_table2_90_5O2e( false) ;
         }
      }

      protected void wb_table1_73_5O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165o1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_VentasClientes.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810314961", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_ventasclientes.js", "?202281810314961", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Ventas por Clientes";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E125O2',iparms:[{av:'AV40TipCcod',fld:'vTIPCCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV42TipCod',fld:'vTIPCOD',pic:''},{av:'AV30PaiCod',fld:'vPAICOD',pic:''},{av:'AV17FDesde',fld:'vFDESDE',pic:''},{av:'AV19FHasta',fld:'vFHASTA',pic:''},{av:'AV48VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV50ZonCod',fld:'vZONCOD',pic:'ZZZZZ9'},{av:'AV38TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]");
         ...
         setEventMetadata("'DOBTNEXCEL'","{handler:'E135O2',iparms:[{av:'AV40TipCcod',fld:'vTIPCCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV42TipCod',fld:'vTIPCOD',pic:''},{av:'AV30PaiCod',fld:'vPAICOD',pic:''},{av:'AV17FDesde',fld:'vFDESDE',pic:''},{av:'AV19FHasta',fld:'vFHASTA',pic:''},{av:'AV48VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV50ZonCod',fld:'vZONCOD',pic:'ZZZZZ9'},{av:'AV38TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV38TieCod',fld:'vTIECOD',pic:'ZZZZZ9'},{av:'AV50ZonCod',fld:'vZONCOD',pic:'ZZZZZ9'},{av:'AV48VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV19FHasta',fld:'vFHASTA',pic:''},{av:'AV17FDesde',fld:'vFDESDE',pic:''},{av:'AV30PaiCod',fld:'vPAICOD',pic:''},{av:'AV42TipCod',fld:'vTIPCOD',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV40TipCcod',fld:'vTIPCCOD',pic:'ZZZZZ9'},{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E145O2',iparms:[{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]}");
         setEventMetadata("BTNBUSCAR.CLICK","{handler:'E165O1',iparms:[{av:'radavTipo'},{av:'AV46Tipo',fld:'vTIPO',pic:''},{av:'AV52CheckRec',fld:'vCHECKREC',pic:'9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV11ErrorMessage = "";
         scmdbuf = "";
         H005O2_A2047VenSts = new short[1] ;
         H005O2_A309VenCod = new int[1] ;
         H005O2_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H005O3_A2095ZonSts = new short[1] ;
         H005O3_A158ZonCod = new int[1] ;
         H005O3_A2094ZonDsc = new string[] {""} ;
         A2094ZonDsc = "";
         H005O4_A1501PaiSts = new short[1] ;
         H005O4_A139PaiCod = new string[] {""} ;
         H005O4_A1500PaiDsc = new string[] {""} ;
         A139PaiCod = "";
         A1500PaiDsc = "";
         H005O5_A1908TipCSts = new short[1] ;
         H005O5_A159TipCCod = new int[1] ;
         H005O5_A1905TipCDsc = new string[] {""} ;
         A1905TipCDsc = "";
         H005O6_A1919TipSts = new short[1] ;
         H005O6_A149TipCod = new string[] {""} ;
         H005O6_A1910TipDsc = new string[] {""} ;
         A149TipCod = "";
         A1910TipDsc = "";
         H005O7_A1899TieSts = new short[1] ;
         H005O7_A178TieCod = new int[1] ;
         H005O7_A1898TieDsc = new string[] {""} ;
         A1898TieDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_ventasclientes__default(),
            new Object[][] {
                new Object[] {
               H005O2_A2047VenSts, H005O2_A309VenCod, H005O2_A2045VenDsc
               }
               , new Object[] {
               H005O3_A2095ZonSts, H005O3_A158ZonCod, H005O3_A2094ZonDsc
               }
               , new Object[] {
               H005O4_A1501PaiSts, H005O4_A139PaiCod, H005O4_A1500PaiDsc
               }
               , new Object[] {
               H005O5_A1908TipCSts, H005O5_A159TipCCod, H005O5_A1905TipCDsc
               }
               , new Object[] {
               H005O6_A1919TipSts, H005O6_A149TipCod, H005O6_A1910TipDsc
               }
               , new Object[] {
               H005O7_A1899TieSts, H005O7_A178TieCod, H005O7_A1898TieDsc
               }
            }
         );
      ...
      private short[] H005O2_A2047VenSts ;
      private int[] H005O2_A309VenCod ;
      private string[] H005O2_A2045VenDsc ;
      private short[] H005O3_A2095ZonSts ;
      private int[] H005O3_A158ZonCod ;
      private string[] H005O3_A2094ZonDsc ;
      private short[] H005O4_A1501PaiSts ;
      private string[] H005O4_A139PaiCod ;
      private string[] H005O4_A1500PaiDsc ;
      private short[] H005O5_A1908TipCSts ;
      private int[] H005O5_A159TipCCod ;
      private string[] H005O5_A1905TipCDsc ;
      private short[] H005O6_A1919TipSts ;
      private string[] H005O6_A149TipCod ;
      private string[] H005O6_A1910TipDsc ;
      private short[] H005O7_A1899TieSts ;
      private int[] H005O7_A178TieCod ;
      private string[] H005O7_A1898TieDsc ;
   ...
   public class r_ventasclientes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005O2", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005O3", "SELECT [ZonSts], [ZonCod], [ZonDsc] FROM [CZONAS] WHERE [ZonSts] = 1 ORDER BY [ZonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005O4", "SELECT [PaiSts], [PaiCod], [PaiDsc] FROM [CPAISES] WHERE [PaiSts] = 1 ORDER BY [PaiDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005O5", "SELECT [TipCSts], [TipCCod], [TipCDsc] FROM [CTIPOCLIENTE] WHERE [TipCSts] = 1 ORDER BY [TipCDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005O6", "SELECT [TipSts], [TipCod], [TipDsc] FROM [CTIPDOC] WHERE [TipSts] = 1 ORDER BY [TipDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005O7", "SELECT [TieSts], [TieCod], [TieDsc] FROM [SGTIENDAS] WHERE [TieSts] = 1 ORDER BY [TieDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O7,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
