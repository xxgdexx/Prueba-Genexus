...
namespace GeneXus.Programs.ventas {
   public class r_resumenletras : GXDataArea
   {
      public r_resumenletras( )
      {
      ...
      public r_resumenletras( IGxContext context )
      {
      ...
      {
         cmbavLetpsec = new GXCombobox();
         radavCcestado = new GXRadio();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810312817", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ventas.r_resumenletras.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vVENCOD_DATA", AV34VenCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vVENCOD_DATA", AV34VenCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vBANCOD_DATA", AV37BanCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vBANCOD_DATA", AV37BanCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      {
         return formatLink("ventas.r_resumenletras.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Ventas.R_ResumenLetras" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Letras por Cobrar" ;
      }
      ...
      protected void WB580( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockclicod_Internalname, "Cliente", "", "", lblTextblockclicod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_25_582( true) ;
         }
         else
         {
            wb_table1_25_582( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_582e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_vencod_Internalname, "Vendedor", "", "", lblTextblockcombo_vencod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_vencod.SetProperty("DropDownOptionsData", AV34VenCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_bancod_Internalname, "Banco", "", "", lblTextblockcombo_bancod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_bancod.SetProperty("DropDownOptionsData", AV37BanCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableletpsec_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockletpsec_Internalname, "Estado", "", "", lblTextblockletpsec_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, cmbavLetpsec_Internalname, "Let PSec", "col-sm-3 AttributeRealWidth50WithLabel", 0, true, "");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 59,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavLetpsec, cmbavLetpsec_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV36LetPSec), 6, 0)), 1, cmbavLetpsec_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavLetpsec.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "", true, 1, "HLP_Ventas\\R_ResumenLetras.htm");
            cmbavLetpsec.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV36LetPSec), 6, 0));
            AssignProp("", false, cmbavLetpsec_Internalname, "Values", (string)(cmbavLetpsec.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableccestado_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccestado_Internalname, "Estado", "", "", lblTextblockccestado_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", "CCEstado", "col-sm-3 AttributeCheckBoxLabel", 0, true, "");
            /* Radio button */
            ClassString = "AttributeCheckBox";
            StyleString = "";
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 76,'',false,'',0)\"";
            GxWebStd.gx_radio_ctrl( context, radavCcestado, radavCcestado_Internalname, StringUtil.RTrim( AV38CCEstado), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavCcestado_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "F.Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_84_582( true) ;
         }
         else
         {
            wb_table2_84_582( false) ;
         }
         return  ;
      }

      protected void wb_table2_84_582e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipfecha_Internalname, "Filtrar", "", "", lblTextblocktipfecha_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipfecha, radavTipfecha_Internalname, StringUtil.RTrim( AV39TipFecha), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipfecha_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,101);\"", "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportal a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Imprimir PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVencod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33VenCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV33VenCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,117);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVencod_Jsonclick, 0, "Attribute", "", "", "", "", edtavVencod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 118,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBancod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35BanCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV35BanCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,118);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBancod_Jsonclick, 0, "Attribute", "", "", "", "", edtavBancod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 119,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV20MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START582( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Letras por Cobrar", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         if ( cmbavLetpsec.ItemCount > 0 )
         {
            AV36LetPSec = (int)(NumberUtil.Val( cmbavLetpsec.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV36LetPSec), 6, 0))), "."));
            AssignAttri("", false, "AV36LetPSec", StringUtil.LTrimStr( (decimal)(AV36LetPSec), 6, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavLetpsec.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV36LetPSec), 6, 0));
            AssignProp("", false, cmbavLetpsec_Internalname, "Values", cmbavLetpsec.ToJavascriptSource(), true);
         }
         AssignAttri("", false, "AV38CCEstado", AV38CCEstado);
         AssignAttri("", false, "AV39TipFecha", AV39TipFecha);
      }
      ...
      protected void STRUP580( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vVENCOD_DATA"), AV34VenCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vBANCOD_DATA"), AV37BanCod_Data);
            ...
            cmbavLetpsec.CurrentValue = cgiGet( cmbavLetpsec_Internalname);
            AV36LetPSec = (int)(NumberUtil.Val( cgiGet( cmbavLetpsec_Internalname), "."));
            AssignAttri("", false, "AV36LetPSec", StringUtil.LTrimStr( (decimal)(AV36LetPSec), 6, 0));
            AV38CCEstado = cgiGet( radavCcestado_Internalname);
            AssignAttri("", false, "AV38CCEstado", AV38CCEstado);
            ...
            AV39TipFecha = cgiGet( radavTipfecha_Internalname);
            AssignAttri("", false, "AV39TipFecha", AV39TipFecha);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavVencod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavVencod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV33VenCod = 0;
               AssignAttri("", false, "AV33VenCod", StringUtil.LTrimStr( (decimal)(AV33VenCod), 6, 0));
            }
            else
            {
               AV33VenCod = (int)(context.localUtil.CToN( cgiGet( edtavVencod_Internalname), ".", ","));
               AssignAttri("", false, "AV33VenCod", StringUtil.LTrimStr( (decimal)(AV33VenCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavBancod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavBancod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV35BanCod = 0;
               AssignAttri("", false, "AV35BanCod", StringUtil.LTrimStr( (decimal)(AV35BanCod), 6, 0));
            }
            else
            {
               AV35BanCod = (int)(context.localUtil.CToN( cgiGet( edtavBancod_Internalname), ".", ","));
               AssignAttri("", false, "AV35BanCod", StringUtil.LTrimStr( (decimal)(AV35BanCod), 6, 0));
            }
      ...
      protected void E12582( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "rrresumenletrascobrar.aspx"+UrlEncode(StringUtil.RTrim(AV5CliCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV35BanCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36LetPSec,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20MonCod,6,0)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV13FDesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV15FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV38CCEstado)) + "," + UrlEncode(StringUtil.RTrim(AV39TipFecha)) + "," + UrlEncode(StringUtil.LTrimStr(AV33VenCod,6,0));
         Innewwindow_Target = formatLink("rrresumenletrascobrar.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E13582( )
      {
         ...
         new presumenletrasexcel(context ).execute( ref  AV5CliCod, ref  AV35BanCod, ref  AV36LetPSec, ref  AV20MonCod, ref  AV13FDesde, ref  AV15FHasta, ref  AV38CCEstado, ref  AV39TipFecha, ref  AV33VenCod, out  AV10ExcelFilename, out  AV9ErrorMessage) ;
         AssignAttri("", false, "AV5CliCod", AV5CliCod);
         AssignAttri("", false, "AV35BanCod", StringUtil.LTrimStr( (decimal)(AV35BanCod), 6, 0));
         AssignAttri("", false, "AV36LetPSec", StringUtil.LTrimStr( (decimal)(AV36LetPSec), 6, 0));
         AssignAttri("", false, "AV20MonCod", StringUtil.LTrimStr( (decimal)(AV20MonCod), 6, 0));
         ...
         /*  Sending Event outputs  */
         radavTipfecha.CurrentValue = StringUtil.RTrim( AV39TipFecha);
         AssignProp("", false, radavTipfecha_Internalname, "Values", radavTipfecha.ToJavascriptSource(), true);
         radavCcestado.CurrentValue = StringUtil.RTrim( AV38CCEstado);
         AssignProp("", false, radavCcestado_Internalname, "Values", radavCcestado.ToJavascriptSource(), true);
         cmbavLetpsec.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV36LetPSec), 6, 0));
         AssignProp("", false, cmbavLetpsec_Internalname, "Values", cmbavLetpsec.ToJavascriptSource(), true);
      }
      ...
      protected void S132( )
      {
         ...
         {
            A1235MonSts = H00582_A1235MonSts[0];
            A180MonCod = H00582_A180MonCod[0];
            A1234MonDsc = H00582_A1234MonDsc[0];
      ...
      protected void S122( )
      {
         ...
         {
            A483BanSts = H00583_A483BanSts[0];
            A372BanCod = H00583_A372BanCod[0];
            A482BanDsc = H00583_A482BanDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV8Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A372BanCod), 6, 0));
            AV8Combo_DataItem.gxTpr_Title = A482BanDsc;
            AV37BanCod_Data.Add(AV8Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_bancod_Selectedvalue_set = ((0==AV35BanCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV35BanCod), 6, 0)));
      ...
      protected void S112( )
      {
         ...
         {
            A2047VenSts = H00584_A2047VenSts[0];
            A309VenCod = H00584_A309VenCod[0];
            A2045VenDsc = H00584_A2045VenDsc[0];
            AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            AV34VenCod_Data.Add(AV8Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_vencod_Selectedvalue_set = ((0==AV33VenCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV33VenCod), 6, 0)));
      ...
      protected void wb_table2_84_582( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV13FDesde, "99/99/99"), context.localUtil.Format( AV13FDesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,88);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV15FHasta, "99/99/99"), context.localUtil.Format( AV15FHasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,92);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Ventas\\R_ResumenLetras.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table2_84_582e( true) ;
         }
         else
         {
            wb_table2_84_582e( false) ;
         }
      }

      protected void wb_table1_25_582( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16581_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Ventas\\R_ResumenLetras.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031303", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ventas/r_resumenletras.js", "?20228181031304", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         cmbavLetpsec.Name = "vLETPSEC";
         cmbavLetpsec.WebTags = "";
         cmbavLetpsec.addItem("0", "(Todos)", 0);
         cmbavLetpsec.addItem("1", "Por Aceptar", 0);
         cmbavLetpsec.addItem("8", "Cartera", 0);
         cmbavLetpsec.addItem("2", "Descuento", 0);
         cmbavLetpsec.addItem("3", "Cobranza", 0);
         cmbavLetpsec.addItem("4", "Cobranza Libre", 0);
         cmbavLetpsec.addItem("5", "Garantia", 0);
         cmbavLetpsec.addItem("6", "Protestado", 0);
         cmbavLetpsec.addItem("7", "Refinanciado", 0);
         cmbavLetpsec.addItem("10", "Refinanciamiento Amort.", 0);
         cmbavLetpsec.addItem("11", "Factura Negociable - Descuento", 0);
         cmbavLetpsec.addItem("12", "Factura Negociable - Cobranza", 0);
         cmbavLetpsec.addItem("9", "Aceptada", 0);
         if ( cmbavLetpsec.ItemCount > 0 )
         {
            AV36LetPSec = (int)(NumberUtil.Val( cmbavLetpsec.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV36LetPSec), 6, 0))), "."));
            AssignAttri("", false, "AV36LetPSec", StringUtil.LTrimStr( (decimal)(AV36LetPSec), 6, 0));
         }
         radavCcestado.Name = "vCCESTADO";
         radavCcestado.WebTags = "";
         radavCcestado.addItem("", "Pendientes", 0);
         radavCcestado.addItem("A", "Anuladas", 0);
         radavCcestado.addItem("T", "Terminadas", 0);
         radavCcestado.addItem("O", "Todos", 0);
         radavTipfecha.Name = "vTIPFECHA";
         radavTipfecha.WebTags = "";
         radavTipfecha.addItem("E", "Fecha Emisión", 0);
         radavTipfecha.addItem("V", "Fecha Vencimiento", 0);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockletpsec_Internalname = "TEXTBLOCKLETPSEC";
         cmbavLetpsec_Internalname = "vLETPSEC";
         divUnnamedtableletpsec_Internalname = "UNNAMEDTABLELETPSEC";
         ...
         lblTextblockccestado_Internalname = "TEXTBLOCKCCESTADO";
         radavCcestado_Internalname = "vCCESTADO";
         divUnnamedtableccestado_Internalname = "UNNAMEDTABLECCESTADO";
      ...
      public override void initialize_properties( )
      {
         ...
         radavCcestado_Jsonclick = "";
         cmbavLetpsec_Jsonclick = "";
         cmbavLetpsec.Enabled = 1;
         Innewwindow_Target = "";
         ...
         Dvpanel_panel1_Title = "Resumen de Letras por Cobrar";
         ...
         Form.Caption = "Resumen de Letras por Cobrar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12582',iparms:[{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV35BanCod',fld:'vBANCOD',pic:'ZZZZZ9'},{av:'cmbavLetpsec'},{av:'AV36LetPSec',fld:'vLETPSEC',pic:'ZZZZZ9'},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV33VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13582',iparms:[{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'AV35BanCod',fld:'vBANCOD',pic:'ZZZZZ9'},{av:'cmbavLetpsec'},{av:'AV36LetPSec',fld:'vLETPSEC',pic:'ZZZZZ9'},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV33VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV33VenCod',fld:'vVENCOD',pic:'ZZZZZ9'},{av:'AV15FHasta',fld:'vFHASTA',pic:''},{av:'AV13FDesde',fld:'vFDESDE',pic:''},{av:'AV20MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'cmbavLetpsec'},{av:'AV36LetPSec',fld:'vLETPSEC',pic:'ZZZZZ9'},{av:'AV35BanCod',fld:'vBANCOD',pic:'ZZZZZ9'},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E14582',iparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         setEventMetadata("BTNBUSCAR.CLICK","{handler:'E16581',iparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("BTNBUSCAR.CLICK",",oparms:[{av:'AV7CliDsc',fld:'vCLIDSC',pic:''},{av:'AV5CliCod',fld:'vCLICOD',pic:''},{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'radavCcestado'},{av:'AV38CCEstado',fld:'vCCESTADO',pic:''},{av:'radavTipfecha'},{av:'AV39TipFecha',fld:'vTIPFECHA',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV34VenCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV37BanCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV9ErrorMessage = "";
         scmdbuf = "";
         H00582_A1235MonSts = new short[1] ;
         H00582_A180MonCod = new int[1] ;
         H00582_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV8Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00583_A483BanSts = new short[1] ;
         H00583_A372BanCod = new int[1] ;
         H00583_A482BanDsc = new string[] {""} ;
         A482BanDsc = "";
         H00584_A2047VenSts = new short[1] ;
         H00584_A309VenCod = new int[1] ;
         H00584_A2045VenDsc = new string[] {""} ;
         A2045VenDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ventas.r_resumenletras__default(),
            new Object[][] {
                new Object[] {
               H00582_A1235MonSts, H00582_A180MonCod, H00582_A1234MonDsc
               }
               , new Object[] {
               H00583_A483BanSts, H00583_A372BanCod, H00583_A482BanDsc
               }
               , new Object[] {
               H00584_A2047VenSts, H00584_A309VenCod, H00584_A2045VenDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV36LetPSec ;
      private int AV33VenCod ;
      private int edtavVencod_Visible ;
      private int AV35BanCod ;
      ...
      private string divUnnamedtableletpsec_Internalname ;
      private string lblTextblockletpsec_Internalname ;
      private string lblTextblockletpsec_Jsonclick ;
      private string cmbavLetpsec_Internalname ;
      private string TempTags ;
      private string cmbavLetpsec_Jsonclick ;
      ...
      private string divUnnamedtableccestado_Internalname ;
      private string lblTextblockccestado_Internalname ;
      private string lblTextblockccestado_Jsonclick ;
      private string radavCcestado_Internalname ;
      private string radavCcestado_Jsonclick ;
      ...
      private string AV38CCEstado ;
      private string AV39TipFecha ;
      ...
      private GXCombobox cmbavLetpsec ;
      private GXRadio radavCcestado ;
      private GXRadio radavTipfecha ;
      private IDataStoreProvider pr_default ;
      private short[] H00582_A1235MonSts ;
      private int[] H00582_A180MonCod ;
      private string[] H00582_A1234MonDsc ;
      private short[] H00583_A483BanSts ;
      private int[] H00583_A372BanCod ;
      private string[] H00583_A482BanDsc ;
      private short[] H00584_A2047VenSts ;
      private int[] H00584_A309VenCod ;
      private string[] H00584_A2045VenDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV34VenCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV37BanCod_Data ;
   ...
   public class r_resumenletras__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00582", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00582,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00583", "SELECT [BanSts], [BanCod], [BanDsc] FROM [TSBANCOS] WHERE [BanSts] = 1 ORDER BY [BanDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00583,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00584", "SELECT [VenSts], [VenCod], [VenDsc] FROM [CVENDEDORES] WHERE [VenSts] = 1 ORDER BY [VenDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00584,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
