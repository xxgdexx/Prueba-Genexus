...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Format.ConditionalStyle" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerElements.Element.Format.ConditionalStyle", Namespace="SIGERP_ADVANCED")]
