...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	public class SdtQueryViewerItemDoubleClickData : GxUserType
	{
		...
		public GXBaseCollection<SdtQueryViewerItemDoubleClickData_Element> gxTpr_Context
		{
			...
			set {
				gxTv_SdtQueryViewerItemDoubleClickData_Context_N = false;
		...
		public GXBaseCollection<SdtQueryViewerItemDoubleClickData_Filter> gxTpr_Filters
		{
			...
			set {
				gxTv_SdtQueryViewerItemDoubleClickData_Filters_N = false;
		...
		protected bool gxTv_SdtQueryViewerItemDoubleClickData_Context_N;
		protected GXBaseCollection<SdtQueryViewerItemDoubleClickData_Element> gxTv_SdtQueryViewerItemDoubleClickData_Context = null; 

		protected bool gxTv_SdtQueryViewerItemDoubleClickData_Filters_N;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerItemDoubleClickData", Namespace="SIGERP_ADVANCED")]
