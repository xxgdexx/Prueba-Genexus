...
namespace GeneXus.Programs.activosfijos {
   public class r_reporteactivosvalorlibros : GXDataArea
   {
      public r_reporteactivosvalorlibros( )
      {
      ...
      public r_reporteactivosvalorlibros( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181032693", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("activosfijos.r_reporteactivosvalorlibros.aspx") +"\">") ;
      ...
      {
         return formatLink("activosfijos.r_reporteactivosvalorlibros.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "ActivosFijos.R_ReporteActivosValorLibros" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte de Activos Valor en Libros" ;
      }
      ...
      protected void WB6H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_actclacod_Internalname, "Tipo de Activo", "", "", lblTextblockcombo_actclacod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_actgrupcod_Internalname, "Grupo de Activo", "", "", lblTextblockcombo_actgrupcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockactactcod_Internalname, "Activo", "", "", lblTextblockactactcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_40_6H2( true) ;
         }
         else
         {
            wb_table1_40_6H2( false) ;
         }
         return  ;
      }

      protected void wb_table1_40_6H2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcano_Internalname, "Año", "", "", lblTextblockcano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCano_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cAno), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCano_Enabled!=0) ? context.localUtil.Format( (decimal)(AV12cAno), "ZZZ9") : context.localUtil.Format( (decimal)(AV12cAno), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCano_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavCano_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcmes_Internalname, "Mes", "", "", lblTextblockcmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCmes, cmbavCmes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV13cMes), 2, 0)), 1, cmbavCmes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavCmes.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "", true, 1, "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavActclacod_Internalname, AV8ACTClaCod, StringUtil.RTrim( context.localUtil.Format( AV8ACTClaCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,80);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavActclacod_Jsonclick, 0, "Attribute", "", "", "", "", edtavActclacod_Visible, 1, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 81,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavActgrupcod_Internalname, AV10ACTGrupCod, StringUtil.RTrim( context.localUtil.Format( AV10ACTGrupCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,81);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavActgrupcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavActgrupcod_Visible, 1, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ActivosFijos\\R_ReporteActivosValorLibros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6H2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte de Activos Valor en Libros", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E126H2( )
      {
         ...
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "activosfijos.r_activosvalorlibrospdf.aspx"+UrlEncode(StringUtil.RTrim(AV8ACTClaCod)) + "," + UrlEncode(StringUtil.RTrim(AV10ACTGrupCod)) + "," + UrlEncode(StringUtil.RTrim(AV5ACTActCod)) + "," + UrlEncode(StringUtil.RTrim(AV7ACTActItem)) + "," + UrlEncode(StringUtil.LTrimStr(AV12cAno,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV13cMes,2,0));
         Innewwindow_Target = formatLink("activosfijos.r_activosvalorlibrospdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S122( )
      {
         ...
         {
            A2197ACTGrupSts = H006H2_A2197ACTGrupSts[0];
            A2103ACTGrupCod = H006H2_A2103ACTGrupCod[0];
            A2196ACTGrupDsc = H006H2_A2196ACTGrupDsc[0];
      ...
      protected void S112( )
      {
         ...
         {
            A2185ACTClaSts = H006H3_A2185ACTClaSts[0];
            A426ACTClaCod = H006H3_A426ACTClaCod[0];
            A2184ACTClaDsc = H006H3_A2184ACTClaDsc[0];
            AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void wb_table1_40_6H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181032815", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("activosfijos/r_reporteactivosvalorlibros.js", "?20228181032815", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Activos Valor en Libros";
         ...
         Form.Caption = "Reporte de Activos Valor en Libros";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E126H2',iparms:[{av:'AV8ACTClaCod',fld:'vACTCLACOD',pic:''},{av:'AV10ACTGrupCod',fld:'vACTGRUPCOD',pic:''},{av:'AV5ACTActCod',fld:'vACTACTCOD',pic:''},{av:'AV7ACTActItem',fld:'vACTACTITEM',pic:'',hsh:true},{av:'AV12cAno',fld:'vCANO',pic:'ZZZ9'},{av:'cmbavCmes'},{av:'AV13cMes',fld:'vCMES',pic:'Z9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E136H2',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNBUSCARACT'","{handler:'E156H1',iparms:[{av:'AV5ACTActCod',fld:'vACTACTCOD',pic:''},{av:'AV6ACTActDsc',fld:'vACTACTDSC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H006H2_A426ACTClaCod = new string[] {""} ;
         H006H2_A2197ACTGrupSts = new short[1] ;
         H006H2_A2103ACTGrupCod = new string[] {""} ;
         H006H2_A2196ACTGrupDsc = new string[] {""} ;
         A2103ACTGrupCod = "";
         A2196ACTGrupDsc = "";
         AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H006H3_A2185ACTClaSts = new short[1] ;
         H006H3_A426ACTClaCod = new string[] {""} ;
         H006H3_A2184ACTClaDsc = new string[] {""} ;
         A426ACTClaCod = "";
         A2184ACTClaDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.activosfijos.r_reporteactivosvalorlibros__default(),
            new Object[][] {
                new Object[] {
               H006H2_A426ACTClaCod, H006H2_A2197ACTGrupSts, H006H2_A2103ACTGrupCod, H006H2_A2196ACTGrupDsc
               }
               , new Object[] {
               H006H3_A2185ACTClaSts, H006H3_A426ACTClaCod, H006H3_A2184ACTClaDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] H006H2_A426ACTClaCod ;
      private short[] H006H2_A2197ACTGrupSts ;
      private string[] H006H2_A2103ACTGrupCod ;
      private string[] H006H2_A2196ACTGrupDsc ;
      private short[] H006H3_A2185ACTClaSts ;
      private string[] H006H3_A426ACTClaCod ;
      private string[] H006H3_A2184ACTClaDsc ;
   ...
   public class r_reporteactivosvalorlibros__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006H2", "SELECT [ACTClaCod], [ACTGrupSts], [ACTGrupCod], [ACTGrupDsc] FROM [ACTGRUPO] WHERE [ACTGrupSts] = 1 ORDER BY [ACTGrupDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006H2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006H3", "SELECT [ACTClaSts], [ACTClaCod], [ACTClaDsc] FROM [ACTCLASE] WHERE [ACTClaSts] = 1 ORDER BY [ACTClaDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006H3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
