...
namespace GeneXus.Programs.activosfijos {
   public class r_reporteretirospdf : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "activosfijos.r_reporteretirospdf.aspx")), "activosfijos.r_reporteretirospdf.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "activosfijos.r_reporteretirospdf.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public r_reporteretirospdf( IGxContext context )
      {
      ...
      public void executeSubmit( ref string aP0_ACTClaCod ,
                                 ...
                                 ref short aP5_Mes )
      {
         r_reporteretirospdf objr_reporteretirospdf;
         objr_reporteretirospdf = new r_reporteretirospdf();
         objr_reporteretirospdf.AV16ACTClaCod = aP0_ACTClaCod;
         objr_reporteretirospdf.AV26ACTGrupCod = aP1_ACTGrupCod;
         objr_reporteretirospdf.AV8ACTActCod = aP2_ACTActCod;
         objr_reporteretirospdf.AV11ActActItem = aP3_ActActItem;
         objr_reporteretirospdf.AV37Ano = aP4_Ano;
         objr_reporteretirospdf.AV68Mes = aP5_Mes;
         objr_reporteretirospdf.context.SetSubmitInitialConfig(context);
         objr_reporteretirospdf.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_reporteretirospdf);
         aP0_ACTClaCod=this.AV16ACTClaCod;
         aP1_ACTGrupCod=this.AV26ACTGrupCod;
         aP2_ACTActCod=this.AV8ACTActCod;
         aP3_ActActItem=this.AV11ActActItem;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_reporteretirospdf)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV94Titulo = "Reporte de Retiros de Activos";
            GXt_char1 = AV39cMes;
            ...
            {
               A2114ACTSGrupCod = P00FA2_A2114ACTSGrupCod[0];
               A2159ACTRetFec = P00FA2_A2159ACTRetFec[0];
               A2104ActActItem = P00FA2_A2104ActActItem[0];
               n2104ActActItem = P00FA2_n2104ActActItem[0];
               A2100ACTActCod = P00FA2_A2100ACTActCod[0];
               A2103ACTGrupCod = P00FA2_A2103ACTGrupCod[0];
               A426ACTClaCod = P00FA2_A426ACTClaCod[0];
               A2118ACTActCodEQV = P00FA2_A2118ACTActCodEQV[0];
               A2155ACTSGrupDsc = P00FA2_A2155ACTSGrupDsc[0];
               A2122ACTActDsc = P00FA2_A2122ACTActDsc[0];
               A2156ACTSGrupPor = P00FA2_A2156ACTSGrupPor[0];
               A2158ACTRetDepre = P00FA2_A2158ACTRetDepre[0];
               A2105ACTRetCod = P00FA2_A2105ACTRetCod[0];
               A2103ACTGrupCod = P00FA2_A2103ACTGrupCod[0];
               A426ACTClaCod = P00FA2_A426ACTClaCod[0];
               A2118ACTActCodEQV = P00FA2_A2118ACTActCodEQV[0];
               A2122ACTActDsc = P00FA2_A2122ACTActDsc[0];
               ...
               A2155ACTSGrupDsc = P00FA2_A2155ACTSGrupDsc[0];
               A2156ACTSGrupPor = P00FA2_A2156ACTSGrupPor[0];
               AV19ACTDetFecIni = A2159ACTRetFec;
      ...
      protected void S111( )
      {
         ...
         {
            A2104ActActItem = P00FA3_A2104ActActItem[0];
            n2104ActActItem = P00FA3_n2104ActActItem[0];
            A2100ACTActCod = P00FA3_A2100ACTActCod[0];
            A2150ACTDetValorNeto = P00FA3_A2150ACTDetValorNeto[0];
         ...
         {
            A2204AMRepFec = P00FA4_A2204AMRepFec[0];
            A2100ACTActCod = P00FA4_A2100ACTActCod[0];
            A2209AMRepValor = P00FA4_A2209AMRepValor[0];
            A2104ActActItem = P00FA4_A2104ActActItem[0];
            n2104ActActItem = P00FA4_n2104ActActItem[0];
            A2112AMRepCod = P00FA4_A2112AMRepCod[0];
            AV24ACTDetValorReparacion = (decimal)(AV24ACTDetValorReparacion+((String.IsNullOrEmpty(StringUtil.RTrim( A2104ActActItem))||P00FA4_n2104ActActItem[0] ? NumberUtil.Round( (A2209AMRepValor*AV79Porcentaje)/ (decimal)(100), 2) : ((StringUtil.StrCmp(A2104ActActItem, AV11ActActItem)==0) ? A2209AMRepValor : (decimal)(0)))));
         ...
         {
            A2218ACTRevFec = P00FA5_A2218ACTRevFec[0];
            A2100ACTActCod = P00FA5_A2100ACTActCod[0];
            A2217ActRevCosto = P00FA5_A2217ActRevCosto[0];
            A2104ActActItem = P00FA5_A2104ActActItem[0];
            n2104ActActItem = P00FA5_n2104ActActItem[0];
            A2113ACTRevCod = P00FA5_A2113ACTRevCod[0];
            AV23ACTDetValorCompras = (decimal)(AV23ACTDetValorCompras+((String.IsNullOrEmpty(StringUtil.RTrim( A2104ActActItem))||P00FA5_n2104ActActItem[0] ? NumberUtil.Round( (A2217ActRevCosto*AV79Porcentaje)/ (decimal)(100), 2) : ((StringUtil.StrCmp(A2104ActActItem, AV11ActActItem)==0) ? A2217ActRevCosto : (decimal)(0)))));
            pr_default.readNext(3);
         }
         pr_default.close(3);
      }

      protected void HFA0( bool bFoot ,
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               ...
               getPrinter().GxDrawText("DEPRECIACIÓN RETIRO", 694, Gx_line+85, 795, Gx_line+95, 0+256, 0, 0, 0) ;
               ...
               getPrinter().GxDrawText("RETIRO ACTIVO", 607, Gx_line+85, 675, Gx_line+95, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
      ...
      public override void initialize( )
      {
         ...
         P00FA2_A2114ACTSGrupCod = new string[] {""} ;
         P00FA2_A2159ACTRetFec = new DateTime[] {DateTime.MinValue} ;
         P00FA2_A2104ActActItem = new string[] {""} ;
         P00FA2_n2104ActActItem = new bool[] {false} ;
         P00FA2_A2100ACTActCod = new string[] {""} ;
         P00FA2_A2103ACTGrupCod = new string[] {""} ;
         P00FA2_A426ACTClaCod = new string[] {""} ;
         P00FA2_A2118ACTActCodEQV = new string[] {""} ;
         P00FA2_A2155ACTSGrupDsc = new string[] {""} ;
         P00FA2_A2122ACTActDsc = new string[] {""} ;
         P00FA2_A2156ACTSGrupPor = new decimal[1] ;
         P00FA2_A2158ACTRetDepre = new decimal[1] ;
         P00FA2_A2105ACTRetCod = new string[] {""} ;
         A2114ACTSGrupCod = "";
         A2118ACTActCodEQV = "";
         A2155ACTSGrupDsc = "";
         A2122ACTActDsc = "";
         ...
         AV28ACTSGrupDsc = "";
         AV25ActDsc = "";
         P00FA3_A2104ActActItem = new string[] {""} ;
         P00FA3_n2104ActActItem = new bool[] {false} ;
         P00FA3_A2100ACTActCod = new string[] {""} ;
         P00FA3_A2150ACTDetValorNeto = new decimal[1] ;
         P00FA4_A2204AMRepFec = new DateTime[] {DateTime.MinValue} ;
         P00FA4_A2100ACTActCod = new string[] {""} ;
         P00FA4_A2209AMRepValor = new decimal[1] ;
         P00FA4_A2104ActActItem = new string[] {""} ;
         P00FA4_n2104ActActItem = new bool[] {false} ;
         P00FA4_A2112AMRepCod = new string[] {""} ;
         A2204AMRepFec = DateTime.MinValue;
         A2112AMRepCod = "";
         P00FA5_A2218ACTRevFec = new DateTime[] {DateTime.MinValue} ;
         P00FA5_A2100ACTActCod = new string[] {""} ;
         P00FA5_A2217ActRevCosto = new decimal[1] ;
         P00FA5_A2104ActActItem = new string[] {""} ;
         P00FA5_n2104ActActItem = new bool[] {false} ;
         P00FA5_A2113ACTRevCod = new string[] {""} ;
         A2218ACTRevFec = DateTime.MinValue;
         A2113ACTRevCod = "";
         Gx_time = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.activosfijos.r_reporteretirospdf__default(),
            new Object[][] {
                new Object[] {
               P00FA2_A2114ACTSGrupCod, P00FA2_A2159ACTRetFec, P00FA2_A2104ActActItem, P00FA2_n2104ActActItem, P00FA2_A2100ACTActCod, P00FA2_A2103ACTGrupCod, P00FA2_A426ACTClaCod, P00FA2_A2118ACTActCodEQV, P00FA2_A2155ACTSGrupDsc, P00FA2_A2122ACTActDsc,
               P00FA2_A2156ACTSGrupPor, P00FA2_A2158ACTRetDepre, P00FA2_A2105ACTRetCod
               }
               , new Object[] {
               P00FA3_A2104ActActItem, P00FA3_A2100ACTActCod, P00FA3_A2150ACTDetValorNeto
               }
               , new Object[] {
               P00FA4_A2204AMRepFec, P00FA4_A2100ACTActCod, P00FA4_A2209AMRepValor, P00FA4_A2104ActActItem, P00FA4_n2104ActActItem, P00FA4_A2112AMRepCod
               }
               , new Object[] {
               P00FA5_A2218ACTRevFec, P00FA5_A2100ACTActCod, P00FA5_A2217ActRevCosto, P00FA5_A2104ActActItem, P00FA5_n2104ActActItem, P00FA5_A2113ACTRevCod
               }
            }
         );
      ...
      private string[] P00FA2_A2114ACTSGrupCod ;
      private DateTime[] P00FA2_A2159ACTRetFec ;
      private string[] P00FA2_A2104ActActItem ;
      private bool[] P00FA2_n2104ActActItem ;
      private string[] P00FA2_A2100ACTActCod ;
      private string[] P00FA2_A2103ACTGrupCod ;
      private string[] P00FA2_A426ACTClaCod ;
      private string[] P00FA2_A2118ACTActCodEQV ;
      private string[] P00FA2_A2155ACTSGrupDsc ;
      private string[] P00FA2_A2122ACTActDsc ;
      private decimal[] P00FA2_A2156ACTSGrupPor ;
      private decimal[] P00FA2_A2158ACTRetDepre ;
      private string[] P00FA2_A2105ACTRetCod ;
      private string[] P00FA3_A2104ActActItem ;
      private bool[] P00FA3_n2104ActActItem ;
      private string[] P00FA3_A2100ACTActCod ;
      private decimal[] P00FA3_A2150ACTDetValorNeto ;
      private DateTime[] P00FA4_A2204AMRepFec ;
      private string[] P00FA4_A2100ACTActCod ;
      private decimal[] P00FA4_A2209AMRepValor ;
      private string[] P00FA4_A2104ActActItem ;
      private bool[] P00FA4_n2104ActActItem ;
      private string[] P00FA4_A2112AMRepCod ;
      private DateTime[] P00FA5_A2218ACTRevFec ;
      private string[] P00FA5_A2100ACTActCod ;
      private decimal[] P00FA5_A2217ActRevCosto ;
      private string[] P00FA5_A2104ActActItem ;
      private bool[] P00FA5_n2104ActActItem ;
      private string[] P00FA5_A2113ACTRevCod ;
   }

   public class r_reporteretirospdf__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV37Ano )
      {
         ...
         scmdbuf = "SELECT T3.[ACTSGrupCod], T1.[ACTRetFec], T1.[ActActItem], T1.[ACTActCod], T2.[ACTGrupCod], T2.[ACTClaCod], T2.[ACTActCodEQV], T4.[ACTSGrupDsc], T2.[ACTActDsc], T4.[ACTSGrupPor], T1.[ACTRetDepre], T1.[ACTRetCod] FROM ((([ACTRETIROACTIVO] T1 INNER JOIN [ACTACTIVOS] T2 ON T2.[ACTActCod] = T1.[ACTActCod]) LEFT JOIN [ACTACTIVOSDET] T3 ON T3.[ACTActCod] = T1.[ACTActCod] AND T3.[ActActItem] = T1.[ActActItem]) LEFT JOIN [ACTSUBGRUPO] T4 ON T4.[ACTClaCod] = T2.[ACTClaCod] AND T4.[ACTGrupCod] = T2.[ACTGrupCod] AND T4.[ACTSGrupCod] = T3.[ACTSGrupCod])";
         AddWhere(sWhereString, "(YEAR(T1.[ACTRetFec]) = @AV37Ano)");
         ...
         if ( ! (0==AV68Mes) )
         {
            AddWhere(sWhereString, "(MONTH(T1.[ACTRetFec]) = @AV68Mes)");
         }
         else
         {
            GXv_int3[5] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00FA2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00FA3", "SELECT [ActActItem], [ACTActCod], [ACTDetValorNeto] FROM [ACTACTIVOSDET] WHERE [ACTActCod] = @AV17ActCod and [ActActItem] = @AV27ActItem ORDER BY [ACTActCod], [ActActItem] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00FA3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00FA4", "SELECT [AMRepFec], [ACTActCod], [AMRepValor], [ActActItem], [AMRepCod] FROM [ACTMOVREPARACION] WHERE ([ACTActCod] = @AV17ActCod) AND ([AMRepFec] > @AV19ACTDetFecIni) AND ([AMRepFec] <= @AV55FechaUlt) ORDER BY [ACTActCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00FA4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00FA5", "SELECT [ACTRevFec], [ACTActCod], [ActRevCosto], [ActActItem], [ACTRevCod] FROM [ACTRevaluacion] WHERE ([ACTActCod] = @AV17ActCod) AND ([ACTRevFec] > @AV19ACTDetFecIni) AND ([ACTRevFec] <= @AV55FechaUlt) ORDER BY [ACTActCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00FA5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
