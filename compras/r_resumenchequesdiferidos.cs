...
namespace GeneXus.Programs.compras {
   public class r_resumenchequesdiferidos : GXDataArea
   {
      public r_resumenchequesdiferidos( )
      {
      ...
      public r_resumenchequesdiferidos( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031426", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_resumenchequesdiferidos.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPPCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16TipPCod), "ZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTPRVCOD_DATA", AV15TprvCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTPRVCOD_DATA", AV15TprvCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vESTCOD_DATA", AV7EstCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vESTCOD_DATA", AV7EstCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vTIPPCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16TipPCod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPPCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16TipPCod), "ZZZZZ9"), context));
      ...
      {
         return formatLink("compras.r_resumenchequesdiferidos.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_ResumenChequesDiferidos" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Cheques Diferidos por periodos" ;
      }
      ...
      protected void WB3S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tprvcod_Internalname, "Tipo de Proveedor", "", "", lblTextblockcombo_tprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            ucCombo_tprvcod.SetProperty("DropDownOptionsData", AV15TprvCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_estcod_Internalname, "Estado", "", "", lblTextblockcombo_estcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_estcod.SetProperty("DropDownOptionsData", AV7EstCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprvcod_Internalname, "Proveedor", "", "", lblTextblockprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_40_3S2( true) ;
         }
         else
         {
            wb_table1_40_3S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_40_3S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockflag_Internalname, "Periodo", "", "", lblTextblockflag_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavFlag, radavFlag_Internalname, StringUtil.Str( (decimal)(AV9Flag), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavFlag_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,65);\"", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV8Fdesde, "99/99/99"), context.localUtil.Format( AV8Fdesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTprvcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14TprvCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14TprvCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,88);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTprvcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTprvcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 89,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEstcod_Internalname, StringUtil.RTrim( AV6EstCod), StringUtil.RTrim( context.localUtil.Format( AV6EstCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEstcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavEstcod_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 90,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Cheques Diferidos por periodos", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         AV9Flag = (short)(context.localUtil.CToN( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9Flag), 1, 0, ".", "")), ".", ","));
         AssignAttri("", false, "AV9Flag", StringUtil.Str( (decimal)(AV9Flag), 1, 0));
      }
      ...
      protected void STRUP3S0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vTPRVCOD_DATA"), AV15TprvCod_Data);
            ajax_req_read_hidden_sdt(cgiGet( "vESTCOD_DATA"), AV7EstCod_Data);
            ...
            AV12PrvCod = StringUtil.Upper( cgiGet( edtavPrvcod_Internalname));
            AssignAttri("", false, "AV12PrvCod", AV12PrvCod);
            AV13PrvDsc = cgiGet( edtavPrvdsc_Internalname);
            AssignAttri("", false, "AV13PrvDsc", AV13PrvDsc);
            ...
            {
               AV9Flag = (short)(context.localUtil.CToN( cgiGet( radavFlag_Internalname), ".", ","));
               AssignAttri("", false, "AV9Flag", StringUtil.Str( (decimal)(AV9Flag), 1, 0));
            }
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavTprvcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavTprvcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV14TprvCod = 0;
               AssignAttri("", false, "AV14TprvCod", StringUtil.LTrimStr( (decimal)(AV14TprvCod), 6, 0));
            }
            else
            {
               AV14TprvCod = (int)(context.localUtil.CToN( cgiGet( edtavTprvcod_Internalname), ".", ","));
               AssignAttri("", false, "AV14TprvCod", StringUtil.LTrimStr( (decimal)(AV14TprvCod), 6, 0));
            }
      ...
      protected void E123S2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compras.r_resumenchequesdiferidospdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV16TipPCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV12PrvCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV10MonCod,6,0)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV8Fdesde)) + "," + UrlEncode(StringUtil.LTrimStr(AV9Flag,1,0));
         Innewwindow_Target = formatLink("compras.r_resumenchequesdiferidospdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S132( )
      {
         ...
         {
            A1235MonSts = H003S2_A1235MonSts[0];
            A180MonCod = H003S2_A180MonCod[0];
            A1234MonDsc = H003S2_A1234MonDsc[0];
      ...
      protected void S122( )
      {
         ...
         {
            A975EstSts = H003S3_A975EstSts[0];
            A140EstCod = H003S3_A140EstCod[0];
            A602EstDsc = H003S3_A602EstDsc[0];
            AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV5Combo_DataItem.gxTpr_Id = A140EstCod;
            AV5Combo_DataItem.gxTpr_Title = A602EstDsc;
            AV7EstCod_Data.Add(AV5Combo_DataItem, 0);
      ...
      protected void S112( )
      {
         ...
         {
            A1942TprvSts = H003S4_A1942TprvSts[0];
            A298TprvCod = H003S4_A298TprvCod[0];
            A1941TprvDsc = H003S4_A1941TprvDsc[0];
            AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            AV15TprvCod_Data.Add(AV5Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_tprvcod_Selectedvalue_set = ((0==AV14TprvCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV14TprvCod), 6, 0)));
      ...
      protected void wb_table1_40_3S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvcod_Internalname, StringUtil.RTrim( AV12PrvCod), StringUtil.RTrim( context.localUtil.Format( AV12PrvCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavPrvcod_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Proveedor", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e153s1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvdsc_Internalname, StringUtil.RTrim( AV13PrvDsc), StringUtil.RTrim( context.localUtil.Format( AV13PrvDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvdsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavPrvdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_ResumenChequesDiferidos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_40_3S2e( true) ;
         }
         else
         {
            wb_table1_40_3S2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031585", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_resumenchequesdiferidos.js", "?20228181031585", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Resumen de Cheques Diferidos por periodos";
         ...
         Form.Caption = "Resumen de Cheques Diferidos por periodos";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV16TipPCod',fld:'vTIPPCOD',pic:'ZZZZZ9',hsh:true},{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E123S2',iparms:[{av:'AV16TipPCod',fld:'vTIPPCOD',pic:'ZZZZZ9',hsh:true},{av:'AV12PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV10MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV8Fdesde',fld:'vFDESDE',pic:''},{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E133S2',iparms:[{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E153S1',iparms:[{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV13PrvDsc',fld:'vPRVDSC',pic:''},{av:'AV12PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavFlag'},{av:'AV9Flag',fld:'vFLAG',pic:'9'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV15TprvCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV7EstCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H003S2_A1235MonSts = new short[1] ;
         H003S2_A180MonCod = new int[1] ;
         H003S2_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H003S3_A139PaiCod = new string[] {""} ;
         H003S3_A975EstSts = new short[1] ;
         H003S3_A140EstCod = new string[] {""} ;
         H003S3_A602EstDsc = new string[] {""} ;
         A140EstCod = "";
         A602EstDsc = "";
         H003S4_A1942TprvSts = new short[1] ;
         H003S4_A298TprvCod = new int[1] ;
         H003S4_A1941TprvDsc = new string[] {""} ;
         A1941TprvDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_resumenchequesdiferidos__default(),
            new Object[][] {
                new Object[] {
               H003S2_A1235MonSts, H003S2_A180MonCod, H003S2_A1234MonDsc
               }
               , new Object[] {
               H003S3_A139PaiCod, H003S3_A975EstSts, H003S3_A140EstCod, H003S3_A602EstDsc
               }
               , new Object[] {
               H003S4_A1942TprvSts, H003S4_A298TprvCod, H003S4_A1941TprvDsc
               }
            }
         );
         AV10MonCod = 1;
      ...
      private short[] H003S2_A1235MonSts ;
      private int[] H003S2_A180MonCod ;
      private string[] H003S2_A1234MonDsc ;
      private string[] H003S3_A139PaiCod ;
      private short[] H003S3_A975EstSts ;
      private string[] H003S3_A140EstCod ;
      private string[] H003S3_A602EstDsc ;
      private short[] H003S4_A1942TprvSts ;
      private int[] H003S4_A298TprvCod ;
      private string[] H003S4_A1941TprvDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV15TprvCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV7EstCod_Data ;
   ...
   public class r_resumenchequesdiferidos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH003S4;
          prmH003S4 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H003S2", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003S2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003S3", "SELECT [PaiCod], [EstSts], [EstCod], [EstDsc] FROM [CESTADOS] WHERE [EstSts] = 1 ORDER BY [EstDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003S3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H003S4", "SELECT [TprvSts], [TprvCod], [TprvDsc] FROM [CTIPOPROVEEDOR] WHERE [TprvSts] = 1 ORDER BY [TprvDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003S4,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
