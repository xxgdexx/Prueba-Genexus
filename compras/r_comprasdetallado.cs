...
namespace GeneXus.Programs.compras {
   public class r_comprasdetallado : GXDataArea
   {
      public r_comprasdetallado( )
      {
      ...
      public r_comprasdetallado( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031859", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_comprasdetallado.aspx") +"\">") ;
      ...
      {
         return formatLink("compras.r_comprasdetallado.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_ComprasDetallado" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte de Compras Detallado" ;
      }
      ...
      protected void WB420( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprvcod_Internalname, "Proveedor", "", "", lblTextblockprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_25_422( true) ;
         }
         else
         {
            wb_table1_25_422( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_422e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_42_422( true) ;
         }
         else
         {
            wb_table2_42_422( false) ;
         }
         return  ;
      }

      protected void wb_table2_42_422e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcuecod_Internalname, "Cuenta Gasto", "", "", lblTextblockcuecod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table3_59_422( true) ;
         }
         else
         {
            wb_table3_59_422( false) ;
         }
         return  ;
      }

      protected void wb_table3_59_422e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV12Fdesde, "99/99/99"), context.localUtil.Format( AV12Fdesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ComprasDetallado.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV13Fhasta, "99/99/99"), context.localUtil.Format( AV13Fhasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,93);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ComprasDetallado.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableopc_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockopc_Internalname, "Ordenado Por", "", "", lblTextblockopc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", "Opc", "col-sm-3 AttributeCheckBoxLabel", 0, true, "");
            /* Radio button */
            ClassString = "AttributeCheckBox";
            StyleString = "";
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 101,'',false,'',0)\"";
            GxWebStd.gx_radio_ctrl( context, radavOpc, radavOpc_Internalname, StringUtil.Str( (decimal)(AV14Opc), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavOpc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,101);\"", "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,117);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START422( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte de Compras Detallado", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         AV14Opc = (short)(context.localUtil.CToN( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14Opc), 1, 0, ".", "")), ".", ","));
         AssignAttri("", false, "AV14Opc", StringUtil.Str( (decimal)(AV14Opc), 1, 0));
      }
      ...
      protected void initialize_formulas( )
      {
         ...
         edtavCuedsc_Enabled = 0;
         AssignProp("", false, edtavCuedsc_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavCuedsc_Enabled), 5, 0), true);
      }
      ...
      protected void STRUP420( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV9CueCod = cgiGet( edtavCuecod_Internalname);
            AssignAttri("", false, "AV9CueCod", AV9CueCod);
            AV10CueDsc = cgiGet( edtavCuedsc_Internalname);
            AssignAttri("", false, "AV10CueDsc", AV10CueDsc);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( radavOpc_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( radavOpc_Internalname), ".", ",") > Convert.ToDecimal( 9 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vOPC");
               wbErr = true;
               AV14Opc = 0;
               AssignAttri("", false, "AV14Opc", StringUtil.Str( (decimal)(AV14Opc), 1, 0));
            }
            ...
            {
               AV14Opc = (short)(context.localUtil.CToN( cgiGet( radavOpc_Internalname), ".", ","));
               AssignAttri("", false, "AV14Opc", StringUtil.Str( (decimal)(AV14Opc), 1, 0));
            }
      ...
      protected void E12422( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compras.r_comprasdetalladopdf.aspx"+UrlEncode(StringUtil.RTrim(AV9CueCod)) + "," + UrlEncode(StringUtil.RTrim(AV7ProdCod)) + "," + UrlEncode(StringUtil.RTrim(AV5PrvCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV11MonCod,6,0)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12Fdesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV13Fhasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV14Opc,1,0));
         Innewwindow_Target = formatLink("compras.r_comprasdetalladopdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E13422( )
      {
         /* 'DoBtnExcel' Routine */
         returnInSub = false;
         new GeneXus.Programs.compras.r_comprasdetalladoexcel(context ).execute( ref  AV9CueCod, ref  AV7ProdCod, ref  AV5PrvCod, ref  AV11MonCod, ref  AV12Fdesde, ref  AV13Fhasta, out  AV17ExcelFilename, out  AV18ErrorMessage) ;
         AssignAttri("", false, "AV9CueCod", AV9CueCod);
         AssignAttri("", false, "AV7ProdCod", AV7ProdCod);
         AssignAttri("", false, "AV5PrvCod", AV5PrvCod);
         AssignAttri("", false, "AV11MonCod", StringUtil.LTrimStr( (decimal)(AV11MonCod), 6, 0));
      ...
      protected void S112( )
      {
         ...
         {
            A1235MonSts = H00422_A1235MonSts[0];
            A180MonCod = H00422_A180MonCod[0];
            A1234MonDsc = H00422_A1234MonDsc[0];
            ...
            AV15MonCod_Data.Add(AV16Combo_DataItem, 0);
      ...
      protected void wb_table3_59_422( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedcuecod_Internalname, tblTablemergedcuecod_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='MergeDataCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCuecod_Internalname, "Cuenta", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCuecod_Internalname, StringUtil.RTrim( AV9CueCod), StringUtil.RTrim( context.localUtil.Format( AV9CueCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCuecod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCuecod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtngasto_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Gasto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtngasto_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16421_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ComprasDetallado.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCuedsc_Internalname, "Descripción de Cuenta", "gx-form-item ReadonlyAttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 68,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCuedsc_Internalname, StringUtil.RTrim( AV10CueDsc), StringUtil.RTrim( context.localUtil.Format( AV10CueDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,68);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCuedsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavCuedsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_ComprasDetallado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_59_422e( true) ;
         }
         else
         {
            wb_table3_59_422e( false) ;
         }
      }

      protected void wb_table2_42_422( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnproduc_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnproduc_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17421_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ComprasDetallado.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
      ...
      protected void wb_table1_25_422( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnprov_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Proveedor", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnprov_Jsonclick, "'"+""+"'"+",false,"+"'"+"e18421_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ComprasDetallado.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031980", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_comprasdetallado.js", "?20228181031981", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         radavOpc.Name = "vOPC";
         radavOpc.WebTags = "";
         radavOpc.addItem("1", "Fecha", 0);
         radavOpc.addItem("2", "Proveedor", 0);
      ...
      protected void init_default_properties( )
      {
         ...
         imgBtnproduc_Internalname = "BTNPRODUC";
         ...
         edtavCuecod_Internalname = "vCUECOD";
         imgBtngasto_Internalname = "BTNGASTO";
         edtavCuedsc_Internalname = "vCUEDSC";
         tblTablemergedcuecod_Internalname = "TABLEMERGEDCUECOD";
         ...
         lblTextblockopc_Internalname = "TEXTBLOCKOPC";
         radavOpc_Internalname = "vOPC";
         divUnnamedtableopc_Internalname = "UNNAMEDTABLEOPC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCuedsc_Jsonclick = "";
         edtavCuedsc_Enabled = 1;
         edtavCuecod_Jsonclick = "";
         edtavCuecod_Enabled = 1;
         ...
         Dvpanel_panel1_Title = "Reporte de Compras Detallado";
         ...
         Form.Caption = "Reporte de Compras Detallado";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12422',iparms:[{av:'AV9CueCod',fld:'vCUECOD',pic:''},{av:'AV7ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV11MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV12Fdesde',fld:'vFDESDE',pic:''},{av:'AV13Fhasta',fld:'vFHASTA',pic:''},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E13422',iparms:[{av:'AV9CueCod',fld:'vCUECOD',pic:''},{av:'AV7ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV5PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV11MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV12Fdesde',fld:'vFDESDE',pic:''},{av:'AV13Fhasta',fld:'vFHASTA',pic:''},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV13Fhasta',fld:'vFHASTA',pic:''},{av:'AV12Fdesde',fld:'vFDESDE',pic:''},{av:'AV11MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV5PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV7ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV9CueCod',fld:'vCUECOD',pic:''},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E14422',iparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("'DOBTNPROV'","{handler:'E18421',iparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("'DOBTNPROV'",",oparms:[{av:'AV6PrvDsc',fld:'vPRVDSC',pic:''},{av:'AV5PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("'DOBTNPRODUC'","{handler:'E17421',iparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("'DOBTNPRODUC'",",oparms:[{av:'AV8ProdDsc',fld:'vPRODDSC',pic:''},{av:'AV7ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("'DOBTNGASTO'","{handler:'E16421',iparms:[{av:'AV9CueCod',fld:'vCUECOD',pic:''},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("'DOBTNGASTO'",",oparms:[{av:'AV10CueDsc',fld:'vCUEDSC',pic:''},{av:'AV9CueCod',fld:'vCUECOD',pic:''},{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'radavOpc'},{av:'AV14Opc',fld:'vOPC',pic:'9'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV18ErrorMessage = "";
         scmdbuf = "";
         H00422_A1235MonSts = new short[1] ;
         H00422_A180MonCod = new int[1] ;
         H00422_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         sStyleString = "";
         sImgUrl = "";
         imgBtngasto_Jsonclick = "";
         imgBtnproduc_Jsonclick = "";
         imgBtnprov_Jsonclick = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_comprasdetallado__default(),
            new Object[][] {
                new Object[] {
               H00422_A1235MonSts, H00422_A180MonCod, H00422_A1234MonDsc
               }
            }
         );
         AV11MonCod = 1;
      ...
      private int edtavCuedsc_Enabled ;
      private int A180MonCod ;
      private int edtavCuecod_Enabled ;
      ...
      private string divUnnamedtableopc_Internalname ;
      private string lblTextblockopc_Internalname ;
      private string lblTextblockopc_Jsonclick ;
      private string radavOpc_Internalname ;
      private string radavOpc_Jsonclick ;
      ...
      private string edtavCuedsc_Internalname ;
      ...
      private string edtavCuecod_Internalname ;
      private string AV10CueDsc ;
      private string GXEncryptionTmp ;
      private string scmdbuf ;
      private string A1234MonDsc ;
      private string sStyleString ;
      private string tblTablemergedcuecod_Internalname ;
      private string edtavCuecod_Jsonclick ;
      private string sImgUrl ;
      private string imgBtngasto_Internalname ;
      private string imgBtngasto_Jsonclick ;
      private string edtavCuedsc_Jsonclick ;
      private string tblTablemergedprodcod_Internalname ;
      private string edtavProdcod_Jsonclick ;
      private string imgBtnproduc_Internalname ;
      private string imgBtnproduc_Jsonclick ;
      ...
      private GXRadio radavOpc ;
      private IDataStoreProvider pr_default ;
      private short[] H00422_A1235MonSts ;
      private int[] H00422_A180MonCod ;
      private string[] H00422_A1234MonDsc ;
   ...
   public class r_comprasdetallado__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00422", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00422,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
