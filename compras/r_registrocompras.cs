...
namespace GeneXus.Programs.compras {
   public class r_registrocompras : GXDataArea
   {
      public r_registrocompras( )
      {
      ...
      public r_registrocompras( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031342", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_registrocompras.aspx") +"\">") ;
      ...
      {
         return formatLink("compras.r_registrocompras.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_RegistroCompras" ;
      }
      ...
      protected void WB3V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjano_Internalname, "Año", "", "", lblTextblockjano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavJano_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5jAno), 4, 0, ".", "")), StringUtil.LTrim( ((edtavJano_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5jAno), "ZZZ9") : context.localUtil.Format( (decimal)(AV5jAno), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavJano_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavJano_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjmes_Internalname, "Mes", "", "", lblTextblockjmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockorden_Internalname, "Orden", "", "", lblTextblockorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavOrden, radavOrden_Internalname, StringUtil.RTrim( AV7Orden), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavOrden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_RegistroCompras.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3V2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Registro de Compras", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E123V2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compras.r_registrocompraspdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV5jAno,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6jMes,2,0)) + "," + UrlEncode(StringUtil.RTrim(AV7Orden));
         Innewwindow_Target = formatLink("compras.r_registrocompraspdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void E133V2( )
      {
         /* 'DoBtnExcel' Routine */
         returnInSub = false;
         new pregistrocomprasexcel(context ).execute( ref  AV5jAno, ref  AV6jMes, ref  AV7Orden, out  AV8ExcelFilename, out  AV9ErrorMessage) ;
         AssignAttri("", false, "AV5jAno", StringUtil.LTrimStr( (decimal)(AV5jAno), 4, 0));
         AssignAttri("", false, "AV6jMes", StringUtil.LTrimStr( (decimal)(AV6jMes), 2, 0));
         AssignAttri("", false, "AV7Orden", AV7Orden);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228181031388", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_registrocompras.js", "?20228181031388", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         radavOrden.addItem("N", "N° Registro", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Registro de Compras";
         ...
         Form.Caption = "Registro de Compras";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E123V2',iparms:[{av:'AV5jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV6jMes',fld:'vJMES',pic:'Z9'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E133V2',iparms:[{av:'AV5jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV6jMes',fld:'vJMES',pic:'Z9'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'cmbavJmes'},{av:'AV6jMes',fld:'vJMES',pic:'Z9'},{av:'AV5jAno',fld:'vJANO',pic:'ZZZ9'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E143V2',iparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''}]}");
         return  ;
      }
