...
namespace GeneXus.Programs.compras {
   public class r_ordenesdetalle : GXDataArea
   {
      public r_ordenesdetalle( )
      {
      ...
      public r_ordenesdetalle( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxSuggest"+"_"+"vORDCOD") == 0 )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810305047", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_ordenesdetalle.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14ProdCod, "@!")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_vLINCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9Lincod), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_vOPC", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Opc), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOSCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6CosCod, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPORDEN", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV17TipOrden, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTPRVCOD_DATA", AV19TprvCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTPRVCOD_DATA", AV19TprvCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vPRODCOD", StringUtil.RTrim( AV14ProdCod));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14ProdCod, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vLINCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9Lincod), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vLINCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9Lincod), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vOPC", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Opc), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vOPC", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12Opc), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vCOSCOD", StringUtil.RTrim( AV6CosCod));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOSCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6CosCod, "")), context));
         GxWebStd.gx_hidden_field( context, "vTIPORDEN", AV17TipOrden);
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPORDEN", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV17TipOrden, "")), context));
      ...
      {
         return formatLink("compras.r_ordenesdetalle.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_OrdenesDetalle" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte Detalle de Ordenes de Compra" ;
      }
      ...
      protected void WB330( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprvcod_Internalname, "Proveedor", "", "", lblTextblockprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
      ...
      protected void wb_table1_25_332e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_tprvcod_Internalname, "Tipo de Proveedor", "", "", lblTextblockcombo_tprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_tprvcod.SetProperty("DropDownOptionsData", AV19TprvCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableordcod_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockordcod_Internalname, "N° Orden", "", "", lblTextblockordcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavOrdcod_Internalname, "N° Orden", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 57,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdcod_Internalname, StringUtil.RTrim( AV13OrdCod), StringUtil.RTrim( context.localUtil.Format( AV13OrdCod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavOrdcod_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, 0, 0, true, "", "left", true, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Deste", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV7Fdesde, "99/99/99"), context.localUtil.Format( AV7Fdesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV8Fhasta, "99/99/99"), context.localUtil.Format( AV8Fhasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,75);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTprvcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18TprvCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV18TprvCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTprvcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavTprvcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 90,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START332( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte Detalle de Ordenes de Compra", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXSGVvORDCOD330( string A289OrdCod )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXSGVvORDCOD_data330( A289OrdCod) ;
         gxdynajaxindex = 1;
      ...
      protected void GXSGVvORDCOD_data330( string A289OrdCod )
      {
         l289OrdCod = StringUtil.PadR( StringUtil.RTrim( A289OrdCod), 10, "%");
         /* Using cursor H00332 */
         pr_default.execute(0, new Object[] {l289OrdCod});
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         while ( (pr_default.getStatus(0) != 101) )
         {
            gxdynajaxctrlcodr.Add(StringUtil.RTrim( H00332_A289OrdCod[0]));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H00332_A289OrdCod[0]));
      ...
      protected void STRUP330( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vTPRVCOD_DATA"), AV19TprvCod_Data);
            ...
            AV15PrvCod = StringUtil.Upper( cgiGet( edtavPrvcod_Internalname));
            AssignAttri("", false, "AV15PrvCod", AV15PrvCod);
            AV16PrvDsc = cgiGet( edtavPrvdsc_Internalname);
            AssignAttri("", false, "AV16PrvDsc", AV16PrvDsc);
            AV13OrdCod = cgiGet( edtavOrdcod_Internalname);
            AssignAttri("", false, "AV13OrdCod", AV13OrdCod);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavTprvcod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavTprvcod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV18TprvCod = 0;
               AssignAttri("", false, "AV18TprvCod", StringUtil.LTrimStr( (decimal)(AV18TprvCod), 6, 0));
            }
            else
            {
               AV18TprvCod = (int)(context.localUtil.CToN( cgiGet( edtavTprvcod_Internalname), ".", ","));
               AssignAttri("", false, "AV18TprvCod", StringUtil.LTrimStr( (decimal)(AV18TprvCod), 6, 0));
            }
      ...
      protected void E12332( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compras.r_resumenordencompradetalladopdf.aspx"+UrlEncode(StringUtil.RTrim(AV15PrvCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV18TprvCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV10MonCod,6,0)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV7Fdesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV8Fhasta)) + "," + UrlEncode(StringUtil.RTrim(AV14ProdCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV9Lincod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV12Opc,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV6CosCod)) + "," + UrlEncode(StringUtil.RTrim(AV17TipOrden));
         Innewwindow_Target = formatLink("compras.r_resumenordencompradetalladopdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S122( )
      {
         ...
         {
            A1235MonSts = H00333_A1235MonSts[0];
            A180MonCod = H00333_A180MonCod[0];
            A1234MonDsc = H00333_A1234MonDsc[0];
      ...
      protected void S112( )
      {
         ...
         {
            A1942TprvSts = H00334_A1942TprvSts[0];
            A298TprvCod = H00334_A298TprvCod[0];
            A1941TprvDsc = H00334_A1941TprvDsc[0];
            AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            AV19TprvCod_Data.Add(AV5Combo_DataItem, 0);
            pr_default.readNext(2);
         }
         pr_default.close(2);
         Combo_tprvcod_Selectedvalue_set = ((0==AV18TprvCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV18TprvCod), 6, 0)));
      ...
      protected void wb_table1_25_332( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvcod_Internalname, StringUtil.RTrim( AV15PrvCod), StringUtil.RTrim( context.localUtil.Format( AV15PrvCod, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvcod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavPrvcod_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Proveedor", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15331_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_OrdenesDetalle.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvdsc_Internalname, StringUtil.RTrim( AV16PrvDsc), StringUtil.RTrim( context.localUtil.Format( AV16PrvDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvdsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavPrvdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_OrdenesDetalle.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810305183", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_ordenesdetalle.js", "?202281810305183", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockordcod_Internalname = "TEXTBLOCKORDCOD";
         edtavOrdcod_Internalname = "vORDCOD";
         divUnnamedtableordcod_Internalname = "UNNAMEDTABLEORDCOD";
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte Detalle de Ordenes de Compra";
         ...
         Form.Caption = "Reporte Detalle de Ordenes de Compra";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV14ProdCod',fld:'vPRODCOD',pic:'@!',hsh:true},{av:'AV9Lincod',fld:'vLINCOD',pic:'ZZZZZ9',hsh:true},{av:'AV12Opc',fld:'vOPC',pic:'ZZZ9',hsh:true},{av:'AV6CosCod',fld:'vCOSCOD',pic:'',hsh:true},{av:'AV17TipOrden',fld:'vTIPORDEN',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12332',iparms:[{av:'AV15PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV18TprvCod',fld:'vTPRVCOD',pic:'ZZZZZ9'},{av:'AV10MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV7Fdesde',fld:'vFDESDE',pic:''},{av:'AV8Fhasta',fld:'vFHASTA',pic:''},{av:'AV14ProdCod',fld:'vPRODCOD',pic:'@!',hsh:true},{av:'AV9Lincod',fld:'vLINCOD',pic:'ZZZZZ9',hsh:true},{av:'AV12Opc',fld:'vOPC',pic:'ZZZ9',hsh:true},{av:'AV6CosCod',fld:'vCOSCOD',pic:'',hsh:true},{av:'AV17TipOrden',fld:'vTIPORDEN',pic:'',hsh:true}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E13332',iparms:[]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E15331',iparms:[]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV16PrvDsc',fld:'vPRVDSC',pic:''},{av:'AV15PrvCod',fld:'vPRVCOD',pic:'@!'}]}");
      ...
      public override void initialize( )
      {
         ...
         AV17TipOrden = "";
         GXKey = "";
         AV19TprvCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         scmdbuf = "";
         l289OrdCod = "";
         H00332_A289OrdCod = new string[] {""} ;
         AV15PrvCod = "";
         AV16PrvDsc = "";
         GXEncryptionTmp = "";
         H00333_A1235MonSts = new short[1] ;
         H00333_A180MonCod = new int[1] ;
         H00333_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV5Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00334_A1942TprvSts = new short[1] ;
         H00334_A298TprvCod = new int[1] ;
         H00334_A1941TprvDsc = new string[] {""} ;
         A1941TprvDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_ordenesdetalle__default(),
            new Object[][] {
                new Object[] {
               H00332_A289OrdCod
               }
               , new Object[] {
               H00333_A1235MonSts, H00333_A180MonCod, H00333_A1234MonDsc
               }
               , new Object[] {
               H00334_A1942TprvSts, H00334_A298TprvCod, H00334_A1941TprvDsc
               }
            }
         );
         AV10MonCod = 1;
      ...
      private string divUnnamedtableordcod_Internalname ;
      private string lblTextblockordcod_Internalname ;
      private string lblTextblockordcod_Jsonclick ;
      private string edtavOrdcod_Internalname ;
      private string TempTags ;
      private string AV13OrdCod ;
      ...
      private string l289OrdCod ;
      private string edtavPrvdsc_Internalname ;
      private string AV15PrvCod ;
      private string AV16PrvDsc ;
      ...
      private string[] H00332_A289OrdCod ;
      private short[] H00333_A1235MonSts ;
      private int[] H00333_A180MonCod ;
      private string[] H00333_A1234MonDsc ;
      private short[] H00334_A1942TprvSts ;
      private int[] H00334_A298TprvCod ;
      private string[] H00334_A1941TprvDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV19TprvCod_Data ;
   ...
   public class r_ordenesdetalle__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@l289OrdCod",GXType.NChar,10,0)
          };
          Object[] prmH00333;
          ...
          def= new CursorDef[] {
              new CursorDef("H00332", "SELECT TOP 10 [OrdCod] FROM [CPORDEN] WHERE (UPPER([OrdCod]) like UPPER(@l289OrdCod)) AND ([OrdSts] <> 'A') ORDER BY [OrdCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00332,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00333", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00333,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00334", "SELECT [TprvSts], [TprvCod], [TprvDsc] FROM [CTIPOPROVEEDOR] WHERE [TprvSts] = 1 ORDER BY [TprvDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00334,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
