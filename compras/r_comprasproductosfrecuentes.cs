...
namespace GeneXus.Programs.compras {
   public class r_comprasproductosfrecuentes : GXDataArea
   {
      public r_comprasproductosfrecuentes( )
      {
      ...
      public r_comprasproductosfrecuentes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810311279", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_comprasproductosfrecuentes.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSUBLCOD_DATA", AV18SublCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSUBLCOD_DATA", AV18SublCod_Data);
         }
      ...
      {
         return formatLink("compras.r_comprasproductosfrecuentes.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_ComprasProductosFrecuentes" ;
      }

      public override string GetPgmdesc( )
      {
         return "Reporte de Productos Frecuentes y No Frecuentes" ;
      }
      ...
      protected void WB4B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_lincod_Internalname, "Linea de productos", "", "", lblTextblockcombo_lincod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_sublcod_Internalname, "Sub Linea de productos", "", "", lblTextblockcombo_sublcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_sublcod.SetProperty("DropDownOptionsData", AV18SublCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprvcod_Internalname, "Proveedor", "", "", lblTextblockprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_40_4B2( true) ;
         }
         else
         {
            wb_table1_40_4B2( false) ;
         }
         return  ;
      }

      protected void wb_table1_40_4B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprodcod_Internalname, "Producto", "", "", lblTextblockprodcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table2_57_4B2( true) ;
         }
         else
         {
            wb_table2_57_4B2( false) ;
         }
         return  ;
      }

      protected void wb_table2_57_4B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV12Fdesde, "99/99/99"), context.localUtil.Format( AV12Fdesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,75);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV13Fhasta, "99/99/99"), context.localUtil.Format( AV13Fhasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "Tipo de Producto", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.RTrim( AV14Tipo), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,93);\"", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtabletipo2_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo2_Internalname, "Tipo de Reporte", "", "", lblTextblocktipo2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", "Tipo2", "col-sm-3 AttributeCheckBoxLabel", 0, true, "");
            /* Radio button */
            ClassString = "AttributeCheckBox";
            StyleString = "";
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'',false,'',0)\"";
            GxWebStd.gx_radio_ctrl( context, radavTipo2, radavTipo2_Internalname, StringUtil.RTrim( AV15Tipo2), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,102);\"", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavLincod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5LinCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5LinCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,116);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLincod_Jsonclick, 0, "Attribute", "", "", "", "", edtavLincod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 117,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSublcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SublCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6SublCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,117);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSublcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavSublcod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Reporte de Productos Frecuentes y No Frecuentes", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         AV15Tipo2 = StringUtil.RTrim( AV15Tipo2);
         AssignAttri("", false, "AV15Tipo2", AV15Tipo2);
      }
      ...
      protected void STRUP4B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vSUBLCOD_DATA"), AV18SublCod_Data);
            /* Read saved values. */
            ...
            AssignAttri("", false, "AV14Tipo", AV14Tipo);
            AV15Tipo2 = cgiGet( radavTipo2_Internalname);
            AssignAttri("", false, "AV15Tipo2", AV15Tipo2);
      ...
      protected void E124B2( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compras.r_comprasproductosfrecuentespdf.aspx"+UrlEncode(StringUtil.LTrimStr(AV5LinCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6SublCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV9ProdCod)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12Fdesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV13Fhasta)) + "," + UrlEncode(StringUtil.LTrimStr(AV19DocMonCod,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV7PrvCod)) + "," + UrlEncode(StringUtil.RTrim(AV14Tipo)) + "," + UrlEncode(StringUtil.RTrim(AV15Tipo2));
         Innewwindow_Target = formatLink("compras.r_comprasproductosfrecuentespdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S122( )
      {
         ...
         {
            A1893SublSts = H004B2_A1893SublSts[0];
            A51SublCod = H004B2_A51SublCod[0];
            A1892SublDsc = H004B2_A1892SublDsc[0];
            AV17Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV17Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A51SublCod), 6, 0));
            AV17Combo_DataItem.gxTpr_Title = A1892SublDsc;
            AV18SublCod_Data.Add(AV17Combo_DataItem, 0);
      ...
      protected void S112( )
      {
         ...
         {
            A1159LinSts = H004B3_A1159LinSts[0];
            A52LinCod = H004B3_A52LinCod[0];
            A1153LinDsc = H004B3_A1153LinDsc[0];
            AV17Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV17Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A52LinCod), 6, 0));
            AV17Combo_DataItem.gxTpr_Title = A1153LinDsc;
            AV16LinCod_Data.Add(AV17Combo_DataItem, 0);
      ...
      protected void wb_table2_57_4B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnprod_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Producto", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnprod_Jsonclick, "'"+""+"'"+",false,"+"'"+"e154b1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table1_40_4B2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgBtnprov_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Proveedor", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnprov_Jsonclick, "'"+""+"'"+",false,"+"'"+"e164b1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ComprasProductosFrecuentes.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810311437", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_comprasproductosfrecuentes.js", "?202281810311437", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         radavTipo.WebTags = "";
         radavTipo.addItem("F", "Productos Frecuentes", 0);
         radavTipo.addItem("N", "Productos No Frecuentes", 0);
         radavTipo2.Name = "vTIPO2";
         radavTipo2.WebTags = "";
         radavTipo2.addItem("D", "Detallado", 0);
         radavTipo2.addItem("R", "Resumido", 0);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblocktipo2_Internalname = "TEXTBLOCKTIPO2";
         radavTipo2_Internalname = "vTIPO2";
         divUnnamedtabletipo2_Internalname = "UNNAMEDTABLETIPO2";
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Reporte de Productos Frecuentes y No Frecuentes";
         ...
         Form.Caption = "Reporte de Productos Frecuentes y No Frecuentes";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV19DocMonCod',fld:'vDOCMONCOD',pic:'ZZZZZ9',hsh:true},{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E124B2',iparms:[{av:'AV5LinCod',fld:'vLINCOD',pic:'ZZZZZ9'},{av:'AV6SublCod',fld:'vSUBLCOD',pic:'ZZZZZ9'},{av:'AV9ProdCod',fld:'vPRODCOD',pic:'@!'},{av:'AV12Fdesde',fld:'vFDESDE',pic:''},{av:'AV13Fhasta',fld:'vFHASTA',pic:''},{av:'AV19DocMonCod',fld:'vDOCMONCOD',pic:'ZZZZZ9',hsh:true},{av:'AV7PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E134B2',iparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         setEventMetadata("'DOBTNPROV'","{handler:'E164B1',iparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("'DOBTNPROV'",",oparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         setEventMetadata("'DOBTNPROD'","{handler:'E154B1',iparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("'DOBTNPROD'",",oparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'radavTipo'},{av:'AV14Tipo',fld:'vTIPO',pic:''},{av:'radavTipo2'},{av:'AV15Tipo2',fld:'vTIPO2',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV18SublCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H004B2_A1893SublSts = new short[1] ;
         H004B2_A51SublCod = new int[1] ;
         H004B2_A1892SublDsc = new string[] {""} ;
         A1892SublDsc = "";
         AV17Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H004B3_A1159LinSts = new short[1] ;
         H004B3_A52LinCod = new int[1] ;
         H004B3_A1153LinDsc = new string[] {""} ;
         A1153LinDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_comprasproductosfrecuentes__default(),
            new Object[][] {
                new Object[] {
               H004B2_A1893SublSts, H004B2_A51SublCod, H004B2_A1892SublDsc
               }
               , new Object[] {
               H004B3_A1159LinSts, H004B3_A52LinCod, H004B3_A1153LinDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string divUnnamedtabletipo2_Internalname ;
      private string lblTextblocktipo2_Internalname ;
      private string lblTextblocktipo2_Jsonclick ;
      private string radavTipo2_Internalname ;
      private string AV15Tipo2 ;
      private string radavTipo2_Jsonclick ;
      ...
      private GXRadio radavTipo2 ;
      private IDataStoreProvider pr_default ;
      private short[] H004B2_A1893SublSts ;
      private int[] H004B2_A51SublCod ;
      private string[] H004B2_A1892SublDsc ;
      private short[] H004B3_A1159LinSts ;
      private int[] H004B3_A52LinCod ;
      private string[] H004B3_A1153LinDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV16LinCod_Data ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV18SublCod_Data ;
      private GXWebForm Form ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV17Combo_DataItem ;
   }

   public class r_comprasproductosfrecuentes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004B2", "SELECT [SublSts], [SublCod], [SublDsc] FROM [CSUBLPROD] WHERE [SublSts] = 1 ORDER BY [SublDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004B2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H004B3", "SELECT [LinSts], [LinCod], [LinDsc] FROM [CLINEAPROD] WHERE [LinSts] = 1 ORDER BY [LinDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004B3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
