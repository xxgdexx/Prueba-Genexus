...
namespace GeneXus.Programs.compras {
   public class r_resumenletraspagarpdf : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "compras.r_resumenletraspagarpdf.aspx")), "compras.r_resumenletraspagarpdf.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "compras.r_resumenletraspagarpdf.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public r_resumenletraspagarpdf( )
      {
      ...
      public r_resumenletraspagarpdf( IGxContext context )
      {
      ...
      public void executeSubmit( ref string aP0_PrvCod ,
                                 ...
                                 ref string aP6_CPEstado )
      {
         r_resumenletraspagarpdf objr_resumenletraspagarpdf;
         objr_resumenletraspagarpdf = new r_resumenletraspagarpdf();
         objr_resumenletraspagarpdf.AV37PrvCod = aP0_PrvCod;
         objr_resumenletraspagarpdf.AV38BanCod = aP1_BanCod;
         objr_resumenletraspagarpdf.AV49LetPSec = aP2_LetPSec;
         objr_resumenletraspagarpdf.AV14MonCod = aP3_MonCod;
         objr_resumenletraspagarpdf.AV30FDesde = aP4_FDesde;
         objr_resumenletraspagarpdf.AV31FHasta = aP5_FHasta;
         objr_resumenletraspagarpdf.AV54CPEstado = aP6_CPEstado;
         objr_resumenletraspagarpdf.context.SetSubmitInitialConfig(context);
         objr_resumenletraspagarpdf.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_resumenletraspagarpdf);
         aP0_PrvCod=this.AV37PrvCod;
         aP1_BanCod=this.AV38BanCod;
         aP2_LetPSec=this.AV49LetPSec;
         aP3_MonCod=this.AV14MonCod;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_resumenletraspagarpdf)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A180MonCod = P00AB2_A180MonCod[0];
               A1234MonDsc = P00AB2_A1234MonDsc[0];
            ...
            {
               A265LetPLetCod = P00AB3_A265LetPLetCod[0];
               A1146LetPTipo = P00AB3_A1146LetPTipo[0];
               A1135LetPFecVcto = P00AB3_A1135LetPFecVcto[0];
               A266LetPMonCod = P00AB3_A266LetPMonCod[0];
               A1142LetPSec = P00AB3_A1142LetPSec[0];
               A1127LetPBanCod = P00AB3_A1127LetPBanCod[0];
               A267LetPPrvCod = P00AB3_A267LetPPrvCod[0];
               A269LetPTipCod = P00AB3_A269LetPTipCod[0];
               A1131LetPDocNum = P00AB3_A1131LetPDocNum[0];
               A1133LetPDPrvCod = P00AB3_A1133LetPDPrvCod[0];
               A1138LetPImpDet = P00AB3_A1138LetPImpDet[0];
               A1130LetPDias = P00AB3_A1130LetPDias[0];
               A1128LetPBanNum = P00AB3_A1128LetPBanNum[0];
               A247PrvDsc = P00AB3_A247PrvDsc[0];
               n247PrvDsc = P00AB3_n247PrvDsc[0];
               A1134LetPFecLet = P00AB3_A1134LetPFecLet[0];
               A268LetPItem = P00AB3_A268LetPItem[0];
               A266LetPMonCod = P00AB3_A266LetPMonCod[0];
               A267LetPPrvCod = P00AB3_A267LetPPrvCod[0];
               A247PrvDsc = P00AB3_A247PrvDsc[0];
               n247PrvDsc = P00AB3_n247PrvDsc[0];
      ...
      protected void S111( )
      {
         ...
         {
            A372BanCod = P00AB4_A372BanCod[0];
            A482BanDsc = P00AB4_A482BanDsc[0];
      ...
      protected void S121( )
      {
         ...
         {
            A262CPPrvCod = P00AB5_A262CPPrvCod[0];
            A261CPComCod = P00AB5_A261CPComCod[0];
            A260CPTipCod = P00AB5_A260CPTipCod[0];
            A815CPEstado = P00AB5_A815CPEstado[0];
            A818CPImpPago = P00AB5_A818CPImpPago[0];
            A820CPImpTotal = P00AB5_A820CPImpTotal[0];
      ...
      protected void HAB0( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         AV24Filtro3 = "";
         scmdbuf = "";
         P00AB2_A180MonCod = new int[1] ;
         P00AB2_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         A267LetPPrvCod = "";
         A1146LetPTipo = "";
         A1135LetPFecVcto = DateTime.MinValue;
         P00AB3_A265LetPLetCod = new string[] {""} ;
         P00AB3_A1146LetPTipo = new string[] {""} ;
         P00AB3_A1135LetPFecVcto = new DateTime[] {DateTime.MinValue} ;
         P00AB3_A266LetPMonCod = new int[1] ;
         P00AB3_A1142LetPSec = new int[1] ;
         P00AB3_A1127LetPBanCod = new int[1] ;
         P00AB3_A267LetPPrvCod = new string[] {""} ;
         P00AB3_A269LetPTipCod = new string[] {""} ;
         P00AB3_A1131LetPDocNum = new string[] {""} ;
         P00AB3_A1133LetPDPrvCod = new string[] {""} ;
         P00AB3_A1138LetPImpDet = new decimal[1] ;
         P00AB3_A1130LetPDias = new short[1] ;
         P00AB3_A1128LetPBanNum = new string[] {""} ;
         P00AB3_A247PrvDsc = new string[] {""} ;
         P00AB3_n247PrvDsc = new bool[] {false} ;
         P00AB3_A1134LetPFecLet = new DateTime[] {DateTime.MinValue} ;
         P00AB3_A268LetPItem = new int[1] ;
         A265LetPLetCod = "";
         A269LetPTipCod = "";
         A1131LetPDocNum = "";
         A1133LetPDPrvCod = "";
         ...
         AV53Estado = "";
         AV41Banco = "";
         P00AB4_A372BanCod = new int[1] ;
         P00AB4_A482BanDsc = new string[] {""} ;
         A482BanDsc = "";
         P00AB5_A262CPPrvCod = new string[] {""} ;
         P00AB5_A261CPComCod = new string[] {""} ;
         P00AB5_A260CPTipCod = new string[] {""} ;
         P00AB5_A815CPEstado = new string[] {""} ;
         P00AB5_A818CPImpPago = new decimal[1] ;
         P00AB5_A820CPImpTotal = new decimal[1] ;
         A262CPPrvCod = "";
         A261CPComCod = "";
         A260CPTipCod = "";
         A815CPEstado = "";
         ...
         AV47Logo = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_resumenletraspagarpdf__default(),
            new Object[][] {
                new Object[] {
               P00AB2_A180MonCod, P00AB2_A1234MonDsc
               }
               , new Object[] {
               P00AB3_A265LetPLetCod, P00AB3_A1146LetPTipo, P00AB3_A1135LetPFecVcto, P00AB3_A266LetPMonCod, P00AB3_A1142LetPSec, P00AB3_A1127LetPBanCod, P00AB3_A267LetPPrvCod, P00AB3_A269LetPTipCod, P00AB3_A1131LetPDocNum, P00AB3_A1133LetPDPrvCod,
               P00AB3_A1138LetPImpDet, P00AB3_A1130LetPDias, P00AB3_A1128LetPBanNum, P00AB3_A247PrvDsc, P00AB3_n247PrvDsc, P00AB3_A1134LetPFecLet, P00AB3_A268LetPItem
               }
               , new Object[] {
               P00AB4_A372BanCod, P00AB4_A482BanDsc
               }
               , new Object[] {
               P00AB5_A262CPPrvCod, P00AB5_A261CPComCod, P00AB5_A260CPTipCod, P00AB5_A815CPEstado, P00AB5_A818CPImpPago, P00AB5_A820CPImpTotal
               }
            }
         );
      ...
      private int[] P00AB2_A180MonCod ;
      private string[] P00AB2_A1234MonDsc ;
      private string[] P00AB3_A265LetPLetCod ;
      private string[] P00AB3_A1146LetPTipo ;
      private DateTime[] P00AB3_A1135LetPFecVcto ;
      private int[] P00AB3_A266LetPMonCod ;
      private int[] P00AB3_A1142LetPSec ;
      private int[] P00AB3_A1127LetPBanCod ;
      private string[] P00AB3_A267LetPPrvCod ;
      private string[] P00AB3_A269LetPTipCod ;
      private string[] P00AB3_A1131LetPDocNum ;
      private string[] P00AB3_A1133LetPDPrvCod ;
      private decimal[] P00AB3_A1138LetPImpDet ;
      private short[] P00AB3_A1130LetPDias ;
      private string[] P00AB3_A1128LetPBanNum ;
      private string[] P00AB3_A247PrvDsc ;
      private bool[] P00AB3_n247PrvDsc ;
      private DateTime[] P00AB3_A1134LetPFecLet ;
      private int[] P00AB3_A268LetPItem ;
      private int[] P00AB4_A372BanCod ;
      private string[] P00AB4_A482BanDsc ;
      private string[] P00AB5_A262CPPrvCod ;
      private string[] P00AB5_A261CPComCod ;
      private string[] P00AB5_A260CPTipCod ;
      private string[] P00AB5_A815CPEstado ;
      private decimal[] P00AB5_A818CPImpPago ;
      private decimal[] P00AB5_A820CPImpTotal ;
   }

   public class r_resumenletraspagarpdf__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00AB3( IGxContext context ,
                                             string AV37PrvCod ,
                                             int AV38BanCod ,
                                             int AV49LetPSec ,
                                             int AV14MonCod ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00AB3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (string)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00AB2", "SELECT [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonCod] = @AV14MonCod ORDER BY [MonCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AB2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00AB3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AB3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00AB4", "SELECT [BanCod], [BanDsc] FROM [TSBANCOS] WHERE [BanCod] = @AV50LetCBanCod ORDER BY [BanCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AB4,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00AB5", "SELECT [CPPrvCod], [CPComCod], [CPTipCod], [CPEstado], [CPImpPago], [CPImpTotal] FROM [CPCUENTAPAGAR] WHERE [CPTipCod] = @AV51LetCTipCod and [CPComCod] = @AV52LetCDocNum and [CPPrvCod] = @AV55LetPPrvCod ORDER BY [CPTipCod], [CPComCod], [CPPrvCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AB5,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
