...
namespace GeneXus.Programs.compras {
   public class r_resumenletraspagar : GXDataArea
   {
      public r_resumenletraspagar( )
      {
      ...
      public r_resumenletraspagar( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281810305557", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_resumenletraspagar.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vCPESTADO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV17CPEstado, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vBANCOD_DATA", AV13BanCod_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vBANCOD_DATA", AV13BanCod_Data);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vCPESTADO", StringUtil.RTrim( AV17CPEstado));
         GxWebStd.gx_hidden_field( context, "gxhash_vCPESTADO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV17CPEstado, "")), context));
      ...
      {
         return formatLink("compras.r_resumenletraspagar.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_ResumenLetrasPagar" ;
      }

      public override string GetPgmdesc( )
      {
         return "Resumen de Letras por Pagar" ;
      }
      ...
      protected void WB360( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockprvcod_Internalname, "Proveedor", "", "", lblTextblockprvcod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            wb_table1_25_362( true) ;
         }
         else
         {
            wb_table1_25_362( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_362e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_bancod_Internalname, "Banco", "", "", lblTextblockcombo_bancod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_bancod.SetProperty("DropDownOptionsData", AV13BanCod_Data);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockletpsec_Internalname, "Tipo de Afectación", "", "", lblTextblockletpsec_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, cmbavLetpsec_Internalname, "Seccion Bancaria", "col-sm-3 AttributeRealWidth50WithLabel", 0, true, "");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 50,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavLetpsec, cmbavLetpsec_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV8LetPSec), 6, 0)), 1, cmbavLetpsec_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavLetpsec.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,50);\"", "", true, 1, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            cmbavLetpsec.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8LetPSec), 6, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_moncod_Internalname, "Moneda", "", "", lblTextblockcombo_moncod_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockccestado_Internalname, "Estado", "", "", lblTextblockccestado_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", "Estado", "col-sm-3 AttributeCheckBoxLabel", 0, true, "");
            /* Radio button */
            ClassString = "AttributeCheckBox";
            StyleString = "";
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'',0)\"";
            GxWebStd.gx_radio_ctrl( context, radavCcestado, radavCcestado_Internalname, StringUtil.RTrim( AV10CCEstado), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavCcestado_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfdesde_Internalname, "Fecha Desde", "", "", lblTextblockfdesde_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFdesde_Internalname, context.localUtil.Format(AV11Fdesde, "99/99/99"), context.localUtil.Format( AV11Fdesde, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFdesde_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFdesde_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_bitmap( context, edtavFdesde_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFdesde_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfhasta_Internalname, "Fecha Hasta", "", "", lblTextblockfhasta_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFhasta_Internalname, context.localUtil.Format(AV12FHasta, "99/99/99"), context.localUtil.Format( AV12FHasta, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,83);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFhasta_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavFhasta_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_bitmap( context, edtavFhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBancod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7BanCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV7BanCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,97);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBancod_Jsonclick, 0, "Attribute", "", "", "", "", edtavBancod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 98,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMoncod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9MonCod), 6, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9MonCod), "ZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,98);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavMoncod_Jsonclick, 0, "Attribute", "", "", "", "", edtavMoncod_Visible, 1, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START362( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Resumen de Letras por Pagar", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV8LetPSec = (int)(NumberUtil.Val( cmbavLetpsec.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV8LetPSec), 6, 0))), "."));
            AssignAttri("", false, "AV8LetPSec", StringUtil.LTrimStr( (decimal)(AV8LetPSec), 6, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavLetpsec.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8LetPSec), 6, 0));
         ...
         AV10CCEstado = StringUtil.RTrim( AV10CCEstado);
         AssignAttri("", false, "AV10CCEstado", AV10CCEstado);
      }
      ...
      protected void STRUP360( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vBANCOD_DATA"), AV13BanCod_Data);
            ...
            AV18PrvDsc = cgiGet( edtavPrvdsc_Internalname);
            AssignAttri("", false, "AV18PrvDsc", AV18PrvDsc);
            cmbavLetpsec.CurrentValue = cgiGet( cmbavLetpsec_Internalname);
            AV8LetPSec = (int)(NumberUtil.Val( cgiGet( cmbavLetpsec_Internalname), "."));
            AssignAttri("", false, "AV8LetPSec", StringUtil.LTrimStr( (decimal)(AV8LetPSec), 6, 0));
            AV10CCEstado = cgiGet( radavCcestado_Internalname);
            AssignAttri("", false, "AV10CCEstado", AV10CCEstado);
            ...
            {
               AV7BanCod = (int)(context.localUtil.CToN( cgiGet( edtavBancod_Internalname), ".", ","));
               AssignAttri("", false, "AV7BanCod", StringUtil.LTrimStr( (decimal)(AV7BanCod), 6, 0));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavMoncod_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavMoncod_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV9MonCod = 0;
               AssignAttri("", false, "AV9MonCod", StringUtil.LTrimStr( (decimal)(AV9MonCod), 6, 0));
            }
            else
            {
               AV9MonCod = (int)(context.localUtil.CToN( cgiGet( edtavMoncod_Internalname), ".", ","));
               AssignAttri("", false, "AV9MonCod", StringUtil.LTrimStr( (decimal)(AV9MonCod), 6, 0));
            }
      ...
      protected void E12362( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compras.r_resumenletraspagarpdf.aspx"+UrlEncode(StringUtil.RTrim(AV16PrvCod)) + "," + UrlEncode(StringUtil.LTrimStr(AV7BanCod,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8LetPSec,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV9MonCod,6,0)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV11Fdesde)) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV12FHasta)) + "," + UrlEncode(StringUtil.RTrim(AV17CPEstado));
         Innewwindow_Target = formatLink("compras.r_resumenletraspagarpdf.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
      ...
      protected void S122( )
      {
         ...
         {
            A1235MonSts = H00362_A1235MonSts[0];
            A180MonCod = H00362_A180MonCod[0];
            A1234MonDsc = H00362_A1234MonDsc[0];
            ...
            AV15MonCod_Data.Add(AV14Combo_DataItem, 0);
            pr_default.readNext(0);
         }
         pr_default.close(0);
         Combo_moncod_Selectedvalue_set = ((0==AV9MonCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV9MonCod), 6, 0)));
      ...
      protected void S112( )
      {
         ...
         {
            A483BanSts = H00363_A483BanSts[0];
            A372BanCod = H00363_A372BanCod[0];
            A482BanDsc = H00363_A482BanDsc[0];
            AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            ...
            AV13BanCod_Data.Add(AV14Combo_DataItem, 0);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         Combo_bancod_Selectedvalue_set = ((0==AV7BanCod) ? "" : StringUtil.Trim( StringUtil.Str( (decimal)(AV7BanCod), 6, 0)));
      ...
      protected void wb_table1_25_362( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgBtnbuscar_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Buscar Cliente", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgBtnbuscar_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15361_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Compras\\R_ResumenLetrasPagar.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavPrvdsc_Internalname, StringUtil.RTrim( AV18PrvDsc), StringUtil.RTrim( context.localUtil.Format( AV18PrvDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPrvdsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavPrvdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Compras\\R_ResumenLetrasPagar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_25_362e( true) ;
         }
         else
         {
            wb_table1_25_362e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810305696", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_resumenletraspagar.js", "?202281810305696", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavLetpsec.addItem("1", "Cartera", 0);
         ...
         radavCcestado.addItem("", "Pendiente", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Resumen de Letras por Pagar";
         ...
         Form.Caption = "Resumen de Letras por Pagar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV17CPEstado',fld:'vCPESTADO',pic:'',hsh:true},{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E12362',iparms:[{av:'AV16PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'AV7BanCod',fld:'vBANCOD',pic:'ZZZZZ9'},{av:'cmbavLetpsec'},{av:'AV8LetPSec',fld:'vLETPSEC',pic:'ZZZZZ9'},{av:'AV9MonCod',fld:'vMONCOD',pic:'ZZZZZ9'},{av:'AV11Fdesde',fld:'vFDESDE',pic:''},{av:'AV12FHasta',fld:'vFHASTA',pic:''},{av:'AV17CPEstado',fld:'vCPESTADO',pic:'',hsh:true},{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E13362',iparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]}");
         setEventMetadata("'DOBTNBUSCAR'","{handler:'E15361',iparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]");
         setEventMetadata("'DOBTNBUSCAR'",",oparms:[{av:'AV18PrvDsc',fld:'vPRVDSC',pic:''},{av:'AV16PrvCod',fld:'vPRVCOD',pic:'@!'},{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]}");
         setEventMetadata("VALIDV_FDESDE","{handler:'Validv_Fdesde',iparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]");
         setEventMetadata("VALIDV_FDESDE",",oparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]}");
         setEventMetadata("VALIDV_FHASTA","{handler:'Validv_Fhasta',iparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]");
         setEventMetadata("VALIDV_FHASTA",",oparms:[{av:'radavCcestado'},{av:'AV10CCEstado',fld:'vCCESTADO',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV17CPEstado = "";
         GXKey = "";
         AV13BanCod_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         GXEncryptionTmp = "";
         scmdbuf = "";
         H00362_A1235MonSts = new short[1] ;
         H00362_A180MonCod = new int[1] ;
         H00362_A1234MonDsc = new string[] {""} ;
         A1234MonDsc = "";
         AV14Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H00363_A483BanSts = new short[1] ;
         H00363_A372BanCod = new int[1] ;
         H00363_A482BanDsc = new string[] {""} ;
         A482BanDsc = "";
         sStyleString = "";
         sImgUrl = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_resumenletraspagar__default(),
            new Object[][] {
                new Object[] {
               H00362_A1235MonSts, H00362_A180MonCod, H00362_A1234MonDsc
               }
               , new Object[] {
               H00363_A483BanSts, H00363_A372BanCod, H00363_A482BanDsc
               }
            }
         );
         AV9MonCod = 1;
      ...
      private short[] H00362_A1235MonSts ;
      private int[] H00362_A180MonCod ;
      private string[] H00362_A1234MonDsc ;
      private short[] H00363_A483BanSts ;
      private int[] H00363_A372BanCod ;
      private string[] H00363_A482BanDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV13BanCod_Data ;
   ...
   public class r_resumenletraspagar__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00362", "SELECT [MonSts], [MonCod], [MonDsc] FROM [CMONEDAS] WHERE [MonSts] = 1 ORDER BY [MonDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00362,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00363", "SELECT [BanSts], [BanCod], [BanDsc] FROM [TSBANCOS] WHERE [BanSts] = 1 ORDER BY [BanDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00363,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
