...
namespace GeneXus.Programs.compras {
   public class r_ordencompracomparativopreciopdf : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "compras.r_ordencompracomparativopreciopdf.aspx")), "compras.r_ordencompracomparativopreciopdf.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "compras.r_ordencompracomparativopreciopdf.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public r_ordencompracomparativopreciopdf( )
      {
      ...
      public r_ordencompracomparativopreciopdf( IGxContext context )
      {
      ...
      public void executeSubmit( ref string aP0_cPrvCod ,
                                 ...
                                 ref DateTime aP4_FHasta )
      {
         r_ordencompracomparativopreciopdf objr_ordencompracomparativopreciopdf;
         objr_ordencompracomparativopreciopdf = new r_ordencompracomparativopreciopdf();
         objr_ordencompracomparativopreciopdf.AV13cPrvCod = aP0_cPrvCod;
         objr_ordencompracomparativopreciopdf.AV10cLinCod = aP1_cLinCod;
         objr_ordencompracomparativopreciopdf.AV12cProdCod = aP2_cProdCod;
         objr_ordencompracomparativopreciopdf.AV20FDesde = aP3_FDesde;
         objr_ordencompracomparativopreciopdf.AV21FHasta = aP4_FHasta;
         objr_ordencompracomparativopreciopdf.context.SetSubmitInitialConfig(context);
         objr_ordencompracomparativopreciopdf.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objr_ordencompracomparativopreciopdf);
         aP0_cPrvCod=this.AV13cPrvCod;
         aP1_cLinCod=this.AV10cLinCod;
         aP2_cProdCod=this.AV12cProdCod;
         aP3_FDesde=this.AV20FDesde;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((r_ordencompracomparativopreciopdf)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A244PrvCod = P00A72_A244PrvCod[0];
               A247PrvDsc = P00A72_A247PrvDsc[0];
            ...
            {
               A28ProdCod = P00A73_A28ProdCod[0];
               A55ProdDsc = P00A73_A55ProdDsc[0];
            ...
            {
               A49UniCod = P00A74_A49UniCod[0];
               A1462OrdSts = P00A74_A1462OrdSts[0];
               A293OrdFec = P00A74_A293OrdFec[0];
               A52LinCod = P00A74_A52LinCod[0];
               A28ProdCod = P00A74_A28ProdCod[0];
               A244PrvCod = P00A74_A244PrvCod[0];
               A290OrdMonCod = P00A74_A290OrdMonCod[0];
               A1431OrdDCan = P00A74_A1431OrdDCan[0];
               A1438OrdDPre = P00A74_A1438OrdDPre[0];
               A247PrvDsc = P00A74_A247PrvDsc[0];
               A1997UniAbr = P00A74_A1997UniAbr[0];
               A55ProdDsc = P00A74_A55ProdDsc[0];
               A289OrdCod = P00A74_A289OrdCod[0];
               A295OrdDItem = P00A74_A295OrdDItem[0];
               A49UniCod = P00A74_A49UniCod[0];
               A52LinCod = P00A74_A52LinCod[0];
               A55ProdDsc = P00A74_A55ProdDsc[0];
               A1997UniAbr = P00A74_A1997UniAbr[0];
      ...
      protected void S111( )
      {
         ...
         {
            A244PrvCod = P00A75_A244PrvCod[0];
            A284CPLisProdCod = P00A75_A284CPLisProdCod[0];
            A829CPLisPrvMN = P00A75_A829CPLisPrvMN[0];
            A828CPLisPrvME = P00A75_A828CPLisPrvME[0];
            A285CPLisPrvItem = P00A75_A285CPLisPrvItem[0];
            if ( AV32MonCod == 1 )
            {
      ...
      protected void HA70( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         AV24Filtro3 = "";
         scmdbuf = "";
         P00A72_A244PrvCod = new string[] {""} ;
         P00A72_A247PrvDsc = new string[] {""} ;
         A244PrvCod = "";
         A247PrvDsc = "";
         P00A73_A28ProdCod = new string[] {""} ;
         P00A73_A55ProdDsc = new string[] {""} ;
         A28ProdCod = "";
         A55ProdDsc = "";
         AV50TipoOrdenes = "";
         AV51TipOrden = "";
         ...
         P00A74_A49UniCod = new int[1] ;
         P00A74_A1462OrdSts = new string[] {""} ;
         P00A74_A293OrdFec = new DateTime[] {DateTime.MinValue} ;
         P00A74_A52LinCod = new int[1] ;
         P00A74_A28ProdCod = new string[] {""} ;
         P00A74_A244PrvCod = new string[] {""} ;
         P00A74_A290OrdMonCod = new int[1] ;
         P00A74_A1431OrdDCan = new decimal[1] ;
         P00A74_A1438OrdDPre = new decimal[1] ;
         P00A74_A247PrvDsc = new string[] {""} ;
         P00A74_A1997UniAbr = new string[] {""} ;
         P00A74_A55ProdDsc = new string[] {""} ;
         P00A74_A289OrdCod = new string[] {""} ;
         P00A74_A295OrdDItem = new int[1] ;
         A1997UniAbr = "";
         A289OrdCod = "";
         AV34OrdCod = "";
         AV42PrvCod = "";
         AV41ProdCod = "";
         P00A75_A244PrvCod = new string[] {""} ;
         P00A75_A284CPLisProdCod = new string[] {""} ;
         P00A75_A829CPLisPrvMN = new decimal[1] ;
         P00A75_A828CPLisPrvME = new decimal[1] ;
         P00A75_A285CPLisPrvItem = new short[1] ;
         A284CPLisProdCod = "";
         Gx_time = "";
         Gx_date = DateTime.MinValue;
         AV31Logo = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compras.r_ordencompracomparativopreciopdf__default(),
            new Object[][] {
                new Object[] {
               P00A72_A244PrvCod, P00A72_A247PrvDsc
               }
               , new Object[] {
               P00A73_A28ProdCod, P00A73_A55ProdDsc
               }
               , new Object[] {
               P00A74_A49UniCod, P00A74_A1462OrdSts, P00A74_A293OrdFec, P00A74_A52LinCod, P00A74_A28ProdCod, P00A74_A244PrvCod, P00A74_A290OrdMonCod, P00A74_A1431OrdDCan, P00A74_A1438OrdDPre, P00A74_A247PrvDsc,
               P00A74_A1997UniAbr, P00A74_A55ProdDsc, P00A74_A289OrdCod, P00A74_A295OrdDItem
               }
               , new Object[] {
               P00A75_A244PrvCod, P00A75_A284CPLisProdCod, P00A75_A829CPLisPrvMN, P00A75_A828CPLisPrvME, P00A75_A285CPLisPrvItem
               }
            }
         );
      ...
      private string[] P00A72_A244PrvCod ;
      private string[] P00A72_A247PrvDsc ;
      private string[] P00A73_A28ProdCod ;
      private string[] P00A73_A55ProdDsc ;
      private int[] P00A74_A49UniCod ;
      private string[] P00A74_A1462OrdSts ;
      private DateTime[] P00A74_A293OrdFec ;
      private int[] P00A74_A52LinCod ;
      private string[] P00A74_A28ProdCod ;
      private string[] P00A74_A244PrvCod ;
      private int[] P00A74_A290OrdMonCod ;
      private decimal[] P00A74_A1431OrdDCan ;
      private decimal[] P00A74_A1438OrdDPre ;
      private string[] P00A74_A247PrvDsc ;
      private string[] P00A74_A1997UniAbr ;
      private string[] P00A74_A55ProdDsc ;
      private string[] P00A74_A289OrdCod ;
      private int[] P00A74_A295OrdDItem ;
      private string[] P00A75_A244PrvCod ;
      private string[] P00A75_A284CPLisProdCod ;
      private decimal[] P00A75_A829CPLisPrvMN ;
      private decimal[] P00A75_A828CPLisPrvME ;
      private short[] P00A75_A285CPLisPrvItem ;
   }

   public class r_ordencompracomparativopreciopdf__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00A74( IGxContext context ,
                                             string AV13cPrvCod ,
                                             string AV12cProdCod ,
                                             int AV10cLinCod ,
                                             string A244PrvCod ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 2 :
                     return conditional_P00A74(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00A72", "SELECT [PrvCod], [PrvDsc] FROM [CPPROVEEDORES] WHERE [PrvCod] = @AV13cPrvCod ORDER BY [PrvCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A72,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00A73", "SELECT [ProdCod], [ProdDsc] FROM [APRODUCTOS] WHERE [ProdCod] = @AV12cProdCod ORDER BY [ProdCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A73,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00A74", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A74,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00A75", "SELECT [PrvCod], [CPLisProdCod], [CPLisPrvMN], [CPLisPrvME], [CPLisPrvItem] FROM [CPLISTAPRECIOSDET] WHERE ([CPLisProdCod] = @AV41ProdCod) AND ([PrvCod] = @AV42PrvCod) ORDER BY [CPLisProdCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A75,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
