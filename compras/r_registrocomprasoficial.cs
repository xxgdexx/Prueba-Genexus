...
namespace GeneXus.Programs.compras {
   public class r_registrocomprasoficial : GXDataArea
   {
      public r_registrocomprasoficial( )
      {
      ...
      public r_registrocomprasoficial( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181031558", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compras.r_registrocomprasoficial.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vANO", StringUtil.LTrim( StringUtil.NToC( AV13Ano, 10, 2, ".", "")));
         GxWebStd.gx_hidden_field( context, "vMES", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14Mes), 9, 0, ".", "")));
      ...
      {
         return formatLink("compras.r_registrocomprasoficial.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Compras.R_RegistroComprasOficial" ;
      }

      public override string GetPgmdesc( )
      {
         return "Registro de Compras Oficial" ;
      }
      ...
      protected void WB3W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjano_Internalname, "Año", "", "", lblTextblockjano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavJano_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5jAno), 4, 0, ".", "")), StringUtil.LTrim( ((edtavJano_Enabled!=0) ? context.localUtil.Format( (decimal)(AV5jAno), "ZZZ9") : context.localUtil.Format( (decimal)(AV5jAno), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavJano_Jsonclick, 0, "AttributeWidthAuto", "", "", "", "", 1, edtavJano_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockjmes_Internalname, "Mes", "", "", lblTextblockjmes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavJmes, cmbavJmes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV6jMes), 2, 0)), 1, cmbavJmes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavJmes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeRealWidth50With", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "", true, 1, "HLP_Compras\\R_RegistroComprasOficial.htm");
            cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV6jMes), 2, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockorden_Internalname, "Orden", "", "", lblTextblockorden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavOrden, radavOrden_Internalname, StringUtil.RTrim( AV7Orden), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavOrden_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 MergeLabelCell CellWidth_12_5", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktipo_Internalname, "", "", "", lblTextblocktipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 CellWidth_87_5", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavTipo, radavTipo_Internalname, StringUtil.Str( (decimal)(AV8Tipo), 1, 0), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTipo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,52);\"", "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnimprimir_Internalname, "", "Imprimir", bttBtnbtnimprimir_Jsonclick, 5, "Imprimir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNIMPRIMIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnexcel_Internalname, "", "Excel", bttBtnbtnexcel_Jsonclick, 5, "Exportar a Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbtnsalir_Internalname, "", "Salir", bttBtnbtnsalir_Jsonclick, 5, "Salir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBTNSALIR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Compras\\R_RegistroComprasOficial.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3W2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Registro de Compras Oficial", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV6jMes = (short)(NumberUtil.Val( cmbavJmes.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV6jMes), 2, 0))), "."));
            AssignAttri("", false, "AV6jMes", StringUtil.LTrimStr( (decimal)(AV6jMes), 2, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavJmes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV6jMes), 2, 0));
         ...
         AV7Orden = StringUtil.RTrim( AV7Orden);
         AssignAttri("", false, "AV7Orden", AV7Orden);
         AV8Tipo = (short)(context.localUtil.CToN( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Tipo), 1, 0, ".", "")), ".", ","));
         AssignAttri("", false, "AV8Tipo", StringUtil.Str( (decimal)(AV8Tipo), 1, 0));
      }
      ...
      protected void STRUP3W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV5jAno = 0;
               AssignAttri("", false, "AV5jAno", StringUtil.LTrimStr( (decimal)(AV5jAno), 4, 0));
            }
            else
            {
               AV5jAno = (short)(context.localUtil.CToN( cgiGet( edtavJano_Internalname), ".", ","));
               AssignAttri("", false, "AV5jAno", StringUtil.LTrimStr( (decimal)(AV5jAno), 4, 0));
            }
            cmbavJmes.CurrentValue = cgiGet( cmbavJmes_Internalname);
            AV6jMes = (short)(NumberUtil.Val( cgiGet( cmbavJmes_Internalname), "."));
            AssignAttri("", false, "AV6jMes", StringUtil.LTrimStr( (decimal)(AV6jMes), 2, 0));
            AV7Orden = cgiGet( radavOrden_Internalname);
            AssignAttri("", false, "AV7Orden", AV7Orden);
            ...
            {
               AV8Tipo = (short)(context.localUtil.CToN( cgiGet( radavTipo_Internalname), ".", ","));
               AssignAttri("", false, "AV8Tipo", StringUtil.Str( (decimal)(AV8Tipo), 1, 0));
            }
      ...
      protected void E113W2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV5jAno = (short)(DateTimeUtil.Year( DateTimeUtil.Now( context)));
         AssignAttri("", false, "AV5jAno", StringUtil.LTrimStr( (decimal)(AV5jAno), 4, 0));
         AV6jMes = (short)(DateTimeUtil.Month( DateTimeUtil.Now( context)));
         AssignAttri("", false, "AV6jMes", StringUtil.LTrimStr( (decimal)(AV6jMes), 2, 0));
         AV7Orden = "R";
         AssignAttri("", false, "AV7Orden", AV7Orden);
         AV8Tipo = 1;
      ...
      protected void E123W2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "contabilidad.rrregistrocomprasoficial.aspx"+UrlEncode(StringUtil.LTrimStr(AV5jAno,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6jMes,2,0)) + "," + UrlEncode(StringUtil.RTrim(AV7Orden));
            Innewwindow_Target = formatLink("contabilidad.rrregistrocomprasoficial.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "contabilidad.rrregistrocomprasoficial2.aspx"+UrlEncode(StringUtil.LTrimStr(AV5jAno,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6jMes,2,0)) + "," + UrlEncode(StringUtil.RTrim(AV7Orden));
            Innewwindow_Target = formatLink("contabilidad.rrregistrocomprasoficial2.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            ucInnewwindow.SendProperty(context, "", false, Innewwindow_Internalname, "Target", Innewwindow_Target);
            this.executeUsercontrolMethod("", false, "INNEWWINDOWContainer", "OpenWindow", "", new Object[] {});
         }
      ...
      protected void E133W2( )
      {
         /* 'DoBtnExcel' Routine */
         returnInSub = false;
         GXt_int1 = (short)(AV13Ano);
         GXt_int2 = (short)(AV14Mes);
         new pregistrocomprasexcel(context ).execute( ref  GXt_int1, ref  GXt_int2, ref  AV7Orden, out  AV9ExcelFilename, out  AV10ErrorMessage) ;
         AV13Ano = (decimal)((decimal)(GXt_int1));
         AV14Mes = GXt_int2;
         AssignAttri("", false, "AV13Ano", StringUtil.LTrimStr( AV13Ano, 10, 2));
         AssignAttri("", false, "AV14Mes", StringUtil.LTrimStr( (decimal)(AV14Mes), 9, 0));
         AssignAttri("", false, "AV7Orden", AV7Orden);
         ...
         /*  Sending Event outputs  */
         radavOrden.CurrentValue = StringUtil.RTrim( AV7Orden);
         AssignProp("", false, radavOrden_Internalname, "Values", radavOrden.ToJavascriptSource(), true);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022818103169", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compras/r_registrocomprasoficial.js", "?2022818103169", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         radavOrden.WebTags = "";
         radavOrden.addItem("R", "Fecha Registro", 0);
         radavOrden.addItem("N", "Nº Registro", 0);
         radavOrden.addItem("F", "Fecha Emisión", 0);
         radavOrden.addItem("P", "Proveedor", 0);
         radavTipo.Name = "vTIPO";
         radavTipo.WebTags = "";
         radavTipo.addItem("1", "Formato 1", 0);
         radavTipo.addItem("2", "Formato 2", 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_panel1_Title = "Registro de Compras Oficial ";
         ...
         Form.Caption = "Registro de Compras Oficial";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]}");
         setEventMetadata("'DOBTNIMPRIMIR'","{handler:'E123W2',iparms:[{av:'AV5jAno',fld:'vJANO',pic:'ZZZ9'},{av:'cmbavJmes'},{av:'AV6jMes',fld:'vJMES',pic:'Z9'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]");
         setEventMetadata("'DOBTNIMPRIMIR'",",oparms:[{av:'Innewwindow_Target',ctrl:'INNEWWINDOW',prop:'Target'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]}");
         setEventMetadata("'DOBTNEXCEL'","{handler:'E133W2',iparms:[{av:'AV13Ano',fld:'vANO',pic:'9999999.99'},{av:'AV14Mes',fld:'vMES',pic:'ZZZZZZZZ9'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]");
         setEventMetadata("'DOBTNEXCEL'",",oparms:[{av:'AV14Mes',fld:'vMES',pic:'ZZZZZZZZ9'},{av:'AV13Ano',fld:'vANO',pic:'9999999.99'},{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]}");
         setEventMetadata("'DOBTNSALIR'","{handler:'E143W2',iparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]");
         setEventMetadata("'DOBTNSALIR'",",oparms:[{av:'radavOrden'},{av:'AV7Orden',fld:'vORDEN',pic:''},{av:'radavTipo'},{av:'AV8Tipo',fld:'vTIPO',pic:'9'}]}");
         return  ;
      }
      ...
      private short AV5jAno ;
      private short AV6jMes ;
      private short AV8Tipo ;
