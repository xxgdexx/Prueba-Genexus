...
namespace GeneXus.Programs.seguridad
{
	...
	[XmlType(TypeName="TreeNode" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	public class SdtTreeNodeCollection_TreeNode : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.seguridad.SdtTreeNodeCollection_TreeNode> gxTpr_Nodes_GXBaseCollection
		{
			get {
				if ( gxTv_SdtTreeNodeCollection_TreeNode_Nodes == null )
				{
					gxTv_SdtTreeNodeCollection_TreeNode_Nodes = new GXBaseCollection<GeneXus.Programs.seguridad.SdtTreeNodeCollection_TreeNode>( context, "TreeNodeCollection", "");
				}
				return gxTv_SdtTreeNodeCollection_TreeNode_Nodes;
			}
			set {
				gxTv_SdtTreeNodeCollection_TreeNode_Nodes_N = false;
				gxTv_SdtTreeNodeCollection_TreeNode_Nodes = value;
			}
		}

		[XmlIgnore]
		public GXBaseCollection<GeneXus.Programs.seguridad.SdtTreeNodeCollection_TreeNode> gxTpr_Nodes
		{
			get {
				if ( gxTv_SdtTreeNodeCollection_TreeNode_Nodes == null )
				{
		...
		protected bool gxTv_SdtTreeNodeCollection_TreeNode_Nodes_N;
		protected GXBaseCollection<GeneXus.Programs.seguridad.SdtTreeNodeCollection_TreeNode> gxTv_SdtTreeNodeCollection_TreeNode_Nodes = null;  


		#endregion
	}
	#region Rest interface
	[DataContract(Name=@"TreeNode", Namespace="SIGERP_ADVANCED")]
	public class SdtTreeNodeCollection_TreeNode_RESTInterface : GxGenericCollectionItem<SdtTreeNodeCollection_TreeNode>, System.Web.SessionState.IRequiresSessionState
	{
		...
		public  GxGenericCollection<GeneXus.Programs.seguridad.SdtTreeNodeCollection_TreeNode_RESTInterface> gxTpr_Nodes
		{
			get { 
				if (sdt.ShouldSerializegxTpr_Nodes_GXBaseCollection_Json())
					return new GxGenericCollection<GeneXus.Programs.seguridad.SdtTreeNodeCollection_TreeNode_RESTInterface>(sdt.gxTpr_Nodes);
				else
					return null;
