...
namespace GeneXus.Programs {
   public class rrresumenlistaprecioshistorico : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "rrresumenlistaprecioshistorico.aspx")), "rrresumenlistaprecioshistorico.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "rrresumenlistaprecioshistorico.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public rrresumenlistaprecioshistorico( )
      {
      ...
      public rrresumenlistaprecioshistorico( IGxContext context )
      {
      ...
      public void executeSubmit( ref string aP0_PrvCod ,
                                 ...
                                 ref DateTime aP4_FHasta )
      {
         rrresumenlistaprecioshistorico objrrresumenlistaprecioshistorico;
         objrrresumenlistaprecioshistorico = new rrresumenlistaprecioshistorico();
         objrrresumenlistaprecioshistorico.AV37PrvCod = aP0_PrvCod;
         objrrresumenlistaprecioshistorico.AV45ProdCod = aP1_ProdCod;
         objrrresumenlistaprecioshistorico.AV49LinCod = aP2_LinCod;
         objrrresumenlistaprecioshistorico.AV30FDesde = aP3_FDesde;
         objrrresumenlistaprecioshistorico.AV31FHasta = aP4_FHasta;
         objrrresumenlistaprecioshistorico.context.SetSubmitInitialConfig(context);
         objrrresumenlistaprecioshistorico.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objrrresumenlistaprecioshistorico);
         aP0_PrvCod=this.AV37PrvCod;
         aP1_ProdCod=this.AV45ProdCod;
         aP2_LinCod=this.AV49LinCod;
         aP3_FDesde=this.AV30FDesde;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((rrresumenlistaprecioshistorico)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A244PrvCod = P00A82_A244PrvCod[0];
               A247PrvDsc = P00A82_A247PrvDsc[0];
            ...
            {
               BRKA84 = false;
               A825CPLisHisProdDsc = P00A83_A825CPLisHisProdDsc[0];
               A286CPLisHisProdCod = P00A83_A286CPLisHisProdCod[0];
               A288CPLisHisFecha = P00A83_A288CPLisHisFecha[0];
               A52LinCod = P00A83_A52LinCod[0];
               n52LinCod = P00A83_n52LinCod[0];
               A287CPLisHisPrvCod = P00A83_A287CPLisHisPrvCod[0];
               A825CPLisHisProdDsc = P00A83_A825CPLisHisProdDsc[0];
               A52LinCod = P00A83_A52LinCod[0];
               n52LinCod = P00A83_n52LinCod[0];
               while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00A83_A286CPLisHisProdCod[0], A286CPLisHisProdCod) == 0 ) )
               {
                  BRKA84 = false;
                  A825CPLisHisProdDsc = P00A83_A825CPLisHisProdDsc[0];
                  A288CPLisHisFecha = P00A83_A288CPLisHisFecha[0];
      ...
      protected void S111( )
      {
         ...
         {
            A288CPLisHisFecha = P00A84_A288CPLisHisFecha[0];
            A286CPLisHisProdCod = P00A84_A286CPLisHisProdCod[0];
            A52LinCod = P00A84_A52LinCod[0];
            n52LinCod = P00A84_n52LinCod[0];
            A287CPLisHisPrvCod = P00A84_A287CPLisHisPrvCod[0];
            A824CPLisHisImpMN = P00A84_A824CPLisHisImpMN[0];
            A823CPLisHisImpME = P00A84_A823CPLisHisImpME[0];
            A826CPLisHisPrvDsc = P00A84_A826CPLisHisPrvDsc[0];
            A52LinCod = P00A84_A52LinCod[0];
            n52LinCod = P00A84_n52LinCod[0];
            A826CPLisHisPrvDsc = P00A84_A826CPLisHisPrvDsc[0];
      ...
      protected void S126( )
      {
         ...
         {
            A288CPLisHisFecha = P00A85_A288CPLisHisFecha[0];
            A286CPLisHisProdCod = P00A85_A286CPLisHisProdCod[0];
            A287CPLisHisPrvCod = P00A85_A287CPLisHisPrvCod[0];
            A824CPLisHisImpMN = P00A85_A824CPLisHisImpMN[0];
            A823CPLisHisImpME = P00A85_A823CPLisHisImpME[0];
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P00A82_A244PrvCod = new string[] {""} ;
         P00A82_A247PrvDsc = new string[] {""} ;
         A244PrvCod = "";
         A247PrvDsc = "";
         A287CPLisHisPrvCod = "";
         A286CPLisHisProdCod = "";
         A288CPLisHisFecha = DateTime.MinValue;
         P00A83_A825CPLisHisProdDsc = new string[] {""} ;
         P00A83_A286CPLisHisProdCod = new string[] {""} ;
         P00A83_A288CPLisHisFecha = new DateTime[] {DateTime.MinValue} ;
         P00A83_A52LinCod = new int[1] ;
         P00A83_n52LinCod = new bool[] {false} ;
         P00A83_A287CPLisHisPrvCod = new string[] {""} ;
         A825CPLisHisProdDsc = "";
         AV51Codigo = "";
         AV50Producto = "";
         P00A84_A288CPLisHisFecha = new DateTime[] {DateTime.MinValue} ;
         P00A84_A286CPLisHisProdCod = new string[] {""} ;
         P00A84_A52LinCod = new int[1] ;
         P00A84_n52LinCod = new bool[] {false} ;
         P00A84_A287CPLisHisPrvCod = new string[] {""} ;
         P00A84_A824CPLisHisImpMN = new decimal[1] ;
         P00A84_A823CPLisHisImpME = new decimal[1] ;
         P00A84_A826CPLisHisPrvDsc = new string[] {""} ;
         A826CPLisHisPrvDsc = "";
         AV52Proveedor = "";
         AV53CPLisHisFecha = DateTime.MinValue;
         AV58FechaANT = DateTime.MinValue;
         P00A85_A288CPLisHisFecha = new DateTime[] {DateTime.MinValue} ;
         P00A85_A286CPLisHisProdCod = new string[] {""} ;
         P00A85_A287CPLisHisPrvCod = new string[] {""} ;
         P00A85_A824CPLisHisImpMN = new decimal[1] ;
         P00A85_A823CPLisHisImpME = new decimal[1] ;
         Gx_time = "";
         Gx_date = DateTime.MinValue;
         AV42Logo = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rrresumenlistaprecioshistorico__default(),
            new Object[][] {
                new Object[] {
               P00A82_A244PrvCod, P00A82_A247PrvDsc
               }
               , new Object[] {
               P00A83_A825CPLisHisProdDsc, P00A83_A286CPLisHisProdCod, P00A83_A288CPLisHisFecha, P00A83_A52LinCod, P00A83_n52LinCod, P00A83_A287CPLisHisPrvCod
               }
               , new Object[] {
               P00A84_A288CPLisHisFecha, P00A84_A286CPLisHisProdCod, P00A84_A52LinCod, P00A84_n52LinCod, P00A84_A287CPLisHisPrvCod, P00A84_A824CPLisHisImpMN, P00A84_A823CPLisHisImpME, P00A84_A826CPLisHisPrvDsc
               }
               , new Object[] {
               P00A85_A288CPLisHisFecha, P00A85_A286CPLisHisProdCod, P00A85_A287CPLisHisPrvCod, P00A85_A824CPLisHisImpMN, P00A85_A823CPLisHisImpME
               }
            }
         );
      ...
      private string[] P00A82_A244PrvCod ;
      private string[] P00A82_A247PrvDsc ;
      private string[] P00A83_A825CPLisHisProdDsc ;
      private string[] P00A83_A286CPLisHisProdCod ;
      private DateTime[] P00A83_A288CPLisHisFecha ;
      private int[] P00A83_A52LinCod ;
      private bool[] P00A83_n52LinCod ;
      private string[] P00A83_A287CPLisHisPrvCod ;
      private DateTime[] P00A84_A288CPLisHisFecha ;
      private string[] P00A84_A286CPLisHisProdCod ;
      private int[] P00A84_A52LinCod ;
      private bool[] P00A84_n52LinCod ;
      private string[] P00A84_A287CPLisHisPrvCod ;
      private decimal[] P00A84_A824CPLisHisImpMN ;
      private decimal[] P00A84_A823CPLisHisImpME ;
      private string[] P00A84_A826CPLisHisPrvDsc ;
      private DateTime[] P00A85_A288CPLisHisFecha ;
      private string[] P00A85_A286CPLisHisProdCod ;
      private string[] P00A85_A287CPLisHisPrvCod ;
      private decimal[] P00A85_A824CPLisHisImpMN ;
      private decimal[] P00A85_A823CPLisHisImpME ;
   }

   public class rrresumenlistaprecioshistorico__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00A83( IGxContext context ,
                                             string AV37PrvCod ,
                                             string AV45ProdCod ,
                                             int AV49LinCod ,
      ...
      protected Object[] conditional_P00A84( IGxContext context ,
                                             string AV37PrvCod ,
                                             int AV49LinCod ,
                                             string A287CPLisHisPrvCod ,
                                             int A52LinCod ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00A83(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] );
               case 2 :
                     return conditional_P00A84(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (int)dynConstraints[3] , (DateTime)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00A82", "SELECT [PrvCod], [PrvDsc] FROM [CPPROVEEDORES] WHERE [PrvCod] = @AV37PrvCod ORDER BY [PrvCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A82,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00A83", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A83,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00A84", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A84,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00A85", "SELECT [CPLisHisFecha], [CPLisHisProdCod] AS CPLisHisProdCod, [CPLisHisPrvCod] AS CPLisHisPrvCod, [CPLisHisImpMN], [CPLisHisImpME] FROM [CPLISTAPRECIOSHIS] WHERE ([CPLisHisProdCod] = @AV51Codigo and [CPLisHisPrvCod] = @AV52Proveedor) AND ([CPLisHisFecha] < @AV30FDesde) ORDER BY [CPLisHisProdCod], [CPLisHisPrvCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00A85,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
