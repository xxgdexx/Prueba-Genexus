...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Filter" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	public class SdtQueryViewerItemDoubleClickData_Filter : GxUserType
	{
		...
		public GxSimpleCollection<string> gxTpr_Values_GxSimpleCollection
		{
			...
			set {
				gxTv_SdtQueryViewerItemDoubleClickData_Filter_Values_N = false;
		...
		{
			gxTv_SdtQueryViewerItemDoubleClickData_Filter_Values_N = true;
		...
		{
			return gxTv_SdtQueryViewerItemDoubleClickData_Filter_Values == null;
		}
		...
		protected bool gxTv_SdtQueryViewerItemDoubleClickData_Filter_Values_N;
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Filter", Namespace="SIGERP_ADVANCED")]
