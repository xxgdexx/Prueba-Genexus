...
namespace GeneXus.Programs.wwpbaseobjects {
   public class exportoptions : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228181027225", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         GXEncryptionTmp = "wwpbaseobjects.exportoptions.aspx"+UrlEncode(StringUtil.RTrim(AV12ExcelFileName)) + "," + UrlEncode(StringUtil.RTrim(AV9DefaultTitle));
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_092( true) ;
         }
         else
         {
            wb_table1_6_092( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_092e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void E13092( )
      {
         ...
         returnInSub = false;
         AV15GoogleDocsResult.FromXml(AV14GoogleDocResultXML, null, "", "");
      ...
      protected void wb_table1_6_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_15_092( true) ;
         }
         else
         {
            wb_table2_15_092( false) ;
         }
         return  ;
      }

      protected void wb_table2_15_092e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_52_092( true) ;
         }
         else
         {
            wb_table3_52_092( false) ;
         }
         return  ;
      }

      protected void wb_table3_52_092e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_6_092e( true) ;
         }
         else
         {
            wb_table1_6_092e( false) ;
         }
      }

      protected void wb_table3_52_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_52_092e( true) ;
         }
         else
         {
            wb_table3_52_092e( false) ;
         }
      }

      protected void wb_table2_15_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_element( context, cmbavExporttype_Internalname, "Tipo de exportación", "col-sm-3 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavExporttype, cmbavExporttype_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV13ExportType), 1, 0)), 1, cmbavExporttype_Jsonclick, 7, "'"+""+"'"+",false,"+"'"+"e15091_client"+"'", "int", "", 1, cmbavExporttype.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "", true, 1, "HLP_WWPBaseObjects\\ExportOptions.htm");
            cmbavExporttype.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV13ExportType), 1, 0));
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='ExportOptionsPanellCell'>") ;
            wb_table4_28_092( true) ;
         }
         else
         {
            wb_table4_28_092( false) ;
         }
         return  ;
      }

      protected void wb_table4_28_092e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_15_092e( true) ;
         }
         else
         {
            wb_table2_15_092e( false) ;
         }
      }

      protected void wb_table4_28_092( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavDoctitle_Internalname, "Título del documento", "col-sm-3 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_28_092e( true) ;
         }
         else
         {
            wb_table4_28_092e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281810272326", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/exportoptions.js", "?202281810272327", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DODOWNLOADTOFILE'","{handler:'E12092',iparms:[]");
         setEventMetadata("'DODOWNLOADTOFILE'",",oparms:[]}");
         setEventMetadata("'DOSAVEGOOGLEDRIVE'","{handler:'E13092',iparms:[{av:'AV14GoogleDocResultXML',fld:'vGOOGLEDOCRESULTXML',pic:'',hsh:true}]");
         ...
         setEventMetadata("VEXPORTTYPE.CLICK","{handler:'E15091',iparms:[{av:'cmbavExporttype'},{av:'AV13ExportType',fld:'vEXPORTTYPE',pic:'9'}]");
