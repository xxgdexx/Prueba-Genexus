...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwptabbedview : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281811383230", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wwpbaseobjects.wwptabbedview.aspx"+UrlEncode(StringUtil.RTrim(AV7TabCode));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("wwpbaseobjects.wwptabbedview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.wwptabbedview.aspx")), "wwpbaseobjects.wwptabbedview.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.wwptabbedview.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void wb_table2_5_132( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='TableAttributesCell'>") ;
            wb_table3_8_132( true) ;
         }
         else
         {
            wb_table3_8_132( false) ;
         }
         return  ;
      }

      protected void wb_table3_8_132e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_8_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table4_11_132( true) ;
         }
         else
         {
            wb_table4_11_132( false) ;
         }
         return  ;
      }

      protected void wb_table4_11_132e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table5_31_132( true) ;
         }
         else
         {
            wb_table5_31_132( false) ;
         }
         return  ;
      }

      protected void wb_table5_31_132e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_8_132e( true) ;
         }
         else
         {
            wb_table3_8_132e( false) ;
         }
      }

      protected void wb_table5_31_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table6_34_132( true) ;
         }
         else
         {
            wb_table6_34_132( false) ;
         }
         return  ;
      }

      protected void wb_table6_34_132e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_31_132e( true) ;
         }
         else
         {
            wb_table5_31_132e( false) ;
         }
      }

      protected void wb_table6_34_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table6_34_132e( true) ;
         }
         else
         {
            wb_table6_34_132e( false) ;
         }
      }

      protected void wb_table4_11_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 14 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_11_132e( true) ;
         }
         else
         {
            wb_table4_11_132e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281811383263", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/wwptabbedview.js", "?202281811383263", false, true);
      ...
      {
         AV5Tabs = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWPTabOptions_TabOptionsItem>( context, "TabOptionsItem", "SIGERP_ADVANCED");
         wcpOAV7TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
