...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Format.ValueStyle" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerElements.Element.Format.ValueStyle", Namespace="SIGERP_ADVANCED")]
