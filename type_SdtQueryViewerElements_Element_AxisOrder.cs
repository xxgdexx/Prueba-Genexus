...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.AxisOrder" , Namespace="SIGERP_ADVANCED" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerElements.Element.AxisOrder", Namespace="SIGERP_ADVANCED")]
