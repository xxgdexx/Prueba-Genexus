...
namespace GeneXus.Programs {
   public class rrresumenventasxproducto : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "rrresumenventasxproducto.aspx")), "rrresumenventasxproducto.aspx") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "rrresumenventasxproducto.aspx")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public rrresumenventasxproducto( )
      {
      ...
      public rrresumenventasxproducto( IGxContext context )
      {
      ...
      public void executeSubmit( ref int aP0_VenCod ,
                                 ...
                                 ref int aP8_TieCod )
      {
         rrresumenventasxproducto objrrresumenventasxproducto;
         objrrresumenventasxproducto = new rrresumenventasxproducto();
         objrrresumenventasxproducto.AV98VenCod = aP0_VenCod;
         objrrresumenventasxproducto.AV65ProdCod = aP1_ProdCod;
         objrrresumenventasxproducto.AV15CliCod = aP2_CliCod;
         objrrresumenventasxproducto.AV43Fdesde = aP3_Fdesde;
         objrrresumenventasxproducto.AV45FHasta = aP4_FHasta;
         objrrresumenventasxproducto.AV55LinCod = aP5_LinCod;
         objrrresumenventasxproducto.AV71SubLCod = aP6_SubLCod;
         objrrresumenventasxproducto.AV80Tipo = aP7_Tipo;
         objrrresumenventasxproducto.AV76TieCod = aP8_TieCod;
         objrrresumenventasxproducto.context.SetSubmitInitialConfig(context);
         objrrresumenventasxproducto.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objrrresumenventasxproducto);
         aP0_VenCod=this.AV98VenCod;
         aP1_ProdCod=this.AV65ProdCod;
         aP2_CliCod=this.AV15CliCod;
         aP3_Fdesde=this.AV43Fdesde;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((rrresumenventasxproducto)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               BRKEM3 = false;
               A149TipCod = P00EM2_A149TipCod[0];
               A24DocNum = P00EM2_A24DocNum[0];
               A1153LinDsc = P00EM2_A1153LinDsc[0];
               A52LinCod = P00EM2_A52LinCod[0];
               A941DocSts = P00EM2_A941DocSts[0];
               A946DocTipo = P00EM2_A946DocTipo[0];
               A227DocVendCod = P00EM2_A227DocVendCod[0];
               A51SublCod = P00EM2_A51SublCod[0];
               n51SublCod = P00EM2_n51SublCod[0];
               A28ProdCod = P00EM2_A28ProdCod[0];
               A231DocCliCod = P00EM2_A231DocCliCod[0];
               A232DocFec = P00EM2_A232DocFec[0];
               A178TieCod = P00EM2_A178TieCod[0];
               n178TieCod = P00EM2_n178TieCod[0];
               A894DocDpre = P00EM2_A894DocDpre[0];
               A233DocItem = P00EM2_A233DocItem[0];
               A941DocSts = P00EM2_A941DocSts[0];
               A946DocTipo = P00EM2_A946DocTipo[0];
               A227DocVendCod = P00EM2_A227DocVendCod[0];
               A231DocCliCod = P00EM2_A231DocCliCod[0];
               ...
               n51SublCod = P00EM2_n51SublCod[0];
               A1153LinDsc = P00EM2_A1153LinDsc[0];
               while ( (pr_default.getStatus(0) != 101) && ( P00EM2_A52LinCod[0] == A52LinCod ) )
               {
                  BRKEM3 = false;
                  A149TipCod = P00EM2_A149TipCod[0];
                  A24DocNum = P00EM2_A24DocNum[0];
               ...
               AV57LineaCod = A52LinCod;
               AV56Linea = A1153LinDsc;
               AV73TCantidad = 0.00m;
               AV91TTotalMN = 0.00m;
               AV90TTotalME = 0.00m;
               ...
               HEM0( false, 40) ;
               getPrinter().GxDrawLine(93, Gx_line+8, 1095, Gx_line+8, 1, 0, 0, 0, 0) ;
               ...
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV56Linea, "")), 93, Gx_line+15, 383, Gx_line+29, 0, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
            ...
            pr_default.close(0);
            HEM0( false, 60) ;
            getPrinter().GxDrawLine(95, Gx_line+17, 1097, Gx_line+17, 1, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Tahoma", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
      ...
      protected void S111( )
      {
         ...
         /* Using cursor P00EM3 */
         pr_default.execute(1, new Object[] {AV43Fdesde, AV45FHasta, AV57LineaCod, AV76TieCod, AV15CliCod, AV65ProdCod, AV71SubLCod, AV98VenCod});
         while ( (pr_default.getStatus(1) != 101) )
         {
            BRKEM5 = false;
            A149TipCod = P00EM3_A149TipCod[0];
            A24DocNum = P00EM3_A24DocNum[0];
            A49UniCod = P00EM3_A49UniCod[0];
            A55ProdDsc = P00EM3_A55ProdDsc[0];
            A28ProdCod = P00EM3_A28ProdCod[0];
            A941DocSts = P00EM3_A941DocSts[0];
            A946DocTipo = P00EM3_A946DocTipo[0];
            A227DocVendCod = P00EM3_A227DocVendCod[0];
            A51SublCod = P00EM3_A51SublCod[0];
            n51SublCod = P00EM3_n51SublCod[0];
            A231DocCliCod = P00EM3_A231DocCliCod[0];
            A52LinCod = P00EM3_A52LinCod[0];
            A232DocFec = P00EM3_A232DocFec[0];
            A178TieCod = P00EM3_A178TieCod[0];
            n178TieCod = P00EM3_n178TieCod[0];
            A894DocDpre = P00EM3_A894DocDpre[0];
            A1997UniAbr = P00EM3_A1997UniAbr[0];
            A233DocItem = P00EM3_A233DocItem[0];
            A941DocSts = P00EM3_A941DocSts[0];
            A946DocTipo = P00EM3_A946DocTipo[0];
            A227DocVendCod = P00EM3_A227DocVendCod[0];
            A231DocCliCod = P00EM3_A231DocCliCod[0];
            ...
            A52LinCod = P00EM3_A52LinCod[0];
            A1997UniAbr = P00EM3_A1997UniAbr[0];
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00EM3_A28ProdCod[0], A28ProdCod) == 0 ) )
            {
               BRKEM5 = false;
               A149TipCod = P00EM3_A149TipCod[0];
               A24DocNum = P00EM3_A24DocNum[0];
            ...
            getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( AV11Cantidad, "ZZZZZZZZZZZZ9.9999")), 429, Gx_line+4, 543, Gx_line+19, 2+256, 0, 0, 0) ;
      ...
      protected void S125( )
      {
         ...
         /* Using cursor P00EM4 */
         pr_default.execute(2, new Object[] {AV67Producto, AV43Fdesde, AV45FHasta, AV57LineaCod, AV76TieCod, AV15CliCod, AV71SubLCod, AV98VenCod});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A941DocSts = P00EM4_A941DocSts[0];
            A946DocTipo = P00EM4_A946DocTipo[0];
            A227DocVendCod = P00EM4_A227DocVendCod[0];
            A51SublCod = P00EM4_A51SublCod[0];
            n51SublCod = P00EM4_n51SublCod[0];
            A231DocCliCod = P00EM4_A231DocCliCod[0];
            A28ProdCod = P00EM4_A28ProdCod[0];
            A52LinCod = P00EM4_A52LinCod[0];
            A232DocFec = P00EM4_A232DocFec[0];
            A178TieCod = P00EM4_A178TieCod[0];
            n178TieCod = P00EM4_n178TieCod[0];
            A894DocDpre = P00EM4_A894DocDpre[0];
            A149TipCod = P00EM4_A149TipCod[0];
            A24DocNum = P00EM4_A24DocNum[0];
            A230DocMonCod = P00EM4_A230DocMonCod[0];
            A226DocMovCod = P00EM4_A226DocMovCod[0];
            A899DocDcto = P00EM4_A899DocDcto[0];
            A892DocDTot = P00EM4_A892DocDTot[0];
            A511TipSigno = P00EM4_A511TipSigno[0];
            A895DocDCan = P00EM4_A895DocDCan[0];
            A882DocAnticipos = P00EM4_A882DocAnticipos[0];
            A929DocFecRef = P00EM4_A929DocFecRef[0];
            A233DocItem = P00EM4_A233DocItem[0];
            A51SublCod = P00EM4_A51SublCod[0];
            n51SublCod = P00EM4_n51SublCod[0];
            A52LinCod = P00EM4_A52LinCod[0];
            A511TipSigno = P00EM4_A511TipSigno[0];
      ...
      protected void S137( )
      {
         ...
         {
            A235MovVCod = P00EM5_A235MovVCod[0];
            A1242MovVAbr = P00EM5_A1242MovVAbr[0];
      ...
      protected void S147( )
      {
         ...
         {
            A24DocNum = P00EM7_A24DocNum[0];
            A149TipCod = P00EM7_A149TipCod[0];
            A927DocSubExonerado = P00EM7_A927DocSubExonerado[0];
            A922DocSubSelectivo = P00EM7_A922DocSubSelectivo[0];
            A921DocSubInafecto = P00EM7_A921DocSubInafecto[0];
            A920DocSubAfecto = P00EM7_A920DocSubAfecto[0];
            A927DocSubExonerado = P00EM7_A927DocSubExonerado[0];
            A922DocSubSelectivo = P00EM7_A922DocSubSelectivo[0];
            A921DocSubInafecto = P00EM7_A921DocSubInafecto[0];
            A920DocSubAfecto = P00EM7_A920DocSubAfecto[0];
      ...
      protected void HEM0( bool bFoot ,
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               ...
               getPrinter().GxDrawText("Resumen de Ventas por Producto", 425, Gx_line+28, 708, Gx_line+48, 0+256, 0, 0, 0) ;
               getPrinter().GxAttris("Tahoma", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
      ...
      public override void initialize( )
      {
         ...
         A941DocSts = "";
         P00EM2_A149TipCod = new string[] {""} ;
         P00EM2_A24DocNum = new string[] {""} ;
         P00EM2_A1153LinDsc = new string[] {""} ;
         P00EM2_A52LinCod = new int[1] ;
         P00EM2_A941DocSts = new string[] {""} ;
         P00EM2_A946DocTipo = new string[] {""} ;
         P00EM2_A227DocVendCod = new int[1] ;
         P00EM2_A51SublCod = new int[1] ;
         P00EM2_n51SublCod = new bool[] {false} ;
         P00EM2_A28ProdCod = new string[] {""} ;
         P00EM2_A231DocCliCod = new string[] {""} ;
         P00EM2_A232DocFec = new DateTime[] {DateTime.MinValue} ;
         P00EM2_A178TieCod = new int[1] ;
         P00EM2_n178TieCod = new bool[] {false} ;
         P00EM2_A894DocDpre = new decimal[1] ;
         P00EM2_A233DocItem = new long[1] ;
         A149TipCod = "";
         A24DocNum = "";
         A1153LinDsc = "";
         AV56Linea = "";
         P00EM3_A149TipCod = new string[] {""} ;
         P00EM3_A24DocNum = new string[] {""} ;
         P00EM3_A49UniCod = new int[1] ;
         P00EM3_A55ProdDsc = new string[] {""} ;
         P00EM3_A28ProdCod = new string[] {""} ;
         P00EM3_A941DocSts = new string[] {""} ;
         P00EM3_A946DocTipo = new string[] {""} ;
         P00EM3_A227DocVendCod = new int[1] ;
         P00EM3_A51SublCod = new int[1] ;
         P00EM3_n51SublCod = new bool[] {false} ;
         P00EM3_A231DocCliCod = new string[] {""} ;
         P00EM3_A52LinCod = new int[1] ;
         P00EM3_A232DocFec = new DateTime[] {DateTime.MinValue} ;
         P00EM3_A178TieCod = new int[1] ;
         P00EM3_n178TieCod = new bool[] {false} ;
         P00EM3_A894DocDpre = new decimal[1] ;
         P00EM3_A1997UniAbr = new string[] {""} ;
         P00EM3_A233DocItem = new long[1] ;
         A55ProdDsc = "";
         A1997UniAbr = "";
         AV67Producto = "";
         AV66ProdDsc = "";
         AV97UniAbr = "";
         P00EM4_A941DocSts = new string[] {""} ;
         P00EM4_A946DocTipo = new string[] {""} ;
         P00EM4_A227DocVendCod = new int[1] ;
         P00EM4_A51SublCod = new int[1] ;
         P00EM4_n51SublCod = new bool[] {false} ;
         P00EM4_A231DocCliCod = new string[] {""} ;
         P00EM4_A28ProdCod = new string[] {""} ;
         P00EM4_A52LinCod = new int[1] ;
         P00EM4_A232DocFec = new DateTime[] {DateTime.MinValue} ;
         P00EM4_A178TieCod = new int[1] ;
         P00EM4_n178TieCod = new bool[] {false} ;
         P00EM4_A894DocDpre = new decimal[1] ;
         P00EM4_A149TipCod = new string[] {""} ;
         P00EM4_A24DocNum = new string[] {""} ;
         P00EM4_A230DocMonCod = new int[1] ;
         P00EM4_A226DocMovCod = new int[1] ;
         P00EM4_A899DocDcto = new decimal[1] ;
         P00EM4_A892DocDTot = new decimal[1] ;
         P00EM4_A511TipSigno = new short[1] ;
         P00EM4_A895DocDCan = new decimal[1] ;
         P00EM4_A882DocAnticipos = new decimal[1] ;
         P00EM4_A929DocFecRef = new DateTime[] {DateTime.MinValue} ;
         P00EM4_A233DocItem = new long[1] ;
         A929DocFecRef = DateTime.MinValue;
         AV79TipCod = "";
         AV30DocNum = "";
         AV44Fecha = DateTime.MinValue;
         GXt_char3 = "";
         P00EM5_A235MovVCod = new int[1] ;
         P00EM5_A1242MovVAbr = new string[] {""} ;
         A1242MovVAbr = "";
         P00EM7_A24DocNum = new string[] {""} ;
         P00EM7_A149TipCod = new string[] {""} ;
         P00EM7_A927DocSubExonerado = new decimal[1] ;
         P00EM7_A922DocSubSelectivo = new decimal[1] ;
         P00EM7_A921DocSubInafecto = new decimal[1] ;
         P00EM7_A920DocSubAfecto = new decimal[1] ;
         Gx_time = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rrresumenventasxproducto__default(),
            new Object[][] {
                new Object[] {
               P00EM2_A149TipCod, P00EM2_A24DocNum, P00EM2_A1153LinDsc, P00EM2_A52LinCod, P00EM2_A941DocSts, P00EM2_A946DocTipo, P00EM2_A227DocVendCod, P00EM2_A51SublCod, P00EM2_n51SublCod, P00EM2_A28ProdCod,
               P00EM2_A231DocCliCod, P00EM2_A232DocFec, P00EM2_A178TieCod, P00EM2_n178TieCod, P00EM2_A894DocDpre, P00EM2_A233DocItem
               }
               , new Object[] {
               P00EM3_A149TipCod, P00EM3_A24DocNum, P00EM3_A49UniCod, P00EM3_A55ProdDsc, P00EM3_A28ProdCod, P00EM3_A941DocSts, P00EM3_A946DocTipo, P00EM3_A227DocVendCod, P00EM3_A51SublCod, P00EM3_n51SublCod,
               P00EM3_A231DocCliCod, P00EM3_A52LinCod, P00EM3_A232DocFec, P00EM3_A178TieCod, P00EM3_n178TieCod, P00EM3_A894DocDpre, P00EM3_A1997UniAbr, P00EM3_A233DocItem
               }
               , new Object[] {
               P00EM4_A941DocSts, P00EM4_A946DocTipo, P00EM4_A227DocVendCod, P00EM4_A51SublCod, P00EM4_n51SublCod, P00EM4_A231DocCliCod, P00EM4_A28ProdCod, P00EM4_A52LinCod, P00EM4_A232DocFec, P00EM4_A178TieCod,
               P00EM4_n178TieCod, P00EM4_A894DocDpre, P00EM4_A149TipCod, P00EM4_A24DocNum, P00EM4_A230DocMonCod, P00EM4_A226DocMovCod, P00EM4_A899DocDcto, P00EM4_A892DocDTot, P00EM4_A511TipSigno, P00EM4_A895DocDCan,
               P00EM4_A882DocAnticipos, P00EM4_A929DocFecRef, P00EM4_A233DocItem
               }
               , new Object[] {
               P00EM5_A235MovVCod, P00EM5_A1242MovVAbr
               }
               , new Object[] {
               P00EM7_A24DocNum, P00EM7_A149TipCod, P00EM7_A927DocSubExonerado, P00EM7_A922DocSubSelectivo, P00EM7_A921DocSubInafecto, P00EM7_A920DocSubAfecto
               }
            }
         );
      ...
      private string[] P00EM2_A149TipCod ;
      private string[] P00EM2_A24DocNum ;
      private string[] P00EM2_A1153LinDsc ;
      private int[] P00EM2_A52LinCod ;
      private string[] P00EM2_A941DocSts ;
      private string[] P00EM2_A946DocTipo ;
      private int[] P00EM2_A227DocVendCod ;
      private int[] P00EM2_A51SublCod ;
      private bool[] P00EM2_n51SublCod ;
      private string[] P00EM2_A28ProdCod ;
      private string[] P00EM2_A231DocCliCod ;
      private DateTime[] P00EM2_A232DocFec ;
      private int[] P00EM2_A178TieCod ;
      private bool[] P00EM2_n178TieCod ;
      private decimal[] P00EM2_A894DocDpre ;
      private long[] P00EM2_A233DocItem ;
      private string[] P00EM3_A149TipCod ;
      private string[] P00EM3_A24DocNum ;
      private int[] P00EM3_A49UniCod ;
      private string[] P00EM3_A55ProdDsc ;
      private string[] P00EM3_A28ProdCod ;
      private string[] P00EM3_A941DocSts ;
      private string[] P00EM3_A946DocTipo ;
      private int[] P00EM3_A227DocVendCod ;
      private int[] P00EM3_A51SublCod ;
      private bool[] P00EM3_n51SublCod ;
      private string[] P00EM3_A231DocCliCod ;
      private int[] P00EM3_A52LinCod ;
      private DateTime[] P00EM3_A232DocFec ;
      private int[] P00EM3_A178TieCod ;
      private bool[] P00EM3_n178TieCod ;
      private decimal[] P00EM3_A894DocDpre ;
      private string[] P00EM3_A1997UniAbr ;
      private long[] P00EM3_A233DocItem ;
      private string[] P00EM4_A941DocSts ;
      private string[] P00EM4_A946DocTipo ;
      private int[] P00EM4_A227DocVendCod ;
      private int[] P00EM4_A51SublCod ;
      private bool[] P00EM4_n51SublCod ;
      private string[] P00EM4_A231DocCliCod ;
      private string[] P00EM4_A28ProdCod ;
      private int[] P00EM4_A52LinCod ;
      private DateTime[] P00EM4_A232DocFec ;
      private int[] P00EM4_A178TieCod ;
      private bool[] P00EM4_n178TieCod ;
      private decimal[] P00EM4_A894DocDpre ;
      private string[] P00EM4_A149TipCod ;
      private string[] P00EM4_A24DocNum ;
      private int[] P00EM4_A230DocMonCod ;
      private int[] P00EM4_A226DocMovCod ;
      private decimal[] P00EM4_A899DocDcto ;
      private decimal[] P00EM4_A892DocDTot ;
      private short[] P00EM4_A511TipSigno ;
      private decimal[] P00EM4_A895DocDCan ;
      private decimal[] P00EM4_A882DocAnticipos ;
      private DateTime[] P00EM4_A929DocFecRef ;
      private long[] P00EM4_A233DocItem ;
      private int[] P00EM5_A235MovVCod ;
      private string[] P00EM5_A1242MovVAbr ;
      private string[] P00EM7_A24DocNum ;
      private string[] P00EM7_A149TipCod ;
      private decimal[] P00EM7_A927DocSubExonerado ;
      private decimal[] P00EM7_A922DocSubSelectivo ;
      private decimal[] P00EM7_A921DocSubInafecto ;
      private decimal[] P00EM7_A920DocSubAfecto ;
   }

   public class rrresumenventasxproducto__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P00EM3( IGxContext context ,
                                             int AV76TieCod ,
                                             string AV15CliCod ,
                                             string AV65ProdCod ,
                                             int AV71SubLCod ,
                                             ...
                                             int AV57LineaCod )
      {
         ...
         AddWhere(sWhereString, "(T2.[DocFec] <= @AV45FHasta)");
         AddWhere(sWhereString, "(T2.[DocSts] <> 'A')");
         AddWhere(sWhereString, "(T3.[LinCod] = @AV57LineaCod)");
         if ( ! (0==AV76TieCod) )
         {
            AddWhere(sWhereString, "(T2.[TieCod] = @AV76TieCod)");
         }
      ...
      protected Object[] conditional_P00EM4( IGxContext context ,
                                             int AV76TieCod ,
                                             string AV15CliCod ,
                                             int AV71SubLCod ,
                                             int AV98VenCod ,
                                             ...
                                             string A28ProdCod )
      {
         ...
         AddWhere(sWhereString, "(T2.[LinCod] = @AV57LineaCod)");
         if ( ! (0==AV76TieCod) )
         {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15CliCod)) )
         {
            AddWhere(sWhereString, "(T4.[DocCliCod] = @AV15CliCod)");
         }
         else
         {
            GXv_int8[5] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV43Fdesde",GXType.Date,8,0) ,
          new ParDef("@AV45FHasta",GXType.Date,8,0) ,
          new ParDef("@AV57LineaCod",GXType.Int32,6,0) ,
          new ParDef("@AV76TieCod",GXType.Int32,6,0) ,
          new ParDef("@AV15CliCod",GXType.NChar,20,0) ,
          new ParDef("@AV65ProdCod",GXType.NChar,15,0) ,
          new ParDef("@AV71SubLCod",GXType.Int32,6,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00EM3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EM3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00EM4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EM4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00EM5", "SELECT [MovVCod], [MovVAbr] FROM [CMOVVENTAS] WHERE [MovVCod] = @AV29DocMovCod ORDER BY [MovVCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EM5,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00EM7", "SELECT T1.[DocNum], T1.[TipCod], COALESCE( T2.[DocSubExonerado], 0) AS DocSubExonerado, COALESCE( T2.[DocSubSelectivo], 0) AS DocSubSelectivo, COALESCE( T2.[DocSubInafecto], 0) AS DocSubInafecto, COALESCE( T2.[DocSubAfecto], 0) AS DocSubAfecto FROM ([CLVENTAS] T1 LEFT JOIN (SELECT SUM(CASE  WHEN [DocDIna] = 0 THEN [DocDTot] ELSE 0 END) AS DocSubAfecto, [TipCod], [DocNum], SUM(CASE  WHEN [DocDIna] = 1 THEN [DocDTot] ELSE 0 END) AS DocSubInafecto, SUM(( ROUND(CAST(( [DocDTot] * CAST([DocDPorSel] AS decimal( 28, 10))) AS decimal( 30, 10)) / 100, 2)) + ( [DocDCan] * CAST([DocDValSel] AS decimal( 25, 10)))) AS DocSubSelectivo, SUM(CASE  WHEN [DocDIna] = 2 THEN [DocDTot] ELSE 0 END) AS DocSubExonerado FROM [CLVENTASDET] GROUP BY [TipCod], [DocNum] ) T2 ON T2.[TipCod] = T1.[TipCod] AND T2.[DocNum] = T1.[DocNum]) WHERE T1.[TipCod] = @AV79TipCod and T1.[DocNum] = @AV30DocNum ORDER BY T1.[TipCod], T1.[DocNum] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00EM7,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
